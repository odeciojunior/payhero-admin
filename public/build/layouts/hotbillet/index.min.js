      ...
      success: function success(response) {
        ...
        if (isEmpty(response.projects)) {
          ...
          for (var i = 0; i < projects.length; i++) {
            $("#select_projects_edit").append("<option value=\"".concat(projects[i].id, "\">").concat(projects[i].name, "</option>"));
            $("#select_projects_create").append("<option value=\"".concat(projects[i].id, "\">").concat(projects[i].name, "</option>"));
          }
