...
$(document).ready(function () {
  ...
  _updateList = function updateList() {
        ...
        if (isEmpty(response.data)) {
          ...
          $.each(response.data, function (index, value) {
            ...
            */
            ...
            data += "\n                            <tr class='".concat(tableClass, " text-center'>\n                                <td class='display-sm-none display-m-none display-lg-none text-center'>\n                                    ").concat(value.sale_code, "\n                                </td>\n                                <td>").concat(value.project, "</td>\n                                <td>").concat(value.product, "</td>\n                                <td class='display-sm-one display-m-none display-lg-none'>").concat(value.customer, "</td>\n\n                                <td class='display-sm-one display-m-one'>").concat(value.start_date, "</td>\n                                <td>\n                                    <a role='button' class='detalhes-black-antifraud pointer' sale='").concat(value.sale_code, "'>\n                                        <span class=\"o-eye-1\"></span>\n                                    </a>\n                                </td>\n                            </tr>\n                        ");
          });
          $("#dados_tabela").append(data);
          pagination(response, "sales-atifraud-blacklist", _updateList);
...
$(function () {
  $(document).on("click", ".detalhes-black-antifraud", function () {
    var sale = $(this).attr("sale").replace("#", "");
  ...
  function renderSale(sale) {
    ...
    $("#payment-type").text("Pagamento via ".concat(sale.payment_method === 2 ? "Boleto" : "Cartao " + sale.flag, " em ").concat(sale.start_date, " "));
    var status = $(".modal-body-detalhes-black-antifraud #status");
    status.html("").append("<img style='width: 50px;' src='/build/global/img/cartoes/".concat(sale.flag, ".png' alt='Cartao utilizado'>"));
  ...
  function renderProducts(products) {
    ...
    var div = "";
    var photo = "/build/global/img/produto.img";
    $.each(products, function (index, value) {
      if (!value.photo) {
        value.photo = photo;
      }

      div += "<div class=\"row align-items-baseline justify-content-between mb-15\">\n                        <div class=\"col-lg-2\">\n                            <img onerror=this.src='/build/global/img/produto.png' src='".concat(value.photo, "' width='50px' style='border-radius: 6px;'>\n                        </div>\n                        <div class=\"col-lg-5\">\n                            <h4 class=\"table-title\">").concat(value.name, "</h4>\n                        </div>\n                        <div class=\"col-lg-3 text-right\">\n                            <p class=\"sm-text text-muted\">").concat(value.amount, "x</p>\n                        </div>\n                    </div>");
  ...
  function renderClient(customer) {
    ...
    $("#customer-telephone").val(customer.telephone).attr("customer", customer.code).mask("+0#");
    $("#customer-email").val(customer.email).attr("customer", customer.code);
