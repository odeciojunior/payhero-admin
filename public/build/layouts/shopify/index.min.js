$(document).ready(function () {
  ...
  getCompaniesAndProjects().done(function (data) {
    ...
    if (companiesAndProjects.company_default_fullname.length > 40) $('.company_name').val(companiesAndProjects.company_default_fullname.substring(0, 40) + '...');else $('.company_name').val(companiesAndProjects.company_default_fullname);
    getCompanies();
  });
  ...
  function getShopifyIntegrations() {
    $.ajax({
      ...
      success: function success(response) {
        var shopifyIntegrations = response.data;
        $("#content").html("");
  ...
  $(".sync-template").click(function () {
    syncAction = "template";
    toggle_confirm("Template", "Antes de sincronizar um novo tema em sua loja, tenha em mente que as configurações feitas antes serão atualizadas, <strong> podendo alterar o funcionamento de sua loja.</strong>");
  });
