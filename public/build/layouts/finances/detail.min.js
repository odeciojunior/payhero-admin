$(function () {
  ...
  $(document).on("click", ".details_transaction", function () {
    var withdrawal = $(this).attr("withdrawal");
    ...
    $.ajax({
      ...
      success: function success(response) {
        $("#withdrawal-code").html("<span class=\"mr-30\">ID #".concat(response.id, "</span><span>Solicitado em ").concat(response.date_request, "</span>"));
        if (response.debt_pending_value != null && response.debt_pending_value != "R$ 0,00") {
          $("#pending_debt").show().html("\n                        <span class=\"mr-30\" style=\"color:#FF0404;\">\n                            Desconto de - ".concat(response.debt_pending_value, " em d\xE9bitos pendentes\n                        </span>\n                    "));
        }
        var dataHtml = "";
        $.each(response.transactions, function (index, value) {
          ...
          dataHtml += "\n                        <tr>\n                            <td>\n                                <img src='/build/global/img/".concat(value.brand, ".svg'   width='50px;' style='border-radius:6px;' alt=\"brand\"><br>\n                            </td>\n                            <td>\n                                <div class=\"d-flex justify-content-center align-items-center align-self-center \">\n                                    <span class=\"transaction-status d-flex justify-content-center align-items-center align-self-center rounded-circle rounded-circle\" >\n                                        <span class=\"rounded-circle ").concat(is_liquidated, " \" ></span>\n                                    </span>\n                                </div>\n                            </td>\n                            <td>\n                                <span class='small'>").concat(value.date, "</span>\n                            </td>\n                            <td>\n                                <span class='small font-weight-bold'>").concat(value.value, "</span>\n                            </td>\n                        </tr>\n                    ");
        });
        dataHtml += "<tr>\n                                <td> </td>\n                                <td> </td>\n                                <td>\n                                    <span class='small font-weight-bold'>Total </span>\n                                </td>\n                                <td>\n                                    <span class='small font-weight-bold'>".concat(response.total_withdrawal, "</span>\n                                </td>\n                            </tr>");
