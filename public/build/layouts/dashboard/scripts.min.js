...
$(document).ready(function () {
  ...
  function updateCashback(money) {
    $('#cashback-container #cashback-container-money').text("".concat(money));
      ...
      success: function success(data) {
        if (!isEmpty(data.companies)) {
          ...
          for (var i = 0; i < data.companies.length; i++) {
            if (localStorage.getItem('companySelected') == data.companies[i].id_code) itemSel = 'selected="selected"';else itemSel = '';
  ...
  function updateValues() {
    ...
    $.ajax({
      ...
      success: function success(data) {
        ...
        var title = "Valor incluindo o saldo bloqueado de R$ " + data.blocked_balance_total;
        ...
        loadOnAnyEllipsis('.text-money, .update-text, .text-circle', true); //loadingOnScreenRemove();
      }
    });
