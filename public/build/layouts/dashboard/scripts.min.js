...
$(document).ready(function () {
  var levelInfo = {
    ...
    6: {
      ...
      storytelling: "Parabéns! Você atingiu os confins do universo e a expressiva marca de 100M de faturamento, um verdadeiro explorador do espaço e dos negócios. Você acaba de chegar na Canis Major e conhecer de perto a Admin, a estrela mais brilhante!",
  ...
  window.updateValues = function () {
    ...
    $.ajax({
      ...
      success: function success(data) {
        ...
        var title = "Valor incluindo o saldo da reserva de segurança de R$ " + data.security_reserve_balance;
