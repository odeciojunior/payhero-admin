    ...
    $.ajax({
      ...
      success: function success(response) {
        ...
        $.each(response.data, function (index, value) {
          ...
          $("#data-table-pixel").append("\n                        <tr>\n                            <td>".concat(value.name_short, "</td>\n                            <td>").concat(value.code, "</td>\n                            <td>").concat(value.platform_enum, "</td>\n                            <td>\n                                <span class=\"badge badge-").concat(statusPixel[value.status], "\">\n                                    ").concat(value.status_translated, "\n                                </span>\n                            </td>\n                            <td style='text-align:center'>\n                                <div class='d-flex justify-content-end align-items-center'>\n                                    <a role='button' title='Visualizar' class='mg-responsive details-pixel pointer' pixel='").concat(value.id, "' data-target='#modal-details-pixel' data-toggle='modal'><span class=\"o-eye-1\"></span></a>\n                                    <a role='button' title='Editar' class='mg-responsive edit-pixel pointer' pixel='").concat(value.id, "' data-toggle='modal' type='a'><span class=\"o-edit-1\"></span></a>\n                                    <a role='button' title='Excluir' class='mg-responsive delete-pixel pointer' pixel='").concat(value.id, "' data-toggle='modal' type='a'><span class='o-bin-1'></span></a>\n                                </div>\n                            </td>\n                        </tr>\n                    "));
          $("#table-pixel").addClass("table-striped");
        });
