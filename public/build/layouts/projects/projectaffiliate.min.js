...
$(function () {
  ...
  atualizarPixel(currentPage); //comportamentos da tela
  ...
  function isChecked(input) {
    var pixelAttribute = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
    ...
    $.ajax({
      ...
      success: function success(response) {
        ...
        $.each(response.data, function (index, value) {
          ...
          $("#data-table-pixel").append("\n                        <tr>\n                            <td>".concat(value.name_short, "</td>\n                            <td>").concat(value.code, "</td>\n                            <td>").concat(value.platform_enum, "</td>\n                            <td class=\"text-center\">\n                                <span class=\"badge badge-").concat(statusPixel[value.status], "\">\n                                    ").concat(value.status_translated, "\n                                </span>\n                            </td>\n                            <td style='text-align:center'>\n                                <div class='d-flex justify-content-end align-items-center'>\n                                    <a role='button' title='Visualizar' class='mg-responsive details-pixel pointer' pixel='").concat(value.id, "' data-target='#modal-details-pixel' data-toggle='modal'><span class=\"\"><img src='/build/global/img/icon-eye.svg'/></span></a>\n                                    <a role='button' title='Editar' class='mg-responsive edit-pixel pointer' pixel='").concat(value.id, "' data-toggle='modal' type='a'><span class=\"\"><img src='/build/global/img/pencil-icon.svg'/></span></a>\n                                    <a role='button' title='Excluir' class='mg-responsive delete-pixel pointer' pixel='").concat(value.id, "' data-toggle='modal' type='a'><span class=''><img src='/build/global/img/icon-trash-tale.svg'/></span></a>\n                                </div>\n                            </td>\n                        </tr>\n                    "));
          $("#table-pixel").addClass("table-striped");
        });
  ...
  function renderDetailPixel(pixel) {
    ...
    $("#modal-detail-pixel .pixel-status").html(pixel.status == 1 ? '<span class="badge badge-success text-left">Ativo</span>' : '<span class="badge badge-danger">Desativado</span>');
  ...
  $(document).on("click", ".edit-pixel", function () {
    $.ajax({
      method: "GET",
      url: "/api/project/".concat(projectId, "/pixels/").concat($(this).attr("pixel"), "/edit"),
      dataType: "json",
      headers: {
        Authorization: $('meta[name="access-token"]').attr("content"),
        Accept: "application/json"
  ...
  $("#btn-update-pixel").on("click", function () {
    var inputDescriptionEdit = $("#modal-edit-pixel .description-edit").val();
    var inputPlatformEdit = $("#modal-edit-pixel .platform-edit").val();
    var isApi = $("#modal-edit-pixel input[type=radio]:checked").val();
    var inputCodeEdit = $("#modal-edit-pixel .code-edit").val();
    var inputConversionalEdit = $("#modal-edit-pixel .conversional-edit").val();
    var valuePercentagePurchaseBoleto = $("#modal-edit-pixel .percentage-boleto-value-edit").val();
    var valuePercentagePurchasePix = $("#modal-edit-pixel .percentage-pix-value-edit").val();
    var facebookTokenApi = $("#modal-edit-pixel #facebook-token-api-edit").val();
    var inputPurchaseEventName = $("#modal-edit-pixel .input-purchase-event-name-edit").val();
    var plansApply = $("#modal-edit-pixel .apply_plans").val();
    ...
    $.ajax({
      method: "PUT",
      url: "/api/project/".concat(projectId, "/pixels/").concat(pixelEdit.id_code),
      dataType: "json",
      headers: {
        Authorization: $('meta[name="access-token"]').attr("content"),
        Accept: "application/json"
  ...
  function renderModalPixelEdit(pixel) {
    var newPlatform = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
    resetInputs();
    var imgPlatform = $(".img-edit-selected");
    var codeEditInput = $(".code-edit");
    var conversionalEditInput = $(".conversional-edit");
    var singleEvent = $(".single-event-edit");
    var multipleEvent = $(".multiple-event-edit");
    var code = inputCodeByPlatform(pixel.platform, pixel.code, "", true);
    ...
    $(".percentage-pix-value-edit").val(pixel.value_percentage_purchase_pix); // plans

    var plansInput = $(".apply_plans");
    plansInput.val(null).trigger("change");
    plansInput.html("");
    var applyOnPlans = [];

    var _iterator = _createForOfIteratorHelper(pixel.apply_on_plans),
        _step;
    ...
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        ...
        plansInput.append("\n                <option value=\"".concat(plan.id, "\">\n                    ").concat(plan.name + (plan.description ? " - " + plan.description : ""), "\n                </option>\n            "));
      }
    } catch (err) {
      _iterator.e(err);
    } finally {
    ...
    plansInput.val(applyOnPlans); // Run Pixel
  ...
  function inputCodeByPlatform(platform, code) {
    var conversional = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "";
    var explode = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;

    switch (platform) {
      case "google_adwords":
        return explode ? code.split("/") : "".concat(code, "/").concat(conversional);
  ...
  $("#modal-create-pixel #btn-store-pixel").on("click", function () {
    var formData = new FormData(document.querySelector("#modal-create-pixel  #form-register-pixel"));
  ...
  function validateDataPixelForm(formData) {
    ...
    if (formData.value_percentage_purchase_pix.length > 0 && (formData.value_percentage_purchase_pix > 100 || formData.value_percentage_purchase_pix < 10)) {
  ...
  $("#add_pixel_plans").select2(Object.assign(selectPlan(), {
    dropdownParent: $("#modal-create-pixel")
  }));
  $(".edit-plans").select2(Object.assign(selectPlan(), {
...
$(function () {
  var projectId = $(window.location.pathname.split("/")).get(-2);
  var affiliateId = $(window.location.pathname.split("/")).get(-1); // COMPORTAMENTOS DA TELA
...
$(function () {
  ...
  $("#modal-create-link .btn-save").on("click", function () {
    var formData = new FormData(document.querySelector("#modal-create-link  #form-register-link"));
  ...
  $(document).on("click", "#modal-edit-link .btn-update", function () {
    loadingOnScreen();
    var link = $("#modal-edit-link .link-id").val();
    $.ajax({
      method: "PUT",
          ...
          if (response.data[0].document_status == "approved") {
            if (response.data[0].status_affiliate == 2) {
              ...
              $.each(response.data, function (index, value) {
                data = "";
                data += "<tr>";
                data += '<td class="display-sm-none display-m-none" title="Copiar Link" link="' + value.link + '">'; // if (value.plan_name == null) {
                ...
                data += '<a title="Visualizar" class="mg-responsive details-link pointer" link="' + value.id + '" data-target="#modal-details-link" data-toggle="modal"><span class=""><img src="/build/global/img/icon-eye.svg"/></span></a>';

                if (value.plan_name == "" && value.link != null) {
                  data += '<a title="Editar" class="mg-responsive edit-link pointer" link="' + value.id + '" data-toggle="modal"><span class=""><img src="/build/global/img/pencil-icon.svg"/></span></a>';
                  data += '<a title="Excluir" class="mg-responsive delete-link pointer" link="' + value.id + '" data-toggle="modal"><span class=""><img src="/build/global/img/icon-trash-tale.svg"/></span></a>';
                } else {
                  data += '<a title="Editar" class="mg-responsive pointer disabled"><span class=""><img src="/build/global/img/pencil-icon.svg"/></span></a>';
                  data += '<a title="Excluir" class="mg-responsive pointer disabled"><span class=""><img src="/build/global/img/icon-trash-tale.svg"/></span></a>';
                }
