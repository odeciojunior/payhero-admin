...
$(function () {
  ...
  index = function index() {
    ...
    $.ajax({
      ...
      success: function success(response) {
        loadOnAny("#data-table-projects", true);
        var deleteProjectsShowOrHidde = $("#deleted_project_filter");
        ...
        if (response.data.length) {
          ...
          $.each(response.data, function (key, project) {
            if (verifyAccountFrozen()) {
              ...
              linkProject = "<a href=\"/projects/".concat(project.id).concat(project.affiliated ? "/" + project.affiliate_id : "", "\" class=\"stretched-link\"></a>");
            }

            var data = "\n                            <div class=\"col-xl-3 col-lg-3 col-md-4 col-sm-6 name_project\" data-id=\"".concat(project.id, "\">\n                                <div class=\"card\">\n                                    ").concat(project.woocommerce_id != null ? "<div class=\"ribbon ribbon-woo\">\n                                            <span>WooCommerce\n                                                <a class=\"ribbon-woocommerce-default\"></a>\n                                            </span>\n                                        </div>" : "", "\n                                    ").concat(project.shopify_id != null && !project.affiliated ? "<div class=\"ribbon\">\n                                            <span>Shopify\n                                                <a class=\"ribbon-shopify-default\"></a>\n                                            </span>\n                                        </div>" : "", "\n                                    ").concat(project.affiliated ? "<div class=\"ribbon-left\">\n                                            <span>Afiliado</span>\n                                        </div>" : "", "\n                                    <img class=\"card-img-top\" onerror=\"this.src = 'build/global/img/produto.svg'\" src=\"").concat(project.photo ? project.photo : "build/global/img/produto.svg", "\" alt=\"").concat(project.name, "\">\n                                    <div class=\"card-body\">\n                                        <h5 class=\"card-title text-truncate\">").concat(project.name, "</h5>\n                                        <div class=\"d-flex align-item-center justify-content-between\">\n                                            <p class=\"card-text sm mb-0\">Criado em ").concat(project.created_at, "</p>\n                                            <img src=\"build/layouts/projects/img/dragItem.svg\" class=\"drag-drop-icon p-5\"/>\n                                        </div>\n                                        ").concat(linkProject, "\n                                    </div>\n                                </div>\n                            </div>");
          ...
          $("#subtitle_drag_drop").hide(); //$("#button_toggle").css({visibility: "hidden"});
  ...
  var sortableElement = $("#data-table-projects");
  sortableElement.sortable({
    ...
    update: function update(event, ui) {
      var projectOrder = $(this).sortable("toArray", {
        attribute: "data-id"
      });
      $.ajax({
        method: "POST",
  ...
  function verifyHasOnlyOne() {
    var hasOnlyOne = $("#data-table-projects").children().length <= 1;
  ...
  $("#deleted_project_filter").on("change", function () {
    var showProjectsDeleteds = $("#deleted_project_filter").val();
    $.ajax({
      method: "POST",
      ...
      success: function success(response) {
        $("#modal_config").modal("hide"); //location.reload(true);
        //index();
