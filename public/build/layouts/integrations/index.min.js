$(document).ready(function () {
  ...
  function updateIntegrationTableData(response) {
    ...
    if (response.data.length > 0 && (response.data.findIndex(function (e) {
      return e.integration_type_enum == "4";
    }) != -1 || response.data.findIndex(function (e) {
      return e.integration_type_enum == "5";
    }) != -1)) {
      $("#content-script").show();
    ...
    $.each(response.data, function (index, value) {
      ...
      dados += '<button class="btn pointer edit-integration" style="background-color:transparent;" integration="' + value.id_code + '"' + disabled + ' title="Editar integração"><span class=""><img src="/build/global/img/pencil-icon.svg"/></span></button>';
      ...
      dados += '<button class="btn pointer delete-integration" style="background-color:transparent;" integration="' + value.id_code + '"' + disabled + ' title="Deletar token"><span class=""><img src="/build/global/img/icon-trash-tale.svg"/></span></button>';
      dados += "</td>";
      dados += "</tr>";
    ...
    $('.fullInformation-api').bind('mouseover', function () {
      ...
      if (this.offsetWidth < this.scrollWidth && !$this.attr('title')) {
        $this.attr({
          ...
          container: ".container-tooltips-api"
        });
        $this.tooltip("show");
      }
    });
  ...
  function createIntegration() {
    ...
    $(".store-integrate").on("click", function () {
      ...
      $("#btn-save-integration").on("click", function () {
        ...
        var companyHash = $('.company-navbar').val();
        if (description == '') {
