$(function () {
  ...
  function renderSale(sale) {
    ...
    $('#comission-value').text(sale.comission ? sale.comission : ''); //Detalhes da venda
  ...
  function renderProducts(products, sale) {
    ...
    $.each(products, function (index, value) {
      ...
      div += "<div class=\"row align-items-baseline justify-content-between mb-15\">\n                        <div class=\"col-lg-2\">\n                            <img src='".concat(value.photo, "' width='50px' style='border-radius: 6px;'>\n                        </div>\n                        <div class=\"col-lg-5\">\n                            <h4 class=\"table-title\">").concat(value.name, "</h4>\n                        </div>\n                        <div class=\"col-lg-3 text-right\">\n                            <p class=\"sm-text text-muted\">").concat(value.amount, "x</p>\n                        </div>\n                    </div>");
      $("#table-product").html(div); //Tabela de produtos Tracking Code

      if (value.sale_status == 1) {
        var data = "<tr>\n                                <td>\n                                    <img src='".concat(value.photo, "'  width='35px;' style='border-radius:6px;'><br>\n                                    <span class='small' style='display: inline-block; width: 60px;white-space: nowrap;overflow: hidden !important;text-overflow: ellipsis;'>").concat(value.name, "</span>\n                                </td>\n                                <td>\n                                    <span class='tracking-code-span small ellipsis'>").concat(value.tracking_code, "</span>\n                                    <input class='form-control' id='tracking_code' name='tracking_code' value='").concat(value.tracking_code, "' style='display:none;'/>\n                                </td>\n                                <td>\n                                    <span class='tracking-status-span small'>").concat(value.tracking_status_enum, "</span>\n                                </td>\n                                <td>\n                                    <a class='pointer btn-edit-trackingcode p-5' title='Editar C\xF3digo de rastreio' product-code='").concat(value.id, "'><i class='icon wb-edit' aria-hidden='true' style='color:#f1556f;'></i></a>\n                                    <a class='pointer btn-save-trackingcode p-3 mb-15' title='Salvar C\xF3digo de rastreio' sale='").concat(sale, "' product-code='").concat(value.id, "' style='display:none;'><i class=\"material-icons gradient\" style=\"font-size:17px;\">save</i></a>\n                                    <a class='pointer btn-close-tracking' title='Fechar' style='display:none;'><i class='material-icons gradient mt-5'>close</i></a>\n                                </td>\n                            </tr>");
