    ...
    $.ajax({
      ...
      success: function success(response) {
        ...
        $.each(response.data, function (index, tracking) {
          ...
          dados += "".concat(!tracking.tracking_status_enum ? "<div class=\"col-7\">\n                            <input maxlength=\"30\" minlength=\"10\" class=\"mr-10 form-control font-weight-bold input-tracking-code fake-label\" placeholder=\"Clique para adicionar\" value=\"".concat(tracking.tracking_code, "\" style=\"border-radius: 8px; max-height:35px; padding: 8px 0 8px 10px !important;\">\n                            </div>\n                            <a class='tracking-add pointer mt-1 px-0 default-buttons' title=\"Adicionar\">\n                            <span id=\"add-tracking-code\" class='o-add-1 text-primary border border-primary'></span>\n                        </a>") + save : "");
          dados += "".concat(tracking.tracking_status_enum ? "<div class=\"col-7\" >\n                            <input maxlength=\"30\" minlength=\"10\" class=\"mr-10 form-control font-weight-bold input-tracking-code\" readonly placeholder=\"Informe o c\xF3digo de rastreio\" style=\"border-radius: 8px;\" value=\"".concat(tracking.tracking_code, "\">\n                            </div>\n                        ") + edit_detail_save_close + "" : "");
          dados += "</div>\n                        </td>";
          dados += "</tr>";
