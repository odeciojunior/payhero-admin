...
var chartDefaultColorsLabel = ["rgba(255, 205, 27, 1)", // POSTADO (DARK-BLUE)             ficara amarelo
    ...
    $.ajax({
      ...
      success: function success(response) {
        ...
        $.each(response.data, function (index, tracking) {
          ...
          var htmlButtonAdd = "\n                        <input maxlength=\"18\" minlength=\"10\" class=\"mr-10 col-sm-7 form-control font-weight-bold input-tracking-code fake-label\" placeholder=\"Clique para adicionar\" value=\"".concat(tracking.tracking_code, "\" style=\"padding-bottom: 5px;border-radius: 8px;max-height:38px;\">\n\n                        <a class='tracking-add pointer mt-1 ml-10 px-0 default-buttons' title=\"Adicionar\">\n                            <span id=\"add-tracking-code\" class='o-add-1 text-primary border border-primary'></span>\n                        </a>");
          var htmlButtonEdit = "\n                        <div class=\"edit-detail d-flex justify-content-between px-0 col-5\">\n\n                            <a class='tracking-edit pointer default-buttons' title=\"Editar\">\n                                <span>\n                                    <img src=\"build/global/img/pencil-icon.svg\"/>\n                                </span>\n                            </a>\n\n                            <a class='tracking-detail pointer pt-2' title=\"Visualizar\" tracking='".concat(tracking.id, "'>\n                                <span>\n                                    <img src=\"/build/global/img/icon-eye.svg\"/>\n                                </span>\n                            </a>\n                        </div>");
          var dados = "\n                        <tr ".concat(grayRow ? 'class="td-odd"' : "", ">\n\n                            ").concat(lastSale !== tracking.sale ? "\n                                <td class=\"detalhes_venda pointer col-sm-1\" venda=\"".concat(tracking.sale, "\">\n                                    #").concat(tracking.sale, "\n                                </td>") : "<td>\n                                </td>", "\n\n                            <td class=\"\">\n                                <span>\n                                    ").concat(tracking.product.amount, "x ").concat(tracking.product.name, " ").concat(tracking.product.description ? "(" + tracking.product.description + ")" : "", "\n                                </span>\n                            </td>\n\n                            <td class=\"\">").concat(tracking.approved_date, "</td>\n\n                            <td class=\"text-center\">\n                                <span class=\"badge ").concat(statusEnum[tracking.tracking_status_enum], "\">\n                                    ").concat(tracking.tracking_status, "\n                                </span>\n                            </td>\n\n                            <td style=\"width: 2%;padding: 0px !important;\">\n                                ").concat(systemStatus[tracking.system_status_enum], "\n                                ").concat(tracking.is_chargeback_recovered ? '<img class="orange-gradient ml-10" width="20px" src="/build/global/img/svg/chargeback.svg" title="Chargeback recuperado">' : "", "\n                            </td>\n\n                            <td class=\"text-left mb-0\" style=\"max-height:74px!important;\">\n                                <div class=\"d-flex\">\n\n                                    ").concat(tracking.tracking_status_enum ? "\n                                    <input maxlength=\"18\" minlength=\"10\" class=\"mr-10 col-7 form-control font-weight-bold input-tracking-code\" readonly placeholder=\"Informe o c\xF3digo de rastreio\" style=\"border-radius: 8px;\" value=\"".concat(tracking.tracking_code, "\">") + htmlButtonEdit : htmlButtonAdd, "\n\n                                    <div class=\"save-close buttons d-flex px-0 col-5\" style=\"max-height: 38px;\">\n\n                                        <a id='pencil' class='o-checkmark-1 text-white tracking-save pointer mr-10 text-center default-buttons' title=\"Salvar\" pps='").concat(tracking.pps_id, "'style=\"display:none\"></a>\n\n                                        <div class='tracking-close pointer' data-code='").concat(tracking.tracking_code, "' title=\"Fechar\" style=\"display:none\">\n                                            &#x2715\n                                        </div>\n\n                                    </div>\n                                </div>\n                            </td>\n\n                        </tr>");
    ...
    $.ajax({
      ...
      success: function success(response) {
        if (!isEmpty(response.data.tracking_status)) {
          ...
          var statusBadge = btnSave.parent().parent().parent().find(".badge");
