...
var systemStatus = {
  1: "",
  2: "<i data-toggle=\"tooltip\" data-container=\".page\" title=\"O c\xF3digo foi reconhecido pela transportadora mas, ainda n\xE3o teve nenhuma movimenta\xE7\xE3o. Essa informa\xE7\xE3o pode ser atualizada nos pr\xF3ximos dias\"><img src=\"build/global/img/alert-icon-code.svg\"/></i>",
  3: "<i data-toggle=\"tooltip\" data-container=\".page\" title=\"O c\xF3digo n\xE3o foi reconhecido por nenhuma transportadora\"><img src=\"build/global/img/alert-icon-code.svg\"/></i>",
  4: "<i data-toggle=\"tooltip\" data-container=\".page\" title=\"A data de postagem da remessa \xE9 anterior a data da venda\"><img src=\"build/global/img/alert-icon-code.svg\"/></i>",
  5: "<i data-toggle=\"tooltip\" data-container=\".page\" title=\"J\xE1 existe uma venda com esse c\xF3digo de rastreio cadastrado\"><img src=\"build/global/img/alert-icon-code.svg\"/></i>",
  "": ""
};
$(function () {
    ...
    $.ajax({
      ...
      $.each(data, function (c, company) {
        ...
        $.each(company.projects, function (i, project) {
          if (dataSales.includes(project.id)) $("#project-select").append($("<option>", {
            value: project.id,
            text: project.name
          }));
        }); //}
