          ...
          if (validadeForm(formData)) {
            $.ajax({
              ...
              success: function success() {
                ...
                $('#save_success').fadeIn('slow', 'linear'); // inicio: update session storage of company_default and companies/projects
                // $.ajax({
                //     method: "GET",
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          if (company.status != "pending") {
            if (company.name.length > 20) companyName = company.name.substring(0, 20) + '...';else companyName = company.name;
