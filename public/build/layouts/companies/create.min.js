$(document).ready(function () {
  ...
  $('.btn-next-div1').on('click', function (e) {
    e.preventDefault();
    var companyDocumentVal = $('.company_document_1').val().replace(/[^0-9]/g, '');
    var fantasyNameVal = $('.fantasy_name_1').val();

    if ($('.company_document_1').val() != '') {
      var result = verifyEqualCNPJ($('.company_document_1').val());
  ...
  $('.btn-next-div2').on('click', function (e) {
    e.preventDefault();
    var companyDocumentVal = $('.company_document_2').val().replace(/[^0-9]/g, '');
    var fantasyNameVal = $('.fantasy_name_2').val();

    if ($('.company_document_2').val() != '') {
      var result = verifyEqualCNPJ($('.company_document_2').val());
