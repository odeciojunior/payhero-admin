...
$.fn.select3 = function (options) {
  ...
  var $select = $(this);
  var $originalSelect = $select.get(0).outerHTML;
  var $wrapper;
  var $options;
  var $searchInput;
  var $controls;
  ...
  var renderOptions = function renderOptions() {
    ...
    $select.children('option').each(function () {
      ...
      if (config.multiselect && selectOptions) {
        $controls.find('.select3-uncheck').show().text("".concat(config.language.uncheckAll, " (").concat(selectOptions, ")"));
      }
    });
  };

  var loadFromAjax = function loadFromAjax() {
    if ($isAjax && $hasMorePages) {
      ...
      $.ajax({
        ...
        success: function success(res) {
          setTimeout(function () {
            var _config$ajax$processR = config.ajax.processResults(res),
                results = _config$ajax$processR.results,
                pagination = _config$ajax$processR.pagination;
            ...
            if (results.length) {
              ...
              try {
                for (_iterator.s(); !(_step = _iterator.n()).done;) {
                  ...
                  if (!$select.children("option[value=\"".concat(option.id, "\"]")).length) {
                    $select.append("<option value=\"".concat(option.id, "\">").concat(option.text, "</option>"));
                  }
                }
              } catch (err) {
                _iterator.e(err);
  ...
  $select.init.prototype.setup = function () {
    ...
    $options.unbind('scroll').bind('scroll', function () {
      var scrolledToEnd = this.offsetHeight + this.scrollTop >= this.scrollHeight;
    ...
    $wrapper.on('click', '.select3-option', function () {
      if (!config.multiselect) {
        ...
        if (count) {
          $controls.find('.select3-uncheck').show().text("".concat(config.language.uncheckAll, " (").concat(count, ")"));
        } else {
...
!function (e, o) {
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "undefined" != typeof module ? module.exports = o() : "function" == typeof define && define.amd ? define(o) : (e = e || self).EmojiButton = o();
}(this, function () {
  "use strict";
  /*! *****************************************************************************
  ...
  function r(e, o) {
    ...
    for (o.includeContainer && i.call(e, a) && (g = Array.prototype.slice.apply(g)).unshift(e), n = 0; n < g.length; n++) {
      t(r = g[n]) && (0 === (m = c(r)) ? s.push(r) : u.push({
        documentOrder: n,
        tabIndex: m,
        node: r
      }));
  ...
  b.prototype = {
    ...
    emit: function emit(e) {
      for (var o = [].slice.call(arguments, 1), n = ((this.e || (this.e = {}))[e] || []).slice(), a = 0, i = n.length; a < i; a++) {
    ...
    off: function off(e, o) {
      var n = this.e || (this.e = {}),
          a = n[e],
          i = [];
      if (a && o) for (var r = 0, t = a.length; r < t; r++) {
  ...
  var pe = Y({
    defaultModifiers: [{
      ...
      effect: function effect(e) {
        ...
        }), m && s.addEventListener("resize", n.update, Z), function () {
      ...
      effect: function effect(e) {
        ...
        return Object.assign(o.elements.popper.style, n), function () {
          Object.keys(o.elements).forEach(function (e) {
            var a = o.elements[e],
    ...
    function u(e, o) {
      for (var a, i, r, m, c, u, g, v, l, f, y, j, p, h = function e(o, n) {
        for (var a, i, r = o.childNodes, m = r.length; m--;) {
          3 === (i = (a = r[m]).nodeType) ? n.push(a) : 1 !== i || ("ownerSVGElement" in a) || t.test(a.nodeName.toLowerCase()) || e(a, n);
        }
        ...
        for (r = !1, m = document.createDocumentFragment(), u = (c = h[b]).nodeValue, v = 0; g = n.exec(u);) {
          if ((l = g.index) !== v && m.appendChild(s(u.slice(v, l), !0)), j = d(y = g[0]), v = l + y.length, p = o.callback(j, o), j && p) {
            for (i in (f = new Image()).onerror = o.onerror, f.setAttribute("draggable", "false"), a = o.attributes(y, j)) {
    ...
    function g(e, o) {
      return f(e, function (e) {
        ...
        if (t && m) {
          for (a in i = "<img ".concat('class="', o.className, '" ', 'draggable="false" ', 'alt="', e, '"', ' src="', m, '"'), n = o.attributes(e, t)) {
            n.hasOwnProperty(a) && 0 !== a.indexOf("on") && -1 === i.indexOf(" " + a + "=") && (i = i.concat(" ", a, '="', n[a].replace(r, v), '"'));
          }
    ...
    function y(e, o) {
      for (var n = [], a = 0, i = 0, r = 0; r < e.length;) {
        a = e.charCodeAt(r++), i ? (n.push((65536 + (i - 55296 << 10) + (a - 56320)).toString(16)), i = 0) : 55296 <= a && a <= 56319 ? i = a : n.push(a.toString(16));
      }
  ...
  var io = function io() {},
    ...
    for (void 0 === n ? (i = 1, t = e[m[0]]) : (i = 0, t = n); i < s; i++) {
      t = c(t, e[r = m[i]], r, e);
    }
  ...
  var wo,
    ...
    return o = e, (n = [{
      ...
      value: function value() {
        for (var e = this, o = arguments.length, n = new Array(o), a = 0; a < o; a++) {
          n[a] = arguments[a];
        }
  ...
  return function () {
    function o(o) {
      void 0 === o && (o = {}), this.events = new w(), this.publicEvents = new w(), this.pickerVisible = !1, this.options = _e2(_e2({}, Xo), o), this.options.rootElement || (this.options.rootElement = document.body), this.i18n = _e2(_e2({}, Ko), o.i18n), this.onDocumentClick = this.onDocumentClick.bind(this), this.onDocumentKeydown = this.onDocumentKeydown.bind(this);
    }
...
var attachments2send = [];
$(function () {
  loadingOnScreen(); //fill the filter if the parameter comes in the url
        ...
        if (resp.data.length) {
          ...
          try {
            for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
              ...
              $('#project-select').append("<option value=\"".concat(project.id, "\">").concat(project.name, "</option>"));
            }
          } catch (err) {
            _iterator2.e(err);
          } finally {
  ...
  window.getFilters = function () {
    ...
    var plan = $('#filter-plan').data('value') || '';
    var transaction = $("#filter-transaction").data('value') || '';
    var document = $('#filter-document').data('value') || '';
    var name = $('#filter-name').data('value') || '';
    var answered = $("#filter-answer").data('value') || '';
    var period = $('#filter-date').data('value') || '';
    var status = $('#filter-status').val();
    var nameOrDocument = $('#name-or-document').val();
    var filters = {
      project: project,
      plan: plan,
      document: document,
  ...
  function showTicket(ticket) {
    ...
    $('.ticket-status .ticket-status-icon').removeClass('open closed mediation answered').addClass(statusColor[ticket.ticket_status_enum] || 'answered');
    $('.ticket-start-date').text(ticket.created_at);
    $('.ticket-project').text(ticket.project_name);
    $('.ticket-sale span').text("#".concat(ticket.sale_id));
    $('.ticket-back, .ticket-customer, .ticket-status, .ticket-sale').removeClass('d-none');
    var html = '';

    if (isMobile()) {
      html += "<div class=\"ticket-messages-resume\"><b>Reclama\xE7\xE3o aberta em ".concat(ticket.created_at, " para <b>").concat(ticket.project_name, "</b> referente a venda <b>#").concat(ticket.sale_id, "</b></div>");
    }

    var _iterator4 = _createForOfIteratorHelper(ticket.messages),
        _step4;
    ...
    $('.messages-container').html(html).scrollTop(function () {
  ...
  function getResume() {
    ...
    $.ajax({
      ...
      success: function success(resp) {
        ...
        var percentual = 100 / resp.total * resp.open || 0;
        $('#ticket-open .detail').html("(".concat(percentual.toFixed(1), "%)"));
        $('#ticket-mediation .number').html(resp.mediation);
        percentual = 100 / resp.total * resp.mediation || 0;
        $('#ticket-mediation .detail').html("(".concat(percentual.toFixed(1), "%)"));
        $('#ticket-closed .number').html(resp.closed);
        percentual = 100 / resp.total * resp.closed || 0;
        $('#ticket-closed .detail').html("(".concat(percentual.toFixed(1), "%)"));
  ...
  $('.filter-badge').on('click', function (e) {
    ...
    if (btn.hasClass('editable')) {
      ...
      var closeClick = btn.hasClass('active') && e.offsetX >= this.offsetWidth - 32;
      ...
      if (closeClick) {
        ...
        if (target.length) {
          ...
          var maxLeft = parentWidth - inputWidth - colPadding;
          var left = this.getBoundingClientRect().left - parentLeft;
  ...
  $('.filter-badge-input button').on('click', function () {
    ...
    if (value) {
      var badge = $("[data-target='#".concat(parentId, "']"));
  ...
  $(document).on('click', '.filter-badge-input .select3-option', function () {
    var parent = $(this).parents('.filter-badge-input');
    var parentId = parent.attr('id');
    var badge = $("[data-target='#".concat(parentId, "']"));
    var value = $(this).data('value');
  ...
  function updateAttachments(files) {
    ...
    container.html('');
    attachments2send.push.apply(attachments2send, _toConsumableArray(Array.from(files)));
    attachments2send.forEach(function (attachment, key) {
      ...
      container.append("<div class=\"attachment\" data-id=\"".concat(key, "\">").concat(name, "</div>"));
    });
    container.show();
  }
  ...
  function sendMessage() {
    ...
    if (writeArea.val().length || attachments2send.length) {
      ...
      attachments2send.forEach(function (file, i) {
        data.append("attachments[".concat(i, "]"), file);
      });
      $.ajax({
        method: "POST",
  ...
  function paginate(target, meta) {
    ...
    if (lastPage <= displayMax) {
      ...
      for (var _i2 = 1; _i2 < displayMax; _i2++) {
        data.push(_i2);
      }
    ...
    data.forEach(function (page) {
      var button = "<button ".concat(page === currentPage ? 'class="active"' : '', ">").concat(page, "</button>");
