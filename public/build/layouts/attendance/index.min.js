...
$(function () {
  ...
  function showTicket(ticket) {
    ...
    if (isMobile()) {
      html += "<div class=\"ticket-messages-resume\"><b>".concat(categoryEnum[ticket.ticket_category_enum], "</b> aberta em ").concat(ticket.created_at, " para <b>").concat(ticket.project_name, "</b> referente a venda <b>#").concat(ticket.sale_id, "</b></div>");
    }
