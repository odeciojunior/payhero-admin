...
$(document).ready(function () {
  window.fillProjectsSelect = function (data) {
    $.each(data, function (i, project) {
      if (project.status == 1) $("#project_id, #select_projects_edit").append($("<option>", {
        value: project.id,
        text: project.name
      }));
    });
  ...
  window.index = function () {
    ...
    $.ajax({
      ...
      success: function success(response) {
        $("#content").html(""); //if (isEmpty(response.projects)) {
        ...
        if (isEmpty(data.company_default_projects)) {
          ...
          window.fillProjectsSelect(data.company_default_projects); // let projects = response.projects;
