$(document).ready(function () {
  ...
  function updateWebhookTableData(response) {
    ...
    $.each(response.data, function (index, value) {
      ...
      dados += '<button type="button" class="btn pointer edit-webhook" style="background-color:transparent;" webhook="' + value.id + '"' + ' title="Editar webhook"><span class=""><img src="/build/global/img/icon-eye.svg"></span></button>';
      dados += '<button type="button" class="btn pointer delete-webhook" style="background-color:transparent;" webhook="' + value.id + '"' + ' title="Deletar webhook"><span class=""><img src="/build/global/img/icon-trash-tale.svg"></span></button>';
      dados += "</td>";
      dados += "</tr>";
