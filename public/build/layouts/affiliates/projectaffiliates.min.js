      ...
      success: function success(response) {
        ...
        if (response.data == "") {
          ...
          $.each(response.data, function (index, value) {
            var fullData = value.date;
            var dataParse = fullData.split(" ");
            var dataDay = dataParse[0];
            var dataTime = dataParse[1];
            console.log(dataDay);
            console.log(dataTime);
            if (value.percentage == "" || value.percentage == "0") value.percentage = "0%";
            data = "";
            data += "<tr>";
            data += '<td class="ellipsis-text" style="vertical-align: middle;">' + '<span class="fullInformation" data-toggle="tooltip" data-placement="top" title="' + value.name + '">' + value.name + '</span>';
            "</td>"; // data += '<td class="" style="vertical-align: middle;">' + value.email + '</td>';

            data += '<td class="ellipsis-text" style="vertical-align: middle;">' + '<span class="fullInformation" data-toggle="tooltip" data-placement="top" title="' + value.project_name + '">' + value.project_name + '</span>';
            "</td>";
            data += '<td class="" style="vertical-align: middle;">' + dataDay + '<br> <span class="subdescription font-size-12">' + dataTime + '</span> ' + "</td>";
            ...
            data += "<a title='Visualizar' class='mg-responsive pointer details-affiliate' affiliate='" + value.id + "'><span class=''><img src='/build/global/img/icon-eye.svg'/></span></a>";
            data += "<a title='Editar' class='mg-responsive pointer edit-affiliate'    affiliate='" + value.id + "'><span class=''><img src='build/global/img/pencil-icon.svg'/></span></a>";
            data += "<a title='Excluir' class='mg-responsive pointer delete-affiliate' affiliate='" + value.id + "'><span class=''><img src='/build/global/img/icon-trash-tale.svg'/></span></a>";
            data += "</td>";
            data += "</tr>";
      ...
      success: function success(response) {
        ...
        if (response.data == "") {
          ...
          $.each(response.data, function (index, value) {
            ...
            data += '<td class="ellipsis-text" style="vertical-align: middle;">' + '<span class="fullInformation" data-toggle="tooltip" data-placement="top" title="' + value.name + '">' + value.name + '</span>';
            "</td>";
            data += '<td class="ellipsis-text" style="vertical-align: middle;">' + '<span class="fullInformation" data-toggle="tooltip" data-placement="top" title="' + value.email + '">' + value.email + '</span>';
            "</td>";
            data += '<td class="ellipsis-text" style="vertical-align: middle;">' + '<span class="fullInformation" data-toggle="tooltip" data-placement="top" title="' + value.project_name + '">' + value.project_name + '</span>';
            "</td>";
            data += '<td class="" style="vertical-align: middle;">' + dataDay + '<br> <span class="subdescription font-size-12">' + dataTime + '</span> ' + "</td>"; // data += '<td class="text-center" ><span class="badge badge-' + badgeAffiliateRequest[value.status] + '">' + value.status_translated + '</span></td>';
