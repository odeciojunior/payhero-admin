    ...
    e[t] = function (e, n, t) {
      ...
      trigger: function trigger() {
        var e = this,
            ...
            t = n.shift();
        if (this.cbck[t]) for (var s = 0, a = this.cbck[t].length; a > s; s++) {
      ...
      _initPanels: function _initPanels(n) {
        ...
        l.each(function () {
          ...
          if (!n.children("." + a.navbar).length && !s.hasClass(a.vertical)) {
            if (s.parent().is("." + a.listview)) var s = s.closest("." + a.panel);else var r = s.closest("." + a.panel).find('a[href="#' + n.attr("id") + '"]').first(),
                s = r.closest("." + a.panel);
    ...
    setup: function setup() {
      if (this.opts.offCanvas) {
        ...
        if (this.conf[s], h = t[e].glbl, "boolean" == typeof o && o && (o = {
          height: "auto"
        }), "object" != _typeof2(o) && (o = {}), o = this.opts[s] = t.extend(!0, {}, t[e].defaults[s], o), "auto" == o.height) {
    ...
    setup: function setup() {
      if (this.opts.offCanvas) {
        ...
        if (this.conf[n], a = o[t].glbl, "boolean" == typeof e && (e = {
          close: e
        }), "object" != _typeof2(e) && (e = {}), e = o.extend(!0, {}, o[t].defaults[n], e), e.close) {
  ...
  t[n].addons[e] = {
    setup: function setup() {
      ...
      this.conf[e], c = t[n].glbl, "boolean" == typeof o && (o = {
        add: o,
        update: o
      }), "object" != _typeof2(o) && (o = {}), o = this.opts[e] = t.extend(!0, {}, t[n].defaults[e], o), this.bind("init", function (n) {
  ...
  i[e].addons[s] = {
    setup: function setup() {
      ...
      if (this.conf[s], l = i[e].glbl, "boolean" == typeof a && (a = {
        add: a,
        fixed: a
      }), "object" != _typeof2(a) && (a = {}), a = this.opts[s] = i.extend(!0, {}, i[e].defaults[s], a), this.bind("init", function () {
    ...
    setup: function setup() {
      if (this.opts.offCanvas) {
        ...
        if (r = e[n].glbl, "boolean" == typeof a && (a = {
          open: a
        }), "object" != _typeof2(a) && (a = {}), a = this.opts[o] = e.extend(!0, {}, e[n].defaults[o], a), a.open) {
          var d,
              f,
              c,
              u,
  ...
  e[n].addons[i] = {
    setup: function setup() {
      ...
      if (this.conf[i], d = e[n].glbl, "boolean" == typeof l && (l = {
        ...
        add: !0,
        visible: l
      }), "object" != _typeof2(l) && (l = {}), l = this.opts[i] = e.extend(!0, {}, e[n].defaults[i], l), l.visible++, l.add) {
  ...
  n[a].addons[t] = {
    setup: function setup() {
      ...
      if (i = n[a].glbl, "undefined" != typeof s) {
        ...
        n.each(s, function (i) {
          var o = s[i];
          "boolean" == typeof o && o && (o = {}), "object" != _typeof2(o) && (o = {}), "undefined" == typeof o.content && (o.content = ["prev", "title"]), o.content instanceof Array || (o.content = [o.content]), o = n.extend(!0, {}, r.opts.navbar, o);
          var l = o.position,
              h = o.height;
...
function (n) {
  ...
  n[a].addons[t][e] = function (t) {
    ...
    "object" != _typeof2(this.opts.searchfield) && (this.opts.searchfield = {}), this.opts.searchfield.add = !0, this.opts.searchfield.addTo = r;
  };
}(jQuery),
/*	
  ...
  e[n].addons[a] = {
    setup: function setup() {
      ...
      r = e[n].glbl, "boolean" == typeof d && (d = {
        add: d
      }), "object" != _typeof2(d) && (d = {}), d = this.opts[a] = e.extend(!0, {}, e[n].defaults[a], d), this.bind("close", function () {
          ...
          a.each(function () {
            ...
            if (!s.is("." + l.panel) || !s.is("." + l.vertical)) {
              if (!s.children("." + l.search).length) {
                ...
                if (c.form && "object" == _typeof2(c.form)) for (var t in c.form) {
                  a.attr(t, c.form[t]);
                }
  ...
  e[a].addons[r] = {
    setup: function setup() {
      ...
      this.conf[r], t = e[a].glbl, "boolean" == typeof d && (d = {
        add: d
      }), "object" != _typeof2(d) && (d = {}), d = this.opts[r] = e.extend(!0, {}, e[a].defaults[r], d), this.bind("init", function (a) {
        if (d.add) {
          switch (d.addTo) {
            case "panels":
              var r = a;
...
function selectCompanies() {
  ...
  for (var i = 0; i < parseSessionStorageCompanies.length; i++) {
    ...
    if (parseSessionStorageCompanies[i].active_flag == false || parseSessionStorageCompanies[i].company_document_status != "approved") itemDisabled = 'disabled="disabled"';else itemDisabled = '';
...
function updateProjectsOptions() {
  pathname = window.location.pathname; // corrige lojas em Vendas
