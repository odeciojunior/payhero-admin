...
!(function (e) {
    ...
    (function (e, t) {
        ...
        function o(e) {
            ...
            for (
                var n = a(10) ? document.body : null, i = e.offsetParent;
        ...
        function m(e, n) {
            ...
            o &&
                "HTML" === n.nodeName &&
                ((d.top = U(d.top, 0)), (d.left = U(d.left, 0)));
            var v = f({
                top: l.top - d.top - m,
            ...
            return (
                (s && !o ? n.contains(u) : n === u && "BODY" !== u.nodeName) &&
                    (v = c(v, n)),
                v
            );
        }
        function g(e) {
            var t =
                ...
                i = m(e, n),
                a = U(n.clientWidth, window.innerWidth || 0),
        ...
        function w(e, t, a, o) {
            ...
            return (
                (l.left += a), (l.top += a), (l.right -= a), (l.bottom -= a), l
            );
        }
        function y(e) {
        ...
        for (
            ...
            if (V && 0 <= navigator.userAgent.indexOf(Q[Z])) {
                Y = 1;
                break;
            }
        var K =
            ...
            G = V && !(!window.MSInputMethodContext || !document.documentMode),
            J = V && /MSIE 10/.test(navigator.userAgent),
            X = function (e, t) {
                if (!(e instanceof t))
                    throw new TypeError("Cannot call a class as a function");
            },
                ...
                modifiers: {
                    ...
                    arrow: {
                        ...
                        fn: function (e, n) {
                            ...
                            var a = n.element;
                            if ("string" == typeof a) {
                                if (!(a = e.instance.popper.querySelector(a)))
                                    return e;
                            ...
                            var o = e.placement.split("-")[0],
                                ...
                                g = _(a)[d];
                            l[m] - g < r[p] &&
                                (e.offsets.popper[p] -= r[p] - (l[m] - g)),
                                l[p] + g > r[m] &&
                                    (e.offsets.popper[p] += l[p] + g - r[m]),
                            ...
                            if (
                                ((l =
                                    "bottom" == f
                                        ...
                                        : p.top),
                                (r =
                                    "right" == m ? -d.width + p.right : p.left),
                                c && g)
                            )
                                (u[g] =
                ...
                return (
                    e(document)
                        .on(f.CLICK_DATA_API, l, function (t) {
                            t.preventDefault();
                            var n = t.target;
                            e(n).hasClass(s) || (n = e(n).closest(p)),
    ...
    (function (e) {
        ...
        var i = {
            init: function (a) {
                ...
                return o || !(a.browser.length > 0) || (o && this.length)
                    ? (i.optionCheck.call(this, a) &&
                          e("." + a.overlayClass).length <= 0 &&
                          i.addOverlay.call(this, a),
                      a.loading &&
                          e("." + a.loadingClass).length <= 0 &&
            ...
            out: function (n, a) {
                ...
                (s.data(t).outClass = h),
                    g
                        ? i.outOverlay.call(o, h, m, a)
                        : i.outDefault.call(o, h, m, a);
            },
    ...
    (function (e, t) {
        ...
        for (
            var c, d = ["webkit", "moz"], u = 0;
            u < d.length && !window.requestAnimationFrame;
            ++u
        ) {
            var p = d[u];
            (window.requestAnimationFrame =
                window[p + "RequestAnimationFrame"]),
        ...
        !(function (e) {
            ...
            r() &&
                ((e.transition = new String(d("transition"))),
                (e.transition.end = t.transition.end[e.transition])),
                l() &&
                    ((e.animation = new String(d("animation"))),
                    (e.animation.end = t.animation.end[e.animation])),
                o() &&
                    ((e.transform = new String(d("transform"))),
                    (e.transform3d = s())),
                        ...
                        [
                            ...
                            },
                            {
                                ...
                                value: function (e, t, n, i) {
                                    ...
                                    for (o in s)
                                        if ({}.hasOwnProperty.call(s, o)) break;
            ...
            y = function (e) {
                ...
                if ("string" == typeof e) {
                    var r = (function () {
                        ...
                        return a && "function" == typeof a[i]
                            ? { v: a[i].apply(a, o) }
                            : void 0;
                    })();
                    if ("object" === (void 0 === r ? "undefined" : i(r)))
                        return r.v;
                }
                return this.each(function () {
    ...
    (function (e, t) {
        ...
        var c,
            ...
            b = function (e) {
                ...
                return this.each(function () {
                    (0, n.default)(this).data(g) ||
                        (0, n.default)(this).data(g, new m(this, e));
                });
            };
        ...
        (e[s] && e[s].version > r) ||
            ...
            (e[s].prototype = {
                    ...
                    if (i.hasClass(n.vertical)) {
                        ...
                        o
                            ...
                            t.hasClass(n.opened)
                                ...
                                : (t.addClass(n.highest),
                                  r.addClass(n.subopened)),
                ...
                togglePanel: function (e) {
                    var t = e.parent();
                    t.hasClass(n.vertical) &&
                        this[t.hasClass(n.opened) ? "closePanel" : "openPanel"](
                            e
                        );
                },
                ...
                trigger: function () {
                    var e = this,
                        ...
                        n = t.shift();
                    if (this.cbck[n])
                        for (var i = 0, a = this.cbck[n].length; a > i; i++)
                ...
                _initPanels: function (t) {
                    ...
                    this.__refactorClass(
                        ...
                        "inset"
                    ).addClass(n.nolistview + " " + n.nopanel),
                    ...
                    this.__refactorClass(
                        ...
                        l.each(function () {
                            ...
                            t.removeAttr("id"),
                                ...
                                t.hasClass(n.vertical) &&
                                    (t.removeClass(a.conf.classNames.vertical),
                                    i.add(i.parent()).addClass(n.vertical)),
                                (r = r.add(i));
                        });
                    ...
                    r.each(function () {
                        ...
                        if (
                            (l.is("." + n.panels) ||
                                (l.data(i.sub, t), t.data(i.parent, l)),
                            !l.children("." + n.next).length &&
                                l.parent().is("." + n.listview))
                        ) {
                            var s = t.attr("id"),
                                r = e(
                                    '<a class="' +
                        ...
                        if (
                            ...
                            !l.hasClass(n.vertical)
                        ) {
                            if (l.parent().is("." + n.listview))
                                var l = l.closest("." + n.panel);
                            else
                                l = (o = l
                                    .closest("." + n.panel)
                ...
                _initAnchors: function () {
                    ...
                    o.$body.on(a.click + "-oncanvas", "a[href]", function (i) {
                        ...
                        for (var l in e[s].addons)
                            if ((o = e[s].addons[l].clickAnchor.call(t, a, r)))
                                break;
                        if (!o && r) {
                            var c = a.attr("href");
                        ...
                        if (
                            ...
                            u && i.preventDefault(),
                                t.__valueOrFn(t.opts.onClick.close, a, u) &&
                                    t.close();
                        }
                    });
                },
                _initAddons: function () {
                    for (var t in e[s].addons)
                        e[s].addons[t].add.call(this),
                            (e[s].addons[t].add = function () {});
                ...
                __transitionend: function (e, t, n) {
                    ...
                    e.one(a.transitionend, o),
                        e.one(a.webkitTransitionEnd, o),
                        setTimeout(o, 1.1 * n);
                },
        ...
        (e[o].addons[s] = {
            setup: function () {
                if (this.opts[s]) {
                    ...
                    "left" != n.position && r.push(t.mm(n.position)),
                        ...
                        this._initBlocker(),
                        this["_initWindow_" + s](),
                        this.$menu[i.menuInjectMethod + "To"](
                            i.menuWrapperSelector
                        );
                }
            },
            add: function () {
            ...
            (e[o].prototype._openSetup = function () {
                ...
                r.blockUI && l.push(t.blocking),
                    ...
                    "back" != r.zposition &&
                        l.push(t.mm(this.opts[s].zposition)),
                    ...
                    this.__transitionend(
                        ...
                        function () {
                            i.$menu
                                ...
                                i.opts.extensions &&
                                    a.$html.removeClass(i.opts.extensions),
                                a.$page.each(function () {
                                    e(this).attr(
                                        "style",
                                        e(this).data(n.style)
            ...
            (e[o].prototype.setPage = function (n) {
                ...
                (n && n.length) ||
                    ...
                    o.noPageSelector.length &&
                        (n = n.not(o.noPageSelector.join(", "))),
                    n.length > 1 &&
                        o.wrapPageIfNeeded &&
                        (n = n
                            .wrapAll("<" + this.conf[s].pageNodetype + " />")
                            .parent())),
                    n.each(function () {
                        e(this).attr(
                            "id",
            ...
            (e[o].prototype["_initWindow_" + s] = function () {
                ...
                a.$wndw
                    .off(i.resize + "-" + s)
                    .on(i.resize + "-" + s, function (n, i) {
                        if (
                            1 == a.$page.length &&
                            (i || a.$html.hasClass(t.opened))
                        ) {
                            var o = a.$wndw.height();
                            (i || o != e) &&
                                ((e = o), a.$page.css("minHeight", o));
                        }
                    });
            }),
            ...
            setup: function () {
                if (this.opts.offCanvas) {
                    ...
                    if (
                        ...
                        "auto" ==
                            (r = this.opts[o] =
                                e.extend(!0, {}, e[a].defaults[o], r)).height)
                    ) {
                        this.$menu.addClass(t.autoheight);
                        var l = function (e) {
                            var n = parseInt(this.$pnls.css("top"), 10) || 0;
                            (_bot =
                                parseInt(this.$pnls.css("bottom"), 10) || 0),
                                this.$menu.addClass(t.measureheight),
                                (e =
                                    e ||
                                    this.$pnls.children("." + t.current)).is(
                                    "." + t.vertical
                                ) &&
                                    (e = e
                                        .parents("." + t.panel)
                        ...
                        this.bind("update", function () {
                            this.$pnls.find("." + t.panel).each(function () {
                                ...
                                if (a) {
                                    ...
                                    s.length &&
                                        (i = i.children("." + t.listview))
                                            .length &&
                                        s.html(
                                            o.__filterListItems(i.children())
                                                .length
                                        );
                                }
                            });
            ...
            setup: function () {
                if (this.opts.offCanvas) {
                    ...
                    if (
                        ...
                        "object" != _typeof2(r) && (r = {}),
                        (r = this.opts[o] =
                            e.extend(!0, {}, e[a].defaults[o], r)).open)
                    ) {
                        var c,
                            d,
                            u,
        ...
        (e[n].addons[i] = {
            setup: function () {
                ...
                if (
                    ...
                    for (var s = [], r = 0; r <= o.visible; r++)
                        s.push(t.iconpanel + "-" + r);
                    s = s.join(" ");
                    var l = function (n) {
                        a.$pnls
                            .children("." + t.panel)
    ...
    (function (e) {
        ...
        (e[n].addons[i] = {
                    ...
                    for (var l in (e.each(o, function (l) {
                        ...
                        "boolean" == typeof c && c && (c = {}),
                            ...
                            c.content instanceof Array ||
                                (c.content = [c.content]);
                        var d = (c = e.extend(!0, {}, a.opts.navbar, c))
                                .position,
                            u = c.height;
                        "number" != typeof u && (u = 1),
                        ...
                        var g = Math.ceil(
                            p.children().not("." + t.btn).length / u
                        );
                        g > 1 && p.addClass(t.navbar + "-content-" + g),
                            p.children("." + t.btn).length &&
                                p.addClass(t.hasbtns),
                            p.prependTo(a.$menu);
                    }),
                    r))
            ...
            (e[n].configuration.classNames[i] = {
                panelTitle: "Title",
                panelNext: "Next",
                panelPrev: "Prev",
            });
        ...
        e[t].addons[n].next = function (i) {
            ...
            var o = function (e) {
                ...
                var t = i.find("." + a.next),
                    ...
                    s = o.attr("href"),
                    r = o.html();
                t[s ? "attr" : "removeAttr"]("href", s),
                    t[s || r ? "removeClass" : "addClass"](a.hidden),
                    t.html(r);
            };
    ...
    (function (e) {
        ...
        e[t].addons[n].prev = function (i) {
            ...
            var o = function () {
                ...
                o.length ||
                    (o = e.children("." + a.navbar).children("." + a.prev));
                var s = o.attr("href"),
                    r = o.html();
                t[s ? "attr" : "removeAttr"]("href", s),
                    t[s || r ? "removeClass" : "addClass"](a.hidden),
    ...
    (function (e) {
        ...
        e[t].addons.navbars.searchfield = function (n) {
            ...
            "object" != _typeof2(this.opts.searchfield) &&
    ...
    (function (e) {
        ...
        e[t].addons[n].title = function (i, a) {
            ...
            var s = function (e) {
                ...
                s.length ||
                    (s = e.children("." + o.navbar).children("." + o.title));
                var r = s.attr("href"),
                    l = s.html() || a.title;
                t[r ? "attr" : "removeAttr"]("href", r),
                    t[r || l ? "removeClass" : "addClass"](o.hidden),
                    t.html(l);
            };
...
function pagination(e, t, n) {
    ...
    if (1 !== a && a !== o) {
        var r = "<button class='btn nav-btn active current_page'>".concat(
            a,
            "</button>"
        );
        $(i).append(r),
...
function copyToClipboard(e) {
    ...
    if ((console.log(e.tagName), a))
        (o = e), (t = e.selectionStart), (n = e.selectionEnd);
    else {
                ...
                if ("approved" !== t.data.account.status) {
                    ...
                    "pending" == t.data.user.status
                        ? ((e += 1),
                          ...
                          (p = "Envie sua documentação pessoal"),
                          (f =
                        ...
                        ? ((e += 1),
                          ...
                          (u =
                              '<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M10 0C15.523 0 20 4.478 20 10C20 15.522 15.523 20 10 20C4.477 20 0 15.522 0 10C0 4.478 4.477 0 10 0ZM10 1.667C5.405 1.667 1.667 5.405 1.667 10C1.667 14.595 5.405 18.333 10 18.333C14.595 18.333 18.333 14.595 18.333 10C18.333 5.405 14.595 1.667 10 1.667ZM9.25 4C9.6295 4 9.94346 4.28233 9.99315 4.64827L10 4.75V10H13.25C13.664 10 14 10.336 14 10.75C14 11.1295 13.7177 11.4435 13.3517 11.4931L13.25 11.5H9.25C8.8705 11.5 8.55654 11.2177 8.50685 10.8517L8.5 10.75V4.75C8.5 4.336 8.836 4 9.25 4Z" fill="#FAFAFA"/></svg>'),
                          (p = "Estamos analisando seus documentos"),
                          (f =
                              "Esse processo de revisão leva um tempinho. Mas em breve retornaremos."),
                          (h =
                        ...
                        ? ((e += 1),
                          ...
                          (u =
                              '<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M10 0C15.5228 0 20 4.47715 20 10C20 15.5228 15.5228 20 10 20C4.47715 20 0 15.5228 0 10C0 4.47715 4.47715 0 10 0ZM10 1.5C5.30558 1.5 1.5 5.30558 1.5 10C1.5 14.6944 5.30558 18.5 10 18.5C14.6944 18.5 18.5 14.6944 18.5 10C18.5 5.30558 14.6944 1.5 10 1.5ZM13.4462 6.39705L13.5303 6.46967C13.7966 6.73594 13.8208 7.1526 13.6029 7.44621L13.5303 7.53033L11.061 10L13.5303 12.4697C13.7966 12.7359 13.8208 13.1526 13.6029 13.4462L13.5303 13.5303C13.2641 13.7966 12.8474 13.8208 12.5538 13.6029L12.4697 13.5303L10 11.061L7.53033 13.5303C7.26406 13.7966 6.8474 13.8208 6.55379 13.6029L6.46967 13.5303C6.2034 13.2641 6.1792 12.8474 6.39705 12.5538L6.46967 12.4697L8.939 10L6.46967 7.53033C6.2034 7.26406 6.1792 6.8474 6.39705 6.55379L6.46967 6.46967C6.73594 6.2034 7.1526 6.1792 7.44621 6.39705L7.53033 6.46967L10 8.939L12.4697 6.46967C12.7359 6.2034 13.1526 6.1792 13.4462 6.39705Z" fill="white"/></svg>'),
                          (p = "Tivemos um problema com o seu documento"),
                          (f =
                        ...
                        : "approved" == t.data.user.status &&
                          ...
                          (u =
                              '<svg width="16" height="13" viewBox="0 0 16 13" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M15.6876 0.346147C16.1041 0.807675 16.1041 1.55596 15.6876 2.01749L6.08758 12.6539C5.67102 13.1154 4.99565 13.1154 4.57909 12.6539L0.312419 7.92658C-0.10414 7.46505 -0.10414 6.71677 0.312419 6.25524C0.728979 5.79371 1.40435 5.79371 1.82091 6.25524L5.33333 10.1468L14.1791 0.346147C14.5956 -0.115382 15.271 -0.115382 15.6876 0.346147Z" fill="white"/></svg>'),
                          (p = "Sua documentação foi recebida e aprovada"),
                          (f =
...
function setNewRegisterSavedItem(e, t) {
    ...
    if (
        ...
        (i[e] = t),
            localStorage.setItem("new-register-data-" + n, JSON.stringify(i));
    }
}
function removeNewRegisterSavedItem(e) {
    ...
    if (localStorage.getItem("new-register-data-" + t)) {
        ...
        delete n[e],
            localStorage.setItem("new-register-data-" + t, JSON.stringify(n));
    }
}
...
function loadNewRegisterSavedData() {
    ...
    if (localStorage.getItem("new-register-data-" + e)) {
        ...
        for (var n in t) {
            var i = $("#" + n);
            "DIV" === i.prop("nodeName") &&
                i.addClass("option-selected").attr("data-step-1-selected", 1),
    ...
    loadingOnScreen(),
        $.ajax({
            ...
            success: function (e) {
                ...
                var t = $('meta[name="user-id"]').attr("content");
                localStorage.removeItem("new-register-data-" + t),
                    loadingOnScreenRemove();
            },
        });
}
    ...
    (function (e, t, n) {
        ...
        function (e) {
                ...
                var a = {
                    ...
                    getCaret: function () {
                        try {
                            ...
                            if (
                                ...
                                var s = i.createRange();
                                s.moveStart("character", -a.val().length),
                                    (e = s.text.length);
                            } else (o || "0" === o) && (e = o);
                            return e;
                        } catch (e) {}
                    ...
                    calculateCaretPosition: function (e) {
                        ...
                        if (e !== n) {
                            ...
                            for (s = i - 1; 0 <= s && a.maskDigitPosMap[s]; s--)
                                e++;
                            for (s = i - 1; 0 <= s; s--)
                                a.maskDigitPosMap[s] && c++;
                            for (s = o - 1; 0 <= s; s--)
                                a.maskDigitPosMapOld[s] && d++;
                            i > r
                                ? (i = 10 * n)
                                : o >= i && o !== r
                    ...
                    callbacks: function (e) {
                        ...
                        c("onChange", !0 === s, l),
                            ...
                            c("onInvalid", 0 < a.invalid.length, [
                                o,
                                e,
                                t,
                                a.invalid,
            ...
            (e.fn.mask = function (n, a) {
                ...
                var l = function () {
                    if (i(this, n, a))
                        return e(this).data("mask", new t(this, n, a));
                };
                return (
                    e(this).each(l),
                    o &&
                ...
                (a = e.jMaskGlobals = e.extend(!0, {}, a, e.jMaskGlobals))
                                ...
                                return (
                                    ...
                                    "number" == typeof o.selectionEnd
                                        ...
                                        : (t =
                                          ...
                                          (e = o.value.replace(/\r\n/g, "\n")),
                                          (n =
                                              o.createTextRange()).moveToBookmark(
                                              t.getBookmark()
                                          ),
                                          (a = o.createTextRange()).collapse(
                                              !1
                                          ),
                                          n.compareEndPoints("StartToEnd", a) >
                                          -1
                                              ? (r = l = i)
                                              : ((r = -n.moveStart(
                                                    "character",
                ...
                : (function (e, t) {
                      ...
                      if (((n = o(c, r, t)), t.precision > 0)) {
                          ...
                          (a = l.slice(l.length - t.precision)),
                              (s = new Array(t.precision + 1 - a.length).join(
                                  0
                              )),
                              (n += t.decimal + s + a);
                      }
            ...
            w = function (e) {
                ...
                var t = void 0,
                    ...
                    o =
                        "string" == typeof e.target
                            ...
                            : e.target;
                (t =
                    n && o && n.parentNode !== o.parentNode ? $(e) : n || $(e)),
                    e.width &&
                        (t.style.width =
                ...
                if (
                    ...
                    K([m, g], i.styled),
                        ...
                        e.cancelButtonColor &&
                            (g.style.backgroundColor = e.cancelButtonColor);
                    var z = window
                        .getComputedStyle(m)
                        .getPropertyValue("background-color");
                    (m.style.borderLeftColor = z),
                        (m.style.borderRightColor = z);
                } else
                    G([m, g], i.styled),
            ...
            C = function e() {
                ...
                if ("undefined" != typeof window) {
                    if (
                        ...
                        return (
                            r("SweetAlert2 expects at least 1 attribute!"), !1
                        );
                    var o = p({}, h);
                    switch (u(n[0])) {
                        case "string":
                        ...
                        case "object":
                            if (
                                ...
                                o.inputValidator = o.expectRejections
                                    ? s
                                    : e.adaptInputValidator(s);
                            }
                            if (
                                "url" === o.input &&
                                null === o.inputValidator
                    ...
                    return new Promise(function (t, n) {
                        var a = function (n) {
                                e.closePopup(o.onClose),
                                    o.useRejections ? t(n) : t({ value: n });
                            },
                            s = function (i) {
                                e.closePopup(o.onClose),
                                    o.useRejections ? n(i) : t({ dismiss: i });
                            },
                            l = function (t) {
                        ...
                        o.reverseButtons
                            ...
                            : O.parentNode.insertBefore(O, F);
                        var U = function (e, t) {
                            for (
                                var n = z(o.focusCancel), i = 0;
                                i < n.length;
                                i++
                            ) {
                                (e += t) === n.length
                        ...
                        for (
                            ...
                            if ((te = p(Z[ie]))) {
                                ...
                                for (var ce in o.inputAttributes)
                                    te.setAttribute(ce, o.inputAttributes[ce]);
                            }
                            (se.className = oe),
                                o.inputClass && K(se, o.inputClass),
                                ee(se);
                        }
                        var de,
                            ue,
                        ...
                        switch (o.input) {
                            ...
                            case "range":
                                ...
                                (ve.value = o.inputValue),
                                    (ve.type = o.input),
                                    (be.value = o.inputValue),
                                    X(ge);
                                break;
                            case "select":
                                var we = J(S, i.select);
                        ...
                        (de = o.animation),
                            ...
                            de
                                ? (K(he, i.show), K(fe, i.fade), G(he, i.hide))
                                : G(he, i.fade),
                            X(he),
                            (fe.style.overflowY = "hidden"),
                            ae && !Q(he, i.noanimation)
                                ? he.addEventListener(ae, function e() {
                                      he.removeEventListener(ae, e),
                                          (fe.style.overflowY = "auto");
                                  })
                                : (fe.style.overflowY = "auto"),
                            K(
                                [document.documentElement, document.body, fe],
                                i.shown
                            ),
                            W() && (y(), x()),
        ...
        (e.default = o),
            ...
            (e.pluginFactory = function (e, t) {
                var i =
                    ...
                    a = s(e);
                if (a && void 0 === a.api)
                    return new a(t, n.default.extend(!0, {}, r(e), i));
                if (n.default.fn[e]) {
                    var l = new o(t, i);
                    return (
                        (l.getName = function () {
        ...
        var i = babelHelpers.interopRequireDefault(t),
            ...
            l = (function (e) {
                function t() {
                    ...
                    return (
                        o.setupMenu(),
                        (o.$menuBody = o.$el.children(".mm-panels")),
                        (o.type = "fold"),
                        o
                    );
                }
                    ...
                    babelHelpers.createClass(t, [
                        ...
                        },
                        {
                            ...
                            value: function () {
                                this.animate(
                                    function () {
                                        o.addClass("site-menubar-unfold"),
                ...
                return (
                    ...
                    babelHelpers.createClass(t, [
                        ...
                        },
                        {
                            ...
                            value: function () {
                                var e = this.getCurrentBreakpoint(),
                                    t = !1;
                                switch (
                                    ((!1 === m.data("autoMenubar") ||
                                        m.is(".site-menubar-keep")) &&
                        ...
                        { key: "menubarType", value: function (e) {} },
                        {
                            ...
                            value: function () {
                                (this.menubar = new c.default({
                                    $el: (0, r.default)(".site-menubar"),
                                })),
                                    (this.gridmenu = new p.default({
                                        $el: (0, r.default)(".site-gridmenu"),
                                    })),
                                    (this.sidebar = new d.default());
                                var e = (0, r.default)(".page-aside");
                                e.length > 0 &&
                                    ((this.aside = new u.default({ $el: e })),
                                    this.aside.run()),
                                    this.menubar.run(),
                                    this.gridmenu.run();
                            },
                            ...
                            value: function () {
                                h.on(
                                    ...
                                    .on("shown.bs.dropdown", function (e) {
                                        var t = (0, r.default)(e.target).find(
                        ...
                        },
                        {
                            ...
                            value: function () {
                                (0, r.default)(document).on(
                                    ...
                                    function (e) {
                                        var t = (0, r.default)(this).hasClass(
                                            "collapsed"
                                        );
                        ...
                        },
                        {
                            key: "startLoading",
                            value: function () {
                                if (void 0 === r.default.fn.animsition)
                                    return !1;
                                m.animsition({
                                    inClass: "fade-in",
                                    inDuration: 10,
                            ...
                            value: function (e) {
                                if (void 0 === this.tour) {
                                    ...
                                    (this.tour = introJs()),
                                        ...
                                        (0, r.default)(".site-tour-trigger").on(
                                            "click",
                                            function () {
                                                n.tour.start();
                                            }
