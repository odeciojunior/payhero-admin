...
!(function (e) {
    ...
    (function (e, t) {
        ...
        var K =
            ...
            J = V && !(!window.MSInputMethodContext || !document.documentMode),
    ...
    (function (e, t) {
        ...
        var s = (function (e) {
            ...
            u = (function (e) {
                ...
                return (
                    e(document)
                        .on(d.KEYDOWN_DATA_API, w, D._dataApiKeydownHandler)
                        .on(d.KEYDOWN_DATA_API, x, D._dataApiKeydownHandler)
                        .on(
        ...
        var e = {
            ...
            w = function (e) {
                ...
                var t = void 0,
                    ...
                    o =
                        "string" == typeof e.target
                            ...
                            : e.target;
                (t =
                    n && o && n.parentNode !== o.parentNode ? S(e) : n || S(e)),
                    e.width &&
                        (t.style.width =
                ...
                if (e.type) {
                    ...
                    if (!$) return r("Unknown alert type: " + e.type), !1;
                    var P = t.querySelector("." + i.icon + "." + a[e.type]);
                    X(P),
                        e.animation &&
                            K(P, "swal2-animate-" + e.type + "-icon");
                }
                var B = j();
                if (
                    (e.imageUrl
                ...
                if ("undefined" != typeof window) {
                    ...
                    return new Promise(function (t, n) {
                        ...
                        switch (o.input) {
                            ...
                            case "tel":
                            case "url":
                                ((te = G($, i.input)).value = o.inputValue),
                                    (te.placeholder = o.inputPlaceholder),
                                    (te.type = o.input),
                                    X(te);
                                break;
                            case "file":
                                ((te = G($, i.file)).placeholder =
                                    o.inputPlaceholder),
                                    (te.type = o.input),
                                    X(te);
                                break;
                            ...
                            case "textarea":
                                var Se = G($, i.textarea);
                                (Se.value = o.inputValue),
                                    (Se.placeholder = o.inputPlaceholder),
                                    X(Se);
                                break;
                            case null:
                                break;
                        ...
                        (de = o.animation),
                            ...
                            de
                                ? (K(he, i.show), K(fe, i.fade), J(he, i.hide))
                                : J(he, i.fade),
                            X(he),
