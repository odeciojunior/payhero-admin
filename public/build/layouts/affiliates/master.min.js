                                ...
                                secondary: function secondary(e) {
                                    ...
                                    return (
                                        r[e] > n[e] &&
                                            ...
                                            (i = J(r[o], n[e] - ("right" === e ? r.width : r.height))),
                                        ae({}, o, i)
                                    );
                                },
                            };
 ...
 */ (function (global, factory) {
    (typeof exports === "undefined" ? "undefined" : _typeof2(exports)) === "object" && typeof module !== "undefined"
 ...
 */ (function (global, factory) {
    ...
    (function (support) {
        ...
        if (tests.csstransitions()) {
            /*eslint no-new-wrappers: "off"*/ support.transition = new String(prefixed("transition"));
            support.transition.end = events.transition.end[support.transition];
        }
        if (tests.cssanimations()) {
            /*eslint no-new-wrappers: "off"*/ support.animation = new String(prefixed("animation"));
            support.animation.end = events.animation.end[support.animation];
        }
        if (tests.csstransforms()) {
            /*eslint no-new-wrappers: "off"*/ support.transform = new String(prefixed("transform"));
     ...
     **/ var asScrollbar = (function () {
        function asScrollbar(bar) {
            ...
            if (this.options.direction === "vertical") {
                this.attributes = { axis: "Y", position: "top", length: "height", clientLength: "clientHeight" };
            } else if (this.options.direction === "horizontal") {
                this.attributes = { axis: "X", position: "left", length: "width", clientLength: "clientWidth" };
            ...
            [
                    ...
                    value: function init() {
                        ...
                        if (this.$handle.length === 0) {
                            this.$handle = (0, _jquery2["default"])(
                                options.handleTemplate.replace(/\{\{handle\}\}/g, this.classes.handleClass)
                            ).appendTo(this.$bar);
                        } else {
                    ...
                    value: function bindEvents() {
                        ...
                        if (this.options.keyboard) {
                            (0, _jquery2["default"])(document).on(this.eventName("keydown"), function (e) {
                                ...
                                if (
                                    (0, _jquery2["default"])(activeElement).is(":input,select,option,[contenteditable]")
                                ) {
                                    return;
                                }
                                var by = 0,
                ...
                },
                {
                    ...
                    value: function onClick(event) {
                        ...
                        var distance = this.distance({ x: offset.left, y: offset.top }, this._drag.pointer),
                            factor = 1;
                        if (distance > 0) {
            ...
            var _ret3 = (function () {
                ...
                if (/^_/.test(method)) {
                    ...
                    if (instance && typeof instance[method] === "function") {
                        return { v: instance[method].apply(instance, args) };
                    }
                } else {
                    return {
                ...
                },
                {
                    ...
                    value: function throttle(func, wait) {
                        ...
                        return function () {
                            ...
                            /*eslint consistent-this: "off"*/ var now = _now();
                ...
                _initPanels: function _initPanels(n) {
                        ...
                        d.each(function () {
                            ...
                            n.removeAttr("id"),
                                ...
                                n.hasClass(a.vertical) &&
                                    (n.removeClass(t.conf.classNames.vertical), s.add(s.parent()).addClass(a.vertical)),
                                (l = l.add(s));
                        });
                    ...
                    l.each(function () {
                        ...
                        if (
                            ...
                            var l = n.attr("id"),
                                d = e(
                                    '<a class="' + a.next + '" href="#' + l + '" data-target="#' + l + '" />'
                                ).insertBefore(r);
                        ...
                        if (!n.children("." + a.navbar).length && !s.hasClass(a.vertical)) {
                            ...
                            if (s.length) {
                                ...
                                o
                                    ...
                                    .append(
                                        e(
                                            '<a class="' + a.title + '"' + (_url ? ' href="' + _url + '"' : "") + " />"
                                        ).text(r.text())
                                    )
                                    .prependTo(n),
                                ...
                                t.opts.navbar.title &&
                                    (o
                                        .append('<a class="' + a.title + '">' + t.opts.navbar.title + "</a>")
                                        .prependTo(n),
                                    t.opts.navbar.add && n.addClass(a.hasnavbar));
                        }
                    });
                        ...
                        if (!r && l) {
                            ...
                            if (o.length > 1 && "#" == o.slice(0, 1))
                                try {
                                    var c = e(o, n.$menu);
                                    c.is("." + a.panel) &&
                                        ((r = !0), n[i.parent().hasClass(a.vertical) ? "togglePanel" : "openPanel"](c));
                                } catch (h) {}
                        }
                        if (
                            (r && s.preventDefault(),
    ...
    (i[e].addons[s] = {
        setup: function setup() {
            ...
            if (
                ...
                (this.$fixeddivider = i(
                    '<ul class="' + d.listview + " " + d.fixeddivider + '"><li class="' + d.divider + '"></li></ul>'
                )
                    .prependTo(this.$pnls)
                    .children()),
                    this.bind("openPanel", o),
                    this.bind("init", function (e) {
                        e.off(t.scroll + "-dividers " + t.touchmove + "-dividers").on(
        ...
        clickAnchor: function clickAnchor(i, e) {
            if (this.opts[s].collapse && e) {
                ...
                if (n.is("." + d.divider)) {
                    ...
                    return (
                        n.toggleClass(d.opened), t[n.hasClass(d.opened) ? "addClass" : "removeClass"](d.uncollapsed), !0
                    );
                }
            }
            return !1;
 ...
 */ !(function (e) {
    ...
    (e[n].addons[o] = {
                    ...
                    y.on("panstart", function (e) {
                        ...
                        .on(l.events, function (e) {
                            ...
                            2 == m &&
                                ...
                                r.$slideOutNodes.css({ "-webkit-transform": "-webkit-" + c, transform: c }));
                        })
                        .on("panend", function () {
                            2 == m &&
        ...
        (e[n].defaults[o] = { open: !1, maxStartPos: 100, threshold: 50, vendors: { hammer: {} } }),
        (e[n].configuration[o] = {
 ...
 */ !(function (n) {
    ...
    (n[a].addons[t] = {
        ...
        (n[a].configuration.classNames[t] = { panelTitle: "Title", panelNext: "Next", panelPrev: "Prev" });
    var e, r, s, i;
})(jQuery),
    /*
            ...
            s.add("breadcrumbs separator"),
                ...
                this.bind("init", function (a) {
                    a.removeClass(s.hasnavbar).each(function () {
                        ...
                        e.append(
                            a.join('<span class="' + s.separator + '">' + r.breadcrumbSeparator + "</span>")
                        ...
                        a.each(function () {
                            ...
                            if (!s.is("." + l.panel) || !s.is("." + l.vertical)) {
                                if (!s.children("." + l.search).length) {
                                    ...
                                    if (c.form && "object" == _typeof2(c.form))
                                        for (var t in c.form) {
                                            a.attr(t, c.form[t]);
                                        }
                                    a.append(
                                        '<input placeholder="' + d.placeholder + '" type="text" autocomplete="off" />'
                                    ),
                                        ...
                                        b = function b() {
                                            ...
                                            r.scrollTop(0),
                                                ...
                                                p.each(function () {
                                                    var n = e(this),
                                                        a = v;
                                                    (d.showTextItems || (d.showSubPanels && n.find("." + l.next))) &&
                                                        (a = m),
                                                ...
                                                d.showSubPanels &&
                                                    r.each(function () {
                                                        var s = e(this);
                                                        o.__filterListItems(s.find("." + l.listview).children()).each(
                                                            function () {
                                                                var s = e(this),
                                                                    n = s.data(t.sub);
                                                ...
                                                e(r.get().reverse()).each(function (s) {
                                                    var n = e(this),
                                                        i = n.data(t.parent);
                                                    i &&
                                                        (o.__filterListItems(n.find("." + l.listview).children()).length
                                                            ? (i.hasClass(l.hidden) &&
                                                                  i
                                                                      .children("." + l.next)
                                                                      .not("." + l.fullsubopen)
                                                ...
                                                c[p.not("." + l.hidden).length ? "removeClass" : "addClass"](
                                                    l.noresults
                                                ),
                                                this.update();
                                        };
                ...
                this.bind("init", function (a) {
                    ...
                    if (!this.$indexer && this.$pnls.children("." + n.hasindexer).length) {
                        (this.$indexer = e('<div class="' + n.indexer + '" />')
                            ...
                            this.$indexer
                                .children()
                                .on(s.mouseover + "-sectionindexer " + n.touchstart + "-sectionindexer", function () {
                                    ...
                                    r.scrollTop(0),
                                        s
                                            ...
                                            .each(function () {
                                                t === !1 &&
                                                    a == e(this).text().slice(0, 1).toLowerCase() &&
                    ...
                    this.__refactorClass(t("input", e), this.conf.classNames[c].toggle, "toggle"),
                        ...
                        t("input." + s.toggle + ", input." + s.check, e).each(function () {
                            ...
                            c.children('label[for="' + l + '"]').length ||
                                (e.attr("id", l),
                                c.prepend(e),
                                t('<label for="' + l + '" class="' + s[i] + '"></label>').insertBefore(
...
(function (a, n, f) {
    "function" === typeof define && define.amd
        ? define(["jquery"], a)
        : "object" === (typeof exports === "undefined" ? "undefined" : _typeof2(exports)) &&
            ...
            p = function p(b, d, e) {
                ...
                try {
                    return (
                        ...
                        "object" !== _typeof2(c) || f(c.options) !== f(e) || c.mask !== d
                    );
                } catch (w) {}
            },
            k = function k(a) {
                ...
                return this.each(function () {
                    ...
                    function canInputMoreNumbers() {
                        var haventReachedMaxLength = !(
                            ...
                            haveNumberSelected =
                                selection.start !== selection.end && $input.val().substring(start, end).match(/\d/)
                                    ? true
                                    : false,
                    ...
                    function applyMask(e) {
                        ...
                        value = $input.val();
                        $input.val(
                            value.substring(0, startPos) + keyPressedChar + value.substring(endPos, value.length)
                        );
...
!(function (n, t) {
    ...
    var n = {
                ...
                return (function (n, t) {
                    ...
                    try {
                        for (
                            ...
                            !(o = (r = i.next()).done) && (e.push(r.value), !t || e.length !== t);
                            o = !0
                        ) {}
                    } catch (n) {
                        (a = !0), (s = n);
        ...
        x = function x(n) {
            ...
            (t = e && s && e.parentNode !== s.parentNode ? A(n) : e || A(n)),
                n.width && (t.style.width = "number" == typeof n.width ? n.width + "px" : n.width),
                n.padding && (t.style.padding = "number" == typeof n.padding ? n.padding + "px" : n.padding),
            ...
            if (
                ...
                "string" == typeof n.backdrop
                    ...
                    : n.backdrop || Q([document.documentElement, document.body], o["no-backdrop"]),
                n.html ? I(n.html, d) : n.text ? ((d.textContent = n.text), G(d)) : nn(d),
                n.position in o
                    ? Q(w, o[n.position])
                    : (r('The "position" parameter is not valid, defaulting to "center"'), Q(w, o.center)),
            ...
            "function" == typeof n.animation && (n.animation = n.animation.call()),
                n.showCloseButton ? (g.setAttribute("aria-label", n.closeButtonAriaLabel), G(g)) : nn(g),
                (t.className = o.popup),
                n.toast
                    ? (Q([document.documentElement, document.body], o["toast-shown"]), Q(t, o.toast))
                    : Q(t, o.modal),
                ...
                ? (G(k),
                  ...
                  n.progressSteps.forEach(function (t, e) {
                      ...
                      if (
                          ...
                          Q(s, o.progressline),
                              n.progressStepsDistance && (s.style.width = n.progressStepsDistance),
                              k.appendChild(s);
                      }
                  }))
                : nn(k);
            ...
            if (
                (n.imageUrl
                    ? (N.setAttribute("src", n.imageUrl),
                      ...
                      G(N),
                      n.imageWidth ? N.setAttribute("width", n.imageWidth) : N.removeAttribute("width"),
                      n.imageHeight ? N.setAttribute("height", n.imageHeight) : N.removeAttribute("height"),
                      (N.className = o.image),
                ...
                Q([m, b], o.styled),
                    n.confirmButtonColor && (m.style.backgroundColor = n.confirmButtonColor),
                    n.cancelButtonColor && (b.style.backgroundColor = n.cancelButtonColor);
                ...
                return new Promise(function (t, e) {
                    ...
                    if (
                        ...
                        m.onclick = function (t) {
                            t.target !== m ||
                                s.showConfirmButton ||
                                s.showCancelButton ||
                                (s.allowOutsideClick && (n.closePopup(s.onClose), r(n.DismissReason.backdrop)));
                        };
                    else {
                        var A = !1;
                    ...
                    s.toast && g && ((window.onkeydown = b), (g = !1)),
                        s.toast ||
                            ...
                            (window.onkeydown = function (t) {
                                ...
                                if ("Enter" !== e.key || e.isComposing) {
                                    if ("Tab" === e.key) {
                                        for (
                                            var o = e.target || e.srcElement, a = M(s.focusCancel), i = -1, l = 0;
                                            l < a.length;
                                            l++
                                        ) {
                                            if (o === a[l]) {
                        ...
                        (n.enableInput = function () {
                            ...
                            if ("radio" === n.type)
                                for (
                                    var t = n.parentNode.parentNode.querySelectorAll("input"), e = 0;
                                    e < t.length;
                                    e++
                                ) {
                                    t[e].disabled = !1;
                        ...
                        (n.showValidationError = function (n) {
                            ...
                            (t.style.marginLeft = "-" + e.getPropertyValue("padding-left")),
                                (t.style.marginRight = "-" + e.getPropertyValue("padding-right")),
                                G(t);
                            var a = u();
                            a &&
                    ...
                    for (
                        var _ = ["input", "file", "range", "select", "radio", "checkbox", "textarea"],
                            tn = void 0,
                            on = 0;
                        on < _.length;
                        on++
                    ...
                    switch (s.input) {
                        ...
                        case "select":
                            ...
                            bn = function bn(n) {
                                n.forEach(function (n) {
                                    ...
                                    (a.value = e),
                                        (a.innerHTML = o),
                                        s.inputValue.toString() === e.toString() && (a.selected = !0),
                                        kn.appendChild(a);
                                }),
                                    G(kn),
                                    kn.focus();
                                ...
                                (bn = function bn(n) {
                                    n.forEach(function (n) {
                                        ...
                                        (r.type = "radio"),
                                            (r.name = o.radio),
                                            (r.value = e),
                                            s.inputValue.toString() === e.toString() && (r.checked = !0),
                                            (i.innerHTML = a),
                        ...
                        case "checkbox":
                            ...
                            An.length && Cn.removeChild(An[0]),
                                ((An = document.createElement("span")).innerHTML = s.inputPlaceholder),
                                Cn.appendChild(An),
                                G(Cn);
                            break;
                        case "textarea":
    ...
    (v.isVisible = function () {
        ...
        (v.version = "7.12.15"),
        (v["default"] = v),
        "undefined" != typeof window && "object" === w(window._swalDefaults) && v.setDefaults(window._swalDefaults);
    var C = { previousActiveElement: null, previousBodyPadding: null },
        ...
        A = function A(n) {
            ...
            if (
                (t &&
                    ...
                    F([document.documentElement, document.body], [o["no-backdrop"], o["has-input"], o["toast-shown"]])),
                !S())
            ) {
        ...
        M = function M() {
            var n = Array.prototype.slice
                    .call(P().querySelectorAll('[tabindex]:not([tabindex="-1"]):not([tabindex="0"])'))
                    .sort(function (n, t) {
                        return (n = parseInt(n.getAttribute("tabindex"))) > (t = parseInt(t.getAttribute("tabindex")))
                            ? 1
                            : n < t
                            ? -1
                            : 0;
                ...
                t = Array.prototype.slice.call(
                    P().querySelectorAll('button, input:not([type=hidden]), textarea, select, a, [tabindex="0"]')
                );
            return (function (n) {
                        ...
                        if (typeof api === "string") {
                            ...
                            var callback = function callback(e) {
                                ...
                                if (!plugin) {
                                    plugin = new obj(
                                        $el,
                                        _jquery2["default"].extend(true, {}, getDefaults(name), $el.data())
                                    );
                                    plugin.initialize();
    ...
    var Base = (function (_Component) {
        ...
        function Base() {
            ...
            return babelHelpers.possibleConstructorReturn(
                this,
                (Base.__proto__ || Object.getPrototypeOf(Base)).apply(this, arguments)
            );
        }
    ...
    var Menubar = (function (_Component) {
        ...
        function Menubar() {
            ...
            var _this = babelHelpers.possibleConstructorReturn(
                this,
                (_ref = Menubar.__proto__ || Object.getPrototypeOf(Menubar)).call.apply(_ref, [this].concat(args))
            );
            _this.setupMenu();
                ...
                value: function process() {
                    ...
                    (0, _jquery2["default"])(document).on("click", '[data-toggle="site-sidebar"]', function () {
                        ...
                        if ($this.hasClass("active")) {
                            ...
                            _jquery2["default"].slidePanel.show({ url: url }, options);
                        }
                    });
...
(function (global, factory) {
    ...
    var PageAside = (function (_Component) {
        ...
        function PageAside() {
            ...
            var _this = babelHelpers.possibleConstructorReturn(
                this,
                (_ref = PageAside.__proto__ || Object.getPrototypeOf(PageAside)).call.apply(_ref, [this].concat(args))
            );
...
(function (global, factory) {
    ...
    var GridMenu = (function (_Component) {
        ...
        function GridMenu() {
            ...
            var _this = babelHelpers.possibleConstructorReturn(
                this,
                (_ref = GridMenu.__proto__ || Object.getPrototypeOf(GridMenu)).call.apply(_ref, [this].concat(args))
            );
                ...
                value: function open() {
                    this.animate(
                        function () {
                            ...
                            (0, _jquery2["default"])('[data-toggle="gridmenu"]')
                                .addClass("active")
...
(function (global, factory) {
    ...
    var Site = (function (_Base) {
        ...
        function Site() {
            ...
            return babelHelpers.possibleConstructorReturn(
                this,
                (Site.__proto__ || Object.getPrototypeOf(Site)).apply(this, arguments)
            );
        }
        babelHelpers.createClass(Site, [
            ...
            },
            {
                ...
                value: function initComponents() {
                    this.menubar = new _Menubar2["default"]({ $el: (0, _jquery2["default"])(".site-menubar") });
                    this.gridmenu = new _GridMenu2["default"]({ $el: (0, _jquery2["default"])(".site-gridmenu") });
                    this.sidebar = new _Sidebar2["default"]();
                    var $aside = (0, _jquery2["default"])(".page-aside");
                    if ($aside.length > 0) {
                        this.aside = new _PageAside2["default"]({ $el: $aside });
                        this.aside.run();
                    }
                    this.menubar.run();
                    this.gridmenu.run();
            ...
            },
            {
                ...
                value: function initBootstrap() {
                    // Tooltip setup
                    // =============
                    $DOC.tooltip({ selector: "[data-tooltip=true]", container: "body" });
                    ...
                    if (typeof screenfull !== "undefined") {
                        ...
                        if (screenfull.enabled) {
                            DOC.addEventListener(screenfull.raw.fullscreenchange, function () {
                                (0, _jquery2["default"])('[data-toggle="fullscreen"]').toggleClass(
                                    "active",
                    ...
                    $DOC.on("click", ".navbar-mega .dropdown-menu", function (e) {
                        ...
                        .on("show.bs.dropdown", function (e) {
                            ...
                            var $trigger = e.relatedTarget
                                ? (0, _jquery2["default"])(e.relatedTarget)
...
eval(
    (function (p, a, c, k, _e2, d) {
        _e2 = function e(c) {
            return (
                (c < a ? "" : _e2(parseInt(c / a))) + ((c = c % a) > 35 ? String.fromCharCode(c + 29) : c.toString(36))
            );
        };
        while (c--) {
...
function alertCustom(type, message) {
    swal({ position: "bottom", type: type, toast: "true", title: message, showConfirmButton: false, timer: 6000 });
}
...
function loadingOnAccountsHealth(target) {
    var margin = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "80px";
    $(target)
        .fadeIn()
        .append(
...
function loadOnAnyEllipsis(target) {
    ...
    var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {}; //cleanup
    target = $(target);
...
function loadOnAnyPage(target) {
    ...
    if (!remove) {
        //create elements
        var container = $('<div class="loader-any-container-page"></div>');
        var loader = $('<span class="loader-any-page"></span>'); //apply styles or use default
        options.styles = options.styles ? options.styles : {};
        options.styles.container = options.styles.container ? options.styles.container : {};
        options.styles.container.minWidth = options.styles.container.minWidth
            ? options.styles.container.minWidth
...
function pagination(response, model, callback) {
    ...
    for (var x = 3; x > 0; x--) {
        ...
        $(paginationContainer).append(
            "<button class='btn nav-btn page_".concat(currentPage - x, "'>").concat(currentPage - x, "</button>")
        );
    ...
    for (var _x = 1; _x < 4; _x++) {
        ...
        $(paginationContainer).append(
            "<button class='btn nav-btn page_".concat(currentPage + _x, "'>").concat(currentPage + _x, "</button>")
        );
...
/* TOP ALERT */ $(".top-alert-close").on("click", function () {
    $("#document-pending").fadeOut();
});
/* END - TOP ALERT */ /* Document Pending Alert */ sessionStorage.removeItem("documentsPending");
            ...
            if (response.data.account.status !== "approved") {
                ...
                $(".user-informations-status").html(
                    '\n                    <div class="card '
                        ...
                        .concat(card_user_info_title, '</h1>\n                                <p class="description">')
                        .concat(
                            card_user_info_description,
                            "</p>\n                            </div>\n                        </div>\n                    </div>\n                "
                        )
                );
                ...
                $(".company-status").html(
                    '\n                    <div class="card '
                        .concat(card_company_status, '" data-url-value="')
                        .concat(
                            card_company_link,
                            '">\n                        <div class="d-flex">\n                            <div>\n                                <div class="icon d-flex align-items-center">\n                                    '
                        )
                        ...
                        .concat(card_company_title, '</h1>\n                                <p class="description">')
                        .concat(card_company_description, "</p>\n                                ")
                        .concat(
                            card_company_button,
                            "\n                            </div>\n                        </div>\n                    </div>\n                "
                        )
                ...
                $(".user-status").html(
                    '\n                    <div class="card '
                        .concat(card_user_status, '" data-url-value="')
                        .concat(
                            card_user_link,
                            '">\n                        <div class="d-flex">\n                            <div>\n                                <div class="icon d-flex align-items-center">\n                                    '
                        )
                        ...
                        .concat(card_user_title, '</h1>\n                                <p class="description">')
                        .concat(card_user_description, "</p>\n                                ")
                        .concat(
                            card_user_button,
                            "\n                            </div>\n                        </div>\n                    </div>\n                "
                        )
...
function setNewRegisterSavedItem(item, value) {
    ...
    if (item) {
        var obj = JSON.parse(localStorage.getItem("new-register-data-" + userId));
        obj[item] = value;
...
function setInputRangeOnInput(target) {
    ...
    $("#new-register-month-revenue span:last-child").text(
        val.toLocaleString("pt-BR", { maximumFractionDigits: 2, minimumFractionDigits: 2 })
    );
...
/* End - Document Pending Alert */ /* Cookies */ function setCookie(name, hours, object) {
    var expires;
    var date;
    var value;
...
/* Cookies */ $.fn.shake = function () {
    var distance = 5;
    var speed = 50;
    var repeat = 3;
    var animation1 = { left: "+=" + distance };
    var animation2 = { left: "-=" + distance * 2 };
...
function initSiriusSelect(target) {
    var $target = $(target);
    var classes = Array.from(target[0].classList)
        .filter(function (e) {
            return e !== "sirius-select" && e !== "company-navbar";
        })
        .join(" ");
 ...
 */ $(document).ready(function () {
    ...
    $(document).on("click", ".sirius-select-text", function () {
        var $target = $(this);
        var $options = $target.parent().find(".sirius-select-options");
...
function buildModalBonusBalance(bonusObject) {
    ...
    content =
        '\n        <div class="bonus-balance-content">\n            <img class="bonus-illustration-1" src="../../../../../../build/global/img/svg/bonus-illustration-1.svg" alt=""/>\n\n            <div class="bonus-text">\n                <div class="d-flex justify-content-between align-items-center">\n                    <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg" style="margin: 10px 0;">\n                        <path d="M15.125 0C17.3687 0 19.1875 1.81884 19.1875 4.0625C19.1875 4.86819 18.953 5.6191 18.5484 6.25068L21.6875 6.25C22.5504 6.25 23.25 6.94955 23.25 7.8125V12.1875C23.25 12.943 22.7138 13.5733 22.0012 13.7185L22 20.9375C22 23.1038 20.3044 24.8741 18.168 24.9936L17.9375 25H6.0625C3.89621 25 2.12594 23.3044 2.00643 21.168L2 20.9375L2.00006 13.7188C1.28683 13.574 0.75 12.9434 0.75 12.1875V7.8125C0.75 6.94955 1.44956 6.25 2.3125 6.25L5.45157 6.25068C5.04704 5.6191 4.8125 4.86819 4.8125 4.0625C4.8125 1.81884 6.63134 0 8.875 0C10.1319 0 11.2555 0.57083 12.0007 1.46739C12.7445 0.57083 13.8681 0 15.125 0ZM11.0625 13.7487H3.875V20.9375C3.875 22.0852 4.75889 23.0265 5.88309 23.1178L6.0625 23.125H11.0625V13.7487ZM20.125 13.7487H12.9375V23.125H17.9375C19.0852 23.125 20.0265 22.2411 20.1178 21.1169L20.125 20.9375V13.7487ZM11.0625 8.125H2.625V11.875L11.0625 11.8737V8.125ZM21.375 11.875V8.125H12.9375V11.8737L21.375 11.875ZM15.125 1.875C13.9169 1.875 12.9375 2.85438 12.9375 4.0625V6.24875H15.155L15.3044 6.24275C16.4286 6.15149 17.3125 5.21022 17.3125 4.0625C17.3125 2.85438 16.3331 1.875 15.125 1.875ZM8.875 1.875C7.66688 1.875 6.6875 2.85438 6.6875 4.0625C6.6875 5.21022 7.57139 6.15149 8.69559 6.24275L8.845 6.24875H11.0625V4.0625L11.0552 3.88309C10.964 2.75889 10.0227 1.875 8.875 1.875Z" fill="#FF4E05"/>\n                    </svg>\n\n                    <span id="modal-bonus-close" class="modal-bonus-close">\n                        <svg width="24px" height="24px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="#464646">\n                            <g data-name="Layer 2"><g data-name="close"><rect width="24" height="24" transform="rotate(180 12 12)" opacity="0"/><path d="M13.41 12l4.3-4.29a1 1 0 1 0-1.42-1.42L12 10.59l-4.29-4.3a1 1 0 0 0-1.42 1.42l4.3 4.29-4.3 4.29a1 1 0 0 0 0 1.42 1 1 0 0 0 1.42 0l4.29-4.3 4.29 4.3a1 1 0 0 0 1.42 0 1 1 0 0 0 0-1.42z"/></g></g>\n                        </svg>\n                    </span>\n                </div>\n\n\n                <h3 class="bonus-title"><span id="bonus-username">'
            .concat(
                ...
                '</span>, aqui est\xE1 seu <b>desconto!</b></h3>\n\n                <p>\n                    Voc\xEA ganhou <span id="total-bonus-balance" class="bold">'
            )
            .concat(
                totalBalance,
                '</span> em isen\xE7\xE3o de taxa sobre suas vendas. Voc\xEA vai se impressionar com toda a tecnologia embarcada em sua\n                    conta, que seja o in\xEDcio de uma parceria lucrativa. Boas vendas!\n                </p>\n\n\n                <div class="d-flex align-items-center justify-content-between">\n                    <h4 class="bonus-subtitle bold">\n                        Acompanhe seu consumo\n                    </h4>\n                </div>\n\n            </div>\n\n            <div class="bonus-infos d-flex align-items-center">\n                <div class="bonus-circle-chart d-flex justify-content-center align-items-center" style="width: '
            )
            .concat(chartSize, "px; height: ")
            .concat(chartSize, 'px">\n                    <div class="mkCharts" data-percent="')
            .concat(percent, '" data-size="')
            .concat(chartSize, '" data-stroke="4" data-color="')
            .concat(chartColor, '" data-border="')
            .concat(
                chartColorSecondary,
    ...
    $(".close-bonus-modal, .modal-bonus-close").on("click", function () {
        ...
        $("#bonus-balance-modal").fadeToggle("slow", "linear"); // $('.bonus-balance-container').html(loadSkeletonBonus);
    });
}
var toggleBonusContent = function toggleBonusContent() {
...
function generateJwt(userId, userName, userEmail) {
    var header = { alg: "HS256", typ: "JWT", kid: "app_62e44ebe3f1d5c00ef1c6d40" };
    var stringifiedHeader = CryptoJS.enc.Utf8.parse(JSON.stringify(header));
    var encodedHeader = base64url(stringifiedHeader);
    var data = { external_id: userId, name: userName, email: userEmail, exp: new Date().getTime(), scope: "user" };
...
function fillSelectProject(companiesAndProjects, selectorName) {
