...
$(function () {
  ...
  function renderSale(sale) {
    ...
    $("#tax-percentage").html("Taxa (".concat(sale.percentage_rate, "%)"));
    $("#tax-percentage-value").html("".concat(sale.taxaDiscount));
    $("#tax-fixed").html("Taxa fixa: ");
    $("#tax-fixed-value").html("".concat(sale.transaction_rate));
    ...
    if ((sale.payment_method == 1 || sale.payment_method == 3 || sale.payment_method == 4 && !sale.has_withdrawal) && (sale.status == 1 || sale.status == 8 || sale.status == 24) && sale.userPermissionRefunded) {
    ...
    if (sale.payment_method == 2 && sale.status == 1 && sale.userPermissionRefunded && (sale.gateway_id == 'BeYEwR3AdgdKykA' || sale.gateway_id == 'ODzj6aGnOgwlK9J') //vega
    ) {
      $("#div_refund_billet").html('<button class="btn btn-danger btn-sm btn_refund_billet" sale=' + sale.id + ">Estornar boleto</button>");
    } else {
      $("#div_refund_billet").html("");
    }
