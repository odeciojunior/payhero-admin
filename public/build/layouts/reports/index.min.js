    ...
    return $.ajax({
      ...
      success: function success(response) {
        var _response$data4 = response.data,
            chart = _response$data4.chart,
            total = _response$data4.total,
            variation = _response$data4.variation;
    ...
    return $.ajax({
      ...
      success: function success(response) {
        var _response$data5 = response.data,
            total = _response$data5.total,
            products = _response$data5.products;
