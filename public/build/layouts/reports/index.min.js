    ...
    return $.ajax({
      ...
      success: function success(response) {
        var _response$data = response.data,
            chart = _response$data.chart,
            count = _response$data.count,
            total = _response$data.total,
            variation = _response$data.variation;
        ...
        if (count > 0) {
          ...
          var labels = _toConsumableArray(chart.labels);

          var series = _toConsumableArray(chart.values);
    ...
    return $.ajax({
      ...
      success: function success(response) {
        var _response$data2 = response.data,
            chart = _response$data2.chart,
            total = _response$data2.total,
            variation = _response$data2.variation;
    ...
    return $.ajax({
      ...
      success: function success(response) {
        var _response$data3 = response.data,
            chart = _response$data3.chart,
            total = _response$data3.total,
            variation = _response$data3.variation;
      ...
      success: function success(response) {
        ...
        if (total) {
          $.each(response.data.products, function (i, product) {
            ...
            if (amount) {
              lista = "\n                                <li class=\"".concat(i > 3 && i < 8 ? 'line' : '', "\">\n                                    <div class=\"box-list-products\">\n                                        <figure \n                                            data-container=\"body\" \n                                            data-viewport=\".container\" \n                                            data-placement=\"top\" \n                                            data-toggle=\"tooltip\" \n                                            title=\"").concat(name, "\">\n                                                <img class=\"photo\" src=\"").concat(image, "\" width=\"24px\" height=\"24px\" />\n                                        </figure>\n                                        <span style=\"color: #636363; padding-left: 0;\">").concat(100 * amount / total > 19 ? '' : amount, "</span>\n                                        <div class=\"bars ").concat(color, "\" style=\"width:").concat((100 * amount / total).toFixed(2), "%\">\n                                            <span>").concat(100 * amount / total > 19 ? amount : '', "</span>\n                                        </div>\n                                    </div>\n                                </li>");
