 ...
 */
!function (t, e) {
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof2(exports)) && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : (t = "undefined" != typeof globalThis ? globalThis : t || self).Chart = e();
}(this, function () {
  "use strict";
  ...
  function Zt(t, e, i, s) {
    ...
    var h = e.pointStyle,
        ...
        d = e.radius;
    var u = (c || 0) * Mt;
    if (h && "object" == _typeof2(h) && (n = h.toString(), "[object HTMLImageElement]" === n || "[object HTMLCanvasElement]" === n)) return t.save(), t.translate(i, s), t.rotate(u), t.drawImage(h, -h.width / 2, -h.height / 2, h.width, h.height), void t.restore();
  ...
  function ne(t, e, i, s, n) {
    if (n.strikethrough || n.underline) {
      var _o3 = t.measureText(s),
          ...
          _c2 = n.strikethrough ? (_l2 + _h2) / 2 : _h2;

      t.strokeStyle = t.fillStyle, t.beginPath(), t.lineWidth = n.decorationWidth || 2, t.moveTo(_a5, _c2), t.lineTo(_r2, _c2), t.stroke();
    }
  }
  ...
  function ei(t, e, i, s) {
    ...
    for (o = 0, a = t.length, h = 0; o < a; ++o) {
      ...
      h |= _a10 && n.length, c = c || _d2, l.fullSize || n.push(r);
    }
  ...
  function wi(t) {
    ...
    !function (t, e, i) {
      ...
      for (var _c3 = 0; _c3 < s - 1; ++_c3) {
        l = h, h = _i(t, _c3 + 1), l && h && (Lt(e[_c3], 0, bi) ? i[_c3] = i[_c3 + 1] = 0 : (n = i[_c3] / e[_c3], o = i[_c3 + 1] / e[_c3], r = Math.pow(n, 2) + Math.pow(o, 2), r <= 9 || (a = 3 / Math.sqrt(r), i[_c3] = n * a * e[_c3], i[_c3 + 1] = o * a * e[_c3])));
      }
    }(t, n, o), function (t, e) {
      ...
      for (var _h6 = 0; _h6 < n; ++_h6) {
        ...
        var _n9 = r[i],
            _c4 = r[s];
        a && (o = (_n9 - a[i]) / 3, r["cp1".concat(i)] = _n9 - o, r["cp1".concat(s)] = _c4 - o * e[_h6]), l && (o = (l[i] - _n9) / 3, r["cp2".concat(i)] = _n9 + o, r["cp2".concat(s)] = _c4 + o * e[_h6]);
      }
    }(t, o, e);
  }
  ...
  var us = /*#__PURE__*/function () {
    function us(t, e, i, s) {
      ...
      var o = je([t.from, n, s]);
      this._active = !0, this._fn = t.fn || ds[t.type || _typeof2(o)], this._easing = Ci[t.easing] || Ci.linear, this._start = Math.floor(Date.now() + (t.delay || 0)), this._duration = this._total = Math.floor(t.duration), this._loop = !!t.loop, this._target = e, this._prop = i, this._from = o, this._to = s, this._promises = void 0;
    }
    ...
    _createClass(gs, [{
      ...
      value: function configure(t) {
        ...
        Object.getOwnPropertyNames(t).forEach(function (i) {
          ...
          var _iterator15 = _createForOfIteratorHelper(fs),
              _step15;
      ...
      value: function _createAnimations(t, e) {
        ...
        for (r = o.length - 1; r >= 0; --r) {
          ...
          _d3 && _d3.duration ? (n[_l8] = _c5 = new us(_d3, t, _l8, _h7), s.push(_c5)) : t[_l8] = _h7;
        }
  ...
  function vs(t, e) {
    ...
    for (var _t21 = 0; _t21 < d; ++_t21) {
      var _i19 = e[_t21],
          _o15 = _i19[l],
          _d4 = _i19[h];
      u = (_i19._stacks || (_i19._stacks = {}))[h] = _s(n, c, _o15), u[r] = _d4, u._top = ys(u, a, !0, s.type), u._bottom = ys(u, a, !1, s.type);
    }
  }
    ...
    _createClass(Bs, [{
      ...
      value: function fit() {
        ...
        if (o) {
          ...
          if (a ? (t.width = this.maxWidth, t.height = Is(n) + _o17) : (t.height = this.maxHeight, t.width = Is(n) + _o17), i.display && this.ticks.length) {
            ...
            if (a) {
              var _e25 = i.mirror ? 0 : _c6 * _n16.width + _h8 * _o18.height;

              t.height = Math.min(this.maxHeight, t.height + _e25 + _r8);
            } else {
              var _e26 = i.mirror ? 0 : _h8 * _n16.width + _c6 * _o18.height;

              t.width = Math.min(this.maxWidth, t.width + _e26 + _r8);
            }

            this._calculatePadding(_e24, _s22, _c6, _h8);
          }
        }
      ...
      value: function _calculatePadding(t, e, i, s) {
        ...
        if (this.isHorizontal()) {
          ...
          var _c7 = 0,
              _d5 = 0;
          r ? l ? (_c7 = s * t.width, _d5 = i * e.height) : (_c7 = i * t.height, _d5 = s * e.width) : "start" === n ? _d5 = e.width : "end" === n ? _c7 = t.width : (_c7 = t.width / 2, _d5 = e.width / 2), this.paddingLeft = Math.max((_c7 - _a12 + o) * this.width / (this.width - _a12), 0), this.paddingRight = Math.max((_d5 - _h9 + o) * this.width / (this.width - _h9), 0);
        } else {
          var _i23 = e.height / 2,
              _s23 = t.height / 2;
  ...
  var Sn = /*#__PURE__*/function (_Ps) {
    ...
    _createClass(Sn, [{
      ...
      value: function updateElements(t, e, i, s) {
        ...
        for (var _c8 = e; _c8 < e + i; _c8++) {
          var _e46 = this.getParsed(_c8),
              _i38 = n || $(_e46[a.axis]) ? {
            base: r,
            head: r
          } : this._calculateBarValuePixels(_c8),
              _f2 = this._calculateBarIndexPixels(_c8, h),
          ...
          u && (_p.options = d || this.resolveDataElementOptions(_c8, t[_c8].active ? "active" : s));

          var _m = _p.options || t[_c8].options;

          vn(_p, _m, _g, o), kn(_p, _m, h.ratio), this.updateElement(t[_c8], _c8, _p, s);
        }
      }
    }, {
      key: "_getStacks",
          ...
          if (e < yt) {
            var _r12 = t,
              ...
              return Ht(t, _r12, _l15, !0) ? -1 : Math.min(e, e * i, s, s * i);
                ...
                _m2 = _f4(kt, _c9, _u3),
                _x = _g2(_t, _h13, _d8),
                _b2 = _g2(_t + kt, _c9, _u3);

            s = (_p2 - _x) / 2, n = (_m2 - _b2) / 2, o = -(_p2 + _x) / 2, a = -(_m2 + _b2) / 2;
          }
        ...
        var _ref11 = function (t, e, i) {
          ...
          if (t._sorted) {
            var _a17 = t.iScale,
                ...
                _c10 = _a17$getUserBounds.max,
                _d9 = _a17$getUserBounds.minDefined,
                _u4 = _a17$getUserBounds.maxDefined;

            _d9 && (n = jt(Math.min(re(_r13, _a17.axis, _h14).lo, i ? s : re(e, _l16, _a17.getPixelForValue(_h14)).lo), 0, s - 1)), o = _u4 ? jt(Math.max(re(_r13, _a17.axis, _c10).hi + 1, i ? 0 : re(e, _l16, _a17.getPixelForValue(_c10)).hi + 1), n, s) - n : s - n;
          }
      ...
      value: function updateElements(t, e, i, s) {
        ...
        for (var _r14 = e; _r14 < e + i; _r14++) {
          var _e52 = t[_r14],
              ...
              _c11 = a ? o.yCenter : _l17.y,
              _d10 = {
            x: _h16,
            y: _c11,
            angle: _l17.angle,
            skip: isNaN(_h16) || isNaN(_c11),
            options: _i50
          };

          this.updateElement(_e52, _r14, _d10, s);
        }
      }
    }]);
  ...
  var Vn = /*#__PURE__*/function (_Ds2) {
    ...
    function Vn(t) {
      ...
      _this22 = _super12.call(this), _this22.options = void 0, _this22.circumference = void 0, _this22.startAngle = void 0, _this22.endAngle = void 0, _this22.innerRadius = void 0, _this22.outerRadius = void 0, _this22.pixelMargin = 0, _this22.fullCircles = 0, t && Object.assign(_assertThisInitialized(_this22), t);
      return _this22;
    }
  ...
  var qn = /*#__PURE__*/function (_Ds3) {
    ...
    function qn(t) {
      ...
      _this23 = _super13.call(this), _this23.animated = !0, _this23.options = void 0, _this23._chart = void 0, _this23._loop = void 0, _this23._fullLoop = void 0, _this23._path = void 0, _this23._points = void 0, _this23._segments = void 0, _this23._decimated = !1, _this23._pointsUpdated = !1, _this23._datasetIndex = void 0, t && Object.assign(_assertThisInitialized(_this23), t);
      return _this23;
    }
    ...
    _createClass(qn, [{
      ...
      value: function interpolate(t, e) {
        ...
        for (l = 0, h = o.length; l < h; ++l) {
          ...
          var _f5 = r(_d11, _u5, Math.abs((s - _d11[e]) / (_u5[e] - _d11[e])), i.stepped);
  ...
  var Gn = /*#__PURE__*/function (_Ds4) {
    ...
    function Gn(t) {
      ...
      _this24 = _super14.call(this), _this24.options = void 0, _this24.parsed = void 0, _this24.skip = void 0, _this24.stop = void 0, t && Object.assign(_assertThisInitialized(_this24), t);
      return _this24;
    }
  ...
  var so = /*#__PURE__*/function (_Ds5) {
    ...
    function so(t) {
      ...
      _this25 = _super15.call(this), _this25.options = void 0, _this25.horizontal = void 0, _this25.base = void 0, _this25.width = void 0, _this25.height = void 0, _this25.inflateAmount = void 0, t && Object.assign(_assertThisInitialized(_this25), t);
      return _this25;
    }
          ...
          case "lttb":
            u = function (t, e, i, s, n) {
              ...
              for (a[l++] = t[p], c = 0; c < o - 2; c++) {
                ...
                var _b3 = Math.floor(c * r) + 1 + e,
                    _3 = Math.min(Math.floor((c + 1) * r) + 1, i) + e,
                    _t$p = t[p],
                    _y2 = _t$p.x,
                    _v2 = _t$p.y;

                for (u = f = -1, _s41 = _b3; _s41 < _3; _s41++) {
              ...
              for (n = e; n < e + i; ++n) {
                ...
                if (_e61 === l) r < u ? (u = r, h = n) : r > f && (f = r, c = n), g = (p * g + o.x) / ++p;else {
                  ...
                  if (!$(h) && !$(c)) {
                    ...
                    _e62 !== d && _e62 !== _i52 && m.push(_objectSpread(_objectSpread({}, t[_e62]), {}, {
                      x: g
                    })), _s42 !== d && _s42 !== _i52 && m.push(_objectSpread(_objectSpread({}, t[_s42]), {}, {
                      x: g
                    }));
                  }
    ...
    var i = e.line,
      ...
      try {
        for (_iterator25.s(); !(_step25 = _iterator25.n()).done;) {
          ...
          var _l19 = _o(i, n[_s44], n[_r17], _t62.loop);
          ...
          try {
            for (_iterator26.s(); !(_step26 = _iterator26.n()).done;) {
              ...
              var _s45 = _o(i, o[_e65.start], o[_e65.end], _e65.loop),
                  _r18 = Vi(_t62, n, _s45);

              var _iterator27 = _createForOfIteratorHelper(_r18),
                  _step27;
              ...
              try {
                for (_iterator27.s(); !(_step27 = _iterator27.n()).done;) {
                  ...
                  a.push({
                    source: _t63,
                    target: _e65,
                    start: _defineProperty({}, i, yo(_l19, _s45, "start", Math.max)),
                    end: _defineProperty({}, i, yo(_l19, _s45, "end", Math.min))
                  });
                }
              } catch (err) {
                _iterator27.e(err);
    ...
    try {
      for (_iterator28.s(); !(_step28 = _iterator28.n()).done;) {
        ...
        var _e66$style$background = _e66$style.backgroundColor,
            _r19 = _e66$style$background === void 0 ? o : _e66$style$background,
            _d12 = !0 !== s;

        t.save(), t.fillStyle = _r19, vo(t, a, _d12 && _o(n, _h21, _c13)), t.beginPath();
        ...
        if (_d12) {
          ...
          var _e67 = !!s.pathSegment(t, _l20, {
            move: _u6,
            reverse: !0
          });

          _f6 = _u6 && _e67, _f6 || wo(t, s, _h21, n);
        }
  ...
  var Do = /*#__PURE__*/function (_Ds6) {
    ...
    _createClass(Do, [{
      ...
      value: function adjustHitBoxes() {
        ...
        if (this.isHorizontal()) {
          var _o32 = 0,
              _r20 = n(i, this.left + s, this.right - this.lineWidths[_o32]);
          ...
          try {
            for (_iterator29.s(); !(_step29 = _iterator29.n()).done;) {
              var _l21 = _step29.value;
              _o32 !== _l21.row && (_o32 = _l21.row, _r20 = n(i, this.left + s, this.right - this.lineWidths[_o32])), _l21.top += this.top + t + s, _l21.left = a.leftForLtr(a.x(_r20), _l21.width), _r20 += _l21.width + s;
            }
          } catch (err) {
            _iterator29.e(err);
          } finally {
          ...
          var _o33 = 0,
              _r21 = n(i, this.top + t + s, this.bottom - this.columnSizes[_o33].height);
          ...
          try {
            for (_iterator30.s(); !(_step30 = _iterator30.n()).done;) {
              ...
              _l22.col !== _o33 && (_o33 = _l22.col, _r21 = n(i, this.top + t + s, this.bottom - this.columnSizes[_o33].height)), _l22.top = _r21, _l22.left += this.left + s, _l22.left = a.leftForLtr(a.x(_l22.left), _l22.width), _r21 += _l22.height + s;
            }
          } catch (err) {
            _iterator30.e(err);
          } finally {
          ...
          !function (t, e, i) {
            ...
            if (s.fillStyle = K(i.fillStyle, l), s.lineCap = K(i.lineCap, "butt"), s.lineDashOffset = K(i.lineDashOffset, 0), s.lineJoin = K(i.lineJoin, "miter"), s.lineWidth = n, s.strokeStyle = K(i.strokeStyle, l), s.setLineDash(K(i.lineDash, [])), r.usePointStyle) {
              ...
              var _o35 = e + Math.max((f - x) / 2, 0),
                  ...
                  _r22 = We(i.borderRadius);

              s.beginPath(), Object.values(_r22).some(function (t) {
                return 0 !== t;
              }) ? oe(s, {
                x: _a21,
                y: _o35,
  ...
  var Oo = /*#__PURE__*/function (_Ds7) {
    ...
    function Oo(t) {
      ...
      _this29 = _super17.call(this), _this29.chart = t.chart, _this29.options = t.options, _this29.ctx = t.ctx, _this29._padding = void 0, _this29.top = void 0, _this29.bottom = void 0, _this29.left = void 0, _this29.right = void 0, _this29.width = void 0, _this29.height = void 0, _this29.position = void 0, _this29.weight = void 0, _this29.fullSize = void 0;
      return _this29;
    }
  ...
  var Ro = {
    ...
    nearest: function nearest(t, e) {
      ...
      for (i = 0, s = t.length; i < s; ++i) {
        var _s46 = t[i].element;

        if (_s46 && _s46.hasValue()) {
          var _t66 = Vt(e, _s46.getCenterPoint());

          _t66 < r && (r = _t66, n = _s46);
        }
      }
  ...
  var $o = /*#__PURE__*/function (_Ds8) {
    ...
    function $o(t) {
      ...
      _this30 = _super18.call(this), _this30.opacity = 0, _this30._active = [], _this30._eventPosition = void 0, _this30._size = void 0, _this30._cachedAnimations = void 0, _this30._tooltipItems = [], _this30.$animations = void 0, _this30.$context = void 0, _this30.chart = t.chart || t._chart, _this30._chart = _this30.chart, _this30.options = t.options, _this30.dataPoints = void 0, _this30.title = void 0, _this30.beforeBody = void 0, _this30.body = void 0, _this30.afterBody = void 0, _this30.footer = void 0, _this30.xAlign = void 0, _this30.yAlign = void 0, _this30.x = void 0, _this30.y = void 0, _this30.height = void 0, _this30.width = void 0, _this30.caretX = void 0, _this30.caretY = void 0, _this30.labelColors = void 0, _this30.labelPointStyles = void 0, _this30.labelTextColors = void 0;
      return _this30;
    }
    ...
    _createClass($o, [{
      ...
      value: function update(t, e) {
        ...
        if (s.length) {
          ...
          var _e71 = this._size = Fo(this, i),
              ...
              _r23 = Vo(this.chart, i, _a23),
              _l23 = Wo(i, _a23, _r23, this.chart);

          this.xAlign = _r23.xAlign, this.yAlign = _r23.yAlign, n = {
            opacity: 1,
            x: _l23.x,
            y: _l23.y,
            width: _e71.width,
      ...
      value: function drawTitle(t, e, i) {
        ...
        if (n) {
          var _l24 = Ei(i.rtl, this.x, this.width);

          for (t.x = No(this, i.titleAlign, i), e.textAlign = _l24.textAlign(i.titleAlign), e.textBaseline = "middle", o = He(i.titleFont), a = i.titleSpacing, e.fillStyle = i.titleColor, e.font = o.string, r = 0; r < n; ++r) {
            e.fillText(s[r], _l24.x(t.x), t.y + o.lineHeight / 2), t.y += o.lineHeight + a, r + 1 === n && (t.y += i.titleMarginBottom - a);
          }
        }
      }
    }, {
      ...
      value: function _drawColorBox(t, e, i, s, n) {
        ...
        if (n.usePointStyle) {
          ...
          t.strokeStyle = n.multiKeyBackground, t.fillStyle = n.multiKeyBackground, Zt(t, _e72, _i56, _h22), t.strokeStyle = o.borderColor, t.fillStyle = o.backgroundColor, Zt(t, _e72, _i56, _h22);
        } else {
      ...
      value: function drawFooter(t, e, i) {
        ...
        if (n) {
          var _r24 = Ei(i.rtl, this.x, this.width);

          for (t.x = No(this, i.footerAlign, i), t.y += i.footerMarginTop, e.textAlign = _r24.textAlign(i.footerAlign), e.textBaseline = "middle", o = He(i.footerFont), e.fillStyle = i.footerColor, e.font = o.string, a = 0; a < n; ++a) {
            e.fillText(s[a], _r24.x(t.x), t.y + o.lineHeight / 2), t.y += o.lineHeight + i.footerSpacing;
          }
        }
      }
    }, {
      ...
      value: function _updateAnimationTarget(t) {
        ...
        if (s || n) {
          ...
          var _o37 = this._size = Fo(this, t),
              ...
              _r25 = Vo(e, t, _a25),
              _l25 = Wo(t, _a25, _r25, e);

          s._to === _l25.x && n._to === _l25.y || (this.xAlign = _r25.xAlign, this.yAlign = _r25.yAlign, this.width = _o37.width, this.height = _o37.height, this.caretX = _i58.x, this.caretY = _i58.y, this._resolveAnimations().update(this, _l25));
        }
      }
    }, {
      key: "draw",
  ...
  var qo = /*#__PURE__*/function (_Bs) {
    ...
    function qo(t) {
      ...
      _this34 = _super19.call(this, t), _this34._startValue = void 0, _this34._valueRange = 0, _this34._addedLabels = [];
      return _this34;
    }
          ...
          try {
            for (_iterator31.s(); !(_step31 = _iterator31.n()).done;) {
              var _step31$value = _step31.value,
                  _i61 = _step31$value.index,
                  _s48 = _step31$value.label;
              _t69[_i61] === _s48 && _t69.splice(_i61, 1);
            }
          } catch (err) {
            _iterator31.e(err);
          } finally {
  ...
  var Go = /*#__PURE__*/function (_Bs2) {
    ...
    function Go(t) {
      ...
      _this35 = _super20.call(this, t), _this35.start = void 0, _this35.end = void 0, _this35._startValue = void 0, _this35._endValue = void 0, _this35._valueRange = 0;
      return _this35;
    }
    ...
    _createClass(Go, [{
      ...
      value: function configure() {
        ...
        if (_get2(_getPrototypeOf(Go.prototype), "configure", this).call(this), this.options.offset && t.length) {
          var _s49 = (i - e) / Math.max(t.length - 1, 1) / 2;
  ...
  var Qo = /*#__PURE__*/function (_Bs3) {
    ...
    function Qo(t) {
      ...
      _this36 = _super22.call(this, t), _this36.start = void 0, _this36.end = void 0, _this36._startValue = void 0, _this36._valueRange = 0;
      return _this36;
    }
  ...
  function ia(t) {
    ...
    for (var _d13 = 0; _d13 < o; _d13++) {
      var _o38 = a.setContext(t.getPointLabelContext(_d13));

      n[_d13] = _o38.padding;

      var _u7 = t.getPointPosition(_d13, t.drawingArea + n[_d13], r),
          _f7 = He(_o38.font),
          _g4 = (l = t.ctx, h = _f7, c = Y(c = t._pointLabels[_d13]) ? c : [c], {
        w: qt(l, h.string, c),
      ...
      var _p4 = Nt(t.getIndexAngle(_d13) + r),
    ...
    t.setCenterPoint(e.l - i.l, i.r - e.r, e.t - i.t, i.b - e.b), t._pointLabelItems = function (t, e, i) {
      ...
      for (var _o39 = 0; _o39 < n; _o39++) {
        var _n31 = t.getPointPosition(_o39, r + a + i[_o39], l),
            _h23 = Math.round(zt(Nt(_n31.angle + kt))),
            _c14 = e[_o39],
            _d14 = aa(_n31.y, _c14.h, _h23),
            _u8 = na(_h23),
  ...
  var la = /*#__PURE__*/function (_Go2) {
    ...
    function la(t) {
      ...
      _this37 = _super23.call(this, t), _this37.xCenter = void 0, _this37.yCenter = void 0, _this37.drawingArea = void 0, _this37._pointLabels = [], _this37._pointLabelItems = [];
      return _this37;
    }
        ...
        if (e.pointLabels.display && function (t, e) {
          ...
          for (var _n32 = e - 1; _n32 >= 0; _n32--) {
            ...
            if (!$(_f9)) {
              ...
              i.fillStyle = _f9, i.fillRect(_h24 - _t72.left, _c15 - _t72.top, _d15 - _h24 + _t72.width, _u9 - _c15 + _t72.height);
            }

            se(i, t._pointLabels[_n32], _a26, _r26 + _o41.lineHeight / 2, _o41, {
              color: _e77.color,
              textAlign: _l26,
              textBaseline: "middle"
            });
          ...
          for (t.save(), o = n - 1; o >= 0; o--) {
            var _s50 = i.setContext(this.getPointLabelContext(o)),
                _n33 = _s50.color,
                _l27 = _s50.lineWidth;

            _l27 && _n33 && (t.lineWidth = _l27, t.strokeStyle = _n33, t.setLineDash(_s50.borderDash), t.lineDashOffset = _s50.borderDashOffset, a = this.getDistanceFromCenterForValue(e.ticks.reverse ? this.min : this.max), r = this.getPointPosition(o, a), t.beginPath(), t.moveTo(this.xCenter, this.yCenter), t.lineTo(r.x, r.y), t.stroke());
          }
  ...
  var ma = /*#__PURE__*/function (_Bs4) {
    ...
    function ma(t) {
      ...
      _this41 = _super24.call(this, t), _this41._cache = {
        data: [],
        labels: [],
        all: []
  ...
  var ba = /*#__PURE__*/function (_ma) {
    ...
    function ba(t) {
      ...
      _this42 = _super25.call(this, t), _this42._table = [], _this42._minPos = void 0, _this42._tableRange = void 0;
      return _this42;
    }
...
!function (t, e) {
  ...
  });else if ("object" == (typeof module === "undefined" ? "undefined" : _typeof2(module)) && module.exports) {
  ...
  var a = function a(_a27, i, s) {
    if (this.parentEl = "body", this.element = e(_a27), this.startDate = t().startOf("day"), this.endDate = t().endOf("day"), this.minDate = !1, this.maxDate = !1, this.maxSpan = !1, this.autoApply = !1, this.singleDatePicker = !1, this.showDropdowns = !1, this.minYear = t().subtract(100, "year").format("YYYY"), this.maxYear = t().add(100, "year").format("YYYY"), this.showWeekNumbers = !1, this.showISOWeekNumbers = !1, this.showCustomRangeLabel = !0, this.timePicker = !1, this.timePicker24Hour = !1, this.timePickerIncrement = 1, this.timePickerSeconds = !1, this.linkedCalendars = !0, this.autoUpdateInput = !0, this.alwaysShowCalendars = !1, this.ranges = {}, this.opens = "right", this.element.hasClass("pull-right") && (this.opens = "left"), this.drops = "down", this.element.hasClass("dropup") && (this.drops = "up"), this.buttonClasses = "btn btn-sm", this.applyButtonClasses = "btn-primary", this.cancelButtonClasses = "btn-default", this.locale = {
      direction: "ltr",
    ...
    }, this.callback = function () {}, this.isShowing = !1, this.leftCalendar = {}, this.rightCalendar = {}, "object" == _typeof2(i) && null !== i || (i = {}), "string" == typeof (i = e.extend(this.element.data(), i)).template || i.template instanceof e || (i.template = '<div class="daterangepicker"><div class="ranges"></div><div class="drp-calendar left"><div class="calendar-table"></div><div class="calendar-time"></div></div><div class="drp-calendar right"><div class="calendar-table"></div><div class="calendar-time"></div></div><div class="drp-buttons"><span class="drp-selected"></span><button class="cancelBtn" type="button"></button><button class="applyBtn" disabled="disabled" type="button"></button> </div></div>'), this.parentEl = i.parentEl && e(i.parentEl).length ? e(i.parentEl) : e(this.parentEl), this.container = e(i.template).appendTo(this.parentEl), "object" == _typeof2(i.locale) && ("string" == typeof i.locale.direction && (this.locale.direction = i.locale.direction), "string" == typeof i.locale.format && (this.locale.format = i.locale.format), "string" == typeof i.locale.separator && (this.locale.separator = i.locale.separator), "object" == _typeof2(i.locale.daysOfWeek) && (this.locale.daysOfWeek = i.locale.daysOfWeek.slice()), "object" == _typeof2(i.locale.monthNames) && (this.locale.monthNames = i.locale.monthNames.slice()), "number" == typeof i.locale.firstDay && (this.locale.firstDay = i.locale.firstDay), "string" == typeof i.locale.applyLabel && (this.locale.applyLabel = i.locale.applyLabel), "string" == typeof i.locale.cancelLabel && (this.locale.cancelLabel = i.locale.cancelLabel), "string" == typeof i.locale.weekLabel && (this.locale.weekLabel = i.locale.weekLabel), "string" == typeof i.locale.customRangeLabel)) {
      (f = document.createElement("textarea")).innerHTML = i.locale.customRangeLabel;
      var n = f.value;
      this.locale.customRangeLabel = n;
    }

    if (this.container.addClass(this.locale.direction), "string" == typeof i.startDate && (this.startDate = t(i.startDate, this.locale.format)), "string" == typeof i.endDate && (this.endDate = t(i.endDate, this.locale.format)), "string" == typeof i.minDate && (this.minDate = t(i.minDate, this.locale.format)), "string" == typeof i.maxDate && (this.maxDate = t(i.maxDate, this.locale.format)), "object" == _typeof2(i.startDate) && (this.startDate = t(i.startDate)), "object" == _typeof2(i.endDate) && (this.endDate = t(i.endDate)), "object" == _typeof2(i.minDate) && (this.minDate = t(i.minDate)), "object" == _typeof2(i.maxDate) && (this.maxDate = t(i.maxDate)), this.minDate && this.startDate.isBefore(this.minDate) && (this.startDate = this.minDate.clone()), this.maxDate && this.endDate.isAfter(this.maxDate) && (this.endDate = this.maxDate.clone()), "string" == typeof i.applyButtonClasses && (this.applyButtonClasses = i.applyButtonClasses), "string" == typeof i.applyClass && (this.applyButtonClasses = i.applyClass), "string" == typeof i.cancelButtonClasses && (this.cancelButtonClasses = i.cancelButtonClasses), "string" == typeof i.cancelClass && (this.cancelButtonClasses = i.cancelClass), "object" == _typeof2(i.maxSpan) && (this.maxSpan = i.maxSpan), "object" == _typeof2(i.dateLimit) && (this.maxSpan = i.dateLimit), "string" == typeof i.opens && (this.opens = i.opens), "string" == typeof i.drops && (this.drops = i.drops), "boolean" == typeof i.showWeekNumbers && (this.showWeekNumbers = i.showWeekNumbers), "boolean" == typeof i.showISOWeekNumbers && (this.showISOWeekNumbers = i.showISOWeekNumbers), "string" == typeof i.buttonClasses && (this.buttonClasses = i.buttonClasses), "object" == _typeof2(i.buttonClasses) && (this.buttonClasses = i.buttonClasses.join(" ")), "boolean" == typeof i.showDropdowns && (this.showDropdowns = i.showDropdowns), "number" == typeof i.minYear && (this.minYear = i.minYear), "number" == typeof i.maxYear && (this.maxYear = i.maxYear), "boolean" == typeof i.showCustomRangeLabel && (this.showCustomRangeLabel = i.showCustomRangeLabel), "boolean" == typeof i.singleDatePicker && (this.singleDatePicker = i.singleDatePicker, this.singleDatePicker && (this.endDate = this.startDate.clone())), "boolean" == typeof i.timePicker && (this.timePicker = i.timePicker), "boolean" == typeof i.timePickerSeconds && (this.timePickerSeconds = i.timePickerSeconds), "number" == typeof i.timePickerIncrement && (this.timePickerIncrement = i.timePickerIncrement), "boolean" == typeof i.timePicker24Hour && (this.timePicker24Hour = i.timePicker24Hour), "boolean" == typeof i.autoApply && (this.autoApply = i.autoApply), "boolean" == typeof i.autoUpdateInput && (this.autoUpdateInput = i.autoUpdateInput), "boolean" == typeof i.linkedCalendars && (this.linkedCalendars = i.linkedCalendars), "function" == typeof i.isInvalidDate && (this.isInvalidDate = i.isInvalidDate), "function" == typeof i.isCustomDate && (this.isCustomDate = i.isCustomDate), "boolean" == typeof i.alwaysShowCalendars && (this.alwaysShowCalendars = i.alwaysShowCalendars), 0 != this.locale.firstDay) for (var r = this.locale.firstDay; r > 0;) {
  ...
  return a.prototype = {
    ...
    setStartDate: function setStartDate(e) {
      "string" == typeof e && (this.startDate = t(e, this.locale.format)), "object" == _typeof2(e) && (this.startDate = t(e)), this.timePicker || (this.startDate = this.startDate.startOf("day")), this.timePicker && this.timePickerIncrement && this.startDate.minute(Math.round(this.startDate.minute() / this.timePickerIncrement) * this.timePickerIncrement), this.minDate && this.startDate.isBefore(this.minDate) && (this.startDate = this.minDate.clone(), this.timePicker && this.timePickerIncrement && this.startDate.minute(Math.round(this.startDate.minute() / this.timePickerIncrement) * this.timePickerIncrement)), this.maxDate && this.startDate.isAfter(this.maxDate) && (this.startDate = this.maxDate.clone(), this.timePicker && this.timePickerIncrement && this.startDate.minute(Math.floor(this.startDate.minute() / this.timePickerIncrement) * this.timePickerIncrement)), this.isShowing || this.updateElement(), this.updateMonthsInView();
    },
    setEndDate: function setEndDate(e) {
      "string" == typeof e && (this.endDate = t(e, this.locale.format)), "object" == _typeof2(e) && (this.endDate = t(e)), this.timePicker || (this.endDate = this.endDate.endOf("day")), this.timePicker && this.timePickerIncrement && this.endDate.minute(Math.round(this.endDate.minute() / this.timePickerIncrement) * this.timePickerIncrement), this.endDate.isBefore(this.startDate) && (this.endDate = this.startDate.clone()), this.maxDate && this.endDate.isAfter(this.maxDate) && (this.endDate = this.maxDate.clone()), this.maxSpan && this.startDate.clone().add(this.maxSpan).isBefore(this.endDate) && (this.endDate = this.startDate.clone().add(this.maxSpan)), this.previousRightTime = this.endDate.clone(), this.container.find(".drp-selected").html(this.startDate.format(this.locale.format) + this.locale.separator + this.endDate.format(this.locale.format)), this.isShowing || this.updateElement(), this.updateMonthsInView();
    },
...
$(function () {
  ...
  var resumeUrl = '/api/reports/resume';
    ...
    return $.ajax({
      ...
      success: function success(response) {
        ...
        $.each(response.data, function (i, product) {
          if (product.total != 0) {
            if (product.amount) {
              $(".list-products").append($("<li class='" + (i > 3 && i < 8 ? 'line' : '') + "'>" + "<div class='box-list-products'>" + "<figure data-container='body' data-viewport='.container' data-placement='top' data-toggle='tooltip' title='" + product.name + "'><img class='photo' src='" + product.image + "' width='24px' height='24px' /></figure>" + "<div class='bars " + product.color + "' style='width:" + product.percentage + "'>" + "<span>" + product.amount + "</span></div></div></li>"));
    ...
    return $.ajax({
      ...
      success: function success(response) {
        if (response.data != '') {
          ...
          graphRegions();
          var percentage = "<li class='blue'>60%</li>";
          var legend = "<li class='conversion'><span></span>Convers\xF5es</li>";
  ...
  function updateReports() {
    ...
    $("#revenue-generated, #qtd-aproved, #qtd-boletos, #qtd-recusadas, #qtd-chargeback, #qtd-pending, #qtd-canceled, #percent-boleto-convert,#percent-credit-card-convert, #percent-desktop, #percent-mobile, #qtd-cartao-convert, #qtd-boleto-convert, #ticket-medio").html("<span>" + "<span class='loaderSpan' >" + "</span>" + "</span>");
    ...
    $.ajax({
      ...
      success: function success(response) {
        current_currency = response.currency; // if(response.totalPaidValueAproved='R$ 0,00' || response.totalPaidValueAproved ==false || !response.totalPaidValueAproved){
      ...
      var scoreChart = new Chartist.Line("#" + id, {
        ...
        axisY: {
          labelInterpolationFnc: function labelInterpolationFnc(value) {
            value = value * 100; // value = Math.round(value,1);

            var str = value.toString();
            str = str.replace(".", "");
            var complete = 3 - str.length;
  ...
  var endDate = moment().format("DD/MM/YYYY"); // $('input[name="daterange"]').dateRangePicker(
  //     {
  ...
  function newGraphSell(series, labels) {
    ...
    var ctx = document.getElementById('graph-sell').getContext('2d');
  ...
  function newGraphCashback(series, labels) {
    ...
    var ctx = document.getElementById('graph-cashback').getContext('2d');
    var gradient = ctx.createLinearGradient(0, 0, 0, 450);
  ...
  function newGraphPending(series, labels) {
    ...
    var ctx = document.getElementById('graph-pending').getContext('2d');
    var gradient = ctx.createLinearGradient(0, 0, 0, 450);
  ...
  function graphComission(series, labels) {
    ...
    var ctx = document.getElementById('comission-graph').getContext('2d');
    var gradient = ctx.createLinearGradient(0, 0, 0, 450);
    gradient.addColorStop(0, 'rgba(76, 152,242, 0.23)');
    gradient.addColorStop(1, 'rgba(255, 255, 255, 0)');
    var myChart = new Chart(ctx, {
    ...
    var myChart = new Chart(ctx, {
      ...
      data: {
        ...
        datasets: [{
          ...
          data: [60, 22, 48, 35],
          color: '#636363',
          backgroundColor: ['rgba(46, 133, 236, 1)', 'rgba(102, 95, 232, 1)', 'rgba(244, 63, 94, 1)', 'rgba(255, 121, 0, 1)'],
          borderRadius: 4,
          barThickness: 30
        }, {
          label: '',
          data: [100, 42, 58, 45],
          color: '#636363',
          backgroundColor: ['rgba(46, 133, 236, .2)', 'rgba(102, 95, 232, .2)', 'rgba(244, 63, 94, .2)', 'rgba(255, 121, 0, .2)'],
          borderRadius: 4,
          barThickness: 30
        }]
      },
  ...
  function convertToReal(tooltipItem) {
    var tooltipValue = tooltipItem.raw;
  ...
  function getInfo() {
    $('.box-link').on('click', function (e) {
      var calendar = $('input[name=daterange]').val();
      var company = $('#select_projects').val();
      var obj = {
        calendar: calendar,
        company: company
      };
