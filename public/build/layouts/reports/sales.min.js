...
!function (t, e) {
      ...
      value: function mix(t, e) {
        ...
        if (t) {
          ...
          var _a2 = e === _o2 ? .5 : e,
              _r2 = 2 * _a2 - 1,
              _l = _s4.a - _n2.a,
              _h = ((_r2 * _l == -1 ? _r2 : (_r2 + _l) / (1 + _r2 * _l)) + 1) / 2;
  ...
  function ne(t, e, i, s, n) {
    if (n.strikethrough || n.underline) {
      var _o3 = t.measureText(s),
          ...
          _r3 = e + _o3.actualBoundingBoxRight,
          _l2 = i - _o3.actualBoundingBoxAscent,
          _h2 = i + _o3.actualBoundingBoxDescent,
          _c2 = n.strikethrough ? (_l2 + _h2) / 2 : _h2;

      t.strokeStyle = t.fillStyle, t.beginPath(), t.lineWidth = n.decorationWidth || 2, t.moveTo(_a5, _c2), t.lineTo(_r3, _c2), t.stroke();
    }
  }
      ...
      if (void 0 === e || void 0 === i) {
        ...
        if (_o5) {
          var _t4 = _o5.getBoundingClientRect(),
              _a6 = xe(_o5),
              _r4 = ye(_a6, "border", "width"),
              _l3 = ye(_a6, "padding");

          e = _t4.width - _l3.width - _r4.width, i = _t4.height - _l3.height - _r4.height, s = me(_a6.maxWidth, _o5, "clientWidth"), n = me(_a6.maxHeight, _o5, "clientHeight");
      ...
      for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
        ...
        var _t14 = _r6.box,
          ...
          weight: 1
            ...
            _h5 = _r6.stackWeight / _l6.weight || 1;
        ...
        for (_iterator11.s(); !(_step11 = _iterator11.n()).done;) {
          ...
          for (u = d + 1; u <= _t18.end; u++) {
            ...
            _e11 = ji(s.setContext(Ye(n, {
              ...
              p1DataIndex: u % l,
              datasetIndex: a
            }))), $i(_e11, c) && f(d, u - 1, _t18.loop, c), _o13 = _r7, c = _e11;
          }
  ...
  var Bs = /*#__PURE__*/function (_Ds) {
    ...
    _createClass(Bs, [{
      ...
      value: function getMinMax(t) {
        ...
        for (var _r8 = 0, _l9 = a.length; _r8 < _l9; ++_r8) {
          e = a[_r8].controller.getMinMax(this, t), n || (i = Math.min(i, e.min)), o || (s = Math.max(s, e.max));
        }
        ...
        if (o) {
          ...
          if (a ? (t.width = this.maxWidth, t.height = Is(n) + _o17) : (t.height = this.maxHeight, t.width = Is(n) + _o17), i.display && this.ticks.length) {
            ...
            if (a) {
              ...
              t.height = Math.min(this.maxHeight, t.height + _e25 + _r9);
            } else {
              var _e26 = i.mirror ? 0 : _h8 * _n16.width + _c6 * _o18.height;

              t.width = Math.min(this.maxWidth, t.width + _e26 + _r9);
            }
      ...
      value: function _createDescriptors(t, e) {
        ...
        return !1 !== s || e ? function (t, e, i, s) {
          ...
          for (var _a13 = 0; _a13 < e.length; _a13++) {
            ...
            null !== _l12 && n.push({
              plugin: _r11,
              options: js(t.config, _r11, _l12, o)
            });
          }
  ...
  var Pn = /*#__PURE__*/function (_Ps2) {
    ...
    _createClass(Pn, [{
      ...
      value: function updateElements(t, e, i, s) {
        ...
        for (var _r12 = e; _r12 < e + i; _r12++) {
          var _e47 = t[_r12],
              _i41 = !n && this.getParsed(_r12),
              _l14 = {},
              _u2 = _l14[c] = n ? o.getPixelForDecimal(.5) : o.getPixelForValue(_i41[c]),
              _f3 = _l14[d] = n ? a.getBasePixel() : a.getPixelForValue(_i41[d]);

          _l14.skip = isNaN(_u2) || isNaN(_f3), h && (_l14.options = this.resolveDataElementOptions(_r12, _e47.active ? "active" : s), n && (_l14.options.radius = 0)), this.updateElement(_e47, _r12, _l14, s);
        }
        ...
        var e = this.chart,
          ...
          if (e < yt) {
            var _r13 = t,
              ...
              return Ht(t, _r13, _l15, !0) ? 1 : Math.max(e, e * i, s, s * i);
            },
                _g2 = function _g2(t, e, s) {
              return Ht(t, _r13, _l15, !0) ? -1 : Math.min(e, e * i, s, s * i);
            },
                _p2 = _f4(0, _h13, _d8),
                _m2 = _f4(kt, _c9, _u3),
                _x = _g2(_t, _h13, _d8),
      ...
      value: function update(t) {
        ...
        var _ref11 = function (t, e, i) {
          ...
          if (t._sorted) {
            ...
            _d9 && (n = jt(Math.min(re(_r14, _a17.axis, _h14).lo, i ? s : re(e, _l16, _a17.getPixelForValue(_h14)).lo), 0, s - 1)), o = _u4 ? jt(Math.max(re(_r14, _a17.axis, _c10).hi + 1, i ? 0 : re(e, _l16, _a17.getPixelForValue(_c10)).hi + 1), n, s) - n : s - n;
          }
  ...
  var Tn = /*#__PURE__*/function (_Ps6) {
    ...
    _createClass(Tn, [{
      ...
      value: function updateElements(t, e, i, s) {
        ...
        for (var _r15 = e; _r15 < e + i; _r15++) {
          var _e52 = t[_r15],
              _i50 = this.resolveDataElementOptions(_r15, _e52.active ? "active" : s),
              _l17 = o.getPointPositionForValue(_r15, n.data[_r15]),
          ...
          this.updateElement(_e52, _r15, _d10, s);
        }
      }
    }]);
    ...
    Un && !e.options.segment ? function (t, e, i, s) {
      ...
      try {
        for (_iterator23.s(); !(_step23 = _iterator23.n()).done;) {
          var _r16 = _step23.value;
          Wn(t, o, _r16.style), t.beginPath(), a(t, e, _r16, {
            start: i,
            end: i + s - 1
  ...
  function fo(t, e, i) {
    ...
    for (var _n29 = 0; _n29 < i.length; _n29++) {
      ...
      if (!(!_l18 || _a19 && _r17)) if (_a19) s.unshift(_l18);else if (t.push(_l18), !_r17) break;
    }
  ...
  function Mo(t, e) {
    var i = e.line,
      ...
      try {
        for (_iterator25.s(); !(_step25 = _iterator25.n()).done;) {
          ...
          var _l19 = _o(i, n[_s44], n[_r18], _t62.loop);
    ...
    try {
      for (_iterator28.s(); !(_step28 = _iterator28.n()).done;) {
        ...
        t.save(), t.fillStyle = _r20, vo(t, a, _d12 && _o(n, _h21, _c13)), t.beginPath();
        ...
        if (this.isHorizontal()) {
          ...
          try {
            for (_iterator29.s(); !(_step29 = _iterator29.n()).done;) {
              ...
              _o32 !== _l21.row && (_o32 = _l21.row, _r21 = n(i, this.left + s, this.right - this.lineWidths[_o32])), _l21.top += this.top + t + s, _l21.left = a.leftForLtr(a.x(_r21), _l21.width), _r21 += _l21.width + s;
            }
          } catch (err) {
            _iterator29.e(err);
          } finally {
          ...
          try {
            for (_iterator30.s(); !(_step30 = _iterator30.n()).done;) {
              ...
              _l22.col !== _o33 && (_o33 = _l22.col, _r22 = n(i, this.top + t + s, this.bottom - this.columnSizes[_o33].height)), _l22.top = _r22, _l22.left += this.left + s, _l22.left = a.leftForLtr(a.x(_l22.left), _l22.width), _r22 += _l22.height + s;
            }
          } catch (err) {
            _iterator30.e(err);
          } finally {
      ...
      value: function update(t, e) {
        ...
        if (s.length) {
          ...
          var _e71 = this._size = Fo(this, i),
              ...
              _l23 = Wo(i, _a23, _r24, this.chart);
      ...
      value: function _updateAnimationTarget(t) {
        ...
        if (s || n) {
          ...
          var _o37 = this._size = Fo(this, t),
              ...
              _r26 = Vo(e, t, _a25),
              _l25 = Wo(t, _a25, _r26, e);

          s._to === _l25.x && n._to === _l25.y || (this.xAlign = _r26.xAlign, this.yAlign = _r26.yAlign, this.width = _o37.width, this.height = _o37.height, this.caretX = _i58.x, this.caretY = _i58.y, this._resolveAnimations().update(this, _l25));
        }
      }
    }, {
      key: "draw",
...
var salesUrl = '/api/reports/sales';
  ...
  $.ajax({
    ...
    success: function success(response) {
      var _response$data = response.data,
          average_ticket = _response$data.average_ticket,
          chargeback = _response$data.chargeback,
          comission = _response$data.comission,
    ...
    success: function success(response) {
      if (response.data.exception !== null) {
        var _response$data2 = response.data,
            approved = _response$data2.approved,
            canceled = _response$data2.canceled,
            chargeback = _response$data2.chargeback,
            other = _response$data2.other,
            pending = _response$data2.pending,
            refunded = _response$data2.refunded,
            refused = _response$data2.refused,
            total = _response$data2.total;
        var series = [approved.percentage, pending.percentage, canceled.percentage, refused.percentage, refunded.percentage, chargeback.percentage, other.percentage];
  ...
  return $.ajax({
    ...
    success: function success(response) {
      var _response$data3 = response.data,
          total = _response$data3.total,
          percentage_desktop = _response$data3.percentage_desktop,
          percentage_mobile = _response$data3.percentage_mobile,
          count_desktop = _response$data3.count_desktop,
          count_mobile = _response$data3.count_mobile,
          value_desktop = _response$data3.value_desktop,
          value_mobile = _response$data3.value_mobile;
...
function typePayments() {
  var url = "/api/reports/resume/type-payments?date_range=" + $("input[name='daterange']").val();
  var paymentsHtml = '';
  ...
  return $.ajax({
    ...
    success: function success(response) {
      var _response$data4 = response.data,
          credit_card = _response$data4.credit_card,
          pix = _response$data4.pix,
          boleto = _response$data4.boleto;
  ...
  return $.ajax({
    ...
    success: function success(response) {
      var _response$data5 = response.data,
          percentage = _response$data5.percentage,
          value = _response$data5.value;
  ...
  return $.ajax({
    ...
    success: function success(response) {
      var _response$data6 = response.data,
          amount = _response$data6.amount,
          value = _response$data6.value;
  ...
  return $.ajax({
    ...
    success: function success(response) {
      var _response$data7 = response.data,
          value = _response$data7.value,
          amount = _response$data7.amount;
