...
$(function () {
    ...
    $.ajax({
      ...
      success: function success(response) {
        ...
        if (!isEmpty(response.plans)) {
          ...
          table_data_itens += "<tr> <td colspan='3' class='text-center' style='vertical-align: middle;'><img style='width:124px;margin-right:12px;' src='" + $("#origins-table-itens").attr("img-empty") + "'>Nenhuma venda encontrada</td> </tr>";
        }
  ...
  function updateCheckoutsByOrigin() {
    ...
    $.ajax({
      ...
      success: function success(response) {
        if (response.data == '') {
          $('#origins-table').html("<td colspan='3' class='text-center' style='vertical-align: middle;'><img style='width:124px;margin-right:12px;' src='" + $("#origins-table-itens").attr("img-empty") + "'>Nenhuma venda encontrada</div>");
          $("#pagination").html("");
        } else {
          var table_data = '';
