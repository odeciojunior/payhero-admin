      ...
      success: function success(response) {
        if (!isEmpty(response.data)) {
          $.each(response.data, function (index, company) {
            ...
            var document = (company.document.replace(/\D/g, "").length > 11 ? "CNPJ: " : "CPF: ") + company.document;
            $("#company").append("<option value=\"".concat(company.id, "\" data-toggle=\"tooltip\" title=\"").concat(document, "\">").concat(company.name, "</option>"));
          }); // if (hasSale) {
