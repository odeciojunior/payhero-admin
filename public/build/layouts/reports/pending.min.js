...
$(function () {
    ...
    $.ajax({
      ...
      success: function success(response) {
        ...
        $(".btn_refund_billet").on('click', function () {
          ...
          $('#modal_detalhes').modal('hide'); // var refunded_value = $('#refundBilletAmount').val();
  ...
  function renderSale(sale) {
    ...
    $("#total-value").html("R$ " + sale.total); // $("#total-paid-value").html("R$ " + sale.total_paid_value);
    ...
    if (sale.value_anticipable != '0,00') {
      ...
      $(".div-value-anticipated").html('').append("<span id=\"taxareal-value\" class='text-muted ft-12'>R$ ".concat(sale.value_anticipable, "</span>")).show();
    } //comissao afiliado
    ...
    if (sale.status == 7) {
      $('#div_refund_receipt').html("<a class=\"btn btn-sm btn-primary\" target=\"_blank\" href=\"/sales/".concat(sale.id, "/refundreceipt\">Comprovante de estorno</a>"));
    }
  ...
  function renderClient(client) {
    ...
    $('#client-telephone').val(client.telephone).attr('client', client.code).mask('+0#');
  ...
  function refundedClick(sale) {
    var refunded_value = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
    var partial = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
    var refundObservation = arguments.length > 3 ? arguments[3] : undefined;
    loadingOnScreen();
    $.ajax({
      method: "POST",
