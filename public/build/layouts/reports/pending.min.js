      ...
      if (!isEmpty(response.data)) {
        $.each(response.data, function (index, value) {
          ...
          if (value.is_security_reserve) {
            is_security_reserve = "<br><div data-toggle=\"tooltip\" title=\"Reserva de Seguran\xE7a\">\n                                                   <img class=\"ml-30\" width=\"12px\" src=\"/build/global/img/money_lock.svg\" alt=\"Reserva de Seguran\xE7a\">\n                                               </div>";
          }

          dados = "  <tr>\n                                <td class=\"text-center\">\n                                    ".concat(value.sale_code, "\n                                    ").concat(is_security_reserve, "\n                                </td>\n                                <td class=\"text-left\">").concat(value.project, "</td>\n                                <td class=\"text-left\">").concat(value.client, "</td>\n                                <td class=\"display-sm-none display-m-none display-lg-none\">\n                                    <img src='/build/global/img/cartoes/").concat(value.brand, ".png' alt=\"").concat(value.brand, "\"  style='width: 45px'>\n                                </td>\n                                <td class=\"display-sm-none display-m-none display-lg-none text-left\">").concat(start_date, "</td>\n                                <td class=\"text-left\">").concat(end_date, "</td>\n                                <td><b class=\"font-md-size-20\">").concat(value.total_paid, "</b></td>\n                                <td>\n                                    <a role='button' class='detalhes_venda pointer' venda='").concat(value.id, "'><span>\n                                    <img src=\"/build/global/img/icon-eye.svg\"></span></button></a>\n                                </td>\n                            </tr>");
          ...
          $('.fullInformation-pending').bind('mouseover', function () {
            ...
            if (this.offsetWidth < this.scrollWidth && !$this.attr('title')) {
              $this.attr({
                ...
                container: ".container-tooltips-pending"
              });
              $this.tooltip("show");
            }
          });
