    ...
    return $.ajax({
      ...
      success: function success(response) {
        var _response$data6 = response.data,
            coupons = _response$data6.coupons,
            total = _response$data6.total;
    ...
    return $.ajax({
      ...
      success: function success(response) {
        var _response$data7 = response.data,
            boleto = _response$data7.boleto,
            credit_card = _response$data7.credit_card,
            pix = _response$data7.pix,
            total = _response$data7.total;
