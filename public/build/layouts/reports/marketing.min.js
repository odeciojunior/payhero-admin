...
function loadResume() {
  var checkouts,
      salesCount,
      salesValue = ''; // $("#checkouts_count, #sales_count, #sales_value").prepend(skeLoad2);
