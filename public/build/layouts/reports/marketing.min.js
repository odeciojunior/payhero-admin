    ...
    _createClass(dn, [{
      ...
      value: function bindUserEvents() {
        ...
        var t = this._listeners,
            ...
            i = function (_i35) {
          function i(_x, _x2) {
            return _i35.apply(this, arguments);
          }

          i.toString = function () {
            return _i35.toString();
          };

          return i;
        }(function (i, s) {
          e.addEventListener(_this14, i, s), t[i] = s;
        }),
            s = function s(t, e, i) {
      ...
      value: function bindResponsiveEvents() {
        ...
        var t = this._responsiveListeners,
          ...
          e.addEventListener(_this15, i, s), t[i] = s;
        }),
            s = function s(i, _s33) {
      ...
      value: function update(t) {
        var e = this.chart,
          ...
          if (e < yt) {
            ...
            s = (_p2 - _x5) / 2, n = (_m2 - _b2) / 2, o = -(_p2 + _x5) / 2, a = -(_m2 + _b2) / 2;
          }
    ...
    _createClass(On, [{
      ...
      value: function updateElements(t, e, i, s) {
        ...
        for (u = e; u < e + i; u++) {
          ...
          this.updateElement(_e50, u, _x6, s);
        }
      }
    }, {
  ...
  return $.ajax({
    ...
    success: function success(response) {
      var _response$data = response.data,
          coupons = _response$data.coupons,
      ...
      if (total != 0) {
        ...
        for (var _i68 = 0; _i68 < arr.length; _i68++) {
          if (arr[_i68].amount != undefined) {
            seriesArr.push(arr[_i68].amount);
  ...
  return $.ajax({
    ...
    success: function success(response) {
      ...
      $.each(response.data, function (i, item) {
        ...
        var newV = formatCash(String(parseFloat(value)).replace('.', ''));
  ...
  return $.ajax({
    ...
    success: function success(response) {
      var _response$data2 = response.data,
          desktop = _response$data2.desktop,
          mobile = _response$data2.mobile;
      var numbers = [desktop.total, mobile.total].map(Number).reduce(function (prev, value) {
        return prev + value;
      }, 0);
...
function devicesInfo() {
  ...
  Promise.all([loadDevices()]).then(function (result) {
    var _result$0$data = result[0].data,
        desktop = _result$0$data.desktop,
        mobile = _result$0$data.mobile;
    var numbers = [desktop.total, mobile.total].map(Number).reduce(function (prev, value) {
      return prev + value;
    }, 0);
...
var formatCash = function formatCash(n) {
  if (n < 1e3) return n;
