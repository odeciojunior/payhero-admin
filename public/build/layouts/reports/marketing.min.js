...
!function (a, b) {
  ...
  return function (a, b, c) {
    ...
    function d(a) {
      ...
      var b = new RegExp("tooltip-show\\s*", "gi");a.className = a.className.replace(b, "").trim();
    }function f(a, b) {
      return (" " + a.getAttribute("class") + " ").indexOf(" " + b + " ") > -1;
    }function g(a, b) {
      do {
        a = a.nextSibling;
      } while (a && !f(a, b));return a;
    }function h(a) {
      return a.innerText || a.textContent;
    }var i = { currency: void 0, currencyFormatCallback: void 0, tooltipOffset: { x: 0, y: -20 }, anchorToPoint: !1, appendToBody: !1, class: void 0, pointClass: "ct-point" };c.plugins = c.plugins || {}, c.plugins.tooltip = function (j) {
      return j = c.extend({}, i, j), function (i) {
        function k(a, b, c) {
          ...
          p = p || o.offsetHeight, q = q || o.offsetWidth;var c,
              d,
              e = -q / 2 + j.tooltipOffset.x,
              f = -p + j.tooltipOffset.y;if (j.appendToBody) o.style.top = b.pageY + f + "px", o.style.left = b.pageX + e + "px";else {
            var g = n.getBoundingClientRect(),
                h = b.pageX - g.left - a.pageXOffset,
                i = b.pageY - g.top - a.pageYOffset;!0 === j.anchorToPoint && b.target.x2 && b.target.y2 && (c = parseInt(b.target.x2.baseVal.value), d = parseInt(b.target.y2.baseVal.value)), o.style.top = (d || i) + f + "px", o.style.left = (c || h) + e + "px";
          }
        }var m = j.pointClass;i.constructor.name == c.Bar.prototype.constructor.name ? m = "ct-bar" : i.constructor.name == c.Pie.prototype.constructor.name && (m = i.options.donut ? "ct-slice-donut" : "ct-slice-pie");var n = i.container,
            o = n.querySelector(".chartist-tooltip");o || (o = b.createElement("div"), o.className = j.class ? "chartist-tooltip " + j.class : "chartist-tooltip", j.appendToBody ? b.body.appendChild(o) : n.appendChild(o));var p = o.offsetHeight,
            q = o.offsetWidth;e(o), k("mouseover", m, function (a) {
          var e = a.target,
              f = "",
              ...
              r = !!n,
              s = e.getAttribute("ct:value");if (j.transformTooltipTextFnc && "function" == typeof j.transformTooltipTextFnc && (s = j.transformTooltipTextFnc(s)), j.tooltipFnc && "function" == typeof j.tooltipFnc) f = j.tooltipFnc(n, s);else {
            if (j.metaIsHTML) {
              var t = b.createElement("textarea");t.innerHTML = n, n = t.value;
            }if (n = '<span class="chartist-tooltip-meta">' + n + "</span>", r) f += n + "<br>";else if (i instanceof c.Pie) {
              var u = g(e, "ct-label");u && (f += h(u) + "<br>");
...
!function (e, t) {
  ...
  "use strict";
  var t = { className: "", classNames: !1, removeAll: !1, legendNames: !1, clickable: !0, onClick: null, position: "top" };return e.plugins = e.plugins || {}, e.plugins.legend = function (s) {
    function a(e, t) {
      return e - t;
    }if (s && s.position) {
      if (!("top" === s.position || "bottom" === s.position || s.position instanceof HTMLElement)) throw Error("The position you entered is not a valid position");if (s.position instanceof HTMLElement) {
        var i = s.position;delete s.position;
      }
    }return s = e.extend({}, t, s), i && (s.position = i), function (t) {
      var i = t.container.querySelector(".ct-legend");if (i && i.parentNode.removeChild(i), s.clickable) {
        var n = t.data.series.map(function (s, a) {
          return "object" != (typeof s === "undefined" ? "undefined" : _typeof(s)) && (s = { value: s }), s.className = s.className || t.options.classNames.series + "-" + e.alphaNumerate(a), s;
        });t.data.series = n;
      }var o = document.createElement("ul"),
          l = t instanceof e.Pie;o.className = "ct-legend", t instanceof e.Pie && o.classList.add("ct-legend-inside"), "string" == typeof s.className && s.className.length > 0 && o.classList.add(s.className), t.options.width && (o.style.cssText = "width: " + t.options.width + "px;margin: 0 auto;");var r = [],
          c = t.data.series.slice(0),
          d = t.data.series,
          p = l && t.data.labels && t.data.labels.length;if (p) {
        var u = t.data.labels.slice(0);d = t.data.labels;
      }d = s.legendNames || d;var f = Array.isArray(s.classNames) && s.classNames.length === d.length;d.forEach(function (e, t) {
        var a = document.createElement("li");a.className = "ct-series-" + t, f && (a.className += " " + s.classNames[t]), a.setAttribute("data-legend", t), a.textContent = e.name || e, o.appendChild(a);
      }), t.on("created", function (e) {
        if (s.position instanceof HTMLElement) s.position.insertBefore(o, null);else switch (s.position) {case "top":
            t.container.insertBefore(o, t.container.childNodes[0]);break;case "bottom":
            t.container.insertBefore(o, null);}
      }), s.clickable && o.addEventListener("click", function (e) {
        var i = e.target;if (i.parentNode === o && i.hasAttribute("data-legend")) {
          e.preventDefault();var n = parseInt(i.getAttribute("data-legend")),
              l = r.indexOf(n);l > -1 ? (r.splice(l, 1), i.classList.remove("inactive")) : s.removeAll ? (r.push(n), i.classList.add("inactive")) : t.data.series.length > 1 ? (r.push(n), i.classList.add("inactive")) : (r = [], Array.prototype.slice.call(o.childNodes).forEach(function (e) {
            e.classList.remove("inactive");
          }));var d = c.slice(0);if (p) var f = u.slice(0);r.sort(a).reverse(), r.forEach(function (e) {
                                ...
                                <div class="box-payment-option option">
                                    <div class="col-payment">
                                        <div class="box-payment center">
                                            <span class="silver">${mobile.percentage_total}</span>
                                        </div>
                                    </div>
                                    <div class="col-payment">
                        ...
                        <div class="data-holder b-bottom">
                            <div class="box-payment-option pad-0">
                                ...
                                <div class="box-payment-option option">
                                    <div class="col-payment">
                                        <div class="box-payment center">
                                            <span class="silver">${desktop.percentage_total}</span>
                                        </div>
                                    </div>
                                    <div class="col-payment">
                                        <div class="box-payment right">
    ...
    .then(result => {
        ...
        if(numbers !== 0) {
            ...
            deviceInfoBlock = `
                ...
                <div>
                    <span class="mkt-msg-conversion">
                        Tanto mobile como desktop estao com ${numbers}
                    </span>
                </div>
                `;
        }
