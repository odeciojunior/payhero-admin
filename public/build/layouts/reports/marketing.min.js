    ...
    $.ajax({
      ...
      success: function success(response) {
        ...
        $.each(response.data, function (i, data) {
          ...
          if ($("#map-filter").val() == 'density') {
            $('#state-' + data.state + ' path').css({
              fill: getStateBackgroundCollor(maxValue, onlyNumbers(data.percentage))
            });
          } else {
            $('#state-' + data.state + ' path').css({
              fill: getStateBackgroundCollor(maxValue, onlyNumbers(data.value))
            });
          }
