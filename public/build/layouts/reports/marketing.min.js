...
$(function () {
  ...
  changeCompany();
  changeCalendar();
  loadStores(); // $("#select_projects").on("change", function () {
  //     $(".data-pie ul").remove();
  //     $('.onPreLoad *').remove();
  ...
  return $.ajax({
    ...
    success: function success(response) {
      var _response$data2 = response.data,
          ...
          value_desktop = _response$data2.value_desktop,
          value_mobile = _response$data2.value_mobile;
