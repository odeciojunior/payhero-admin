...
$(function () {
  ...
  $("#select_projects").on("change", function () {
    $(".data-pie ul").remove();
    $('.onPreLoad *').remove(); // $('.onPreLoad').append(skeLoad);
...
var mktUrl = '/api/reports/marketing';
...
function loadOrigins() {
  ...
  if (link == null) {
    url = "".concat(resumeUrl, "/origins?date_range=").concat($("input[name='daterange']").val(), "&origin=").concat($("#origin").val(), "&project_id=").concat($("#select_projects option:selected").val());
  } else {
    url = "".concat(resumeUrl, "/origins").concat(link, "&date_range=").concat($("input[name='daterange']").val(), "&origin=").concat($("#origin").val(), "&project_id=").concat($("#select_projects option:selected").val());
  }
...
function updateStorage(value) {
  var prevData = JSON.parse(sessionStorage.getItem('info'));
...
function setCustomMapCss(selector, maxValue, value) {
  ...
  var percentage = 100 * value / maxValue;
