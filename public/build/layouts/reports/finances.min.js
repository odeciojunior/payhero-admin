  ...
  return $.ajax({
    ...
    success: function success(response) {
      ...
      if (response.data.chart) {
        ...
        var withdraw = _toConsumableArray(response.data.chart.withdrawal.values);

        var series = _toConsumableArray(response.data.chart.income.values);
...
function onResume() {
  ...
  return $.ajax({
    ...
    success: function success(response) {
      transactions = "\n                <span class=\"title\">N de transa\xE7\xF5es</span>\n                <div class=\"d-flex\">\n                    <strong class=\"number\">\n                        <span>".concat(response.data.transactions == undefined ? 0 : response.data.transactions, "</span>\n                    </strong>\n                </div>\n            ");
      ticket = "\n                <span class=\"title\">Ticket M\xE9dio</span>\n                <div class=\"d-flex\">\n                    <span class=\"detail\">R$</span>\n                    <strong class=\"number\">".concat(response.data.average_ticket == undefined ? '0,00' : removeMoneyCurrency(response.data.average_ticket), "</strong>\n                </div>\n            ");
      commission = "\n                <span class=\"title\">Comiss\xE3o total</span>\n                <div class=\"d-flex\">\n                    <span class=\"detail\">R$</span>\n                    <strong class=\"number\">".concat(response.data.comission == undefined ? '0,00' : removeMoneyCurrency(response.data.comission), "</strong>\n                </div>\n            ");
      chargebacks = "\n                <span class=\"title\">Total em Chargebacks</span>\n                <div class=\"d-flex\">\n                    <span class=\"detail\">R$</span>\n                    <strong class=\"number\"><span class=\"bold\">".concat(response.data.chargeback == undefined ? '0,00' : removeMoneyCurrency(response.data.chargeback), "</span></strong>\n                </div>\n            ");
  ...
  return $.ajax({
    ...
    success: function success(response) {
      var _response$data3 = response.data,
          amount = _response$data3.amount,
          value = _response$data3.value;
  ...
  return $.ajax({
    ...
    success: function success(response) {
      var _response$data4 = response.data,
          quantity = _response$data4.quantity,
          value = _response$data4.value;
