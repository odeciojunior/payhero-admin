...
var financesResumeUrl = '/api/reports/finances';
  ...
  return $.ajax({
    ...
    success: function success(response) {
      var _response$data = response.data,
          available = _response$data.available,
          blocked = _response$data.blocked,
          pending = _response$data.pending,
          total = _response$data.total;
      var series = [available.percentage < 0 ? 0 : available.percentage, pending.percentage < 0 ? 0 : pending.percentage, blocked.percentage < 0 ? 0 : blocked.percentage];
  ...
  return $.ajax({
    ...
    success: function success(response) {
      if (response.data !== null) {
        ...
        var withdrawal = chart.withdrawal,
            income = chart.income;
        var incomeTotal = String(removeMoneyCurrency(income.total).replace(',', '.'));
        var withdrawalTotal = String(removeMoneyCurrency(withdrawal.total).replace(',', '.'));
        var numbers = [incomeTotal, withdrawalTotal].map(Number).reduce(function (prev, value) {
          return prev + value;
        }, 0);
        ...
        var label = _toConsumableArray(chart.labels);

        var withdraw = _toConsumableArray(chart.withdrawal.values);

        var series = _toConsumableArray(chart.income.values);
...
function blockeds() {
  ...
  return $.ajax({
    ...
    beforeSend: function beforeSend(jqXHR) {
      jqXHR.then(function (dados) {
        var value = dados.data.value;
    ...
    success: function success(response) {
      if (response.data != null) {
        var _response$data2 = response.data,
            amount = _response$data2.amount,
            value = _response$data2.value;
    ...
    success: function success(response) {
      if (response.data != undefined) {
        var _response$data3 = response.data,
            transactions = _response$data3.transactions,
            average_ticket = _response$data3.average_ticket,
            comission = _response$data3.comission,
            chargeback = _response$data3.chargeback;
    ...
    success: function success(response) {
      if (response.data !== null) {
        var _response$data4 = response.data,
            ...
            variation = _response$data4.variation; // <div class="finances-values">
  ...
  return $.ajax({
    ...
    success: function success(response) {
      var _response$data6 = response.data,
          quantity = _response$data6.quantity,
...
function changeCalendar() {
  ...
  data = sessionStorage.getItem('info') ? JSON.parse(sessionStorage.getItem('info')).calendar : "".concat(startDate, "-").concat(endDate);
...
function updateReports() {
  ...
  Promise.all([blockeds(), onResume(), onCommission(), getPending(), getCashback(), withdrawals(), distribution()]).then(function () {
...
function graphComission(series, labels) {
  ...
  var ctx = document.getElementById('comission-graph-finance').getContext('2d');
