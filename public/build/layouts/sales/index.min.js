...
var exportFormat = null; // Obtem lista de vendas
  ...
  $.ajax({
    ...
    success: function success(response) {
      ...
      if (response.total_sales) {
        ...
        $("#total-sales").html("<span class=\"font-size-30 bold\"> ".concat(response.total_sales, " </span>"));
        $("#commission").html("<span style=\"color:#959595\">R$</span> <span class=\"font-size-30 bold\"> ".concat(response.commission, " </span>"));

        if ("".concat(response.total).length >= 13) {
          $("#total").html("<span style=\"color:#959595\">R$</span><span class=\"font-size-30 bold\">&nbsp;</span><span style=\"font-size:27px !important\" class=\"bold\">".concat(response.total, "</span>"));
        } else {
          $("#total").html("<span style=\"color:#959595\">R$</span> <span class=\"font-size-30 bold\"> ".concat(response.total, " </span>"));
        }
      }
    }
  });
...
$(document).ready(function () {
  ...
  getProjects();
  getCompanies(); //Carrega o modal para regerar boleto
