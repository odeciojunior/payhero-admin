      ...
      if (!isEmpty(response.data)) {
        ...
        $.each(response.data, function (index, value) {
          ...
          if (!isEmpty(value.observation) || value.observation === null && false || value.observation === "" && false) {
            observation = "\n                            <a data-toggle=\"tooltip\" title=\"".concat(value.observation, "\" role=\"button\" class=\"sale_observation\" venda=\"").concat(value.id, "\">\n                                <span style=\"color: #44a44b\" class=\"o-info-help-1\"></span>\n                            </a>");
          }

          var cupomCode = "";

          if (!isEmpty(value.cupom_code) || value.cupom_code === null && false || value.cupom_code === "" && false) {
            cupomCode = "\n                            <a class=\"icon-transaction\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Utilizado o cupom ".concat(value.cupom_code, "\" role=\"button\" style='margin-left: 5px;'>\n                                <img width=\"25px\" src=\"/build/global/img/icon-cupom-discout.svg\">\n                            </a>");
          }
          ...
          if (value.cashback_value != "0.00") {
            cashbackIcon = "\n                            <a class=\"icon-transaction\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"".concat(value.cashback_value, "\" role=\"button\" style='margin-left: 5px;'>\n                                <img width=\"27px\" src=\"/build/global/img/icons-cashback.svg\">\n                            </a>");
            cashback = "<b style=\"color: #636363;\">".concat(value.total_paid, "</b>");
          }
        ...
        $('.fullInformation-sales').bind('mouseover', function () {
          ...
          if (this.offsetWidth < this.scrollWidth && !$this.attr('title')) {
            $this.attr({
              ...
              container: ".container-tooltips-sales"
            });
            $this.tooltip("show");
          }
        });
        $('.icon-transaction').tooltip({
          container: ".container-tooltips-sales"
        });
      } else {
...
function getFilters() {
  ...
  var transaction = $("#transaction").val().replace("#", "");
  ...
  var data = {
    ...
    value: parseInt($("#valor").val().replace(/[^\d]+/g, "")) > 0 ? $("#valor").val().replace(/[^\d]+/g, "") : "",
...
function salesResume() {
  ...
  $.ajax({
    ...
    success: function success(response) {
      ...
      $("#commission, #total").html('<span style="color:#959595">R$</span> <span class="font-size-30 bold">0,00</span>');

      if (response.total_sales) {
        $("#total-sales, #commission, #total").text("");
        var quant = response.total_sales;
        $("#total-sales").html("<span class=\"font-size-30 bold\"> ".concat(quant.toLocaleString("pt-BR"), " </span>"));
        var font_commission_style = "";

        if ("".concat(response.commission).length == 12) {
          font_commission_style = "font-size: 27px !important;";
        } else if ("".concat(response.commission).length > 12) {
          font_commission_style = "font-size: 25px !important;";
        }

        $("#commission").html("<span style=\"color:#959595\">R$</span> <span class=\"font-size-30 bold\" style=\"\n                        ".concat(font_commission_style, " \"> ").concat(response.commission, " </span>"));
        var font_total_style = "";

        if ("".concat(response.total).length == 12) {
          font_total_style = "font-size: 27px !important;";
        } else if ("".concat(response.total).length > 12) {
          font_total_style = "font-size: 25px !important;";
        }

        $("#total").html("<span style=\"color:#959595\">R$</span> <span class=\"font-size-30 bold\" style=\"\n                        ".concat(font_total_style, " \"> ").concat(response.total, " </span>"));
      }
    }
  });
}
...
$(document).ready(function () {
  ...
  $(".transaction-value").mask("#.##0,00", {
    reverse: true
  }).removeAttr("maxlength");
  $(".transaction-value").on("blur", function () {
    if ($(this).val().length == 1) {
      var val = "0,0" + $(this).val();
      $(".transaction-value").val(val);
    } else if ($(this).val().length == 2) {
      var _val = "0," + $(this).val();

      $(".transaction-value").val(_val);
    }
  });
  ...
  $("#bt_filtro").on("click", function (event) {
    ...
    $("#container-pagination").hide(); //atualizar();
