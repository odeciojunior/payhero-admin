      ...
      if (!isEmpty(response.data)) {
        ...
        $.each(response.data, function (index, value) {
          ...
          if (!isEmpty(value.cupom_code) || value.cupom_code === null && false || value.cupom_code === "" && false) {
            cupomCode = "\n                            <a data-toggle=\"tooltip\" title=\"Utilizado o cupom ".concat(value.cupom_code, "\" role=\"button\" style='margin-left: 5px;'>\n                                <img width=\"25px\" src=\"/build/global/img/icon-cupom-discout.svg\">\n                            </a>");
          }
          ...
          if (value.cashback_value != "0.00") {
            cashbackIcon = "\n                            <a data-toggle=\"tooltip\" title=\"".concat(value.cashback_value, "\" role=\"button\" style='margin-left: 5px;'>\n                                <img width=\"27px\" src=\"/build/global/img/icons-cashback.svg\">\n                            </a>");
