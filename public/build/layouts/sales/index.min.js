      ...
      if (!isEmpty(response.data)) {
        ...
        $.each(response.data, function (index, value) {
          ...
          if (value.cashback_value != "0.00") {
            cashbackIcon = "<a data-toggle=\"tooltip\" title=\"".concat(value.cashback_value, "\" role=\"button\" style='margin-left: 5px;'>\n                                            <span style=\"color: #5EE2A1; font-size: 26px; -webkit-text-stroke: 2px rgba(94, 226, 161, 0.1);\" class=\"o-reload-1\"></span>\n                                        </a>");
            cashback = "<b style=\"color: #5EE2A1;\">".concat(value.total_paid, "</b>");
          }

          dados = "  <tr class='" + tableClass + "'>\n                                <td class='text-center'>\n                                    <br class=\"d-sm-none\"/>\n                                    ".concat(value.sale_code, " <br>\n                                    <div class=\"d-flex flex-row align-items-center justify-content-center\">\n                                        ").concat(cashbackIcon, "\n                                        ").concat(upsell, "\n                                        ").concat(has_order_bump, "\n                                        ").concat(cupomCode, "\n                                    </div>\n                                </td>\n                                <td>\n                                <strong class=\"bold-mobile\">").concat(value.product, "</strong>\n                                ").concat(value.affiliate != null && value.user_sale_type == "producer" ? "<br><small class=\"gray font-size-12\">(Afiliado: ".concat(value.affiliate, ")</small>") : "", "\n                                <br> <small class=\"gray font-size-12\">").concat(value.project, "</small></td>\n\n                                <td class='display-sm-none display-m-none display-lg-none'>").concat(value.client, "</td>\n                                <td>\n                                    <img src='/build/global/img/cartoes/").concat(value.brand, ".png'  style='width: 45px'>\n                                </td>\n                                <td class='text-center'>\n                                        <span class=\"status-sale badge badge-").concat(statusArray[value.status], " ").concat(value.status_translate === "Pendente" && value.brand != "pix" ? "boleto-pending" : "", "\" ").concat(value.status_translate === "Pendente" ? 'status="' + value.status_translate + '" sale="' + value.id_default + '"' : "", ">").concat(value.status_translate, "</span>\n\n                                </td>\n                                <td class='display-sm-none display-m-none text-left font-size-14'>").concat(start_date, "</td>\n                                <td class='display-sm-none text-left font-size-14'>").concat(end_date, "</td>\n                                <td style='white-space: nowrap;' class=\"text-center text-md-right\">\n                                    ").concat(cashback ? cashback : "<b>".concat(value.total_paid, "</b> <br>"), "\n                                </td>\n                                <td style=\"text-align: center\">\n                                    ").concat(observation, "\n                                    <a role='button' class='detalhes_venda pointer' venda='").concat(value.id, "'>\n                                        <span class=\"o-eye-1\"></span>\n                                    </a>\n                                </td>\n                            </tr>");
          $(function () {
...
$(document).ready(function () {
  ...
  $("#bt_filtro").on("click", function (event) {
    event.preventDefault(); //atualizar();
