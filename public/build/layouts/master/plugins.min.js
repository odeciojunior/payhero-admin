...
$(document).ready(function () {
  ...
  $('#company').change(function () {
    sessionStorage.setItem('companySelected', $(this).val()); //thisPage = window.location.href.substring(window.location.href.lastIndexOf('/') + 1);
...
function ajaxVerifyDocumentPending() {
  $.ajax({
    ...
    success: function success(response) {
      sessionStorage.setItem('documentsPending', JSON.stringify(response)); // if (response.pending) {
...
function verifyDocumentPending() {
  ...
  if (!window.location.href.includes('/companies') && !window.location.href.includes('/core')) {
    var documentsPending = sessionStorage.getItem('documentsPending');
...
function selectCompanies() {
  ...
  for (var i = 0; i < parseSessionStorageCompanies.length; i++) {
    if (sessionStorage.getItem('companySelected') == parseSessionStorageCompanies[i].id) itemSelected = 'selected="selected"';else itemSelected = '';
