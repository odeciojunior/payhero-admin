...
!function (n, t) {
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(t) : n.Sweetalert2 = t();
}(this, function () {
  "use strict";
  ...
  var n = {
    ...
    return "function" == typeof n ? n() : n;
      ...
      w = "function" == typeof Symbol && "symbol" == _typeof(Symbol.iterator) ? function (n) {
    return _typeof(n);
  } : function (n) {
...
$(document).ready(function () {
  ...
  $('.mm-panels.scrollable.scrollable-inverse.scrollable-vertical').removeClass('scrollable scrollable-inverse scrollable-vertical'); // var current_url = window.location.pathname;
...
function renderSiriusSelect(target) {
  ...
  $target.children('option').each(function () {
    var option = $(this);
    $options.append("<div data-value=\"".concat(option.val(), "\">").concat(option.text(), "</div>"));
  });
