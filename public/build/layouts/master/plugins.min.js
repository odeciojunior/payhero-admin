...
$(document).ready(function () {
  ...
  $('#company').change(function () {
    $.ajax({
      ...
      success: function success(response) {// sessionStorage.setItem('companyDefault', $(this).val());
...
function selectCompanies() {
  ...
  for (var i = 0; i < parseSessionStorageCompanies.length; i++) {
    if (sessionStorage.getItem('companyDefault') == parseSessionStorageCompanies[i].id) itemSelected = 'selected="selected"';else itemSelected = '';
