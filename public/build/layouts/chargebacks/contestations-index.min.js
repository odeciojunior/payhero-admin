...
$(document).ready(function () {
  ...
  function getFilters() {
    ...
    var data = {
      ...
      is_expired: (_$$val6 = $("#is_expired").val()) !== null && _$$val6 !== void 0 ? _$$val6 : "",
        ...
        $.each(response.data, function (index, value) {
          ...
          */
          ...
          if (value.status in statusObject) {
            dados += "\n                                    <td class='copy_link'>\n                                        <div class=\"d-flex justify-content-center align-items-center text-center\" >\n                                            <span class='badge ".concat(badgeObject[value.status], " ").concat(value.sale_status === 10 ? "pointer" : "cursor-default", "' data-toggle=\"tooltip\" data-html=\"true\" data-placement=\"top\" title=\"").concat(statusObject[value.status], "\">\n                                                ").concat(statusObject[value.status], "\n                                            </span>\n                                            ").concat(value.sale_is_chargeback_recovered ? '<img class="orange-gradient ml-5" src="/global/img/svg/chargeback.svg" width="20px" title="Chargeback recuperado">' : "", "\n                                        </div>\n                                    </td>");
          } else {
