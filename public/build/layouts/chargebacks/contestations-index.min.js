...
$(document).ready(function () {
  ...
  $("#date_range").val(moment().format("DD/MM/YYYY") + " - " + moment().add(30, "days").format("DD/MM/YYYY")).dateRangePicker({
    format: "DD/MM/YYYY",
  ...
  function getFilters() {
    var _$$val, _$$val2, _$$val3, _$$val$replace, _$$val4, _$$val5, _$$val6;
    ...
    var data = {
      ...
      is_expired: (_$$val6 = $("#is_expired").val()) !== null && _$$val6 !== void 0 ? _$$val6 : "" //sale_approve: $("#sale_approve").is(":checked") ? 1 : 0,
      ...
      success: function success(response) {
        ...
        $.each(response.data, function (index, value) {
          ...
          if (value.status in statusObject) {
            dados += "\n                                    <td class='copy_link'>\n                                        <div class=\"d-flex justify-content-center align-items-center text-center\" >\n                                            <span class='badge ".concat(badgeObject[value.status], " ").concat(value.sale_status === 10 ? "pointer" : "cursor-default", " font-size-14' data-toggle=\"tooltip\" data-html=\"true\" data-placement=\"top\" title=\"").concat(statusObject[value.status], "\">\n                                                ").concat(statusObject[value.status], "\n                                            </span>\n                                            ").concat(value.sale_is_chargeback_recovered ? '<img class="orange-gradient ml-5" src="/global/img/svg/chargeback.svg" width="20px" title="Chargeback recuperado">' : "", "\n                                        </div>\n                                    </td>");
          } else {
