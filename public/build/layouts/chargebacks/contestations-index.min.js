...
$(document).ready(function () {
  ...
  $('#date_range').val(moment().subtract(29, 'days').format('DD/MM/YYYY') + ' - ' + moment().format('DD/MM/YYYY')).dateRangePicker({
    ...
    customShortcuts: [{
      ...
      dates: function dates() {
        return [moment().add(30, 'days').toDate(), new Date()];
      }
    }, {
      name: 'Desde o início',
      dates: function dates() {
  ...
  function getFilters() {
    var _$$val, _$$val2, _$$val3, _$$val$replace, _$$val4, _$$val5, _$$val6, _$$val7;

    var urlParams = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;
    var current_url = window.location.href;
    var vazio = current_url.includes("vazio") ? "true" : "";
    var data = {
      transaction: $("#transaction").val().split("#").join(""),
      project: (_$$val = $("#project").val()) !== null && _$$val !== void 0 ? _$$val : "",
      customer: (_$$val2 = $("#customer").val()) !== null && _$$val2 !== void 0 ? _$$val2 : "",
      customer_document: (_$$val3 = $("#customer_document").val()) !== null && _$$val3 !== void 0 ? _$$val3 : "",
      date_range: (_$$val$replace = $('#date_range').val().replace(" à ", " - ")) !== null && _$$val$replace !== void 0 ? _$$val$replace : "",
      date_type: (_$$val4 = $("#date_type").val()) !== null && _$$val4 !== void 0 ? _$$val4 : "",
      order_by_expiration_date: $("#expiration_date").is(":checked") ? 1 : 0,
      contestation_situation: (_$$val5 = $("#contestation_situation").val()) !== null && _$$val5 !== void 0 ? _$$val5 : "",
      is_contested: (_$$val6 = $("#is_contested").val()) !== null && _$$val6 !== void 0 ? _$$val6 : "",
      is_expired: (_$$val7 = $("#is_expired").val()) !== null && _$$val7 !== void 0 ? _$$val7 : "",
    ...
    if (urlParams) {
      ...
      for (var param in data) {
        params += "".concat(isFirst ? "" : "&").concat(param, "=").concat(data[param]);
        isFirst = false;
      }
  ...
  var addZeroLeft = function addZeroLeft(value) {
    return value > 0 && value < 10 ? String(value).padStart(2, '0') : value;
  };
    ...
    $.ajax({
      ...
      success: function success(response) {
        ...
        $.each(response.data, function (index, value) {
          var objectArray = Object.entries(value.sale_blacklist);
          var valuesObject = "";
          objectArray.forEach(function (_ref) {
            ...
            valuesObject += "".concat(Object.keys(value), " - ").concat(Object.values(value));
          });
          dados = "";
          dados += "\n                        <tr ".concat(value.expiration_user == "Ganha" ? "class='won-contestation'" : "", ">\n                            <td id='").concat(value.id, "'>\n                                <span>").concat(value.sale_code, "</span>\n                            </td>\n\n                            <td class=\"line-overflow\" title=\"").concat(value.company, "\">\n                                ").concat(value.company_limit, "\n                                <br>\n                                <small class=\"text-muted\">\n                                    ").concat(value.project, "\n                                </small>\n                            </td>\n\n                            <td class=\"line-overflow\" title=\"").concat(value.customer, "\">\n                                ").concat(value.customer, "\n                                <br>\n                                <small class=\"text-muted\">\n                                    Pagamento em ").concat(value.adjustment_date, "\n                                </small>\n                            </td>");

          if (value.sale_status in statusObject) {
            dados += "\n                                    <td class='copy_link'>\n                                        <div class=\"d-flex justify-content-center align-items-center text-center\" >\n                                            <span class='badge ".concat(badgeObject[value.sale_status], " ").concat(value.sale_status === 10 ? "pointer" : "cursor-default", " font-size-14' data-toggle=\"tooltip\" data-html=\"true\" data-placement=\"top\" title=\"").concat(valuesObject, "\">\n                                                ").concat(statusObject[value.sale_status], "\n                                            </span>\n                                            ").concat(value.sale_has_valid_tracking ? "" + '<span class="o-truck-1 font-size-20 text-success cursor-default ml-5" data-toggle="tooltip" title="Rastreamento válido"></span>' : value.sale_only_digital_products ? '<i class="material-icons font-size-20 text-info cursor-default ml-5" data-toggle="tooltip" title="A venda não tem produtos físicos">computer</i>' : '<span class="o-truck-1 font-size-20 text-danger cursor-default ml-5" data-toggle="tooltip" title="Rastreamento inválido ou não informado"></span>', "\n                                            ").concat(value.sale_is_chargeback_recovered ? '<img class="orange-gradient ml-5" src="/global/img/svg/chargeback.svg" width="20px" title="Chargeback recuperado">' : "", "\n                                        </div>\n                                    </td>");
          } else {
            dados += "\n                                    <td>\n                                        <span class='badge badge-danger'>\n                                            Vazio\n                                        </span>\n                                    </td>";
          }

          dados += "\n                                    <td class=\"bold\">".concat(value.expiration_user, " ").concat(value.expiration_user.includes("dia") ? '<br><span class="font-size-12 text-muted"> para expirar</span>' : "", "</td>\n                                ");
          dados += "\n                                <td class=\"font-size-12 bold line-overflow\" style=\"white-space: normal;\">\n                                    ".concat(value.reason, "\n                                </td>\n                                <!-- <td style='white-space: nowrap'> <b>").concat(value.amount, "</b> </td>-->\n                                    <td>\n                                        ").concat(value.is_file_user_completed ? '<a  role="button" class="contetation_file pointer  ' + (value.has_expired ? "disabled" : "") + '" title="' + (value.has_expired ? "Prazo para recurso encerrado" : "Enviar arquivo") + '"   style="margin-right:5px" contestation="' + value.id + '"><span class="material-icons" id="check-status-text-icon" data-toggle="tooltip" title="Envio completo">done</span></a>' : '<a  role="button" class="contetation_file pointer  ' + (value.has_expired ? "disabled" : value.has_files ? "text-success" : "") + '" title="' + (value.has_expired ? "Prazo para recurso encerrado" : "Enviar arquivo") + '"   style="margin-right:5px" contestation="' + value.id + '">' + '<span class="o-upload-to-cloud-1  ' + (value.has_files ? "text-success" : "") + '" id="upload-file_' + value.id + ' " ></span>' + "</a>", "\n                                        <a role='button' class='detalhes_venda pointer' venda='").concat(value.sale_id, "'>\n                                            <span class=\"o-eye-1\"></span>\n                                        </a>\n                                  </td>\n                                </tr>");
          $("#chargebacks-table-data").append(dados);
        });

        if (response.data == "") {
          $("#chargebacks-table-data").html("<tr class='text-center gray'><td colspan='10' style='vertical-align: middle;height:257px;'><img style='width:124px;margin-right:12px;' src='" + $("#chargebacks-table-data").attr("img-empty") + "' alt='Sem contestações'>Nenhuma contestação encontrada</td></tr>");
        }
  ...
  function getTotalValues() {
    ...
    var link = "/api/contestations/gettotalvalues?" + getFilters();
    $.ajax({
      method: "GET",
      url: link,
      headers: {
    ...
    $.ajax({
      ...
      success: function success(response) {
        if (!isEmpty(response.data)) {
          $("#project-empty").hide();
          $("#project-not-empty").show(); // $("#export-excel").show();
