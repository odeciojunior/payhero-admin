...
$(document).ready(function () {
    ...
    $.ajax({
      ...
      success: function success(response) {
        if (isEmpty(response.data)) {
          ...
          $("#content-error").hide(); // $("#table_invites").show();
        ...
        window.getInvitationData(); // Reenviar convite
  ...
  $('.company_name').val($('#company-navbar').find('option:selected').text()); //ALTERAÇÃO DE HTML
