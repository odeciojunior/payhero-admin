...
var disabledCompany = false;
var companyVerification = true;
    ...
    $.ajax({
      ...
      success: function success(response) {
        if (isEmpty(response.data)) {
          ...
          $("#card-invitation-data").css("display", "block"); // $("#text-info").css('display', 'block');
          ...
          $.each(response.data, function (index, value) {
            ...
            dados += '<td class="text-center ellipsis-text" style="vertical-align: middle;">' + value.email_invited + "</td>";
            dados += '<td class="text-center ellipsis-text" style="vertical-align: middle;">' + value.company_name + "</td>";
            ...
            if (value.status != "2" || verifyAccountFrozen()) {
              dados += "<td><button class='btn pointer resend-invitation' title='Reenviar convite' style='background-color:transparent;' invitation='" + value.id + "' disabled><span class=''><img src='/build/global/img/icons-cashback.svg'/></span></button></td>";
              dados += "<td><button class='btn pointer delete-invitation' title='Excluir' style='background-color:transparent;' invitation='" + value.id + "' disabled><span class=''><img src='/build/global/img/icon-trash-tale.svg'/></span></button></td>";
            } else {
              dados += "<td><button class='btn pointer resend-invitation' title='Reenviar convite' style='background-color:transparent;' invitation='" + value.id + "'><span class=''><img src='/build/global/img/icons-cashback.svg'/></span></button></td>";
              dados += "<td><button class='btn pointer delete-invitation' title='Excluir' style='background-color:transparent;' invitation='" + value.id + "'><span class=''><img src='/build/global/img/icon-trash-tale.svg'/></span></button></td>";
            }
        ...
        getInvitationData(); // Reenviar convite

        $(".resend-invitation").unbind("click");
        $(".resend-invitation").on("click", function () {
          var invitationId = $(this).attr("invitation");
      ...
      success: function success(response) {
        if (companyVerification) {
          if (isEmpty(response.data)) {
            ...
            loadingOnScreenRemove();
            var contCompanies = 0;
            var contCompaniesNotApproved = 0;
            var selCompany = "";
              ...
              if (companyIsApproved(company)) {
                if (company.type_company === "physical person") {
                  if (statusDocumentUser[company.user_address_document_status] !== "Aprovado" || statusDocumentUser[company.user_personal_document_status] !== "Aprovado") {
                    ...
                    selCompany += "<option value=".concat(company.id_code, " disabled> ").concat(company.fantasy_name, "  </option>");
                  } else {
                    selCompany += "<option value=".concat(company.id_code, " >  ").concat(company.fantasy_name, "  </option>");
                  }
