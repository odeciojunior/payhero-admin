...
$(document).ready(function () {
  ...
  function updateSalesRecovery() {
    ...
    loadOnTable("#table_data", "#carrinhoAbandonado");
    $("#pagination-salesRecovery").children().attr("disabled", "disabled"); // Formata a url
  ...
  function createHtmlCartAbandoned(value) {
    ...
    data += "<td> <span data-toggle='tooltip' data-placement='top' title='" + value.project + "'>" + value.project + "</span> </td>";
    ...
    data += "<td style='padding:0 !important;' class='display-sm-none text-center' align='center'> <a role='button' class='copy_link' style='cursor:pointer;' link='" + value.link + "' title='Copiar link'><span class=''> <img src='build/global/img/icon-copy-table.svg'/> </span></a></td>";
    data += "<td class='display-sm-none' align='center'> <a role='button' class='details-cart-recovery' style='cursor:pointer;' data-venda='" + value.id + "' ><span> <img src='/build/global/img/icon-eye.svg'> </span></button></td>";
    data += "</tr>";
  ...
  function createHtmlOthers(value) {
    ...
    data += "<td class='display-sm-none' align='center'> <a href='" + value.whatsapp_link + "' target='_blank' title='Enviar mensagem pelo whatsapp'><span class='o-whatsapp-1'></span></a></td>";
    data += "<td class='display-sm-none text-right' style='padding:0!important' align='center'> <a role='button' class='copy_link' style='cursor:pointer;' link='" + value.link + "' title='Copiar link'><span class=''><img src='build/global/img/icon-copy-table.svg'/></span></a></td>";
    data += "<td class='display-sm-none' align='center'> <a role='button' class='details-cart-recovery' style='cursor:pointer;' data-venda='" + value.id_default + "' ><span class=''><img src='/build/global/img/icon-eye.svg'/></span></button></td>";
    data += "</tr>";
    $('[data-toggle="tooltip"]').tooltip({
      container: "#carrinhoAbandonado"
    });
  ...
  function createHtmlDetails(data) {
    ...
    var div = "";
    var photo = "public/build/global/img/produto.png";
    $.each(data.products, function (index, value) {
      if (!isEmpty(value.photo)) {
        photo = value.photo;
      }

      div += '<div class="row align-items-baseline justify-content-between mb-15">' + '<div class="col-lg-2">' + "<img onerror=this.src='/build/global/img/produto.png' src='" + value.photo + "' width='50px' style='border-radius: 6px;'>" + "</div>" + '<div class="col-lg-5">' + '<h4 class="table-title">' + value.name + "</h4>\n" + "</div>" + '<div class="col-lg-3 text-right">' + '<p class="sm-text text-muted">' + value.amount + "x</p>" + "</div>" + "</div>";
