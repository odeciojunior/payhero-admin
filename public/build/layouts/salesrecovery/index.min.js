...
$(document).ready(function () {
  ...
  function createHtmlCartAbandoned(value) {
    var date = value.date.split(" ", 1);
    var parseDate = value.date.split(" ", 2);
    var hours = parseDate[1];
    var data = "";
    data = "\n            <tr>\n\n                <td class=\"display-sm-none display-m-none display-lg-none\">\n\n                    ".concat(date, "\n\n                    <br>\n\n                    <span class=\"subdescription\">\n                        ").concat(hours, "\n                    </span>\n\n                </td>\n\n                <td>\n\n                    <div class=\"fullInformation ellipsis-text\">\n                        ").concat(value.project, "\n                    </div>\n\n                    <div class=\"container-tooltips\"></div>\n\n                </td>\n\n\n                <td class=\"d-none client-collumn\">\n\n                    <div class=\"fullInformation ellipsis-text\">\n                        ").concat(value.client, "\n                    </div>\n\n                </td>\n\n\n                <td>\n                    ").concat(value.email_status, " ").concat(setSend(value.email_status), "\n                </td>\n\n\n                <td>\n                    ").concat(value.sms_status, " ").concat(setSend(value.sms_status), "\n                </td>\n\n\n                <td>\n                    <span class=\"sale_status badge badge-").concat(statusRecovery[value.status_translate], "\" status=\"").concat(value.status_translate, "\" sale_id=\"").concat(value.id, "\">\n                        ").concat(value.status_translate, "\n                    </span>\n                </td>\n\n\n                <td class=\"commission-fweight\">\n                    ").concat(value.value, "\n                </td>\n\n\n                <td class=\"display-sm-none\" align=\"center\">\n\n                    <a href=\"").concat(value.whatsapp_link, "\" target=\"_blank\" title=\"Enviar mensagem pelo whatsapp\">\n                        <span class=\"o-whatsapp-1\"></span>\n                    </a>\n\n                </td>\n\n\n                <td style=\"padding:0 !important;\" class=\"display-sm-none text-center\" align=\"center\">\n\n                    <a role=\"button\" class=\"copy_link\" style=\"cursor:pointer;\" link=\"").concat(value.link, "\" title='Copiar link'>\n\n                        <span class=''>\n                            <img src='build/global/img/icon-copy-table.svg'/>\n                        </span>\n                    </a>\n                </td>\n\n\n                <td class=\"display-sm-none\" align=\"center\">\n                    <a role=\"button\" class=\"details-cart-recovery\" style=\"cursor:pointer;\" data-venda=\"").concat(value.id, "\">\n                        <span>\n                            <img src=\"/build/global/img/icon-eye.svg\">\n                        </span>\n                        </button>\n                    </a>\n                </td>\n\n            </tr>\n        ");
    return data;
  }
  /**
  ...
  function createHtmlOthers(value) {
    var date = value.start_date.split(" ", 1);
    var parseDate = value.start_date.split(" ", 2);
    var hours = parseDate[1];
    var data = "";
    data = "\n            <tr>\n\n                <td class=\"display-sm-none display-m-none display-lg-none\">\n                    ".concat(date, "\n                    <br>\n                    <span class=\"subdescription\">\n                        ").concat(hours, "\n                    </span>\n                </td>\n\n\n                <td>\n                    <div class=\"fullInformation ellipsis-text\">\n                        ").concat(value.project, "\n                    </div>\n\n                    <div class=\"container-tooltips\"></div>\n                </td>\n\n\n                <td class=\"d-none client-collumn\">\n\n                    <div class=\"fullInformation ellipsis-text\">\n                        ").concat(value.client, "\n                    </div>\n\n                </td>\n\n\n                <td>\n                    ").concat(value.email_status, " ").concat(setSend(value.email_status), "\n                </td>\n\n\n                <td>\n                    ").concat(value.sms_status, " ").concat(setSend(value.sms_status), "\n                </td>\n\n\n                <td>\n                    <span class=\"sale_status badge badge-").concat(statusRecovery[value.recovery_status], "\" sale_id=\"").concat(value.id_default, "\" >\n                        ").concat(value.recovery_status, "\n                    </span>\n                </td>\n\n\n                <td class=\"commission-fweight\" >\n                    ").concat(value.total_paid, "\n                </td>\n\n\n                <td class=\"display-sm-none\" align=\"center\">\n\n                    <a href=").concat(value.whatsapp_link, "\" target=\"_blank\" title=\"Enviar mensagem pelo whatsapp\">\n\n                        <span class=\"o-whatsapp-1\"> </span>\n\n                    </a>\n\n                </td>\n\n                <td class=\"display-sm-none text-center\" style=\"padding:0!important\" align=\"center\">\n\n                    <a role=\"button\" class=\"copy_link\" style=\"cursor:pointer;\" link=\"").concat(value.link, "\" title=\"Copiar link\">\n\n                        <span class=''>\n                            <img src=\"build/global/img/icon-copy-table.svg\"/>\n                        </span>\n\n                    </a>\n\n                </td>\n\n                <td class=\"display-sm-none\" align=\"center\">\n                    <a role=\"button\" class=\"details-cart-recovery\" style=\"cursor:pointer;\" data-venda=\"").concat(value.id_default, "\">\n\n                        <span class=\"\">\n                            <img src=\"/build/global/img/icon-eye.svg\"/>\n                        </span>\n\n                    </a>\n                </td>\n            </tr>\n        ");
    return data;
  } // ajax modal details
