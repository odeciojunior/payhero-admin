                    ...
                    $.each(response.data, function (index, value) {
                        ...
                        let data = `<tr>
                            ...
                            <td style="text-align:center">
                                <a role="button" title='Visualizar' class="mg-responsive details-project-notification pointer" project-notification="${value.id}"><span class="o-eye-1"></span> </a>
                                <a role="button" title='Editar' class="mg-responsive edit-project-notification pointer" project-notification="${value.id}"><span class="o-edit-1"></span> </a>
...
$(function () {
    ...
    function atualizarSms() {
        ...
        data += "<td style='vertical-align: middle' class=''><a role='button' class='pointer disabled delete-sms' data-toggle='modal' data-target='#modal-delete'>   <span class='o-bin-1'></span> </a></td>";
        data += '</tr>';
        ...
        data += '<td class="shipping-status " style="vertical-align: middle;">';
        data += '<span class="badge badge-success mb-1">Ativo</span>';
        data += '<span class="badge badge-primary">Grátis</span>';o-bin-1
        data += '</td>';
        data += '<td class="shipping-pre-selected " style="vertical-align: middle;">';
        data += '</td>';
        data += "<td style='vertical-align: middle' class=''><a role='button' class='pointer disabled details-sms' data-target='#modal-content' data-toggle='modal'> <span class="o-eye-1"></span> </a></td>";
