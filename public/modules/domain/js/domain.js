...
$(document).ready(function () {
    ...
    function modalUpdateDomains(index, value) {
        ...
        dados += "<a role='button' class='mg-responsive details-domain pointer'       status='" + value.status + "' domain='" + value.id + "' data-target='#modal-content' data-toggle='modal'><span class='orion-icon-eye'></span> </a>"
        dados += "<a role='button' class='mg-responsive edit-domain    pointer'       status='" + value.status + "' domain='" + value.id + "' data-target='#modal-content' data-toggle='modal'><span class='orion-icon-edit'></span> </a>"
        dados += "<a role='button' class='mg-responsive delete-domain  pointer'       status=''                     domain='" + value.id + "' data-target='#modal-delete'  data-toggle='modal'><span class='orion-icon-lixo'></span> </a>";
        dados += "</td>";
        dados += '</tr>';
