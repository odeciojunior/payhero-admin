$(document).ready(function () {
    ...
    $(document).on('click', '.card-edit', function () {
        $(".modal-title").html('Editar Integração com Digital Manager Guru');
        ...
        $.ajax({
            method: "GET",
            url: "/api/apps/digitalmanager/" + $(this).attr('project'),
            dataType: "json",
            headers: {
                'Authorization': $('meta[name="access-token"]').attr('content'),
                'Accept': 'application/json',
    ...
    $(document).on('click', '.btn-update', function () {
        ...
        $.ajax({
            method: "POST",
            url: "/api/apps/digitalmanager/" + integrationId,
            dataType: "json",
            headers: {
                'Authorization': $('meta[name="access-token"]').attr('content'),
                'Accept': 'application/json',
    ...
    $(document).on('click', '.delete-integration', function (e) {
        ...
        $.ajax({
            method: "DELETE",
            url: "/api/apps/digitalmanager/" + project,
            dataType: "json",
            headers: {
                'Authorization': $('meta[name="access-token"]').attr('content'),
                'Accept': 'application/json',
