$(document).ready(function () {
    ...
    $("#btn-add-integration").on("click", function () {
        $(".modal-title").html("Adicionar nova Integração com HotBillet");
    ...
    $(document).on("click", ".card-edit", function () {
        $(".modal-title").html("Editar Integração com HotBillet");
        ...
        $.ajax({
            method: "GET",
            url: "/api/apps/hotbillet/" + $(this).attr("project"),
            dataType: "json",
            headers: {
                Authorization: $('meta[name="access-token"]').attr("content"),
                Accept: "application/json",
    ...
    $(document).on("click", ".btn-update", function () {
        ...
        $.ajax({
            method: "POST",
            url: "/api/apps/hotbillet/" + integrationId,
            dataType: "json",
            headers: {
                Authorization: $('meta[name="access-token"]').attr("content"),
                Accept: "application/json",
