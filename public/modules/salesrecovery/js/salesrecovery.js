...
$(document).ready(function () {
    ...
    function createHtmlCartAbandoned(value) {
        ...
        data += "<td class='display-sm-none' align='center'> <a href='" + value.whatsapp_link + "' target='_blank' title='Enviar mensagem pelo whatsapp'><span class='orion-icon-whatsapp'></span></a></td>";
        data += "<td class='display-sm-none' align='center'> <a role='button' class='copy_link' style='cursor:pointer;' link='" + value.link + "' title='Copiar link'><span class='orion-icon-copy'></span></a></td>";
        data += "<td class='display-sm-none' align='center'> <a role='button' class='details-cart-recovery' style='cursor:pointer;' data-venda='" + value.id + "' ><span class='orion-icon-eye'></span></button></td>";
        data += "</tr>";
    ...
    function createHtmlOthers(value) {
        ...
        data += "<td class='display-sm-none' align='center'> <a href='" + value.whatsapp_link + "' target='_blank' title='Enviar mensagem pelo whatsapp'><span class='orion-icon-whatsapp'></span></a></td>";
        data += "<td class='display-sm-none' align='center'> <a role='button' class='copy_link' style='cursor:pointer;' link='" + value.link + "' title='Copiar link'><span class='orion-icon-copy'></span></a></td>";
        data += "<td class='display-sm-none' align='center'> <a role='button' class='details-cart-recovery' style='cursor:pointer;' data-venda='" + value.id_default + "' ><span class='orion-icon-eye'></span></button></td>";
        data += "</tr>";
...
// ajax modal details
    ...
    function createHtmlDetails(data) {
        ...
        if (!isEmpty(data.link)) {
            $("#link-sale").html('Link: <a role="button" class="copy_link" style="cursor:pointer;" link="' + data.link + '" title="Copiar link"><span class="orion-icon-copy"></span> </a> ');
        } else {
