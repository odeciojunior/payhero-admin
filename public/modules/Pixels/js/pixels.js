        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $.each(response.data, function (index, value) {
                    ...
                    dados += "<td style='vertical-align: middle'><a role='button' class='details-frete pointer' frete='" + value.id + "' data-target='#modal-content' data-toggle='modal' style='margin-right:10px' ><i class='material-icons gradient'>remove_red_eye</i> </a></td>";
                    dados += "<td style='vertical-align: middle'><a role='button' class='edit-frete pointer' frete='" + value.id + "' data-target='#modal-content' data-toggle='modal' style='margin-right:10px' ><i class='material-icons gradient'>edit</i> </a></td>";
                    dados += "<td style='vertical-align: middle'><a role='button' class='delete-frete pointer' frete='" + value.id + "' data-target='#modal-delete' data-toggle='modal' style='margin-right:10px' ><i class='material-icons gradient'>delete_outline</i> </a></td>";
        ...
        $.ajax({
            ...
            headers: {
                ...
                atualizarFrete();
                    ...
                    dados += "<td style='vertical-align: middle'><a role='button' class='details-frete pointer' frete='" + value.shipping_id + "' data-target='#modal-content' data-toggle='modal' style='margin-right:10px' ><i class='material-icons gradient'>remove_red_eye</i> </a></td>";
                    dados += "<td style='vertical-align: middle'><a role='button' class='edit-frete pointer' frete='" + value.shipping_id + "' data-target='#modal-content' data-toggle='modal' style='margin-right:10px' ><i class='material-icons gradient'>edit</i> </a></td>";
                    dados += "<td style='vertical-align: middle'><a role='button' class='delete-frete pointer' frete='" + value.shipping_id + "' data-target='#modal-delete' data-toggle='modal' style='margin-right:10px' ><i class='material-icons gradient'>delete_outline</i> </a></td>";
