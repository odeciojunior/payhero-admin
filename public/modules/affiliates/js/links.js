                ...
                if (isEmpty(response.data)) {
                    ...
                    if (response.data[0].document_status == 'approved') {
                        $.each(response.data, function (index, value) {
                            ...
                            data += '<td class="display-lg-none display-xlg-none" title="Copiar Link"><a class="pointer copy_link_plan" link="' + value.link + '"> <span class="orion-icon-copy"></span> </a></td>';
                            ...
                            data += '<a title="Visualizar" class="mg-responsive details-link pointer" link="' + value.id + '" data-target="#modal-details-link" data-toggle="modal"><span class="orion-icon-eye"></span></a>';

                            if (value.plan_name == '' && value.link != null) {
                                data += '<a title="Editar" class="mg-responsive edit-link pointer" link="' + value.id + '" data-toggle="modal"><span class="orion-icon-edit"></span></a>';
                                data += '<a title="Excluir" class="mg-responsive delete-link pointer" link="' + value.id + '" data-toggle="modal"><span class="orion-icon-lixo"></span></a>';
                            } else {
                                data += '<a title="Editar" class="mg-responsive pointer disabled"><span class="orion-icon-edit"></span></a>';
                                data += '<a title="Excluir" class="mg-responsive pointer disabled"><span class="orion-icon-lixo"></span></a>';
                            }
                            data += '</td>';
                            data += '</tr>';
