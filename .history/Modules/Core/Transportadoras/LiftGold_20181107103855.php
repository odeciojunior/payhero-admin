...
use Modules\Checkout\Entities\Comprador;
use Modules\Checkout\Entities\Entrega;
use Modules\Checkout\Entities\Venda;
use Modules\Checkout\Entities\Produto;
use Modules\Checkout\Entities\ProdutoPlano;
...
class LiftGold {
    ...
    static function realizarPedido($venda, $plano, $entrega, $comprador){
        ...
        //Log::write('info', "Array Produtos lift #:" . print_r($produtos, true));
