...
// die;
    ...
    public function detalhesAntecipacao(Request $request){
        ...
        $dados['taxa_de_antecipacao'] = substr_replace($dados['taxa_de_antecipacao'], '.',strlen($dados['taxa_de_antecipacao']) - 2, 0 );
        ...
        $detalhes = "<table class='table table-bordered table-hover'>";
        $detalhes .= "<tbody>";
        $detalhes .= "<tr><td><b>Taxa</b></td><td id='".$dados['taxa']."'></td></tr>";
        $detalhes .= "<tr><td><b>Taxa de antecipação</b></td><td id='".$dados['taxa_de_antecipacao']."'></td></tr>";
        $detalhes .= "<tr><td><b>Valor total</b></td><td id='".$dados['valor_total']."'></td></tr>";
        $detalhes .= "<tr><td><b>Data do pagamento</b></td><td id='".$dados['data_liberacao']."'></td></tr>";
        $detalhes .= "</tbody>";
        $detalhes .= "</table>";
