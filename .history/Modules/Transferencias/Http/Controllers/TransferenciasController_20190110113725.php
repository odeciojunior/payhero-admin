...
// die;
    ...
    public function detalhesAntecipacao(Request $request){
        ...
        $detalhes .= "<tbody>";
        $detalhes .= "<tr><td><b>Taxa</b></td><td id='"+data.taxa+"'></td></tr>";
        $detalhes .= "<tr><td><b>Taxa de antecipação</b></td><td id='"+data.taxa_de_antecipacao+"'></td></tr>";
        $detalhes .= "<tr><td><b>Valor total</b></td><td id='"+data.valor_total+"'></td></tr>";
        $detalhes .= "<tr><td><b>Data do pagamento</b></td><td id='"+data.data_liberacao+"'></td></tr>";
        $detalhes .= "</tbody>";
        $detalhes .= "</table>";
