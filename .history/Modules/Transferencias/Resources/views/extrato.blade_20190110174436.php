            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    $.each(data, function(i, item) {
                        ...
                        dados_tabela += "<td><span class='badge badge-outline badge-warning'>"+data[i].status+"</span></td>";
                ...
                success: function(data){
                    ...
                    $.each(data, function(i, item) {
                        ...
                        if(data[i].status == "Paga"){
                            dados_tabela += "<td><span class='badge badge-outline badge-success'>"+data[i].status+"</span></td>";
                        }
                        else if(data[i].status == "Aguardando pagamento"){
                            dados_tabela += "<td><span class='badge badge-outline badge-primary'>"+data[i].status+"</span></td>";
                        }
