            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    $.each(data, function(i, item) {
                        ...
                        if(data[i].status == "Transferência pendente"){
                            dados_tabela += "<td><span class='badge  badge-info'>"+data[i].status+"</span></td>";
                            dados_tabela += "<td><button type='button' class='btn btn-danger btn-sm cancelar_transferencia' transferencia='"+data[i].id+"' data-toggle='modal' data-target='#modal_cancelar'>Cancelar antecipação</button></td>";
                        }
                        else{
                            dados_tabela += "<td><span class='badge badge-default'>"+data[i].status+"</span></td>";
                            dados_tabela += "<td></td>";
