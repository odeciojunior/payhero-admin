            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    $("#modal_detalhes_body").html("\
                        <table class='table table-bordered table-hover'><tbody><tr><td><b>Taxa</b></td><td id='"+data.taxa+"'></td></tr><tr>\
                            <td><b>Taxa de antecipação</b></td><td id='"+data.taxa_de_antecipacao+"'></td></tr><tr>\
                            <td><b>Valor total</b></td><td id='"+data.valor_total+"'></td></tr><tr>\
                            <td><b>Data do pagamento</b></td><td id='"+data.data_liberacao+"'></td></tr></tbody></table>"
                    );
                }
            });
