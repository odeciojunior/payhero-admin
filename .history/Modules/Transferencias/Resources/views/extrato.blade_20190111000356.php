                ...
                <div class="nav-tabs-horizontal" data-plugin="tabs">
                    ...
                    <div class="tab-content pt-20">
                        <div class="tab-pane active" id="tab_saldo_futuro" role="tabpanel">
                            ...
                            <table id="tabela_saldo_futuro" class="table table-hover table-bordered" data-paging='true'>
                                <thead>
                                    <th>Data</th>
                                    <th>Status</th>
                                    <th>Valor</th>
        ...
        function atualizarTabelaSaldoFuturo(id_empresa){
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    (0, babelHelpers.interopRequireDefault(_jquery).default)('#tabela_saldo_futuro').footable();
