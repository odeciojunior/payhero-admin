            ...
            <div class="modal fade example-modal-lg modal-3d-flip-vertical" id="modal_cancelar" aria-hidden="true" aria-labelledby="exampleModalTitle" role="dialog" tabindex="-1">
                <div class="modal-dialog modal-simple">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-danger" data-dismiss="modal">Fechar</button>
                            <button id="bt_cancelar" type="button" class="btn btn-success">Confirmar</button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                success: function(data){
                    ...
                    $.each(data, function(i, item) {
                        ...
                        if(data[i].status == "Transferência pendente"){
                            ...
                            dados_tabela += "<td><button type='button' class='btn btn-danger btn-sm cancelar_transferencia' transferencia='"+data[i].id+"'>Cancelar transferência</button></td>";
                        }
                        else{
                    ...
                    $(".cancelar_transferencia").on("click", function(){
                        ...
                        $("#bt_cancelar").on("click", function(){
                            ...
                            alert('cancelar '+id_transferencia);
                        });
                    });
                }
