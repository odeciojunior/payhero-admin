                ...
                <div style="border: 1px solid orange">
                    ...
                    <div class="card-block px-30 py-10">
                        <div class="row">
                            <div class="col-12">
                                <div class="blue-grey-700" style="font-size: 20px">
                                    <p id="label_saldo_antecipavel"></p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        function atualizarSaldos(id_empresa){
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    $('#label_saldo_disponivel').html(data.saldo_disponivel);
                    $('#label_saldo_futuro').html(data.saldo_futuro);
                    $('#label_saldo_antecipavel').html(data.saldo_antecipavel);
                }
