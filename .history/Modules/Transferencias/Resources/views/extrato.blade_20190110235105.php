...
@section('content')
                ...
                <div class="nav-tabs-horizontal" data-plugin="tabs">
                    ...
                    <div class="tab-content pt-20">
                        <div class="tab-pane active" id="tab_saldo_futuro" role="tabpanel">
                            ...
                            <div>
                                <button id="tabela_saldo_futuro_anterior" disabled>&lsaquo; Anterior</button>
                                <span id="tabela_saldo_futuro_numeracao"></span>
                                <button id="tabela_saldo_futuro_proximo" disabled>Próximo &rsaquo;</button>
                            </div>
                        </div>
  ...
  <script>
    ...
    $(document).ready(function(){
        ...
        var tabela_saldo_futuro_tamanho_pagina = 8;
        var tabela_saldo_futuro_pagina = 0;
