                                ...
                                <div class="col-5">
                                    <div style="border: 1px solid green">
                                        ...
                                        <div class="card-block px-30 py-10">
                                            <div class="row">
                                                <div class="col-12">
                                                    <div id="saldo_disponivel" class="blue-grey-700" style="font-size: 30px">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-5">
                                    <div style="border: 1px solid blue">
                                        ...
                                        <div class="card-block px-30 py-10">
                                            <div class="row">
                                                <div class="col-12">
                                                    <div id="saldo_futuro" class="blue-grey-700" style="font-size: 30px">
                                                        R$ {!! $saldo_futuro !!}
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="col-5">
                                    <div style="border: 1px solid grey">
                                        ...
                                        <div class="card-block px-30 py-10">
                                            <div class="row">
                                                <div class="col-12">
                                                    <div id="saldo_transferido" class="blue-grey-700" style="font-size: 30px">
                                                        R$ {!! $saldo_transferido !!}
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="col-5">
                                    <div style="border: 1px solid green">
                                        ...
                                        <div class="card-block px-30 py-10">
                                            <div class="row">
                                                <div class="col-12">
                                                    <div id="saldo_antecipavel" class="blue-grey-700" style="font-size: 30px;padding: 10px 0 10px 0">
                                                        R$ {!! $saldo_antecipavel !!}
                                                    </div>
                                                </div>
                                            </div>
