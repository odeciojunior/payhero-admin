  ...
  <div class="page">
    ...
    <div class="page-content container-fluid">
        <div class="panel pt-30 p-30" data-plugin="matchHeight">
                ...
                <div class="col-4">
                    <div class="card card-shadow" style="border: 1px solid green">
                        ...
                        <div class="card-block px-30 py-10">
                            <div class="row">
                                <div class="col-9">
                                    <div class="blue-grey-700" style="margin-top: 20px; font-size: 30px">
                                        R$ 2.899,44
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-4">
                    <div class="card card-shadow" style="border: 1px solid orange">
            ...
            <div class="row">
                <div class="col-4">
                    <div class="card card-shadow" style="border: 1px solid gray">
                        <div class="card-header bg-gray-600 white px-30 py-10">
