...
class Produto extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['user', 'categoria', 'nome', 'descricao', 'garantia', 'quantidade', 'disponivel', 'formato', 'created_at', 'updated_at', 'custo_produto', 'foto', 'deleted_at', 'altura', 'largura', 'peso'];
