...
class UpdateUserAccomplishedTasks extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'tasks:update-accomplished-tasks';
     ...
     * @var string
     */
    protected $description = 'This command updates user\'s accomplished tasks';
