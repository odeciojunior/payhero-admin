...
class MappingCronTasks extends Command
{
                        ...
                        switch ($task["frequently"]) {
                            case "Min":
                                if ($task["interval"] > 0) {
                                    ...
                                    $dateFormat ==
                                    str_pad($task["hour"], 2, "0", STR_PAD_LEFT) .
                                        ":" .
                                        str_pad($task["min"], 2, "0", STR_PAD_LEFT)
                                ) {
                                    $total++;
                                    $commands[] = $task["command"];
                                }
    ...
    public function getManuallyCronTasks()
    {
        return [
            ...
            [
                "command" => "generate:notazzinvoicessalesapproved",
                "time" => "00:00",
                "repeat" => 30,
                "frequently" => "min",
            ],
            ...
            [
                "command" => "getnet:get-all-statement-chargebacks",
                "time" => "07:00",
                "repeat" => 1,
                "frequently" => "day",
            ],
            ...
            [
                "command" => "getnet:update-confirm-date-debt-pending",
                "time" => "04:00",
                "repeat" => 1,
                "frequently" => "day",
            ],
            ...
            [
                "command" => "getnet:check-withdrawals-liquidated",
                "time" => "10:00",
                "repeat" => 1,
                "frequently" => "day",
            ],
            ...
            [
                "command" => "getnet:import-sale-contestations-txt-format",
                "time" => "16:00",
                "repeat" => 1,
                "frequently" => "day",
            ],
            ...
            [
                "command" => "command:UpdateListsFoxActiveCampaign",
                "time" => "00:00",
                "repeat" => 720,
                "frequently" => "min",
            ],
            [
                "command" => "antifraud:backfill-asaas-chargebacks",
                "time" => "00:00",
                "repeat" => 60,
                "frequently" => "min",
            ],
