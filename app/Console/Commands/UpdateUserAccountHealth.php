...
class UpdateUserAccountHealth extends Command
{
    ...
    public function handle()
    {
        ...
        $output = [];
        $users = [
            26, 557, 577, 42, 109, 152, 153, 154, 2366
...
//            3301, 3420,
        ...
        foreach ($users as $id) {
            ...
            $output[$id][] = 'partial account health: ' . ($accountHealthService->getTrackingScore($user) + $accountHealthService->getChargebackScore($user)) / 2;
        }
        dd($output);
