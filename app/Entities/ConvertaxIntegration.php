...
class ConvertaxIntegration extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['project_id', 'user_id', 'link', 'value', 'boleto_generated', 'boleto_paid', 'credit_card_refused', 'credit_card_paid', 'abandoned_cart', 'created_at', 'updated_at', 'deleted_at'];
