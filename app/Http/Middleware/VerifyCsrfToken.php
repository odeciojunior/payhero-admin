...
class VerifyCsrfToken extends Middleware
{
    ...
    protected $except = [
        ...
        '/brindes/deletarbrinde',
        '/brindes/editarbrinde',
        '/pixels/cadastrarpixel',
        '/pixels/getformeditarpixel',
        '/pixels/editarpixel',
        '/brindes/getformeditarbrinde',
        '/brindes/cadastrarbrinde',
        '/brindes/getformaddbrinde',
        '/brindes/data-source',
        ...
        '/postback/*',
        '/checkout',
        '/invitations/obterconvite',
        '/invitations/obterconvitehubsmart'
    ];
}
