@extends('layouts.auth')
 ...
 @section('title', '- Login')
    @section('content')
    <div class="page vertical-align text-center" data-animsition-in="fade-in" data-animsition-out="fade-out" style="background-image: linear-gradient(to right, #FFA500, #D2691E);">
