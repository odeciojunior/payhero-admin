        ...
        <div class="content-holder">
            <div class="page-content d-flex flex-column justify-content-center">
                <div class="logobar text-center">
                    <img src="{{ asset('modules/global/adminremark/assets/images/logo-oficial.svg') }}"
                         alt="CloudFox">
                </div>
                    ...
                    <div id="panel-login">
                        ...
                        <form autocomplete="off"
                            ...
                            <button type="submit"
                                    ...
                                    class="btn btn-primary orange"> Change
                            </button>
                            <div class="btnfix"></div>
                        </form>
                    </div>
                    <div id="panel-recover"
                         style="display:none;">
                        ...
                        <div class="form-group">
                            <button id='send_recovery_link'
                                    type="submit"
                                    value="Entrar com e-mail"
                                    class="btn btn-primary orange"> Send recover link
                            </button>
                        </div>
                        <div class="btnfix"></div>
                        <div class="text-left">
                            <a id="backLogin"
                               role="button"
                               class="sm-text d-flex align-items-center">
                ...
                <div class="d-flex justify-content-center align-items-center">
                    ...
                    <a class="linkfooter"
                       href="#"
                       style="font-size: 11px"> Support</a>
                </div>
                <div class="clearfix"></div>
            </div>
        </div>
