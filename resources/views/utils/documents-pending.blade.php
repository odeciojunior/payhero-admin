                ...
                <div id="new-register-steps-container">
                            ...
                            <div id="new-register-step-1-container" class="p-4">
                                ...
                                <div class="step-1-options-container">
                                    <div class="d-flex flex-column align-items-center">
                                        <div id="step-1-dropshipping-import" class="step-1-option" data-step-1-value="dropshipping-import" data-step-1-selected="0">
                                    ...
                                    <div class="d-flex flex-column align-items-center">
                                        <div id="step-1-physical-product" class="step-1-option" data-step-1-value="physical-product" data-step-1-selected="0">
                                    ...
                                    <div class="d-flex flex-column align-items-center">
                                        <div id="step-1-digital-product" class="step-1-option" data-step-1-value="digital-product" data-step-1-selected="0">
                                    ...
                                    <div class="d-flex flex-column align-items-center">
                                        <div id="step-1-classes" class="step-1-option" data-step-1-value="classes" data-step-1-selected="0">
                                    ...
                                    <div class="d-flex flex-column align-items-center">
                                        <div id="step-1-subscriptions" class="step-1-option" data-step-1-value="subscriptions" data-step-1-selected="0">
                                            <svg class="svg-icon-2" xmlns="http://www.w3.org/2000/svg" width="66" height="66" viewBox="0 0 66 66" fill="none">
                                    ...
                                    <div class="d-flex flex-column align-items-center">
                                        <div id="step-1-others" class="step-1-option" data-step-1-value="others" data-step-1-selected="0">
                                            <svg class="svg-icon-2" xmlns="http://www.w3.org/2000/svg" width="56" height="66" viewBox="0 0 56 56" fill="none">
                    ...
                    <div id="new-register-steps-actions" class="d-flex justify-content-between flex-wrap-reverse">
                        <div class="d-flex justify-content-center finish-later-container">
                            <button type="button" class="btn new-register-btn close-modal align-self-center">Terminar depois</button>
                        </div>
