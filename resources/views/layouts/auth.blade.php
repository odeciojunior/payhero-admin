...
<head>
    ...
    <!-- Styles -->
    <link rel="stylesheet"
          href="{{ asset('modules/global/adminremark/assets/css/bootstrap.min.css') }}">
    <link rel="stylesheet"
          href="{{ asset('modules/global/adminremark/assets/css/new-login.css') }}">
    <link rel='stylesheet'
          href="{{ mix('modules/global/css/sweetalert2.min.css') }}">
    <link rel="stylesheet"
          href="{{ mix('modules/global/css/loading.min.css') }}">
    <!-- Scripts -->
...
<body style='background:none;padding:0%'>
    <img src="{{ asset('modules/global/adminremark/assets/images/gradient-bg.png') }}"
    ...
    <!-- <script src="{{ asset('modules/global/adminremark/global/vendor/babel-external-helpers/babel-external-helpers.js') }}">
    </script>
    ...
    <script src="{{ asset('modules/global/adminremark/global/vendor/slidepanel/jquery-slidePanel.js') }}"></script>
        <script src="{{ asset('modules/global/adminremark/global/vendor/jquery-placeholder/jquery.placeholder.js') }}">
        </script>
