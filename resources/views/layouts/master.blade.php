...
<!-- access token used for api ajax requests -->
    ...
    <link rel="stylesheet" href="{{ asset('modules/global/css/loading.css?v=3') }}">
...
<body class="animsition site-navbar-small dashboard site-menubar-fold site-menubar-hide site-menubar-hover">
...
<script src="{{ asset('modules/global/js/global.js?v=22') }}"></script>
<script>
