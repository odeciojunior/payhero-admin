...
<head>
    ...
    @endphp
    <meta name="user-id" content="{{ hashids_encode($user_id) }}">
    <!-- Favicon -->
...
<body class="animsition site-navbar-small dashboard site-menubar-fold site-menubar-hide">
    ...
    <noscript>
        <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KDD46QX" height="0" width="0" style="display:none;visibility:hidden"></iframe>
    </noscript>
        ...
        <div class="top-alert warning col-sm-12 col-md-5" id="document-pending" style="display:none;">
            <div class="top-alert-message-container">
                ...
                <div class="col-8 pr-20 d-flex flex-wrap">
                    ...
                    <a href="/companies" data-url-value="/companies" class="top-alert-action redirect-to-accounts">Corrigir
                        documento</a>
                </div>
    ...
    <script>
        @if(\Auth::user())
            ...
            })(window, document, 'script', 'https://app.mais.im/support/assets/js/core/embed.js',
                '273c7ff74192d8dac2ef370dc930d643');
        @endif
    </script>
