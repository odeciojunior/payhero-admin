    ...
    <div class="row no-gutters ml-auto">
        ...
        <div class="row no-gutters d-flex justify-content-end">
            ...
            <div class="row no-gutters d-flex" id="site-navbar-collapse">
                ...
                <div class="bonus-balance-menu d-flex justify-content-center align-items-center">
                    <button id="bonus-balance" class="bonus-balance-button desktop justify-content-center align-items-center" style="display: none; margin-right: 0px; margin-left: 17px">
                ...
                <div id="my-iframe" class="announcekit-widget d-none d-sm-flex align-items-center justify-content-center" style="padding-right: 10px">
                    <span class="nav-link navbar-avatar" data-toggle="dropdown" title="Novidades" id='notification' aria-expanded="false" data-animation="scale-up" role="button" style='padding-right: 10px'>
                ...
                <ul class="nav navbar-toolbar navbar-right navbar-toolbar-right">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <!-- FOTO DO USUARIO -->
                        <a class="nav-link navbar-avatar pr-10 pr-sm-35" data-toggle="dropdown" href="#" aria-expanded="false" data-animation="scale-up" role="button" style="margin-left: -2px;">
                            <span class="avatar avatar-online">
                                <img class='img-user-menu-principal' src="{!! \Auth::user()->photo
                                    ? \Auth::user()->photo
                                    : 'https://cloudfox-documents.s3.amazonaws.com/cloudfox/defaults/user-default.png' !!}" onerror="this.onerror=null; this.src='https://cloudfox-documents.s3.amazonaws.com/cloudfox/defaults/user-default.png'" alt="" title="">
                                <i></i>
                            </span>
                        </a>
                        ...
                        <div id="dropdown_profile_card" class="dropdown-menu" role="menu">
                            ...
                            <a class="dropdown-item disabled" disabled>
                                <img height="24" width="24" src="{{ mix('build/global/img/icon-info.svg') }}" />
                                {{auth()->user()->name}}
                            </a>
