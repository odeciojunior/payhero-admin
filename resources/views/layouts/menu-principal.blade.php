        ...
        <ul class="nav navbar-toolbar navbar-right navbar-toolbar-right">
            <li id="notifications_button" class="nav-item dropdown">
              <a class="nav-link" data-toggle="dropdown" href="javascript:void(0)" title="Notifications"
                ...
                <svg version="1.1" class="topbar-icon mr-0" id="Camada_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
...
<path class="st0" d="M15,1.7C7.4,1.7,1.3,7.9,1.3,15.4S7.4,29.1,15,29.1c0.4,0,0.8,0,1.2-0.1c0.4,0,0.8-0.1,1.1-0.2l0.1,0
	...
	v-3c0-3.3-2.7-5.9-5.9-5.9h-6.4c-3.3,0-5.9,2.7-5.9,5.9v3C1,19.4,1,11.3,6,6.4c5-4.9,13-4.9,18,0C29,11.3,29,19.4,24.1,24.4
	L24.1,24.4z"/>
<path class="st0" d="M15,5.4c-2.5,0-4.6,2-4.6,4.6s2,4.6,4.6,4.6s4.6-2,4.6-4.6C19.6,7.4,17.5,5.4,15,5.4z M15,13.6
	c-2,0-3.7-1.6-3.7-3.7S13,6.3,15,6.3s3.7,1.6,3.7,3.7C18.6,12,17,13.6,15,13.6z"/>
</svg>
