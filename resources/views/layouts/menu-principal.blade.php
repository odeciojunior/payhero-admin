...
<nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega" role="navigation"
    ...
    <div class="navbar-brand navbar-brand-center site-gridmenu-toggle" data-toggle="gridmenu">
        ...
        <img id="logoSirius" class="navbar-brand-logo d-none logo-sirius"
            src="{{ mix('build/global/img/logos/2021/svg/sirius-logo.svg') }}" width="100">
    </div>
            ...
            <div class="row no-gutters d-flex" id="site-navbar-collapse">
                ...
                <ul class="nav navbar-toolbar navbar-right navbar-toolbar-right">
                    ...
                    @hasanyrole('account_owner|admin')
                        ...
                        <li id="notifications_button" class="nav-item dropdown" disabled='true'>
                            ...
                            <span class="nav-link navbar-avatar" data-toggle="dropdown" title="Notificações"
                                id='notification' aria-expanded="false" data-animation="scale-up" role="button"
                            ...
                            <div id="notifications_card" class="dropdown-menu dropdown-menu-right dropdown-menu-media ">
                                <div id='notificationTemplate' class="scrollable-content"
                                    img-empty="{!! mix('build/global/img/notificacoes.svg') !!}" style="scrollbar-width:thin;"></div>
                            </div>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <!-- FOTO DO USUARIO -->
                        <a class="nav-link navbar-avatar pr-10 pr-sm-25" data-toggle="dropdown" href="#"
