...
<nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega" role="navigation"
    ...
    <button type="button" class="navbar-toggler hamburger hamburger-close hamburger-arrow-left navbar-toggler-left hided"
        data-toggle="menubar">
    ...
    <div class="navbar-brand navbar-brand-center site-gridmenu-toggle cloudfox-logo-desktop site-menubar"
        ...
        <img id="logoSirius" class="navbar-brand-logo d-none logo-sirius"
            src="{{ mix('build/global/img/logos/2021/logo-primary.png') }}" height="26"
    ...
    <div class="navbar-brand navbar-brand-center site-gridmenu-toggle cloudfox-logo-mobile" data-toggle="gridmenu">
        <img id="logoIconSirius" class="navbar-brand-logo"
            src="{{ mix('build/global/img/logos/2021/svg/icon-secundary.svg') }}" style="height:  2.7rem;">
    </div>
        ...
        <div class="row no-gutters d-flex justify-content-end">
            ...
            <div class="row no-gutters d-flex" id="site-navbar-collapse">
                ...
                <div id="my-iframe"
                    ...
                    <span class="nav-link navbar-avatar" data-toggle="dropdown" title="Novidades" id='notification'
                        aria-expanded="false" data-animation="scale-up" role="button" style='padding-right: 10px'>
                        <!--  style='cursor:pointer; padding-right: .0rem' -->
                        <img class="svg-menu" src="{{ mix('build/global/img/svg/notificacao.svg') }}"
                            alt="Novidades">
                    </span>
                </div>
                ...
                <ul class="nav navbar-toolbar navbar-right navbar-toolbar-right">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <!-- FOTO DO USUARIO -->
                        <a class="nav-link navbar-avatar pr-10 pr-sm-35" data-toggle="dropdown" href="#"
                            aria-expanded="false" data-animation="scale-up" role="button"
                            style="margin-left: -2px;">
                            <span class="avatar avatar-online">
                                <img class='img-user-menu-principal' src="{!! \Auth::user()->photo
                                    ? \Auth::user()->photo
                        ...
                        <div id="dropdown_profile_card" class="dropdown-menu" role="menu">
                            ...
                            @else
                                <a id="accounts-service" class="dropdown-item redirect-to-accounts" href=""
                                    data-url-value="" role="menuitem">
                                    <img height="24" width="24"
                                        src="{{ mix('build/global/img/svg/settings.svg') }}" />
                                    Configurações
                                </a>
...
<div class="site-menubar">
    <ul class="site-menu" style="margin-top:10px">
        ...
        <!-- hasanyrole('account_owner|admin|attendance|finantial') -->
        @if (auth()->user()->hasAnyPermission(['report_sales', 'report_coupons', 'report_pending', 'report_blockedbalance']))
            <li class="site-menu-item has-sub">
        ...
        @if (auth()->user()->hasRole('account_owner') ||
            ...
            <li class="site-menu-item has-sub">
                <a href="javascript:void(0)" id="api-sirius-link">
                    <span class="bg-menu">
                        <img src="{{ mix('build/global/img/svg/api-sirius-menu.svg') }}" alt="Dev">
                    </span>
