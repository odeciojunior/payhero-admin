$(document).ready(function () {
    ...
    $('.close-bonus-modal').on('click', function() {
...
function loadBonusBalanceTotal() {
    setTimeout(()=>{
        $('#total-bonus-balance').html('R$ 99.9999,99')
    },2000);
}


function loadBonusData(display) {
    ...
    if(display == 'block'){
        ...
        var userName = 'Pedro';
        var totalBalance = '99.999,99';
        var alreadyUsed = '99.999,99';
        ...
        content = `
            <div class="bonus-balance-content">
                ...
                <div class="bonus-text">
                    ...
                    <h3 class="bonus-title"><span id="bonus-username">${userName}</span>, aqui está seu <b>desconto!</b></h3>


                    <p>
                        Você tentou sua sorte e conseguiu <span id="total-bonus-balance" class="bold">R$${totalBalance}</span> em
                        desconto nas taxas da sua venda. Obrigado pela 
