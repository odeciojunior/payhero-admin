...
$(document).ready(function () {
    ...
    $("#accordion_boleto").on("click", function () {
        if ($("#accordion_boleto").parent().hasClass("open")) {
            ...
            if (
                !$("#accordion_boleto").parent().hasClass("open") &&
                !$("#accordion_cartao").parent().hasClass("open")
            ) {
                $("#accordion_cartao").click();
            }
        }
    ...
    $("#card-number").on("input", function () {
        $("#card-number").validateCreditCard(function (result) {
            ...
            if (result.card_type.name == "amex") {
                ...
                $("#cartao_logo").html(
                    "<img src='" + path_dinners_card + "' alt=' ' style='height: 40px; width: 70px'>"
                );
                ...
                $("#cartao_logo").html(
                    "<img src='" + path_hipercard_card + "' alt=' ' style='height: 40px; width: 70px'>"
                );
            } else if (result.card_type.name == "mastercard" || result.card_type.name == "maestro") {
                $("#cartao_logo").html(
                    "<img src='" + path_master_card + "' alt=' ' style='height: 40px; width: 70px'>"
                );
