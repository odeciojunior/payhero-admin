$(document).ready(function () {
    ...
    if (current_url.includes("dashboard")) {
        $("#dashboard_img").attr("src", "/build/global/img/icon-red/dashboard-d.svg");
        ...
        $("#showcase_img").attr("src", "/build/global/img/icon-red/vitrine-d.svg");
        $("#showcase_img").parent().parent().addClass("menu-active");
        $("#showcase_img").css("height", "28px").css("width", "28px").css("margin-left", "-5px");
    } else if (
        current_url.includes("sales") ||
        current_url.includes("recoverycart") ||
        current_url.includes("trackings")
    ) {
        $("#sales_img").attr("src", "/build/global/img/icon-red/vendas-d.svg");
        ...
        $("#projects_img").attr("src", "/build/global/img/icon-red/projetos-d.svg");
        ...
        $("#products_img").attr("src", "/build/global/img/icon-red/produtos-d.svg");
        ...
        $("#attendance_img").attr("src", "/build/global/img/icon-red/atendimento-d.svg");
        ...
        $("#affiliate_img").attr("src", "/build/global/img/icon-red/afiliados-d.svg");
        ...
        $("#finances_img").attr("src", "/build/global/img/icon-red/financas-d.svg");
        ...
        $("#reports_img").attr("src", "/build/global/img/icon-red/ferramentas-d.svg");
        ...
        $("#apps_img").attr("src", "/build/global/img/icon-red/aplicativos-d.svg");
        ...
        $("#invitations_img").attr("src", "/build/global/img/icon-red/convites-d.svg");
...
function loadOnModal(whereToLoad) {
    ...
    $(whereToLoad).append(
        "<div id='loaderModal' class='loadingModal'>" + "<div class='loaderModal'>" + "</div>" + "</div>"
    );
