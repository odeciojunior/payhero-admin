$(function () {
                ...
                $("#bt-change-shopify-integration").on("click", function (event) {
                    ...
                    if (integrationStatus == 2) {
                        ...
                        $("#modal-change-shopify-integration-text").html(
                            "Ao realizar essa operação os pagamentos não serão processados pelo checkout do CloudFox"
                        );
                    } else if (integrationStatus == 3) {
                        $("#modal-change-shopify-integration-title").html("Integrar com shopify?");
                        $("#modal-change-shopify-integration-text").html(
                            "Ao realizar essa operação os pagamentos serão processados pelo checkout do CloudFox"
                        );
                    }
    ...
    if ($("#shopifyIdLabel").data("shopifyid") != "") {
        $("#segundaInfo").html(
            "Digite o nome do seu domínio cadastrado no shopify (Ex: minhaloja.com) e <strong>clique em salvar</strong>"
        );
    } else {
        $("#segundaInfo").html(
            "Digite o nome do seu <strong>domínio e o IP do servidor</strong> onde seu site está hospedado."
        );
    }
