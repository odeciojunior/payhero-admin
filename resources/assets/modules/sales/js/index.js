            ...
            success: function (response) {
                ...
                $.each(response.data, function (index, value) {
                    ...
                    dados +=
                        ...
                        value.id +
                        "' data-target='#modal_detalhes' data-toggle='modal' style='margin-right:10px'><span class='o-eye-1'></span></button></a></td>";
                    dados += "</tr>";
                    $("#dados_tabela").append(dados);
                });
                if (response.data == "") {
                    $("#dados_tabela").html(
                        "<tr class='text-center'><td colspan='10' style='vertical-align: middle'><img src='" +
                            $("#dados_tabela").attr("img-empty") +
                            "'><br><br>Nenhuma venda encontrada</td></tr>"
                    );
                }
                pagination(response);
