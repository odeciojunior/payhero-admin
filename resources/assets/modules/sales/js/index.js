        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $.each(response.data, function (index, value) {
                    ...
                    dados += "<td><a role='button' class='detalhes_venda pointer' venda='" + value.id + "' data-target='#modal_detalhes' data-toggle='modal' style='margin-right:10px'><span class='o-eye-1'></span></button></a></td>";
                    dados += '</tr>';
