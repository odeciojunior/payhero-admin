    ...
    function updateBalances() {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $(".removeSpan").remove();
                $(".disponivelAntecipar").append(
                    '<span class="currency removeSpan">R$</span><span class="antecipable-balance removeSpan">0,00</span>'
                );
                $(".saldoDisponivel").html(
                    '<span class="currency">R$</span><span class="available-balance">0,00 <i class="material-icons ml-5" style="color: #44a44b;">arrow_forward</i></span>'
                );
                    ...
                    if (response.data.user_documents_status == "pending") {
                        ...
                        $("#modal_body").html(
                            '<div class="swal2-icon swal2-error swal2-animate-error-icon" style="display: flex;"><span class="swal2-x-mark"><span class="swal2-x-mark-line-left"></span><span class="swal2-x-mark-line-right"></span></span></div>' +
                                ...
                                '<h5 align="center">Deseja ir ao documentos? <a class="red pointer" href="' +
                                route +
                                '">clique aqui</a></h5>'
                        );
                        ...
                        $("#bt-confirm-withdrawal").on("click", function () {
                            ...
                            $.ajax({
                                    ...
                                    if (response.status === 422) {
                                        ...
                                        $("#modal_body").html(
                                            '<div class="swal2-icon swal2-error swal2-animate-error-icon" style="display: flex;"><span class="swal2-x-mark"><span class="swal2-x-mark-line-left"></span><span class="swal2-x-mark-line-right"></span></span></div>' +
                                                ...
                                                '<h4 align="center">' +
                                                String(response.responseJSON.message) +
                                                "</h4>" +
                                ...
                                success: function (response) {
                                    ...
                                    $("#modal-withdraw-footer").html(
                                        '<div style="width:100%;text-align:center;padding-top:3%"><span class="btn btn-success btn-return" data-dismiss="modal" style="font-size: 25px">Retornar</span></div>'
                                    );
