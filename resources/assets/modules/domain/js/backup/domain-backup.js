...
$("#tabela_dominios").DataTable({
    ...
    drawCallback: function () {
        ...
        $(".excluir_dominio").on("click", function () {
            ...
            $("#modal_excluir_titulo").html("Remover da loja o dominio " + name + "?");
                ...
                success: function (data) {
                    ...
                    $("#bt_adicionar_entrada").on("click", function () {
                        $("#novos_registros").after(
                            "<tr registro='" +
                                ...
                                "</td><td>" +
                                $("#valor_registro").val() +
                                "</td><td><button type='button' class='btn btn-danger remover_entrada'>Remover</button></td></tr>"
                        );

                        $("#editar_dominio").append(
                            '<input type="hidden" name="tipo_registro_' +
                                qtd_novos_registros +
                                '" id="tipo_registro_' +
                                qtd_novos_registros +
                                '" value="' +
                        ...
                        $("#editar_dominio").append(
                            '<input type="hidden" name="nome_registro_' +
                                qtd_novos_registros +
                                '" id="nome_registro_' +
                                qtd_novos_registros +
                                '" value="' +
                        ...
                        $("#editar_dominio").append(
                            '<input type="hidden" name="valor_registro_' +
                                qtd_novos_registros +
                                '" id="valor_registro_' +
                                qtd_novos_registros++ +
                                '" value="' +
                    ...
                    $("#editar").on("click", function () {
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                $(".loading").css("visibility", "hidden");
                                if (data == "sucesso") alertPersonalizado("success", "Domínio atualizado!");
                                else alertPersonalizado("error", data);
