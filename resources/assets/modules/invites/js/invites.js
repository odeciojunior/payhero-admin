$(document).ready(function () {
    ...
    $("#company").on("change", function () {
        $("#invite-link").val(
            "https://accounts.cloudfox.net/signup?i=" + $("#company option:selected").attr("invite-parameter")
        );
    });
            ...
            success: function (response) {
                if (isEmpty(response.data)) {
                    ...
                    $.each(response.data, function (index, value) {
                        ...
                        dados +=
                            '<td class="text-left" style="vertical-align: middle;"><button class="btn btn-floating btn-primary btn-sm" disabled>' +
                            (cont += 1) +
                            "</button></td>";
                        dados +=
        ...
        $.ajax({
            ...
            success: function (response) {
                if (isEmpty(response.data)) {
                    ...
                    linkInvite =
                        "https://accounts.cloudfox.net/signup?i=" + $("#select-company-list option:selected").val();
    ...
    function modalThenCompanies() {
        $("#mainModalBody").html(
            '<div id="modal-then-companies" class="modal-content"><div class="modal-header">' +
