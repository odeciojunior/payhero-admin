        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $.each(response.data, function (index, value) {
                    ...
                    dados +=
                        "<td style='vertical-align: middle' class=''><button class='btn btn-sm btn-outline btn-danger detalhes-frete'  frete='" +
                        value.shipping_id +
                        "' data-target='#modal-content' data-toggle='modal' type='button'><i class='icon wb-eye' aria-hidden='true'></i></button></td>";
                    dados +=
                        "<td style='vertical-align: middle' class=''><button class='btn btn-sm btn-outline btn-danger editar-frete'  frete='" +
                        value.shipping_id +
                        "' data-target='#modal-content' data-toggle='modal' type='button'><i class='icon wb-pencil' aria-hidden='true'></i></button></td>";
                    dados +=
                        "<td style='vertical-align: middle' class=''><button class='btn btn-sm btn-outline btn-danger excluir-frete'  frete='" +
                        value.shipping_id +
                        "'  data-toggle='modal' data-target='#modal-delete' type='button'><i class='icon wb-trash' aria-hidden='true'></i></button></td>";
                    dados += "</tr>";
                ...
                if (response.data == "") {
                    $("#dados-tabela-frete").html(
                        "<tr class='text-center'><td colspan='6' style='height: 70px; vertical-align: middle;'>Nenhum registro encontrado</td></tr>"
                    );
                }
