                ...
                if (response.data == '') {
                    ...
                    $.each(response.data, function (index, value) {
                        ...
                        data += "<td style='min-width:200px;'>" +
                            "<a role='button' class='details-pixel pointer mr-30'  pixel='" + value.id + "' data-target='#modal-content' data-toggle='modal' type='a'><span class='orion-icon-eye'></span> </a>" +
                            "<a role='button'class='edit-pixel pointer'  pixel='" + value.id + "' data-target='#modal-content' data-toggle='modal' type='a'><span class='orion-icon-edit'></span></a>" +
