                ...
                if (response.data == "") {
                    ...
                    $.each(response.data, function (index, value) {
                        ...
                        data +=
                            ...
                            "<a role='button' class='details-coupon pointer mr-30' coupon='" +
                            value.id +
                            "' data-target='#modal-content' data-toggle='modal'><span class='o-eye-1'></span> </a>" +
                            "<a role='button' class='edit-coupon pointer' coupon='" +
                            value.id +
                            "' data-target='#modal-content' data-toggle='modal'><span class='o-edit-1'></span> </a>" +
                            "<a role='button' class='delete-coupon pointer ml-30' coupon='" +
                            value.id +
                            "' data-target='#modal-delete' data-toggle='modal'><span class='orion-icon-lixo'></span> </a>";
                        ("</td>");
                        data += "</tr>";
    ...
    function pagination(response) {
        if (response.meta.last_page == 1) {
            ...
            for (x = 3; x > 0; x--) {
                ...
                $("#pagination-coupons").append(
                    "<button id='pagina_coupons_" +
            ...
            if (response.meta.current_page != 1 && response.meta.current_page != response.meta.last_page) {
                var pagina_atual_coupons =
                    "<button id='pagina_atual_coupons' class='btn nav-btn active'>" +
            ...
            if (response.meta.last_page != "1") {
                var ultima_pagina_coupons =
                    "<button id='ultima_pagina_coupons' class='btn nav-btn'>" + response.meta.last_page + "</button>";
