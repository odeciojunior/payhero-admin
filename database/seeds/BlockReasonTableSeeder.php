...
class BlockReasonTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        BlockReason::updateOrCreate(['reason_enum' => 4], ['reason' => 'O código não foi reconhecido por nenhuma transportadora']);
        BlockReason::updateOrCreate(['reason_enum' => 5], ['reason' => 'A data de postagem da remessa é anterior a data da venda']);
        BlockReason::updateOrCreate(['reason_enum' => 6], ['reason' => 'Já existe uma venda com o código de rastreio informado']);
