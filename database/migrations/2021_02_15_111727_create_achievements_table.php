    ...
    public function up()
    {
        ...
        DB::statement("INSERT INTO achievements (id, name, description, storytelling, icon, created_at)
                             VALUES ( 1, 'Velocidade da Luz',       'Faça entregas rápidas',                   'Apenas os vendedores com as entregas mais rápidas da galáxia ostentam esta medalha. Você deve efetuar suas entregas a bordo da USS Enterprise! Continue fazendo um ótimo trabalho.', 'https://cloudfox-documents.s3.amazonaws.com/cloudfox/defaults/VelocidadeLuz.png',      now()),
                                    ...
                                    (11, 'Lunático',                'Faça login por 21 dias',                  'Uma notícia boa e uma outra ótima: a boa é que você acaba de ganhar a medalha de Lunático por fazer login durante 21 dias. A ótima é que os lunáticos conseguem tudo o que querem!', 'https://cloudfox-documents.s3.amazonaws.com/cloudfox/defaults/Lunatico.png',           now()),
                                    (12, 'Ao Infinito e Além',      'Faça 50 vendas com Order Bump ou Upsell', 'Esta medalha rara é uma honraria do Comando Estelar para os valentes que conseguem fazer 50 vendas com Order Bump ou Upsell. Seria este o segredo do Buzz Lightyear? Só você poderá dizer!', 'https://cloudfox-documents.s3.amazonaws.com/cloudfox/defaults/AoInfinioAlem.png',      now());");
    }
