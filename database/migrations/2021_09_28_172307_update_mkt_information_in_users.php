    ...
    public function up()
    {
        ...
        foreach ($users as $user) {
            ...
            $user->mkt_information = [
                ...
                "niche" => is_array($mktInformation["niche"])
                    ? $mktInformation["niche"]
                    : json_decode($mktInformation["niche"], true),
                "store" => is_array($mktInformation["store"])
                    ? $mktInformation["store"]
                    : json_decode($mktInformation["store"], true),
                "cloudfox_referer" => is_array($mktInformation["cloudfox_referer"])
                    ? $mktInformation["cloudfox_referer"]
                    : json_decode($mktInformation["cloudfox_referer"], true),
            ];
