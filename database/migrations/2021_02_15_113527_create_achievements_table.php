...
class CreateAchievementsTable extends Migration
{
    ...
    public function up()
    {
        ...
        DB::statement("INSERT INTO achievements (id, name, description, storytelling, icon, created_at)
                             VALUES ( 1, 'Velocidade da Luz',       'Faça entregas rápidas',                  'Apenas os vendedores com as entregas mais rápidas da galáxia ostentam esta medalha. Você deve efetuar suas entregas a bordo da USS Enterprise! Continue fazendo um ótimo trabalho.', 'https://cloudfox-documents.s3.amazonaws.com/cloudfox/defaults/VelocidadeLuz.png',      now()),
                                    ( 2, 'Suporte Meteórico',       'Tenha um atendimento rápido',            'Problemas sempre acontecem, isso não é novidade alguma. Mas a sua velocidade em resolver cada um deles é surpreendente, você é digno de receber nossa honraria de Suporte Meteórico!', 'https://cloudfox-documents.s3.amazonaws.com/cloudfox/defaults/SuporteMeteorico.png',   now()),
                                    ...
                                    ( 4, 'Comerciante Celeste',     '+1000 vendas aprovadas no cartão',       'Apenas os Comerciantes Celestes, que dominam todas as regiões espaciais conseguem o feito de ter mais de 1000 vendas aprovadas no cartão. O céu é o limite... Não para você!', 'https://cloudfox-documents.s3.amazonaws.com/cloudfox/defaults/ComercianteCeleste.png', now()),
                                    ( 5, 'Poeira Estelar',          '100 vendas digitais aprovadas',          'Ao ultrapassar a marca de 100 vendas digitais aprovadas você prova que domina o necessário para cruzar o espaço. Aqui está a sua medalha de Poeira Estelar: seu sucesso está deixando rastros!', 'https://cloudfox-documents.s3.amazonaws.com/cloudfox/defaults/PoeiraEstelar.png',      now()),
                                    ( 6, 'Estrela Cadente',         '10 afiliados ativos',                    'Dizem que você dá sorte, mas na verdade, você dá oportunidades! Você recebe esta medalha ao recrutar 10 afiliados ativos em sua jornada. Até vender é mais divertido quando estamos acompanhados!', 'https://cloudfox-documents.s3.amazonaws.com/cloudfox/defaults/estrelaCadente.png',     now()),
                                    ( 7, 'Guerra nas Estrelas',     '50% de boletos aprovados',               'Um verdadeiro Jedi das conversões de boleto. Sábio, rápido, conhecedor das técnicas de vendas. Na galáxia dos negócios, boleto bom é boleto convertido e você teve 50% dos boletos aprovados!', 'https://cloudfox-documents.s3.amazonaws.com/cloudfox/defaults/GuerraNasEstrelas.png',  now()),
                                    ...
                                    (11, 'Lunático',                'Faça login por 21 dias',                 'Uma notícia boa e uma outra ótima: a boa é que você você acaba de ganhar a medalha de Lunático por fazer login durante 21 dias. A ótima é que os lunáticos conseguem tudo o que querem!', 'https://cloudfox-documents.s3.amazonaws.com/cloudfox/defaults/Lunatico.png',           now()),
                                    (12, 'Ao Infinito e Além',      'Faça 50 vendas com Orderbump ou Upsell', 'Esta medalha rara é uma honraria do Comando Estelar para os valentes que conseguem fazer 50 vendas com orderbump ou upsell. Seria este o segredo do Buzz Lightyear? Só você poderá dizer!', 'https://cloudfox-documents.s3.amazonaws.com/cloudfox/defaults/AoInfinioAlem.png',      now());");
    }
