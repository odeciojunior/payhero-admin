    ...
    public function up()
    {
        Schema::create("sale_informations", function (Blueprint $table) {
            ...
            $table
                ...
                ->comment("Sistema operacional do usuário")
                ->nullable();
            $table
                ->string("browser")
            ...
            $table
                ...
                ->comment("Valor total da transação")
                ->nullable()
                ->index();
            $table
                ->string("country")
                ->comment("País informado pelo comprador")
                ->nullable()
                ->index();
            $table
                ->string("zip_code")
            ...
            $table
                ...
                ->comment("Número da casa informada pelo comprador")
                ->nullable()
                ->index();
            $table
                ->string("card_token")
            ...
            $table
                ...
                ->comment("Número de parcelas na compra")
                ->nullable()
                ->index();
            $table
                ->unsignedInteger("first_six_digits")
                ->comment("Primeiros 6 dígitos do cartão")
                ->nullable()
                ->index();
            $table
