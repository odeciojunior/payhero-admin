...
class UpdateProjectNotifications extends Migration
{
    ...
    public function up()
    {
                ...
                [
                    ...
                    'message' => json_encode(
                        [
                            ...
                            'content' => 'Olá {primeiro_nome}, seu pagemento por PIX expirou, mas não se preocupe, você pode regerar o PIX de pagamento clicando no botão abaixo: ',
                        ]
                    ),
        ...
        $projectsStatusFalse = ProjectNotification::where('status', false)->whereIn('notification_enum', [11,12,13])->get();
