...
class CreateCheckoutConfigEachProject extends Migration
{
    ...
    public function up()
    {
        DB::statement("INSERT INTO checkout_configs (project_id, checkout_type_enum, checkout_logo_enabled, checkout_logo, countdown_enabled, countdown_time, countdown_description, countdown_finish_message, notifications_enabled, notifications_interval, notification_buying_enabled, notification_buying_minimum, notification_bought_30_minutes_enabled, notification_bought_30_minutes_minimum, notification_bought_last_hour_enabled, notification_bought_last_hour_minimum, notification_just_bought_enabled, notification_just_bought_minimum, social_proof_enabled, social_proof_message, social_proof_minimum, invoice_description, company_id, cpf_enabled, cnpj_enabled, credit_card_enabled, bank_slip_enabled, pix_enabled, quantity_selector_enabled, email_required, installments_limit, interest_free_installments, preselected_installment, bank_slip_due_days, automatic_discount_credit_card, automatic_discount_bank_slip, automatic_discount_pix, post_purchase_message_enabled, post_purchase_message_title, post_purchase_message_content, whatsapp_enabled, support_phone, support_phone_verified, support_email, support_email_verified, created_at, updated_at) (
                             SELECT p.id                                                                                                 AS project_id,
                                    p.checkout_type                                                                                      AS checkout_type_enum,
                                    p.logo is not null                                                                                   AS checkout_logo_enabled,
                                    ...
                                    up.company_id,
                                    p.document_type_checkout in (1, 3)                                                                   AS cpf_enabled,
                                    p.document_type_checkout in (2, 3)                                                                   AS cnpj_enabled,
