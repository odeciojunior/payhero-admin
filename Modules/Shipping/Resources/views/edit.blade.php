        ...
        <div class='form-group col-6 mb-0' id="shipping-multiple-value-edit" style="display: none">
            <div class="row">
                <div class='form-group col-12 mb-4' id="shipping-region-">
                    ...
                    <input  type='text' class='input-pad shipping-value1-edit' value='' placeholder='0' maxlength='7'>
            ...
            <div class="row">
                <div class='form-group col-12 mb-4' id="shipping-region-">
                    ...
                    <input  type='text' class='input-pad shipping-value2-edit' value='' placeholder='0' maxlength='7'>
                    <span id='shipping-value-error' class='text-danger'></span>
                </div>
            </div>
            <div class="row">
                <div class='form-group col-12 mb-4' id="shipping-region-">
                    ...
                    <input  type='text' class='input-pad shipping-value3-edit' value='' placeholder='0' maxlength='7'>
                    <span id='shipping-value-error' class='text-danger'></span>
                </div>
            </div>
            <div class="row">
                <div class='form-group col-12 mb-4' id="shipping-region-">
                    ...
                    <input  type='text' class='input-pad shipping-value4-edit' value='' placeholder='0' maxlength='7'>
                    <span id='shipping-value-error' class='text-danger'></span>
                </div>
            </div>
            <div class="row">
                <div class='form-group col-12 mb-0' id="shipping-region-">
                    ...
                    <input  type='text' class='input-pad shipping-value5-edit' value='' placeholder='0' maxlength='7'>
                    <span id='shipping-value-error' class='text-danger'></span>
                </div>
            </div>
