...
<form id='form-update-shipping' enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class='form-group mb-0 zip-code-origin-shipping-row' style="display: block">
            ...
            <div class='form-group shipping-not-apply-plans-edit-container'>
                ...
                <select name="not_apply_on_plans[]" id="shipping-not-apply-plans-edit"
        ...
        <div class="col-md-6">
            ...
            <div class="switch-holder">
                ...
                <br>
                <label class="switch">
                    <input type="checkbox" checked class="check shipping-regions-edit" value="1">
                    <span class="slider round"></span>
                </label>
            </div>
            <div class="form-group" id="shipping-single-value-edit">
            ...
            <div id="shipping-multiple-value-edit" style="display:none">
                <div class="row">
                    <div class="form-group col-6" id="shipping-region-">
                        <label for="value">Valor para o Norte</label>
                        <input name="value1" type="text" class="input-pad shipping-value1-edit shipping-money-format"
                               value="" placeholder="0" maxlength="7">
                        <span id="shipping-value-error" class="text-danger"></span>
                    </div>
                    <div class="form-group col-6" id="shipping-region-">
                        <label for="value">Valor para o Nordeste</label>
                        <input name="value2" type="text" class="input-pad shipping-value2-edit shipping-money-format"
                               value="" placeholder="0" maxlength="7">
                        <span id="shipping-value-error" class="text-danger"></span>
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-6" id="shipping-region-">
                        ...
                        <input name="value3" type="text" class="input-pad shipping-value3-edit shipping-money-format"
                               value="" placeholder="0" maxlength="7">
                        <span id="shipping-value-error" class="text-danger"></span>
                    </div>
                    <div class="form-group col-6" id="shipping-region-">
                        <label for="value">Valor para o Sudeste</label>
                        <input name="value4" type="text" class="input-pad shipping-value4-edit shipping-money-format"
                               value="" placeholder="0" maxlength="7">
                        <span id="shipping-value-error" class="text-danger"></span>
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-6" id="shipping-region-">
                        ...
                        <input name="value5" type="text" class="input-pad shipping-value5-edit shipping-money-format"
                               value="" placeholder="0" maxlength="7">
                        <span id="shipping-value-error" class="text-danger"></span>
                    </div>
                </div>
...
@if(false)
    <form id='form-update-shipping' enctype="multipart/form-data">
        ...
        <div class='row value-shipping-row' style="display:none">
            ...
            <div class='form-group col-6 mb-0' id="shipping-multiple-value-edit"
                 style="display: none; position: relative;">

                <div class="row">
                    <div class='form-group col-12 mb-4' id="shipping-region-">
                        <label for='value'>Valor do frete para o Norte</label>
                        <input type='text' class='input-pad shipping-value1-edit shipping-money-format' value=''
                               placeholder='0' maxlength='10'>
                        <span id='shipping-value-error' class='text-danger'></span>
                    </div>
                </div>
                <div class="row">
                    <div class='form-group col-12 mb-4' id="shipping-region-">
                        ...
                        <input type='text' class='input-pad shipping-value2-edit shipping-money-format' value=''
                               placeholder='0' maxlength='10'>
                        <span id='shipping-value-error' class='text-danger'></span>
                    </div>
                </div>
                <div class="row">
                    <div class='form-group col-12 mb-4' id="shipping-region-">
                        ...
                        <input type='text' class='input-pad shipping-value3-edit shipping-money-format' value=''
                               placeholder='0' maxlength='10'>
                        <span id='shipping-value-error' class='text-danger'></span>
                    </div>
                </div>
                ...
                left: 286px;">
                    <div class="row">
                        <div class='form-group col-12 mb-4' id="shipping-region-">
                            ...
                            <input type='text' class='input-pad shipping-value4-edit shipping-money-format' value=''
                                   placeholder='0' maxlength='10'>
                            <span id='shipping-value-error' class='text-danger'></span>
                        </div>
                    </div>
                    <div class="row">
                        <div class='form-group col-12 mb-0' id="shipping-region-">
                            ...
                            <input type='text' class='input-pad shipping-value5-edit shipping-money-format' value=''
                                   placeholder='0' maxlength='10'>
                            <span id='shipping-value-error' class='text-danger'></span>
                        </div>
                    </div>
