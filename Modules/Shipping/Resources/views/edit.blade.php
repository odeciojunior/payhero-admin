...
<form id="form-update-shipping" enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="form-group zip-code-origin-shipping-row" style="display: block">
        ...
        <div class="col-md-6">
            ...
            <div class="d-flex">
                ...
                <div class="switch-holder w-full">
                    <label for="use-variants">Usar variantes</label>
                    <br>
                    <label class="switch">
                        <input name="use-variants" value="1" class="check shipping-use-variants" type="checkbox"
                               checked>
                        <span class="slider round"></span>
                    </label>
                </div>
