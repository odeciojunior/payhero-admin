...
<div id="pagination-container-shipping" class="d-none justify-content-center justify-content-md-end mb-50">
    <ul id="pagination-shippings" class="pagination-sm text-right m-0 pagination-style">
        {{-- js carrega... --}}
    </ul>
</div>
