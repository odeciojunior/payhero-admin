            ...
            <div class='d-flex align-items-center'>
                <div class='col-sm-12'>
                    <div class="d-flex justify-content-end">
                        <div class="btn-holder add-shipping d-flex align-items-center pointer"
                             data-toggle="modal"
                             data-target="#modal-create-shipping">
        ...
        <div class="modal-content p-10">
            <div class="modal-header simple-border-bottom mb-10">
                <h4 class="modal-title"
                    id="modal-title">Detalhes do frete</h4>
...
<!-- Create -->
<div id="modal-create-shipping"
     class="modal fade modal-new-layout"
     role="dialog"
     tabindex="-1">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title bold"
                    id="modal-title">Cadastrar frete</h4>
                <button type="button"
                        class="close"
                        data-dismiss="modal"
                        aria-label="Close">
            ...
            <div class="modal-footer">
                <button type="button"
                        id="btn-mobile-modal-close"
                        class="btn btn-lg btn-default mr-3"
                        data-dismiss="modal">
                    Fechar
                </button>
                <button type="button"
...
<div id="modal-edit-shipping"
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title bold"
                    id="modal-title">Editar frete</h4>
                <button type="button"
                        class="close"
                        data-dismiss="modal"
                        aria-label="Close">
            ...
            <div class="modal-footer">
                ...
                <button type="button"
                        class="btn btn-lg btn-primary btn-update"
                        data-dismiss="modal">
                    Salvar
                </button>
            </div>
