@push('css')
    <link rel="stylesheet"
          href="{{ mix('build/layouts/shipping/create.min.css') }}">
@endpush

<form id="form-add-shipping">
    @csrf
    <input name="regions_values"
           id="regions_values"
           type="hidden">
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <select name="type"
                    ...
                    <option value="static"
                            selected>Frete fixo (você define um valor fixo para o frete)</option>
            ...
            <div class="form-group information-shipping-row">
                ...
                <input name="information"
                       ...
                       maxlength="100">
                <span id="shipping-information-error"
                      class="text-danger"></span>
            </div>
            ...
            <div class="value-shipping-row">
                <div class="switch-holder">
                    ...
                    <label class="switch">
                        <input type="checkbox"
                               checked
                               class="check shipping-regions"
                               value="1">
                        <span class="slider round"></span>
                    </label>
                </div>
                <div class="form-group"
                     id="shipping-single-value">
                ...
                <div id="shipping-multiple-value"
                     style="display:none">
                    <div class="row">
                        <div class="form-group col-6"
                            ...
                            <input name="value1"
                                   type="text"
                                   class="input-pad shipping-value1 shipping-money-format"
                                   value=""
                                   placeholder="R$ 0,00"
                                   maxlength="8">
                            <span id="shipping-value-error"
                        ...
                        <div class="form-group col-6"
                            ...
                            <input name="value2"
                                   type="text"
                                   class="input-pad shipping-value2 shipping-money-format"
                                   value=""
                                   placeholder="R$ 0,00"
                                   maxlength="8">
                            <span id="shipping-value-error"
                    ...
                    <div class="row">
                        <div class="form-group col-6"
                            ...
                            <input name="value3"
                                   type="text"
                                   class="input-pad shipping-value3 shipping-money-format"
                                   value=""
                                   placeholder="R$ 0,00"
                                   maxlength="8">
                            <span id="shipping-value-error"
                        ...
                        <div class="form-group col-6"
                            ...
                            <input name="value4"
                                   type="text"
                                   class="input-pad shipping-value4 shipping-money-format"
                                   value=""
                                   placeholder="R$ 0,00"
                                   maxlength="8">
                            <span id="shipping-value-error"
                    ...
                    <div class="row">
                        <div class="form-group col-6"
                            ...
                            <input name="value5"
                                   type="text"
                                   class="input-pad shipping-value5 shipping-money-format"
                                   value=""
                                   placeholder="R$ 0,00"
                                   maxlength="8">
                            <span id="shipping-value-error"
        ...
        <div class="col-md-6">
            ...
            <div class="form-group shipping-plans-add-container">
                ...
                <select name="apply_on_plans[]"
                        id="shipping-plans-add"
                        class="form-control shipping-plans-add"
                        style="width:100%"
                        data-plugin="select2"
            ...
            <div class="form-group shipping-not-apply-plans-add-container">
                ...
                <select name="not_apply_on_plans[]"
                        id="shipping-not-apply-plans-add"
