            ...
            <div class="d-flex align-items-center">
                <div class="col-sm-12">
                    <div class="d-flex justify-content-end">
                        <div class="div-config d-flex align-items-center"
                             style="display: none; padding-right: 10px; border-right: 1px solid #EDEDED; margin-top: -20px; margin-bottom: -20px; margin-right: 20px;">
                            <div id="config-upsell"
                                 class="btn-holder d-flex align-items-center pointer">
                                <span class="link-button-dependent">Configurações </span>
                                <a class="rounded-add pointer"
                        ...
                        <div class="btn-holder add-upsell d-flex align-items-center pointer"
                             data-toggle="modal"
                             data-target="#modal_add_upsell">
    ...
    <div class="modal-dialog modal-lg d-flex justify-content-center">
        <div class="modal-content w-450"
            ...
            <div class="modal-footer"
                ...
                <button type="button"
                        class="btn btn-success bt-upsell-save"
                        style='display:none;'>Salvar</button>
                <button type="button"
                        class="btn btn-success bt-upsell-update"
    ...
    <div class="modal-dialog modal-lg d-flex justify-content-center">
        <div class="modal-content"
            ...
            <div class="modal-header mb-0">
                ...
                <h4 class="modal-title text-center"
                    style="font-weight: 700;">Configurações Upsell</h4>
            </div>
            ...
            <div class="modal-footer pt-0">
                <button type="button"
                        class="btn btn-success bt-upsell-config-update">Atualizar</button>
            </div>
        </div>
    </div>
</div>
...
<!-- Details -->
<div id="modal-detail-upsell"
     class="modal fade example-modal-lg"
     role="dialog"
     tabindex="-1">
        ...
        <div class="modal-content p-10">
            <div class="modal-header simple-border-bottom mb-10">
                <h4 class="modal-title"
                    id="modal-title">Detalhes do upsell</h4>
