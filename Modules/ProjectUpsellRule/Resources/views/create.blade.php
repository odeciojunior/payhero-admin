        ...
        <div class="row">
            <div class="form-group col-12 mb-10">
                ...
                <div class="d-flex input-group">
                    <input type="text" class="form-control" name="description" id="add_description_upsell" placeholder="Digite a descrição">
                </div>
            </div>
            <div class="form-group col-12 mb-10">
            ...
            <div class="col d-flex mb-10">
                <div class="switch-holder w-full">
                    ...
                    <br>
                    <label class="switch">
                        <input type="checkbox" name="active_flag" id="add_active_flag" class="check" value="1" checked>
                ...
                <div class="switch-holder w-full">
                    ...
                    <br>
                    <label class="switch">
                        <input type="checkbox" name="use_variants" class="use-variants-upsell check" value="1" checked>
                        <span class="slider round"></span>
                    </label>
                </div>
            </div>
            <div class="form-group col-12 mb-10">
                ...
                <select name="apply_on_shipping[]" id="add_apply_on_shipping" class="form-control" style="width:100%" multiple="multiple"></select>
            </div>
            <div class="form-group col-12 mb-10 apply-on-plan-container">
                <label for="add_apply_on_plans">Ao comprar o plano</label>
                <select name="apply_on_plans[]" id="add_apply_on_plans" class="form-control" style="width:100%" multiple="multiple"></select>
            </div>
            <div class="form-group col-12 mb-10 offer-plan-container">
                <label for="add_offer_on_plans">Oferecer o plano</label>
                <select name="offer_on_plans[]" id="add_offer_on_plans" class="form-control" style="width:100%" multiple="multiple"></select>
            </div>
        </div>
    </div>
</form>
