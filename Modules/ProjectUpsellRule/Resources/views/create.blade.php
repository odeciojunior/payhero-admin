        ...
        <div class="row">
            ...
            <div class="form-group col-12" >
                ...
                <div id="us_money_opt" class="input-group input-group-lg mb-3" >
                    ...
                    <input  maxlength="9" name="discount_value" id="us_discount_value" type="text" class=" input-pad form-control value-mask" placeholder="" aria-label="" aria-describedby="basic-addon1">
                </div>

                <div id="us_percent_opt" class="input-group-lg input-group mb-3" style="display: none;">

                    <input  maxlength="2" data-mask="0#" name="percent_value" id="us_percent_value" style="" type="text" class=" input-dad form-control" placeholder="" aria-label="" aria-describedby="basic-addon1" autocomplete="off">
