        ...
        <div class="d-flex justify-content-between align-items-center mb-45">
            <div>
                <h1 class="page-title my-10" style="min-height:28px">
                    <img src="{{ mix('build/global/img/svg/api-sirius.png') }}" style="height:40px;width:auto" alt="Webhooks">
            ...
            <div>
                <button type="button" class="btn btn-floating btn-primary store-webhook" style="display:none;position:relative;float:right;box-shadow:none">
    ...
    <div class="page-content container" id="page-webhooks">
        ...
        <div id="content-error" class="" style="display:none">
            <div class="content-modal-error text-center">
                ...
                <button style="margin:34px auto 0;box-shadow:none" type="button" class="btn btn-floating btn-primary store-webhook">
                    <i class="o-add-1" aria-hidden="true"></i>
                </button>
            </div>
        </div>
                ...
                <div class="modal-content">
                    <div id="modal-loader">
                        <div class="modal-header simple-border-bottom">
                            <h4 class="modal-title bold text-center" style="width: 100%;" id="modal-title-plan"><span class="ml-15">Cadastrar Webhook</span></h4>
                        ...
                        <div id="modal-reverse-body" class="modal-body">
                            <div class="row">
                                <div class="form-group col-12">
                                    ...
                                    <input name="description" type="text" class="form-control form-control-lg" id="description" placeholder="Digite uma descrição para seu webhook">
                                </div>
                            </div>
                            ...
                            <div class="row url-container">
                                <div class="form-group col-sm-12 col-md">
                                    ...
                                    <input name="url" type="text" class="form-control form-control-lg" id="url" placeholder="Digite uma URL válida">
...
<div class="modal fade modal-new-layout" id="modal-edit-webhook" data-backdrop="static" role="dialog" tabindex="-1">
    <div id="mainModalBody" class="modal-dialog modal-dialog-centered modal-simple">
        <div class="modal-content">
            <div id="modal-loader">
                <div class="modal-header simple-border-bottom">
                    <h4 class="modal-title bold text-center" style="width: 100%;" id="modal-title-plan"><span class="ml-15">Editar Webhook</span></h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <i class="material-icons md-22">close</i>
                    </button>
                </div>
                <div id="modal-reverse-body" class="modal-body">
                    <div class="row">
                        <div class="form-group col-12">
                            <label for="description">Descrição</label>
                            <input name="description" type="text" class="form-control form-control-lg" id="description_edit" placeholder="Digite uma descrição para seu webhook">
                        </div>
                    </div>
                    <div class="row companies-container">
                        <div class="form-group col-sm-12 col-md">
                    ...
                    <div class="row url-container">
                        <div class="form-group col-sm-12 col-md">
                            <label for="url">URL para receber os webhooks</label>
                            <input name="url" type="text" class="form-control form-control-lg" id="url_edit" placeholder="Digite uma URL válida">
                            <small class="text-muted">Digite uma URL válida</small>
                        </div>
                    </div>
                </div>
...
<div class="modal fade example-modal-lg modal-new-layout" id="modal-delete-webhook" data-backdrop="static" aria-hidden="true" aria-labelledby="exampleModalTitle" role="dialog" tabindex="-1">
    <div class="modal-dialog  modal-dialog-centered  modal-simple">
        <div class="modal-content">
            ...
            <div class="modal-footer d-flex align-items-center justify-content-center">
                <input type="hidden" id="webhook_id" name="webhook_id">
                <button id="btn-cancel-webhook" type="button" class="col-4 btn border-0 btn-gray btn-cancel-modal form-control d-flex justify-content-center align-items-center align-self-center flex-row" data-dismiss="modal" style="width: 20%;">
                    <b>Cancelar</b>
                </button>
                <button id="btn-delete-webhook" type="button" class="col-4 btn border-0 btn-outline btn-delete-modal form-control d-flex justify-content-center align-items-center align-self-center flex-row" data-dismiss="modal" style="width: 20%;">
