...
@push('css')
    <link rel="stylesheet"
          href="{{ mix('build/layouts/geradorrastreio/index.min.css') }}">
    <style>
        .o-arrow-right-1 {
            font-size: 30px;
        }
...
@section('content')
                ...
                <div class="modal-dialog modal-lg d-flex justify-content-center">
                    <div class="modal-content w-450"
                        ...
                        <div class="pr-20 pl-20 modal_integracao_body">
                            @include('geradorrastreio::create')
                            @include('geradorrastreio::edit')
                        </div>
    ...
    @push('scripts')
        <script src="{{ mix('build/layouts/geradorrastreio/index.min.js') }}"></script>
    @endpush
@endsection
