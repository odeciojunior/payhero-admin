        ...
        try {
            ...
            if ($projectId) {
                ...
                $salesDetails = $salesModel->selectRaw("COUNT(*) AS contSales,
                                                        ...
                                                        SUM(CASE WHEN sales.payment_method = 1 THEN sales.total_paid_value ELSE 0 END) AS totalValueCreditCard,
                                                        SUM(CASE WHEN sales.payment_method = 1 AND sales.status = 1 THEN 1 ELSE 0 END) AS contCreditCardAproved,
                                                        SUM(CASE WHEN sales.payment_method = 2 THEN sales.total_paid_value ELSE 0 END) AS totalValueBoleto,
