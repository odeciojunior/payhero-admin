...
!(function (t, e) {
    ...
    const Si = (t) => 0 === t || 1 === t,
        ...
        Ci = {
            ...
            easeInOutExpo: (t) =>
                Si(t) ? t : t < 0.5 ? 0.5 * Math.pow(2, 10 * (2 * t - 1)) : 0.5 * (2 - Math.pow(2, -10 * (2 * t - 1))),
    ...
    class dn {
        ...
        render() {
            !1 !== this.notifyPlugins("beforeRender", { cancelable: !0 }) &&
                (a.has(this) ? this.attached && !a.running(this) && a.start(this) : (this.draw(), on({ chart: this })));
        }
        draw() {
            let t;
    ...
    (Cn.id = "line"),
        (Cn.defaults = { datasetElementType: "line", dataElementType: "point", showLine: !0, spanGaps: !1 }),
    ...
    class Qo extends Bs {
        ...
        getPixelForValue(t) {
            return (
                ...
                null === t || isNaN(t)
                    ? NaN
                    : this.getPixelForDecimal(t === this.min ? 0 : (Dt(t) - this._startValue) / this._valueRange)
            );
        }
        getValueForPixel(t) {
    ...
    function ua(t, e) {
        ...
        return (
            ...
            null === a
                ? null
                : (n && (a = "week" !== n || (!Tt(o) && !0 !== o) ? i.startOf(a, n) : i.startOf(a, "isoWeek", o)), +a)
        );
    }
    function fa(t, e, i, s) {
        const n = ca.length;
