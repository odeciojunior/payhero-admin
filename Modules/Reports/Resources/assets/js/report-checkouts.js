$(function () {
    ...
    function updateReports() {
        ...
        $(
            "#revenue-generated, #qtd-aproved, #qtd-boletos, #qtd-recusadas, #qtd-chargeback, #qtd-reembolso, #qtd-pending, #qtd-canceled" +
            ...
            success: function success(response) {
                $("#qtd-abandoned").html(
                    '<span class="font-size-30 bold">' +
                        response.contAbandoned +
                        '</span> <span style="color:#959595">(' +
                        response.percentAbandoned +
                        ")</span>"
                );
                $("#qtd-recovered").html(
                    '<span class="font-size-30 bold">' +
                        response.contRecovered +
                        '</span> <span style="color:#959595">(' +
                        response.percentRecovered +
                        ")</span>"
                );
                $("#qtd-finalized").html(
                    '<span class="font-size-30 bold">' +
                        response.contFinalized +
                        '</span> <span style="color:#959595">(' +
                        response.percentFinalized +
                        ")</span>"
                );
