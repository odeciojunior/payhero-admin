...
@section('content')
    ...
    <div class="page mb-0">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-sm-12 col-xs-12">
                            <h1 class="page-title new-title grey">
                                <span class="box-title ico-finance">Vendas</span>
                                Vendas
                            </h1>
                            <span type="hidden" class="error-data"></span>
                        </div>
        ...
        <div id="project-not-empty" style="display: none">
            <div id="reports-content" class="page-content container box-reports">
                <!-- <div class="row align-items-center justify-content-between" style="border: 1px solid red">
