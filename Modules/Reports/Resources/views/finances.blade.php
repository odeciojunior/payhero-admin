                    ...
                    <div class="col-12 box-items-finance"
                        ...
                        <div class="row mb-20">
                            <div class="fianance-items col-md-3 col-6 pr-5 pr-md-15">
                                <div class="finance-card fc no-ske border blue mb-10 onPreLoad"
                                     id="finance-transactions"></div>
                            </div>

                            <div class="fianance-items col-md-3 col-6 pr-5 pr-md-15">
                                <div class="finance-card fc no-ske border orange mb-10 onPreLoad"
                                     id="finance-ticket"></div>
                            </div>

                            <div class="fianance-items col-md-3 col-6 pr-5 pr-md-15">
                                <div class="finance-card fc no-ske commission border green mb-10 onPreLoad"
                                     id="finance-commission"></div>
                            </div>

                            <div class="fianance-items col-md-3 col-6 pr-5 pr-md-15">
                                <div class="finance-card fc no-ske border pink mb-10 onPreLoad"
                                     id="finance-chargebacks"></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12 d-flex box-chart-primary">
                        ...
                        <div class="primary fc">
                            <div class="card"
                                ...
                                <section class="container pb-20 graph-principal">
                                    ...
                                    <div class="onPreLoadBig"
                                         id="block-commission"></div>
                                </section>
                            </div>
                                ...
                                <div class="d-flex justify-content-between sub-comission">
                                    <div class="inner-comission flc">
                                        <div class="card inner cash card-cashback card-fc"
                                            ...
                                            <footer>
                                                <div class="d-flex align-items onPreLoad "
                                                     id="block-cash"></div>
                                            </footer>
                                        </div>
                                        <div class="card card-fc">
                                            <div class="d-flex align-items cash-box">
                                                ...
                                                <div>
                                                    <span class="txt-cash">
                                                        O cashback por venda varia de acordo com o <strong>número de
                                                            parcelas</strong> escolhidas pelo cliente.
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="distribution fc">
                            <div class="card inner distribution-content"
                                ...
                                <div class="onPreLoad"
                                     id="block-distribution"></div>
                            </div>
                            <div class="">
                                <div class="d-flex sub-distribution">
                                    <div class="card inner secondary-blocks"
                                         id="card-pending">
                                        <header class="d-flex title-graph mt-0">
                                            ...
                                            <a href="{{ route('reports.pending') }} "
                                               class="box-link silver">
                                                <span>Acessar&nbsp&nbsp</span>
                                                <i class="o-arrow-right-1 redirect"></i>
                                            </a>
                                        </header>
                                        <div class="onPreLoad no-ske finance-pending"
                                    ...
                                    <div class="card inner secondary-blocks"
                                        ...
                                        <footer class="onPreLoad no-ske"
                                                id="block-blockeds"></footer>
                                    </div>
                                </div>
                            </div>
                        </div>
...
@push('scripts')
    <script type='text/javascript'
            src='{{ mix('build/layouts/reports/finances.min.js') }}'></script>
@endpush
