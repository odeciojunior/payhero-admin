            ...
            <div class="modal-body">
                <div class="transition-details">
                    ...
                    <div class="status d-inline">
                        <img id='chargeback-recovered' class="orange-gradient" src="{{ asset('modules/global/img/svg/chargeback.svg') }}"
                ...
                <div class='div-refund-observation mt-20' style='display:none;'>
                    ...
                    <div class="d-flex align-items-center">
                        <input id="refund-observation" type="email" name="refund_observation"
                               ...
                               readonly>
                        <a class="pointer btn-edit-observation"><span class="orion-icon-edit"></span></a>
                ...
                <div class="tab-content p-10" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <a class="pointer btn-edit-client"><span class="orion-icon-edit"></span></a>
