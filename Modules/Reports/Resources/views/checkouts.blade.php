...
@section('content')
    ...
    @push('css')
        <link rel="stylesheet"
              href="{!! mix('build/layouts/reports/checkouts.min.css') !!}">
    @endpush
                ...
                <div class="row align-items-center justify-content-between">
                    ...
                    <div class="col-sm-6 col-m-3 col-lg-3">
                        <div class="row align-items-center form-icons">
                            <i class="form-control-icon form-control-icon-right o-agenda-1 font-size-18"
                               style="right: 10%;"></i>
                            <input id="date-filter"
                                   type="text"
                                   name="daterange"
                                   class="input-pad text-center font-size-14 pr-30 ml-5"
                                   value=""
                                   readonly
                                ...
                                <div class="card shadow">
                                    <div class="card-header s-card-header">
                                        <div class="row">
                                            ...
                                            <div class="col-4">
                                                <select class="sirius-select float-right"
                                                        id='origin'>
                                                    <option selected
...
@push('scripts')
    <script type='text/javascript'
            src='{{ mix('build/layouts/reports/checkouts.min.js') }}'></script>
@endpush
