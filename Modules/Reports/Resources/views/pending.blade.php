...
@section('content')
    ...
    <div class="page mb-0">
        ...
        <div id="project-not-empty"
            ...
            <section class="container box-inner-reports"
                     id="reports-content">
                <div class="row">
            ...
            <div id="reports-content"
                 class="page-content container inner-reports-content">
                                ...
                                <div class="collapse pt-20" id="bt_collapse">
                                    <div class="row">
                                        <div class="col-sm-6 col-md-3">
                                            ...
                                            <input type="text"
                                                   id="sale_code"
                                                   placeholder="Digite ID da transação"
                                                   class="input-pad">
                                        </div>
                                        <div class="col-sm-6 col-md-3">
                                        ...
                                        <div class="col-sm-6 col-md-3 form-icons">
                                            <label style="margin-bottom: 0.19rem;"
                                                   for="date_range">‏‏‎ ‎</label>
                                        ...
                                        <div class="col-sm-6 col-md-3 pt-20"
                                            ...
                                            <div id="select-statement-div">
                                                ...
                                                <select name='select_type_statement'
                                                    ...
                                                    <option value="automatic_liquidation"
                                                            selected>Extrato Novo</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-sm-6 col-md-6 col-xl-3 col-12  pt-20">
                                            <label for="acquirer">Adquirente</label>
                                            <select name='select_acquirer'
                                                    id="acquirer"
                                                    class="sirius-select">
