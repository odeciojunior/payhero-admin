                    ...
                    <form id='filter_form'>
                        <div id="" class="card shadow p-20">
                            ...
                            <div class="col-sm-8 col-md-6 col-xl-3">
                                ...
                                <input name='customer_document' id="customer_document" class="input-pad default-border" placeholder="Digite o CPF" data-mask="000.000.000-00">
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-md-3 pt-20" style="display:none">
                                    <div id="select-statement-div">
                                        ...
                                        <select name='select_type_statement' id="type_statement" class="form-control select-pad">
