                        ...
                        <div class="row mb-20">
                            <div class="fianance-items col-md-3 col-6 pr-5 pr-md-15">
                                <div class="finance-card fc no-ske border blue mb-10 onPreLoad"
                                     id="sales-transactions"></div>
                            </div>

                            <div class="fianance-items col-md-3 col-6 pr-5 pr-md-15">
                                <div class="finance-card fc no-ske border orange mb-10 onPreLoad"
                                     id="sales-average-ticket"></div>
                            </div>

                            <div class="fianance-items col-md-3 col-6 pr-5 pr-md-15">
                                <div class="finance-card fc no-ske border green mb-10 onPreLoad"
                                     id="sales-comission"></div>
                            </div>

                            <div class="fianance-items col-md-3 col-6 pr-5 pr-md-15">
                                <div class="finance-card fc no-ske border pink mb-10 onPreLoad"
                                     id="sales-number-chargeback"></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12 d-flex box-chart-primary">
                            ...
                            <div class="">
                                <div class="d-flex justify-content-between sub-comission sc">
                                    <div class="inner-comission sc">
                                        <div class="card inner card-payments pad-bottom-0 sc"
                                             id="card-payments">
                                        ...
                                        <div class="card inner pad-bottom-0 card-conversion"
                                             id="card-conversion">
                                            <header class="d-flex title-graph mt-0">
                                                <h5 class="grey font-size-16">
                                            ...
                                            <div class="custom-table onPreLoad"
                                                 id="block-conversion"></div>
                                        </div>
                                    </div>
                                    <div class="inner-comission sc">

                                        <div class="card inner card-devices"
                                             id="card-devices">
                                            <header class="d-flex title-graph mt-0">
                                                <h5 class="grey font-size-16">
                                            ...
                                            <div class="custom-table pb-0 pt-0 onPreLoad"
                                                 id="block-devices"></div>
                                        </div>

                                        <div class="card inner card-abandoned"
                                             id="card-abandoned">
                                            <header class="d-flex title-graph mt-0">
                                                <h5 class="grey font-size-16">
                                            ...
                                            <div id="block-abandoned"
                                                 class="no-ske block-abandoned onPreLoad"></div>
                                        </div>

                                        <div class="card inner card-orderbump"
                                             id="card-orderbump">
                                            ...
                                            <footer id="block-orderbump"
                                                    class="no-ske onPreLoad">
                        ...
                        <div class="distribution sc">
                            <div class="card inner distribution-content sales"
                            ...
                            <div class="">
                                <div class="sub-distribution">
                                    <div class="card inner sales-card card-most-sales"
                                         id="card-most-sales">
                                        <header class="d-flex title-graph mt-0">
                                            <h5 class="grey font-size-16">
                                        ...
                                        <div class="custom-table scrollbar pb-0 pt-0">
                                            <div class="row">
                                                <div class="container">
                                                    <div class="data-holder b-bottom scroll-212 onPreLoad"
                                                         id="block-sales"></div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card inner card-upsell no-ske"
                                         id="card-upsell">
                                        <header class="d-flex title-graph">
                                            <h5 class="grey font-size-16">
                                                <strong>Upsell</strong>
                                        ...
                                        <footer id="block-upsell"
                                                class="onPreLoad"></footer>
                                    </div>
                                </div>
                            </div>
                        </div>
...
@push('scripts')
    <script type='text/javascript'
            src='{{ mix('build/layouts/reports/sales.min.js') }}'></script>
@endpush
