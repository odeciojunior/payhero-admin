 ...
 */
class BackupApp extends Controller
{
    /**
        ...
        try {
            ...
            $config = new \SocialiteProviders\Manager\Config(
                ...
                env("APP_ENV") == "production"
                    ? "https://sirius.cloudfox.net/apps/shopify/login/callback"
    ...
    {
        $integrationToken = Socialite::driver("shopify")
            ->stateless()
            ->user()->token;
                        ...
                        try {
                            foreach ($project->shopifyIntegrations as $shopifyIntegration) {
                                ...
                                if ($htmlCart) {
                                    //template normal
                                    $shopifyIntegration->update([
                                        "theme_type" => $shopifyIntegrationModel
                                            ->present()
