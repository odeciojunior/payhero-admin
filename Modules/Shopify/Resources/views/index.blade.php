...
<div class="page">
    ...
    <div class="page-content container">
                                ...
                                <div class="panel-body justify-content-center">
                                    <div class="d-flex align-items-center">
                                        <span>Após ter se autenticado no shopify, clique em "Apps" <strong class='grad'>(como indica imagem abaixo)</strong>
                                            <img class='img-thumbnail thumbnail' src='https://cloudfox-documents.s3.amazonaws.com/cloudfox/defaults/shoify-integration-step-1.png' style='width:100%'>
                                        </span>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="panel-body justify-content-center">
                                    <div class="d-flex align-items-center">
                                        <span>Ao carregar a página, identifique e clique no link "Manage private apps"
                                            ...
                                            <img class='img-thumbnail thumbnail' src='https://cloudfox-documents.s3.amazonaws.com/cloudfox/defaults/shoify-integration-step-2.png' style='width:100%'>
                                        </span>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="panel-body justify-content-center">
                                    <div class="d-flex align-items-center">
                                        <span>Aguarde a nova página abrir, e clique no botão "Create a new private app"
                                            <strong class='grad'>(como indica imagem abaixo)</strong>
                                            <img class='img-thumbnail thumbnail' src='https://cloudfox-documents.s3.amazonaws.com/cloudfox/defaults/shoify-integration-step-3.png' style='width:100%'>
                                        </span>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="panel-body justify-content-center">
                                    <div class="d-flex align-items-center">
                                        <span>Na nova página você deverá preencher alguns dados.
                                            ...
                                            <img class='img-thumbnail thumbnail' src='https://cloudfox-documents.s3.amazonaws.com/cloudfox/defaults/shoify-integration-step-4-1.png' style='width:100%'>
                                        </span>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="panel-body justify-content-center">
                                    <div class="d-flex align-items-center">
                                        <span>Depois de inserir corretamente os dados acima, precisamos que você nos
                                            ...
                                            <img class='img-thumbnail thumbnail' src='https://cloudfox-documents.s3.amazonaws.com/cloudfox/defaults/shoify-integration-step-4-2.png' style='width:100%'>
                                        </span>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="panel-body justify-content-center">
                                    <div class="d-flex align-items-center">
                                        <span>Confira os dados e clique em "save", o botão podera ser encontrado no
                                            final da página.
                                            <br> Uma janela de confirmação aparecerá para você<strong class='grad'>(selecione o botão como indica imagem
                                                abaixo)</strong>
                                            <img class='img-thumbnail' src='https://cloudfox-documents.s3.amazonaws.com/cloudfox/defaults/shoify-integration-step-6.png' style='width:100%'>
                                        </span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="panel-collapse collapse" id="exampleCollapseEigth" aria-labelledby="exampleHeadingEigth" role="tabpanel" style="" data-parent="#acordionHelp">
                                <div class="panel-body justify-content-center">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <a class="btn btn-floating btn-primary" style="margin:15px;color: white;display: flex;align-items: center;justify-content: center;">
                                ...
                                <div class="panel-body justify-content-center">
                                    <div class="d-flex align-items-center">
                                        <span>O campo "Token (password)" deve ser preenchido com o password do seu
                                            ...
                                            <img class='img-thumbnail thumbnail' src='https://cloudfox-documents.s3.amazonaws.com/cloudfox/defaults/shoify-integration-step-7-1.png' style='width:100%'>
                                            <br>O campo "URL da sua loja no Shopify" sera a URL da sua loja. (sem o
                                            "https://" nem mesmo o que vier após "myshopify.com")<strong class='grad'>(como indica imagem abaixo)</strong>
                                            <img class='img-thumbnail thumbnail' src='https://cloudfox-documents.s3.amazonaws.com/cloudfox/defaults/shopify-url.png' style='width:100%'>
                                        </span>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="modal fade modal-slide-bottom" id="modal_edit" aria-hidden="true" aria-labelledby="exampleModalTitle" role="dialog" tabindex="-1">
            <div class="modal-dialog modal-dialog-centered" style="width: 517px; min-height: 453px">
                <div class="modal-content" id="" style="border-radius: 12px">
                    ...
                    <div style="width: 517px; height:70px; font-size: 22px; font-weight: bold; color:#636363" class="" id="">
                        ...
                        <svg data-dismiss="modal" aria-label="Close" style="position: absolute; top:27px; right:24px" class="close" width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M15 1.75L1 15.75M1 1.75L15 15.75L1 1.75Z" stroke="#636363" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>

                    </div>

                    <div style="padding: 25px 25px 15px 25px; border-top: 1px solid #F4F4F4" class="" id="">
                        <img style="height: 51px; width:51px; border-radius: 8px" id="project-img" class="" src="" alt="" />
                        <span id="project-name" style="font-size: 16px; color:#636363; font-weight: bold; margin-left: 17px">
                            ...
                            <div id="bts-confirm" class="row" style="display: none; margin-top: 16px ">
                                <div class="col-sm ">
                                    ...
                                    <div style="background-color: #F2F8FF; border: 1px solid #2E85EC;
                                        ...
                                        <button id="bt-confirm_old" data-dismiss="" style="padding: 9px 32px; font-weight: bold" aria-label="" class="btn btn-primary" style="">Sim</button>
                                        <button id="bt-cancel" data-dismiss="" style="margin-left:6px; padding: 9px 32px; color:#636363; background-color: #FFFFFF; border:none; font-weight: bold" class="btn btn-secondary" style="">Não</button>
                        ...
                        <div style="padding-top: 28px;">
                            ...
                            <div id="" style="padding-top: 10px ;">
                                ...
                                <div class="input-group mb-3">
                                    <input id="project-token" style="padding: 12px 16px; border-top-left-radius:8px; border-bottom-left-radius: 8px; " disabled type="text" class="input-pad form-control" placeholder="" aria-label="" aria-describedby="basic-addon2">
                                    <div class="input-group-append">
                                        <button id="token-change" style="background: #636363; color:white; font-weight: bold" class="btn btn-outline-secondary" type="button">Alterar</button>
                                    </div>
                                </div>

                                <div style="padding:4px 0">

                                    <svg style="margin-right: 2px" width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M16 8.5C16 4.08172 12.4183 0.5 8 0.5C3.58172 0.5 0 4.08172 0 8.5C0 12.9183 3.58172 16.5 8 16.5C12.4183 16.5 16 12.9183 16 8.5ZM7.50806 7.41012C7.55039 7.17687 7.75454 6.99999 8 6.99999C8.24546 6.99999 8.44961 7.17687 8.49194 7.41012L8.5 7.49999V12.0021L8.49194 12.092C8.44961 12.3253 8.24546 12.5021 8 12.5021C7.75454 12.5021 7.55039 12.3253 7.50806 12.092L7.5 12.0021V7.49999L7.50806 7.41012ZM7.25 5.24999C7.25 4.83578 7.58579 4.49999 8 4.49999C8.41421 4.49999 8.75 4.83578 8.75 5.24999C8.75 5.66421 8.41421 5.99999 8 5.99999C7.58579 5.99999 7.25 5.66421 7.25 5.24999Z" fill="#70707E" />
                                    </svg>
                    ...
                    <div id="footer" style="border-top: 1px solid #F4F4F4; padding:20px; text-align:center">
                        <button id="bt-close" data-dismiss="modal" aria-label="Close" class="btn btn-primary" style="padding: 12px 32px; font-size: 16px; font-weight: 600">Fechar</button>
                        <button id='bt-update-keys' class="btn btn-primary" style="display: none; padding: 12px 32px; font-size: 16px; font-weight: 600">Atualizar
                            e
                            fechar</button>
                    </div>
        ...
        {{-- Modal confirm --}}
        <div class="modal fade modal-slide-bottom" id="modal-confirm" aria-hidden="true" aria-labelledby="exampleModalTitle" role="dialog" tabindex="-1">
            <div class="modal-dialog modal-dialog-centered" style="width: 517px; min-height: 453px">
                <div class="modal-content" id="" style="border-radius: 12px">
                    ...
                    <div style="padding: 25px 25px 15px 25px; border-top: 1px solid #F4F4F4" class="" id="">
                        ...
                        <div class="text-center p-20" style=" margin-bottom: 16px; font-weight: bold;
                            ...
                            Você tem certeza que quer sincronizar <span style="font-weight: bold" id="sync-name"></span>?
                    ...
                    <div id="footer" style="border-top: 1px solid #F4F4F4; padding:20px; text-align:center">
                        <button id="bt-close-confirm" data-dismiss="modal" aria-label="Close" class="btn btn-primary" style="
                        ...
                        <button id='bt-confirm' class="btn btn-primary" style=" padding: 12px 16px; font-size: 16px; font-weight: 600">Sincronizar</button>
                    </div>
