                        ...
                        <ul class="nav nav-tabs nav-tabs-line"
                            ...
                            <li class="nav-item"
                                ...
                                <a id="tab-affiliates"
                                   ...
                                   data-toggle="tab"
                                   href="#tab_affiliates_panel"
                                   aria-controls="tab_affiliates"
                                   role="tab">Afiliados
                                </a>
                            </li>
                            <li class="nav-item"
                                role="presentation">
                                <a id="tab-affiliates-request"
                                   class="nav-link"
                                   data-toggle="tab"
                                   href="#tab_affiliates_request_panel"
                                   aria-controls="tab_affiliates_request"
                                   role="tab">Solicitações de Afiliação
                                </a>
                            </li>
                        </ul>
                    </div>
                        ...
                        <div class="tab-content">
                            <div id="tab_affiliates_panel"
                                ...
                                <div class="card card-body shadow "
                                    ...
                                    <table class='table text-left table-striped unify table-affiliate'
                                           style='width:100%'>
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody id="body-table-affiliates"
                                               img-empty="{!! mix('build/global/img/afiliados.svg') !!}">
                                            <tr class='text-center'>
                                                <td colspan='8'
                                                    style='height: 257px; vertical-align: middle;'>
                                                    <img style='width:124px;margin-right:12px;'
                                                         src='{!! mix('build/global/img/afiliados.svg') !!}'> Nenhum afiliado encontrado
                                                </td>
                                            </tr>
                                            {{-- js carrega --}}
                                        </tbody>
        ...
        <div class="modal fade example-modal-lg modal-3d-flip-vertical"
            ...
            <div class="modal-dialog  modal-dialog-centered  modal-simple">
                <div class="modal-content">
                    ...
                    <div id="modal_excluir_body_affiliate"
                ...
                <div class="modal-content p-10">
                    <div class="modal-header simple-border-bottom mb-10">
                        <h4 class="modal-title"
                            id="modal-title">Editar afiliado</h4>
                        <button type="button"
                                id="btn-close-invite"
                                class="close"
                                data-dismiss="modal"
        ...
        <div id="modal-show-affiliate"
            ...
            <div class="modal-dialog modal-dialog-centered modal-simple">
                <div class="modal-content p-10">
                    <div class="modal-header simple-border-bottom mb-10">
                        <h4 class="modal-title"
                            id="modal-title">Visualizar afiliado</h4>
                        <button type="button"
                                id="btn-close-invite"
                                class="close"
                                data-dismiss="modal"
