...
{{--     <div class="row">
    ...
    <div class="row">
        <div class="form-group col-xl-6">
            ...
            <select name="status_enum" class="sirius-select affiliate-status" required>
        ...
        <div class="form-group col-xl-6">
            ...
            <input name="percentage" type="text" class="form-control affiliate-percentage" data-mask="0#" maxlength="2" style="height: 50px !important;border-radius: 8px !important;">
        </div>
    </div>
</form>
