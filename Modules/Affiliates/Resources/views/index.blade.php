...
<div class="page-content container col-md-6 container-lg" style='display:none;'>
    ...
    <!-- Modal affiliates -->
    <div class="modal fade example-modal-lg modal-3d-flip-vertical" id="modal_store_affiliate" aria-hidden="true" aria-labelledby="exampleModalTitle" role="dialog" tabindex="-1">
    ...
    <!-- End Modal -->
    <!-- Modal Not Company -->
    <div class="modal fade example-modal-lg modal-3d-flip-vertical text-center" id='modal-not-companies' aria-hidden="true" aria-labelledby="exampleModalTitle" role="dialog" tabindex="-1">
        <div class="modal-dialog modal-lg d-flex justify-content-center">
            <div class="modal-content w-450" id="conteudo_modal_add">
    ...
    <div class="modal fade example-modal-lg modal-3d-flip-vertical text-center" id='modal-not-companies-approved' aria-hidden="true" aria-labelledby="exampleModalTitle" role="dialog" tabindex="-1">
        <div class="modal-dialog modal-lg d-flex justify-content-center">
            <div class="modal-content w-450" id="conteudo_modal_add">
