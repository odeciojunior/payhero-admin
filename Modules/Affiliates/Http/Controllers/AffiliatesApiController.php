...
use Modules\Affiliates\Transformers\MeusAffiliatesResource;
use Modules\Affiliates\Transformers\MinhasAfiliacoesResource;
use Modules\Affiliates\Transformers\MeusAffiliatesSolicitacoesResource;
use Modules\Affiliates\Transformers\MinhasAfiliacoesSolicitacoesResource;

class AffiliatesApiController extends Controller {


    public function meusAffiliates() {
