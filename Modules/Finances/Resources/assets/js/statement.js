...
window.updateTransfersTable = function(link = null) {
    ...
    let data = {
        company_id: $("#companyTopbar").val(), //$("#extract_company_select option:selected").val(),
...
window.updateAccountStatementData = function() {
    ...
    let link =
        "/api/transfers?" +
        "company_id=" + $("#companyTopbar").val() + //$("#statement_company_select").val() +
        "&gateway_id=" + window.gatewayCode +
...
$(window).on("load", function() {
    ...
    function getFilters(urlParams = false) {
        let data = {
            'company': $("#companyTopbar").val(), //$("#extract_company_select").val(),
            'reason': $("#reason").val(),
