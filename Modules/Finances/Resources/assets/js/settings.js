$(document).ready(function () {
    ...
    var companySelect = $("#company-navbar").val() //$('#transfers_company_select')
    ...
    window.saveSettings = function (data) {
        ...
        settingsData = Object.assign(settingsData, {
            company_id: $("#company-navbar").val(), //companySelect.val(),
    ...
    if (!isEmpty($("#company-navbar").val())) { //companySelect.val()
        getSettings($("#company-navbar").val()) //companySelect.val()
    } else {
        onWithdrawalByAmountChange()
        onWithdrawalByPeriodChange()
    }
