@push('css')
@endpush
<div class="modal hide fade in example-modal-lg"
     id="modal_detalhes_transacao"
     aria-hidden="true"
    ...
    <div class="modal-dialog modal-simple modal-sidebar modal-lg"
         style="height: 100vh;">
        <div id='modal-transactionsDetails'
            ...
            <div class="header-modal">
                <div class="d-flex flex-row justify-content-between align-items-start align-self-stretch"
                    ...
                    <div class="col-lg-10 text-center">
                        <h4> Liquidação do saque por bandeira </h4>
                    </div>
            ...
            <div class="modal-body">
                ...
                <div class="tab-content mt-20"
                    ...
                    <div id="div_transactions"
                        ...
                        <table id="transactions_table"
                               class="table table-striped mb-10">
                            <thead>
                                <tr>
                                    <th>Forma</th>
                                    <th>Status</th>
                ...
                <div class="col-10 text-left p-2 d-flex">
                    <div class=" d-flex justify-content-start align-items-center mr-4">
                        <span
                              class="transaction-status mr-2 d-flex justify-content-center align-items-center align-self-center rounded-circle rounded-circle">
                ...
                <div class="modal-content p-10 d-none"
                     id="export-finance-getnet-transfer">
                    ...
                    <div class="modal-footer">
                        ...
                        <input type="email"
                               id="email_finance_export_transfer"
                               class="mb-5">

                        <button type="button"
                                class="btn btn-success btn-confirm-export-finance-getnet-transfer mt-5">
                            Enviar
                        </button>
