<div class='container col-sm-12 mt-20 d-lg-block'>
    <div class='row'
        ...
        <div style="background-color: #ED1C24; border: 1px solid #ED1C24; ; display: none"
             class="col-md col-xs-12 card p-0 mx-md-5 balance-resume"
             id="card-debt-balance">
            <div class="card-body">
                <div class="price-holder">
                    <h5 class="font-size-14 gray-600"
                        style="color: #FFF"> Débitos </h5>
                    <h4 class="number saldoDebito"
                        id="debit-value">
                        <span style="color:#FFF">R$ </span><span class="font-size-24 bold debt-balance"
                              style="color: #FFF;">0,00</span>
                    </h4>
                </div>
            </div>
