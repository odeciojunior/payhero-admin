    ...
    <div class="row justify-content-start align-items-center">
        <div class="col-md-8 fix-5 px-sm-15">
            <div class="d-flex align-items-center">
                <div class="p-2 text-lg-left" style="flex:1">
                    <h5 class="title-pad col-12 bold"> Extrato </h5>
        ...
        <div class="col-md-4 d-flex justify-content-start justify-content-lg-end">
            <div class="price-holder px-20 p-md-0 text-left text-md-center" style="position: relative">
