<div style="min-height: 300px" class="card transfersTable">
    <table id="transfersTable" class="table table-striped table-condensed unify">
        <thead>
            <tr>
                <td class='headCenter table-title text-center'>Razão</td>
                <td class='headCenter table-title'>Data da venda</td>
                <td class='headCenter table-title'>Data da transferência</td>
