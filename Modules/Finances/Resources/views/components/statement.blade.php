<div style="min-height: 300px"
     class="card transfersTable">
    <table id="transfersTable"
           class="table table-striped table-condensed unify">
        <thead>
            <tr>
                <td class='col-auto headCenter table-title text-center'
                    style="width: 300px;">Razão</td>
        ...
        <tbody id="table-transfers-body"
               class="custom-t-body"
               img-empty="{!! mix('build/global/img/geral-1.svg') !!}"></tbody>
    </table>
            ...
            <tr>
                ...
                <td class="col-auto headCenter table-title">Data prevista
                    <i style="font-weight: normal"
                       ...
                       data-toggle="tooltip"
                       title=""
                       data-original-title="A comissão será transferida somente após informar códigos de rastreio válidos">
                    </i>
                </td>
...
<div class="row justify-content-end pr-15">
    ...
    <div id="pagination-statement"
         class="pagination-sm margin-chat-pagination pagination-statement-class text-xs-center text-md-right"
         style="margin-top: 10px; position:relative;float:right;display: none">
        {{-- loaded by js... --}}
    </div>
</div>
