<div class="card shadow card-tabs p-20 mb-50">
    <div class="col-12 mb-3 px-0">
        ...
        <div class="alert alert-warning alert-dismissible fade show" id='blocked-unico' role="alert" style='display:none;'>
            Saque suspenso! <strong class="redirect-to-accounts pointer text-decoration-underline" data-url-value="/personal-info">Clique aqui</strong> para cadastrar sua biometria e fortalecer a segurança da sua conta.
        </div>
