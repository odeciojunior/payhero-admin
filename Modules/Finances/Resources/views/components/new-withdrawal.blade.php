<div class="card shadow card-tabs p-20 mb-50">
    <div class="col-12 mb-3 px-0">
        ...
        <div class="alert alert-warning alert-dismissible fade show" id='user-biometry' role="alert" style='display:block;'>
            Saque suspenso! <strong class="redirect-to-accounts pointer" data-url-value="/personal-info">Clique aqui</strong>
            para cadastrar sua biometria e fortalecer a segurança da sua conta.
        </div>
    ...
    <div class='container' style="background: #FCFCFC; border-radius: 8px;">
        <div id="header" class='row align-items-center py-25 d-none d-md-flex' style="position: relative">
            <div class="col-sm-3 d-flex justify-content-center">
                <div id="div-available-money" class="price-holder pointer">
                    <h6 class="label-price mb-10 d-flex justify-content-start align-items-center">
                        ...
                        <span id="title_available_money">Saldo Disponível</span>
                    </h6>
        ...
        <div class='py-20 d-md-none' style="position: relative;">
            ...
            <div class="mt-10 w-p100">
                ...
                <div class="col-md-12 p-0 mt-10">
                    ...
                    <div class="input-group align-items-center input-custom-transfer">
                        <div class="input-moeda">R$</div>
                        <input id="custom-input-addon" type="text" class="form-control input-pad withdrawal-value custom-input-addon-m" placeholder="Digite o valor" aria-label="Digite o valor" aria-describedby="basic-addon1" style='border-radius: 0 8px 8px 0; border: none !important; border-left:1px solid #DDD !important; padding: 10px'>
                    </div>
                </div>
            </div>
            <div class="col-6">
            ...
            <button id="bt-withdrawal_m" class="btn btn-success btn-sacar" data-toggle="modal">
                Realizar saque
            </button>
        </div>
    </div>
