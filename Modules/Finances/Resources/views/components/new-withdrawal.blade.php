<div class="card shadow card-tabs p-20 mb-50">
    ...
    <div class='container'
         style="background: #FCFCFC; border-radius: 8px;">
        <div id="header"
             class='row align-items-center py-25 d-none d-md-flex'
             style="position: relative">
            <div class="col-sm-3 d-flex justify-content-center">
                <div id="div-available-money"
                     class="price-holder pointer">
        ...
        <div class='py-20 d-md-none'
             style="position: relative;">
            <div class="col-md-12 p-0">
                <div id="div-available-money_m"
                     class="price-holder pb-10 pointer d-flex flex-column">
                    ...
                    <h4 class="price saldoDisponivel m-0">
                        ...
                        <span style="color: #70707E"
                              class="font-size-30 bold available-balance">0,00</span>
                    </h4>
                </div>
            </div>
