...
@push('css')
    <link rel="stylesheet"
          href="{{ mix('build/layouts/finances/multi.min.css') }}">
@endpush
    ...
    <div class="page">
        ...
        <div id="project-not-empty"
            ...
            <div class="page-header container px-25 px-md-30"
                 style="padding-bottom: 0; padding-top:30px">
                <div class="row align-items-center justify-content-between"
                    ...
                    <div class="col-9 col-md-6 order-3 p-0 px-md-15"
                        ...
                        <p class="m-0 color-default"
                           id="title_available_money">Disponível para saque</p>
                        <div id="val-skeleton">
                            <div class="skeleton skeleton-text mb-0 my-5"
                                 style="width:207px !important;height: 40px !important;border-radius:20px !important"></div>
                        </div>
                        <div id="container_val"
                             style="display:none;">
                            <div style="margin-right: 24px">
                                <span class="font-size-24 gray">R$</span>
                                <span class="font-size-32 bold total-available-balance"
                                      style="color: #636363;">0,00</span>
                            </div>
                            <img id="eye-slash"
                                 src="{{ mix('build/global/img/logos/2021/svg/eye-slash.svg') }}"
                                 alt=""
                                 class="pointer">
                            <img id="eye-no-slash"
                                 src="{{ mix('build/global/img/logos/2021/svg/eye-no-slash.svg') }}"
                                 alt=""
                                 class="pointer d-none">
                        </div>
                    </div>
                    <div class="col-9 col-md-6 pointer default-hover order-3"
                         style="display:none;"
                         id="container-return">
            ...
            <div class="page-content container">
                <div class="row"
                     id="container-gateways">
                    <div class="col-md-12 col-xl-9 pr-xl-45">
                        <div class="row"
                             id="gateway-skeleton">
                            <div class="col-12 d-md-none">
                                <div class="skeleton skeleton-text"
                                     style="margin-bottom: 15px !important;width:80%; height: 15px"></div>
                    ...
                    <div class="col-md-12 col-xl-3 px-xl-0">
                        <div class="container-history"
                            ...
                            <div class="card card-skeleton mb-0"
                                ...
                                <div class="list-linear-gradient-top"
                                     style="display: none"></div>
                                <div id="container-withdraw"
                                     style="display:none;height: auto;max-height: 360px;"></div>
                                <div class="list-linear-gradient-bottom"></div>
                                <div class="row justify-content-between skeleton-withdrawal p-20 mx-0"
                                     id="skeleton-withdrawal">
                                    <div class="col-3 skeleton skeleton-gateway-logo"
                                         style="height: 30px"></div>
                                    <div class="col-5 text-right skeleton skeleton-text"
                                         style="height: 30px"></div>
                                    <div class="col-7 skeleton skeleton-text mb-0"
                                         style="height: 33px"></div>
                                </div>
                                <div class="row justify-content-between skeleton-withdrawal p-20 mx-0"
                                     id="skeleton-withdrawal2">
                                    <div class="col-3 skeleton skeleton-gateway-logo"
                                         style="height: 30px"></div>
                                    <div class="col-5 text-right skeleton skeleton-text"
                                         style="height: 30px"></div>
                ...
                <div style="display:none"
                     id="container-config">
                    <div style="font-weight: bold; font-size: 24px; line-height: 30px; color: #636363;">Automatize seus
                        saques</div>
                    <div style="font-size: 16px; line-height: 20px; color: #70707E;">Crie regras para realizar saques
                        automaticamente, sem precisar se preocupar!</div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div
                                            ...
                                            <button type="button"
                                                    ...
                                                    class="btn btn-block m-0 mr-5 py-10 disabled"
                                                    disabled="">
                                                Diário
                                            </button>
                                            ...
                                            <button type="button"
                                                    ...
                                                    class="btn btn-block m-0 mx-5 py-10 disabled"
                                                    disabled="">
                                                Semanal
                                            </button>
                                            ...
                                            <button type="button"
                                                    ...
                                                    class="btn btn-block m-0 ml-5 py-10 disabled"
                                                    disabled="">
                                                Mensal
                                            </button>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-5">
                                                <button type="submit"
                                                        class="btn btn-block btn-success-1 py-10 px-15 disabled"
                                                        disabled="">
                                ...
                                <div class="card no-shadow mt-30"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-5">
                                                <button type="submit"
                                                        class="btn btn-block py-10 px-15 btn-success">
                                                    <img style="height: 12px; margin-right: 4px"
                                                         src=" {{ mix('build/global/img/svg/check-all.svg') }} ">
                                                    &nbsp;Salvar&nbsp;
                                                </button>
