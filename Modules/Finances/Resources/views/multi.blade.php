        ...
        <div class="page-header container px-25 px-md-30" style="padding-bottom: 0; padding-top:30px">
            <div class="row align-items-center justify-content-between" style="min-height:50px">
                ...
                <div class="col-9 col-md-6 order-3 p-0 px-md-15" id="container-available">
                    ...
                    <div id="val-skeleton">
                        <div class="skeleton skeleton-text mb-0 my-5" style="width:207px !important;height: 40px !important;border-radius:20px !important"></div>
                    </div>
                    <div id="container_val" style="display:none;">
                        ...
                        <img id="eye-slash" src="{{ mix('build/global/img/logos/2021/svg/eye-slash.svg') }}" alt="" class="pointer">
                        <img id="eye-no-slash" src="{{ mix('build/global/img/logos/2021/svg/eye-no-slash.svg') }}" alt="" class="pointer d-none">
                    </div>
                </div>
                ...
                <div class="col-3 col-md-6 d-none d-md-flex justify-content-end align-items-center order-4 pr-0">
                    <span id="btn-config-all" class="btn btn-sm btn-default">
