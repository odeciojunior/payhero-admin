<div id="modal-refund-transaction"
        ...
        <div id="modal-refund"
            ...
            <div class="modal-header simple-border-bottom mb-10">
                <h4 class="modal-title"
                    id="modal-title">Estornar transação</h4>
                ...
                <div class="col-3">
                    <div class="custom-control custom-radio">
                        ...
                        <label class="custom-control-label"
                               for="radioTotalRefund">Estorno total</label>
                    </div>
                </div>
                <div class="col-3">
                    <div class="custom-control custom-radio mb-3">
                        <input type="radio"
                               class="custom-control-input"
                               id="radioPartialRefund"
                               name="radio-stacked"
                               disabled>
                        <label class="custom-control-label"
                               for="radioPartialRefund">Estorno Parcial</label>
                    </div>
                </div>
                <div class="col-3"></div>
            </div>
            <div class="text-center pt-20 d-none"
                ...
                <div class="value-partial-refund"
                     style="display: none;">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control"
                          id="refund-observation-transaction"
                          rows="3"></textarea>
            </div>
            <div class="modal-footer">
                ...
                <button type="button"
                        class="col-sm-6 col-md-3 col-lg-3 btn btn-success btn-confirm-refund-transaction"
                        total="">
                    Estornar
                </button>
            </div>
