...
@section('content')
    ...
    <!-- Page -->
        ...
        <div id="project-not-empty" style="display:none">
            <div class="page-content container">
                        ...
                        <div id="bt_collapse" class="collapse">
                            ...
                            <div class="row mb-md-15">
                                ...
                                <div class="col-sm-12 col-md-3 mb-15 mb-sm-0">
                                    ...
                                    <select name='select_payment_method' id="forma"
                                ...
                                <div class="col-sm-12 col-md-3 mb-15 mb-sm-0">
                                    ...
                                    <select name='select_project' id="projeto"
                                        class="form-control select-pad applySelect2">
                                ...
                                <div class="col-sm-12 col-md-3 mb-15 mb-sm-0">
                                    ...
                                    <select name='plan' id="plan" class="form-control select-pad applySelect2"
                                        style='width:100%;'>
                                    ...
                                    <div class="row pt-15 d-flex justify-content-end mr-0">
                                        ...
                                        <div
                                            ...
                                            <label class="switch mr-2">
                                                <input type="checkbox" id='upsell' name="upsell" class='check'
                                                    value='0'>
                                        ...
                                        <div
                                            ...
                                            <label class="switch mr-2">
                                                <input type="checkbox" id='order-bump' name="order_bump" class='check'
                                                    value='0'>
                                                <span class="slider round"></span>
                                            </label>
                                        ...
                                        <div
                                            class='col col-sm-4 col-md-3 mb-10 mb-sm-0 d-flex align-items-center justify-content-sm-center justify-content-md-start'>
                                            <label class="switch mr-2">
                                                <input type="checkbox" id='cashback' name="cashback"
                                                    class='check shopify_error' value='0'>
                                                <span class="slider round"></span>
                                            </label>
                        ...
                        <div class="row mb-10 mb-sm-0" style="height: 30px">
                            ...
                            <div class="col-6 col-xl-3 mt-20 offset-xl-6 pr-0">
                                <div class="btn btn-light-1 w-p100 bold d-flex justify-content-center align-items-center"
                                    data-toggle="collapse" data-target="#bt_collapse" aria-expanded="false"
                                    aria-controls="bt_collapse">
                                    <img id="icon-filtro" class="hidden-xs-down"
                                        src=" {{ mix('build/global/img/svg/filter-2-line.svg') }} " />
                                    <div id="text-filtro" style="white-space: normal">Filtros <br
                                            class="d-flex d-sm-none"> avançados</div>
                                </div>
                            </div>
                            ...
                            <div class="col-6 col-xl-3 mt-20">
                                <div id="bt_filtro"
                                    ...
                                    <img class="hidden-xs-down" style="height: 12px; margin-right: 4px"
                ...
                <div id="container-pagination" class="row justify-content-center justify-content-md-end pr-md-15 pb-25">
    ...
    <div class="modal fade example-modal-lg modal-3d-flip-vertical" id="modal_regerar_boleto" aria-hidden="true"
    ...
    <div id="modal-refund-billet" class="modal fade example-modal-lg modal-3d-flip-vertical" role="dialog"
        tabindex="-1">
        <div class="modal-dialog modal-dialog-centered modal-simple">
            <div class="modal-content p-10">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="col-sm-6 col-md-3 col-lg-3 btn btn-success btn-confirm-refund-billet"
                        total="">
                        Estornar
                    </button>
                </div>
    ...
    <div id="modal-new-order-shopify" class="modal fade example-modal-lg modal-3d-flip-vertical" role="dialog"
        tabindex="-1">
        <div class="modal-dialog modal-dialog-centered modal-simple">
            <div class="modal-content p-10">
                <div class='my-20 mx-20 text-center'>
    ...
    <div id="modal-new-order-woocommerce" class="modal fade example-modal-lg modal-3d-flip-vertical" role="dialog"
        tabindex="-1">
        <div class="modal-dialog modal-dialog-centered modal-simple">
            <div class="modal-content p-10">
                <div class='my-20 mx-20 text-center'>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-success btn-confirm-new-order-woocommerce"
                        data-dismiss="modal">
                        Gerar
                    </button>
                </div>
    ...
    <div id="modal-export-sale" class="modal fade example-modal-lg modal-3d-flip-vertical" role="dialog"
        tabindex="-1">
        <div class="modal-dialog modal-dialog-centered modal-simple">
            <div class="modal-content p-10">
                <div class='my-20 mx-20 text-center'>
