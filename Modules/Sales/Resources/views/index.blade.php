...
<div class="page pb-0" style="margin-bottom: 0px !important;">
    ...
    <div id="project-not-empty" style="display:none">
                ...
                <div id="" class="card shadow p-20">
                    ...
                    <div class="row mb-md-15">
                        ...
                        <div class="col-sm-12 col-md-3 mb-15 mb-sm-0">
                            ...
                            <input name="value" id="valor" class="input-pad" placeholder="Valor da comissão">
                        </div>
        ...
        <div id="container-pagination" class="row justify-content-center justify-content-md-end pr-md-15 pb-25">
            <ul id="pagination-sales" class="pagination-sm margin-chat-pagination pagination-style pb-45 mb-70" style="position:relative;float:right">
                {{-- js carrega... --}}
            </ul>
        </div>
...
<div id="modal-new-order-woocommerce" class="modal fade example-modal-lg modal-3d-flip-vertical" role="dialog" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered modal-simple">
        <div class="modal-content p-10">
            <div class='my-20 mx-20 text-center'>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success btn-confirm-new-order-woocommerce" data-dismiss="modal">
                    Gerar
                </button>
            </div>
        </div>
