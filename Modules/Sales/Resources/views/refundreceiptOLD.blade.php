...
<body>
    ...
    <header>
        <img src="{{ mix('build/global/img/getnet-logo.png') }}"
             alt="Getnet Logo">
    </header>
    ...
    <table>
        ...
        <tr>
            <th></th>
            <td>{{ mb_strtoupper("{$company->street}, {$company->number} - {$company->neighborhood}, {$company->city} - {$company->state}, {$company->zip_code}", 'UTF-8') }}
            </td>
            <th></th>
            <td></td>
        </tr>
