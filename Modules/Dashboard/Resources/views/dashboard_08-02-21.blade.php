...
@section('content')
    ...
    @push('css')
        <link rel="stylesheet"
              href="{{ mix('modules/global/css/new-dashboard.min.css') }}">
        <link rel="stylesheet"
              href="{!! mix('modules/reports/css/chartist.min.css') !!}">
        <link rel="stylesheet"
              href="{!! mix('modules/reports/css/chartist-plugin-tooltip.min.css') !!}">
        <link rel="stylesheet"
              href="{{ mix('modules/dashboard/css/index.min.css') }}">
    @endpush
                ...
                <div class="col-lg-6"
                    ...
                    <div class="d-lg-flex align-items-center justify-content-end">
                        ...
                        <div class=" text-lg-right">
                            <select id="company"
                                    class="form-control new-select"> </select>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="card card-shadow bg-white chart-card">
                                ...
                                <div class="card-body my-30 d-flex flex-column justify-content-center align-items-center p-5"
                                    ...
                                    <div id="scoreLineToMonth"
                                         class="ct-chart"></div>
                                    <div id="empty-sale"
                                         style="display: none; font-size: 14px"> Nenhuma venda encontrada </div>
                                </div>
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-condensed">
                                                    <tr class="pb-15">
                                                        <td class="text-right">
                                                            <span id="total_sales_approved"
                                                                  class="text-money mr-1">0</span>
                                                        </td>
                                                        <td class="text-left">
                                                    ...
                                                    <tr>
                                                        <td class="text-right">
                                                            <span id="total_sales_chargeback"
                                                                  class="text-money mr-1">0</span>
                                                        </td>
                                                        <td class="text-left">
