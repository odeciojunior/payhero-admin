@push('css')
    ...
    <link rel="stylesheet" href="{{ asset('modules/dashboard/css/pix.css?v=01') }}">
@endpush
            ...
            <div id="modal-content-pix">
                <div id="modal-pix-content-0">
                    <div id="header-pix-onboarding-1" class="modal-header flex-wrap">
                        <div class="w-p100 d-flex flex-column justify-content-center align-items-center pb-20">
                            <img id="icon" class="mb-30" src="{{ asset('modules/global/img/pix/sirius-icon.svg') }}" width="35">
