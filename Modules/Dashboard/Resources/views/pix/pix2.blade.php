                ...
                <div class="d-flex flex-wrap align-items-md-baseline align-items-lg-center h-p75">
                    <div class="row col-12 col-md-4 col-lg-12 no-gutters align-items-center mb-10">
                        ...
                        <span class="col-12 col-lg-8 text-center text-lg-left pl-lg-2">
                            Após a finalização do pedido, o cliente é encaminhado ao Ambiente Pix.
                        </span>
                    </div>
                    ...
                    <div class="row col-12 col-md-4 col-lg-12 no-gutters align-items-center mb-10">
                        ...
                        <span class="col-12 col-lg-8 text-center text-lg-left pl-lg-2">
                            O ambiente varia de acordo com o dispositivo, oferecendo QR Code ou a Chave Copia e Cola.
                        </span>
                    </div>
