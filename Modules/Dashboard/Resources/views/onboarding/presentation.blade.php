@push('css')
    <link rel="stylesheet"
          href="{{ mix('build/layouts/dashboard/onboarding-details.min.css') }}">
@endpush
        ...
        <div class="modal-content">
            <div id="modal-content-onboarding">
                <div id="modal-presentation">
                    <div id="header-onboarding-1"
                         class="modal-header flex-wrap">
                        <div class="w-p100 d-flex justify-content-center">
                            <img id="icon"
                                 src="{{ mix('build/global/img/onboarding-presentation.png') }}"
                                 alt="Image">
                        </div>
                    </div>
                    <div class="modal-body text-center">
                        ...
                        <div id="onboarding-next-presentation"
                             class="btn btn-primary">Vamos lá!</div>
                    </div>
                </div>
...
@push('scripts')
    <script type="text/javascript"
            src="{{ mix('build/layouts/dashboard/onboarding-details.min.js') }}"></script>
@endpush
