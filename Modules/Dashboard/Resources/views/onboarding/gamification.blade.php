...
<div class="modal-body">
    <div class="row">
        <div class="col-12 col-lg-7 order-lg-1">
            ...
            <div class="row">
                <div
                     class="row col-12 col-md-4 col-lg-12 no-gutters align-items-md-baseline align-items-lg-center mb-15">
                    <div class="col-12 col-lg-2 text-center text-lg-left d-flex justify-content-center">
                        <div class="icon-onboarding-2 text-center">
                            <img class="img-fluid"
                                 alt="Image"
                                 src="{{ mix('build/global/img/svg/bank-notes.svg') }}">
                        </div>
                    </div>
                ...
                <div class="row col-12 col-md-4 col-lg-12 no-gutters align-items-center mb-15">
                    <div class="col-12 col-lg-2 text-center text-lg-left d-flex justify-content-center">
                        <div class="icon-onboarding-2 text-center">
                            <img class="img-fluid"
                                 alt="Image"
                                 src="{{ mix('build/global/img/svg/money-box.svg') }}">
                        </div>
                    </div>
                    <span class="col-12 col-lg-10 text-center text-lg-left pl-lg-2">
                ...
                <div class="row col-12 col-md-4 col-lg-12 no-gutters align-items-center mb-15">
                    <div class="col-12 col-lg-2 text-center text-lg-left d-flex justify-content-center">
                        <div class="icon-onboarding-2 text-center">
                            <img class="img-fluid"
                                 alt="Image"
                                 src="{{ mix('build/global/img/svg/medal.svg') }}">
                        </div>
                    </div>
                    <span
                          class="col-12 col-lg-10 text-center text-lg-left pl-lg-2 mb-md-15 mb-lg-0 h-md-p100 h-lg-auto">
        ...
        <div class="col-12 col-lg-5 order-lg-0 d-flex justify-content-center">
            <img id="img-onboarding"
                 class="img-fluid"
                 alt="Image"
                 src="{{ mix('build/global/img/onboarding/performance@2x.png') }}">
        </div>
    </div>
</div>
<div class="modal-footer justify-content-center">
    <div id="onboarding-next-gamification"
