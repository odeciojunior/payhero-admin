    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="row">
                ...
                <div class="col-12 col-sm-6 order-sm-0 d-flex justify-content-center">
                    <img class="img-fluid" alt="Image" src="{{asset('modules/global/img/onboarding-account-health.png')}}">
                </div>
            </div>
        </div>
