    ...
    <div class="row">
        ...
        <div class="col-12 col-lg-7 order-lg-1 h-p100">
            <div id="title-onboarding-2"
                 class="text-lg-left text-center">MAIS TRANSPARÊNCIA E CONTROLE</div>
                    ...
                    <div class="row col-12 col-md-4 col-lg-12 no-gutters align-items-center mb-15">
                        <div class="col-12 col-lg-2 text-center text-lg-left d-flex justify-content-center">
                            <div class="icon-onboarding-2">
                                <img class="img-fluid"
                                     alt="Image"
                                     src="{{ mix('build/global/img/onboarding/statistic.svg') }}">
                            </div>
                        </div>
                    ...
                    <div class="row col-12 col-md-4 col-lg-12 no-gutters align-items-center mb-15">
                        <div class="col-12 col-lg-2 text-center text-lg-left d-flex justify-content-center">
                            <div class="icon-onboarding-2">
                                <img class="img-fluid"
                                     alt="Image"
                                     src="{{ mix('build/global/img/onboarding/pay.svg') }}">
                            </div>
                        </div>
                        <span class="col-12 col-lg-10 text-center text-lg-left pl-lg-2">
                    ...
                    <div class="row col-12 col-md-4 col-lg-12 no-gutters align-items-center mb-15">
                        <div class="col-12 col-lg-2 text-center text-lg-left d-flex justify-content-center">
                            <div class="icon-onboarding-2">
                                <img class="img-fluid"
                                     alt="Image"
                                     src="{{ mix('build/global/img/onboarding/arrow-right-down.svg') }}">
                            </div>
                        </div>
                        <span class="col-12 col-lg-10 text-center text-lg-left pl-lg-2">
        ...
        <div class="col-12 col-lg-5 order-lg-0 d-flex justify-content-center mt-lg-5 mt-0">
            <img class="img-fluid"
                 alt="Image"
                 id="img-onboarding"
                 src="{{ mix('build/global/img/onboarding/account-health@2x.png') }}">
        </div>
    </div>
</div>
<div class="modal-footer justify-content-center">
    <div id="onboarding-next-account-health"
         class="btn btn-primary">Continuar</div>
</div>
