...
@section('content')
    ...
    @push('css')
        <link rel="stylesheet" href="{{ asset('modules/global/css/new-dashboard.css?v=05') }}">
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-4">
                    <div class="row">
                        ...
                        <div class="col-12 d-flex align-items-stretch font-size-12 order-1 order-sm-0 sirius-cashback">
