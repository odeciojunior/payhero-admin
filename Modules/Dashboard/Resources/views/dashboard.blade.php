...
@section('content')
    ...
    @push('css')
        ...
        <link rel="stylesheet" href="{{ asset('modules/dashboard/css/dashboard-performance.css?v=2') }}">
        <link rel="stylesheet" href="{{ asset('modules/dashboard/css/dashboard-account-health.css?v=2') }}">
    @endpush
