        ...
        <div class="modal-dialog modal-lg d-flex justify-content-center">
            <div class="modal-content w-450"
                ...
                <div class="pr-20 pl-20 modal_integracao_body">
                    @include('adooreicheckout::create')
                    @include('adooreicheckout::edit')
                </div>
...
@push('scripts')
    <script src="{{ mix('build/layouts/adooreicheckout/index.min.js') }}"></script>
@endpush
