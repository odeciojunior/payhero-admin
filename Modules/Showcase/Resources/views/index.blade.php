            ...
            <li class="masonry-item">
              <div class="card card-shadow">
                  <div class="card-header cover">
                    <a class="detalhes_projeto" projeto="{!! $project['id'] !!}" data-toggle='modal' data-target='#modal_detalhes'>
                        <img class="ccover-image img-responsive" src="{!! '/'.Modules\Core\Helpers\CaminhoArquivosHelper::CAMINHO_FOTO_PROJETO.$project['photo'] !!}" alt="Imagem não encontrada" style="height: 180px;width: 90%; margin: 8px 0 8px 0">
                    </a>
                  </div>
