...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Roboto:wght@400;700;900&display=swap"
          rel="stylesheet">
    <link rel="stylesheet"
          href="{{ mix('build/layouts/melhorenvio/tutorial.min.css') }}">
</head>
...
<body>
    <main>
        <div class="sidebar">
            <img class="logo"
                 src="https://azcend.com.br/sirius/assets/img/logos/sirius-powered-cloudfox.svg"
                 alt="Admin Logo">
            <ol>
                <li>
                ...
                <li id="section-1">
                    ...
                    <div>
                        ...
                        <div class="img-container">
                            <img src="{{ mix('build/layouts/melhorenvio/img/step-1b.jpg') }}"
                                 alt="Imagem 2 do passo 1">
                        </div>
                    </div>
                </li>
                <li id="section-2">
                ...
                <li id="section-3">
                    ...
                    <div>
                        Acesse: <span class="breadcrumb">Loja > Sua Loja </span>. Em seguida clique na aba <span
                              class="breadcrumb">Frete</span> e depois no botão <b>Adicionar Frete</b>. Preencha os
                        dados e
                        clique em <span class="btn green">Salvar</span>.
                        <div class="img-container">
                            <img src="{{ mix('build/layouts/melhorenvio/img/step-3a.jpg') }}"
                                 alt="Imagem 1 do passo 3">
                            <img src="{{ mix('build/layouts/melhorenvio/img/step-3b.jpg') }}"
                                 alt="Imagem 2 do passo 3">
                        </div>
                    </div>
                </li>
                <li id="section-4">
                    <h4>Checkout</h4>
                    <div>Se você chegou até aqui, as opções de frete do Melhor Envio já ficaram disponíveis no checkout
                        da
                        sua
                        loja. Quando uma compra for aprovada será criada automáticamente uma etiqueta no carrinho de
                        compras
                        do
                        Melhor Envio.
                        <div class="img-container">
                            <img src="{{ mix('build/layouts/melhorenvio/img/step-4a.jpg') }}"
                                 alt="Imagem 1 do passo 4">
                            <img src="{{ mix('build/layouts/melhorenvio/img/step-4b.jpg') }}"
                                 alt="Imagem 2 do passo 4">
                        </div>
                    </div>
                </li>
            </ol>
