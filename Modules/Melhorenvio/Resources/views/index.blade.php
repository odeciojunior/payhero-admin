...
@push('css')
    <link rel="stylesheet"
          href="{{ mix('build/layouts/melhorenvio/index.min.css') }}">
@endpush
        ...
        <div class="page-header container" style="display:none !important;">
            <div class="row jusitfy-content-between" style="min-height:56px">
                ...
                <div class="col text-right"
                    ...
                    <a data-toggle="modal"
                       data-target="#modal-add-integration"
                       ...
                       style="position: relative;float: right;color: white;display: flex;text-align: center;align-items: center;justify-content: center;">
                        <i class="o-add-1 text-white"
                           aria-hidden="true"></i>
                    </a>
                    <a target="_blank"
                       href="{{ route('melhorenvio.tutorial') }}"
        ...
        <div class="modal-dialog modal-lg d-flex justify-content-center">
            <div class="modal-content w-450"
                ...
                <div class="modal-footer"
                    ...
                    <button id="btn-save"
                            class="btn btn-success">Realizar integração</button>
        ...
        <div class="modal-dialog modal-dialog-centered modal-simple">
            <div class="modal-content">
                ...
                <div class="modal-footer d-flex align-items-center justify-content-center">
                    <button type="button"
                            class="btn btn-outline btn-cancel-modal border-0 col-4 d-flex justify-content-center align-items-center"
                            data-dismiss="modal">
                        <b>Cancelar</b>
                    </button>
                    <button data-dismiss="modal"
                            id="btn-delete-confirm"
                            class="btn btn-outline btn-delete-modal border-0 col-4 d-flex justify-content-center align-items-center">
