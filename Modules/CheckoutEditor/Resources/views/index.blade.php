@push('css')
    <link rel="stylesheet"
          href="{{ mix('build/layouts/checkouteditor/index.min.css') }}">
@endpush

<!-- Page -->
<div class="checkout-container"
     style="max-height: 3585px;  margin-bottom: 20px;">
            ...
            <div class="grid-checkout-editor">
                ...
                <div class="checkout-content visual">
                    <span class="title-icon">
                        <img class="icon-title"
                             src="{{ mix('build/layouts/checkouteditor/img/svg/visual.svg') }}">
                        <h1 class="checkout-title">
                            Visual
                        </h1>
                    </span>
                        ...
                        <div class="logo-container">
                            <div class="title-buttons-group">
                                ...
                                <div class="switch-holder mb-3">
                                    <label class="switch"
                                           style='top:3px; margin-right: 0;'>
                                        <input type="checkbox"
                                               id="checkout_logo_enabled"
                                               name="checkout_logo_enabled"
                                               data-enable=".logo-content"
                                               data-preview=".logo-preview-container"
                            ...
                            <div class="title-buttons-group">
                                <div class="row-flex">
                                    ...
                                    <div class="quantity-selector-tooltip">
                                        <img id="favicon-tooltip"
                                             data-target="favicon-tooltip-container"
                                             src="{{ mix('build/layouts/checkouteditor/img/svg/info-icon.svg') }}">
                                        <div id="favicon-tooltip-container"
                                             class="tooltip-container"
                                             style="display: none">
                                            <div class="tooltip-content">
                                                <p>
                                                    Favicon é a imagem que acompanha o título da sua página na aba do
                                                    navegador.
                                                </p>
                                ...
                                <div class="switch-holder mb-3">
                                    <label class="switch"
                                           style='top:3px; margin-right: 0;'>
                                        <input type="checkbox"
                                               id="checkout_favicon_enabled"
                                               name="checkout_favicon_enabled"
                                               data-enable=".favicon-content"
                                               class='check switch-checkout'>
                                        <span class="slider round"></span>
                                    </label>
                                </div>
                    ...
                    <div class="colors-container">
                        ...
                        <div class="theme-ready-content">
                            <div class="radio-group theme-ready theme-ready-first-line">
                                ...
                                <label for="theme_spaceship">
                                    <div class="theme-primary-color"
                                         style="background: #4B8FEF;"
                                         data-color="#4B8FEF">
                                    </div>
                                    <div class="theme-secondary-color"
                                         style="background: #313C52;"
                                ...
                                <label for="theme_blue_sky">
                                    <div class="theme-primary-color"
                                         style="background: #009BF2;"
                                         data-color="#009BF2">
                                    </div>
                                    <div class="theme-secondary-color"
                                         style="background: #008BD9;"
                            ...
                            <div class="radio-group theme-ready theme-ready-second-line">
                                ...
                                <input class="theme-radio"
                                       id="theme_purple_space"
                                       type="radio"
                                       name="theme_enum"
                                       value="2" />
                                <label for="theme_purple_space">
                                    <div class="theme-primary-color"
                                         style="background: #6C009E;"
                                         data-color="#6C009E">
                                    </div>
                                    <div class="theme-secondary-color"
                                         style="background: #3E005B;"
                                ...
                                <input class="theme-radio"
                                       id="theme_pink_galaxy"
                                       type="radio"
                                       name="theme_enum"
                                       value="8" />
                                <label for="theme_pink_galaxy">
                                    <div class="theme-primary-color"
                                         style="background: #E93889;"
                                         data-color="#E93889">
                                    </div>
                                    <div class="theme-secondary-color"
                                         style="background: #9F2256;"
                                         data-color="#9F2256"></div>
                                    <div class="theme-label">
                                        Pink Galaxy
                                    </div>
                                </label>
                                ...
                                <label for="theme_greener">
                                    <div class="theme-primary-color"
                                         style="background: #23D07D;"
                                         data-color="#23D07D">
                                    </div>
                                    <div class="theme-secondary-color"
                                         style="background: #02AD5B;"
                        ...
                        <div class="title-buttons-group">
                            ...
                            <div class="switch-holder mb-3">
                                <label class="switch"
                                       style='top:3px'>
                                    <input type="checkbox"
                                           id="theme_ready_enabled"
                                           name="theme_ready_enabled"
                                           data-target="custom-theme-content"
                                           data-toggle="theme-ready-second-line"
                    ...
                    <div class="banner-top-container">
                            ...
                            <div
                                ...
                                <div>
                                    <div id="banner_type"
                                        ...
                                        <input class="custom-icon-radio"
                                               ...
                                               type="radio"
                                               name="checkout_banner_type"
                                               value="0" />
                                        <label for="banner_type_square"><img
                                                 src="{{ mix('build/layouts/checkouteditor/img/svg/banner-square.svg') }}"></label>
                                        ...
                                        <label for="banner_type_wide"><img
                                                 src="{{ mix('build/layouts/checkouteditor/img/svg/banner-wide.svg') }}"></label>
                                    </div>
                                </div>
                                ...
                                <div class="switch-holder mb-3">
                                    <label class="switch"
                                           style='top:3px'>
                                        <input type="checkbox"
                                               id="checkout_banner_enabled"
                                               name="checkout_banner_enabled"
                                               data-target="banner-top-content"
                        ...
                        <div class="banner-top-content"
                            ...
                            <div id='upload-banner'>
                                ...
                                <input type="hidden"
                                       id="has_checkout_banner"
                                       value="false">
                                <div id="checkout_banner_error"
                                     class="checkout-error"
                                     style="display: none">
                                    <p>Por favor,carregue uma imagem de formato válido (jpg, jpeg ou png).</p>
                                </div>
                            ...
                            <div class="row-flex">
                                ...
                                <div class="button-template">
                                    <button id="download_template_banner"
                                            class="line-button"
                                            type="button"
                                            data-href="{{ mix('build/layouts/checkouteditor/files/Gabarito_EditorCheckout.zip') }}">
                                        <img class="icon-title download"
                                             src="{{ mix('build/layouts/checkouteditor/img/svg/download-icon.svg') }}">
                                ...
                                <div class="switch-holder mb-3">
                                    <label class="switch"
                                        ...
                                        <input type="checkbox"
                                               ...
                                               data-target="countdown-content"
                                               data-preview=".countdown-preview"
                                               class='check switch-checkout'>
                                        <span class="slider round"></span>
                                    </label>
                                </div>
                            ...
                            <div class="countdown-content"
                                ...
                                <div class="input-container">
                                    <label for="countdown_time"
                                           class="checkout-label">Tempo</label>
                                    <div class="tagged-input-div">
                                        <input class="tagged-input"
                                               type="number"
                                               id="countdown_time"
                                               value="15"
                                               name="countdown_time"
                        ...
                        <div class="textbar-container">
                                ...
                                <div class="switch-holder mb-3">
                                    <label class="switch"
                                        ...
                                        <input type="checkbox"
                                               id="topbar_enabled"
                                               name="topbar_enabled"
                                               data-target="textbar-content"
                                               data-preview=".textbar-preview"
                                               class='check switch-checkout'>
                                        <span class="slider round"></span>
                                    </label>
                                </div>
                            ...
                            <div class="textbar-content"
                                 style="display: none">
                                <label for="topbar_content"
                                       class="checkout-label">Texto na barra</label>
                                <div class="editor-container">
                                    <div id="topbar_content_toolbar_container"
                                ...
                                <div class="switch-holder mb-3">
                                    <label class="switch"
                                        ...
                                        <input type="checkbox"
                                               ...
                                               data-target="sales-notifications-content"
                                               class='check switch-checkout'>
                                        <span class="slider round"></span>
                                    </label>
                                </div>
                                        ...
                                        <table class="table table-hover notification-counts"
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="width: 30px">
                                                        <span class="checkbox-custom checkbox-primary">
                                                            <input class="selectable-notification"
                                                                   type="checkbox"
                                                    ...
                                                    <td class="table-td-input">
                                                        <input class="table-number-input"
                                                               type="number"
                                                               id="notification_buying_minimum"
                                                               name="notification_buying_minimum"
                                                               value="1"
                                                               min="1"
                                                               max="99"
                                                               maxlength="2"
                                                ...
                                                <tr>
                                                    <td style="width: 30px">
                                                        <span class="checkbox-custom checkbox-primary">
                                                            ...
                                                            <label
                                                                   for="notification_bought_30_minutes_enabled"></label>
                                                        </span>
                                                    </td>
                                                    ...
                                                    <td class="table-td-input">
                                                        <input class="table-number-input"
                                                               ...
                                                               name="notification_bought_30_minutes_minimum"
                                                               value="1"
                                                               min="1"
                                                               max="99"
                                                               maxlength="2"
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="table-td-input">
                                                        <input class="table-number-input"
                                                               ...
                                                               name="notification_bought_last_hour_minimum"
                                                               value="1"
                                                               min="1"
                                                               max="99"
                                                               maxlength="2"
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="table-td-input"
                                                        style="padding: 20px 20px 30px 10px;">
                                                        <input class="table-number-input"
                                                               type="number"
                                                               id="notification_just_bought_minimum"
                                                               name="notification_just_bought_minimum"
                                                               value="1"
                                                               min="1"
                                                               max="99"
                                                               maxlength="2"
                        ...
                        <div class="social-proof-container">
                                ...
                                <div class="switch-holder mb-3">
                                    <label class="switch"
                                        ...
                                        <input type="checkbox"
                                               ...
                                               name="social_proof_enabled"
                                               data-target="social-proof-content"
                                               class='check switch-checkout'>
                                        <span class="slider round"></span>
                                    </label>
                                </div>
                            ...
                            <div class="social-proof-content"
                                ...
                                <div>
                                    <label for="social-proof-vars"
                                           class="checkout-label">Adicionar variáveis</label>
                                    <div style="display: flex; margin-bottom: 10px;">
                                        <button id=""
                                                class='add-tag'
                                                data-input="#social_proof_message"
                                ...
                                <div class="input-container"
                                     style="width: 150px;">
                                    <label for="social_proof_minimum"
                                           class="checkout-label">Mínimo de vistantes</label>
                                    <div class="tagged-input-div">
                                        <input class="tagged-input"
                                               type="number"
                                               id="social_proof_minimum"
                                               name="social_proof_minimum"
                                               min="1"
                                               max="99"
                                               maxlength="2"
                                               oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                                ...
                                <div id="social_proof_minimum_error"
                                     class="checkout-error"
                                     style="display: none;">
                ...
                <div class="checkout-content payment"
                    ...
                    <div class="title-buttons-group">
                        <span class="title-icon">
                            <img class="icon-title"
                                 src="{{ mix('build/layouts/checkouteditor/img/svg/payments.svg') }}">
                            <h1 class="checkout-title">
                                Pagamentos
                            </h1>
                        </span>
                    ...
                    <div class="billing-content">
                        ...
                        <div class="row-flex">
                            ...
                            <div id="payments"
                                 ...
                                 style="flex: 7">
                                <label for="company_billing"
                                       class="checkout-label">Empresa responsável pelo
                                    faturamento</label>
                        ...
                        <div class="row-flex">
                            <div class="input-container"
                                ...
                                <div id="payment_type_accept"
                                     class="check-group"
                                     style="justify-self: end;">
                                    <input class="custom-bubble-check accept-payment-type"
                                           type="checkbox"
                                           id="cpf_enabled"
                                           name="cpf_enabled">
                                ...
                                <label class="quantity-selector-label">Seletor de quantidade
                                    <div class="quantity-selector-tooltip">
                                        <img id="selector-tooltip"
                                             src="{{ mix('build/layouts/checkouteditor/img/svg/info-icon.svg') }}">
                                        <div id="selector-tooltip-container"
                                             class="tooltip-container"
                                             style="display: none">
                                            <div class="tooltip-content">
                                                ...
                                                <div class="input-example">
                                                    ...
                                                    <div class="counter-example">
                                                        <img
                                                             src="{{ mix('build/layouts/checkouteditor/img/svg/red-minus.svg') }}">
                                                        <p>1</p>
                                                        <img
                                                             src="{{ mix('build/layouts/checkouteditor/img/svg/green-plus.svg') }}">
                                                    </div>
                    ...
                    <div class="credit-card-container">
                        ...
                        <div style="display: flex; gap: 20px;">
                            <div class="input-container"
                                 style="flex: 1">
                                <label for="company_billing"
                                       class="checkout-label">Limite de parcelas</label>
                                <div class='form-group'>
                                    <select id='installments_limit'
                                            name='installments_limit'
                                            class="sirius-select">
                            ...
                            <div class="input-container"
                                 style="flex: 1">
                                <label for="company_billing"
                                       class="checkout-label">Sem juros até</label>
                                <div class='form-group'>
                                    <select id='interest_free_installments'
                            ...
                            <div class="input-container"
                                 style="flex: 1">
                                <label for="company_billing"
                                       class="checkout-label">Parcela pré-selecionada</label>
                                <div class='form-group'>
                                    <select id='preselected_installment'
                                            name='preselected_installment'
                                            class="sirius-select">
                                        <option value="1">1x</option>
                                        <option value="2">2x</option>
                                        <option value="3">3x</option>
                    ...
                    <div class="bank-billet-container">
                        ...
                        <div>
                            <div class="input-container">
                                <label for="bank_slip_due_days"
                                       class="checkout-label">Dias para vencimento</label>
                                <div class="tagged-input-div">
                                    <input class="tagged-input"
                                           type="number"
                                           id="bank_slip_due_days"
                                           name="bank_slip_due_days"
                                           value="3"
                                           min="1"
                                           max="99"
                                           maxlength="2"
                                ...
                                <div id="bank_slip_due_days_error"
                                     class="checkout-error"
                                     style="display: none;">
                    ...
                    <div class="discount-container">
                        ...
                        <div style="display:flex; justify-content: center;">
                            ...
                            <div class="input-container credit-card-container"
                                 style="flex: 1">
                                <label for="company_billing"
                                       class="checkout-label">Cartão de crédito</label>
                                <div class="tagged-input-div"
                                     style="width: 100px;">
                                    <input class="tagged-input"
                                           type="number"
                                           id="automatic_discount_credit_card"
                                           name="automatic_discount_credit_card"
                                           value="0"
                                           min="0"
                                           max="99"
                                           maxlength="2"
                            ...
                            <div class="input-container bank-billet-container"
                                 style="flex: 1">
                                <label for="company_billing"
                                       class="checkout-label">Boleto</label>
                                <div class="tagged-input-div"
                                     style="width: 100px;">
                                    <input class="tagged-input"
                                           type="number"
                                           id="automatic_discount_bank_slip"
                                           name="automatic_discount_bank_slip"
                                           value="0"
                                           min="0"
                                           max="99"
                                           maxlength="2"
                            ...
                            <div class="input-container pix-container"
                                 style="flex: 1">
                                <label for="company_billing"
                                       class="checkout-label">PIX</label>
                                <div class="tagged-input-div"
                                     style="width: 100px;">
                                    <input class="tagged-input"
                                           type="number"
                                           id="automatic_discount_pix"
                                           name="automatic_discount_pix"
                                           value="0"
                                           min="0"
                                           max="99"
                                           maxlength="2"
                ...
                <div class="checkout-content post-purchase-pages"
                     id="post_purchase"
                     style="margin-bottom: 350px;">

                    <span class="title-icon">
                        <img class="icon-title"
                             src="{{ mix('build/layouts/checkouteditor/img/svg/paid-page.svg') }}">
                        <h1 class="checkout-title">
                            Página pós-compra
                        </h1>
                    </span>
                    ...
                    <div class="thanks-page-container">
                        <div class="title-buttons-group">
                            ...
                            <div class="switch-holder mb-3">
                                <label class="switch"
                                       style='top:3px'>
                                    <input type="checkbox"
                                           id="post_purchase_message_enabled"
                                           name="post_purchase_message_enabled"
                                           data-target="thanks-page-content"
                                           data-preview=".shop-message-preview"
                                           class='check switch-checkout'>
                                    <span class="slider round"></span>
                                </label>
                            </div>
                        ...
                        <div class="thanks-page-content"
                            ...
                            <div style="margin-bottom: 15px;">
                                <label for="post_purchase_message_content"
                                       class="checkout-label">Título da sua
                                    mensagem</label>
                                <input type="text"
                                       class="checkout-input-text"
                                       id="post_purchase_message_title"
                                       name="post_purchase_message_title">
                                <div id="post_purchase_message_title_error"
                                     class="checkout-error"
                                     style="display: none;">
                            ...
                            <div class="editor-container">
                                ...
                                <div id="post_purchase_message_content"
                                     class="quill-editor">
                                </div>
                                <div id="post_purchase_message_content_error"
                                     class="checkout-error"
                                     style="display: none;">
                                    <p>Preencha o campo de mensagem.</p>
                                </div>
                    ...
                    <div class="whatsapp-container">
                            ...
                            <div class="switch-holder mb-3">
                                <label class="switch"
                                    ...
                                    <input type="checkbox"
                                           ...
                                           data-target="whatsapp-content"
                                           data-preview=".whatsapp-preview"
                                           class='check switch-checkout'>
                                    <span class="slider round"></span>
                                </label>
                            </div>
                        ...
                        <div class="whatsapp-content"
                            ...
                            <label for="support_phone"
                                   class="checkout-label">Telefone do suporte <span
                                      class="observation-span">Opcional</span></label>
                            <div class="row-flex">
                                <input type="text"
                                       class="checkout-input-text"
                                ...
                                <button id="remove_phone"
                                        class="remove-button"
                                        type="button">Remover</button>
                                <button id="verify_phone_open"
                                        class="verify-button"
                                        type="button">Validar
                                    telefone</button>
                                <button id="verified_phone_open"
                                        class="verified-button"
                                        type="button"
                                        style="display: none;">Trocar telefone</button>
                            </div>
                            <div id="support_phone_error"
                                 class="checkout-error"
                                 style="display: none">
                ...
                <div class="preview"
                    ...
                    <div id="preview_visual">
                        <div class="title-buttons-group">
                            ...
                            <div id="preview_type_visual"
                                 class="radio-group">
                                <input class="custom-icon-radio desktop preview-type"
                                       id="preview_visual_computer"
                                       type="radio"
                                       name="preview-visual-type"
                                       data-target="preview-desktop-visual"
                                       data-toggle="preview-mobile-visual"
                                       checked />
                                <label for="preview_visual_computer"><img
                                         src="{{ mix('build/layouts/checkouteditor/img/svg/computer-icon.svg') }}"></label>

                                <input class="custom-icon-radio mobile preview-type"
                                       id="preview_visual_mobile"
                                       type="radio"
                                       name="preview-visual-type"
                                       data-target="preview-mobile-visual"
                                       data-toggle="preview-desktop-visual" />
                                <label for="preview_visual_mobile"><img
                                         src="{{ mix('build/layouts/checkouteditor/img/svg/mobile-icon.svg') }}"></label>
                            </div>
                        </div>

                        <div class="preview-container">
                            <div id="preview-desktop-visual"
                                 class="preview-content desktop">
                            ...
                            <div id="preview-mobile-visual"
                                 class="preview-content mobile"
                                 style="display: none;">
                                <div id="preview-mobile-visual-collapse"
                                     class="preview-mobile-collapse">
                                    <div class="preview-header">
                                    ...
                                    <div class="preview-body mobile visual">
                                        ...
                                        <div class="preview-placeholder three-steps">
                                            <div id="finish_button_preview_mobile_visual"
                                                 class="finish-button mobile">
                                            </div>
                                        </div>
                    ...
                    <div id="preview_payment"
                        ...
                        <div class="title-buttons-group">
                            ...
                            <div class="radio-group">
                                <input class="custom-icon-radio desktop preview-type"
                                       id="preview_payment_desktop"
                                       type="radio"
                                       name="preview-payment-type"
                                       data-target="preview-desktop-payment"
                                       data-toggle="preview-mobile-payment"
                                       checked
                                       readonly />
                                ...
                                <input class="custom-icon-radio mobile preview-type"
                                       id="preview_payment_mobile"
                                       type="radio"
                                       name="preview-payment-type"
                                       data-target="preview-mobile-payment"
                        ...
                        <div class="preview-container">
                            <div id="preview-desktop-payment"
                                 class="preview-content desktop">
                                        ...
                                        <div class="preview-payment-content">
                                            ...
                                            <div class="accepted-payment-list">
                                                ...
                                                <div class="accepted-payment accepted-payment-pix"
                                                    ...
                                                    <img src="{{ mix('build/layouts/checkouteditor/img/svg/icon-pix.svg') }}"
                                                         style="width: 35px;">
                                                    <span>Pix</span>
                                                </div>
                                                ...
                                                <div class="accepted-payment accepted-payment-bank-billet"
                                                    ...
                                                    <img src="{{ mix('build/layouts/checkouteditor/img/svg/icon-boleto.svg') }}"
                            ...
                            <div id="preview-mobile-payment"
                                 class="preview-content mobile"
                                 style="display: none">
                                <div id="preview-mobile-payment-collapse"
                                     class="preview-mobile-collapse">
                                    <div class="preview-header">
                                        <div class="header-colorbar mobile primary-color countdown-preview"></div>
                                        <div class="header-colorbar mobile secondary-color textbar-preview"> </div>
                    ...
                    <div id="preview_post_purchase"
                        ...
                        <div class="title-buttons-group">
                            ...
                            <div id="preview_type_post_purchase"
                                 class="radio-group">
                                <input class="custom-icon-radio desktop preview-type"
                                       id="preview_postpurchase_desktop"
                                       type="radio"
                                       name="preview-post-purchase-type"
                                       data-target="preview-desktop-post-purchase"
                                       data-toggle="preview-mobile-post-purchase"
                                       checked />
                                <label for="preview_postpurchase_desktop"><img
                                         src="{{ mix('build/layouts/checkouteditor/img/svg/computer-icon.svg') }}"></label>

                                <input class="custom-icon-radio mobile preview-type"
                                       id="preview_postpurchase_mobile"
                                       type="radio"
                                       name="preview-post-purchase-type"
                        ...
                        <div class="preview-container">
                            <div id="preview-desktop-post-purchase"
                                 class="preview-content desktop">

                                <div class="preview-body desktop post-purchase">
                                    <img src="{{ mix('build/layouts/checkouteditor/img/svg/barcode-icon.svg') }}"
                                         style="margin: 10px 0">

                                    <div class="input-form-placeholder"
                                         style="margin: 10px 0"></div>

                                    <div class="shop-message-preview desktop"
                                         style="margin: 10px 0">
                                    ...
                                    <div class="card-container"
                                        ...
                                        <div class="grey-container"
                                             style="margin-bottom: 10px; height: 60px"></div>
                                        ...
                                        <div style="display: flex; width: 100%; justify-content: space-between">
                                            ...
                                            <div class="whatsapp-preview"
                                                ...
                                                <img
                                                     src="{{ mix('build/layouts/checkouteditor/img/svg/whatsapp-icon.svg') }}">
                                            </div>
                                        </div>
                            ...
                            <div id="preview-mobile-post-purchase"
                                 class="preview-content mobile"
                                 style="display: none">
                ...
                <div class="editor-buttons position-fixed container page-content"
                     style="width: inhe;">
                    ...
                    <div class="save-changes"
                        ...
                        <div>
                            <img class="save-icon"
                                 src="{{ mix('build/layouts/checkouteditor/img/svg/save-check.svg') }}">
                        </div>
                    </div>
                    ...
                    <div class="save-changes"
                        ...
                        <div>
                            <img class="save-icon"
                                 src="{{ mix('build/layouts/checkouteditor/img/svg/save-error.svg') }}">
                        </div>
                    </div>

                    <div class="save-changes"
                         id="save_empty_fields"
                         style="display: none;">
                        <p>
                            <strong>Ops!</strong> Por favor, verifique a(s) mensagem(ns) em vermelho.
                        </p>
    ...
    <div class="modal fade"
         ...
         data-keyboard="false">
        <div class="modal-dialog modal-dialog-centered modal-crop"
             role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"
                        id="modalLabel">Banner no topo</h5>
                </div>
                ...
                <div class="modal-footer btn-group-crop">
                    ...
                    <div class='row-flex'>
                        <button type="button"
                                class="btn btn-secondary btn-crop-outline zoom"
                                id="zoom-out">-</button>
                        <input id="zoom-slide"
                               type="range"
                               min="0"
                        ...
                        <button type="button"
                                ...
                                id="zoom-in">+</button>
                        <button type="button"
                                class="btn btn-crop-reset"
                                id="crop-reset">Reset</button>
                    </div>

                    <div id='slider'></div>
                    <div>
                        <button type="button"
                                class="btn btn-crop-cancel"
                                id="button-cancel-crop"
                                data-dismiss="modal">Cancelar</button>
                        <button type="button"
                                class="btn btn-crop-cut"
                                id="button-crop">Cortar</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered"
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button type="button"
                            class="close verify-phone"
                            aria-hidden="true"
                            data-dismiss="modal">x</button>
                </div>
                <div id="modal_verify_content"
                     class="modal-body spaced">
                    <p>
                    ...
                    <p class="verify-error"
                       style="display: none">Código inválido ou vencido.</p>

                    <a id="resend_code"
                       class="resend-code">Reenviar código</a>
                    <p id="timer"
                       style="display: none"></p>

                    <button id="verify_phone"
                            class="verify-button"
                            type="button">Verificar</button>

                </div>

                <div id="modal_verified_content"
                     class="modal-body centered"
                     style="display: none">
                    <img class="icon-verified-modal"
                         src="{{ mix('build/layouts/checkouteditor/img/svg/verified-icon.svg') }}">
