...
<div class="checkout-container" style="max-height: 3585px;  margin-bottom: 20px;">
    ...
    <form id="form-checkout-editor">
        <div style="display: flex; flex-direction: column;">
            <div class="grid-checkout-editor">
                ...
                <div id="checkout_type" class="checkout-content select-type">
                    ...
                    <div id="checkout_type" class="radio-group">
                        <input class="custom-radio" id="checkout_type_steps" type="radio" name="checkout_type" value="1" checked/>
                        <label for="checkout_type_steps">Checkout de 3 passos</label>

                        <input class="custom-radio" id="checkout_type_unique" type="radio" name="checkout_type" value="2" />
                ...
                <div class="checkout-content visual">
                    ...
                    <div class="upload-container">
                        <div id='upload_logo'>
                            ...
                            <input type="file" id="logo_upload" name="logo" data-height="651" data-max-width="651" data-max-file-size="10M" data-allowed-file-extensions="jpg jpeg png">
                        </div>
                    ...
                    <div class="banner-top-container">
                            ...
                            <div style=" display: flex; min-width: 140px; align-items: center;">
                                ...
                                <div class="switch-holder mb-3">
                                    <label class="switch" style='top:3px'>
                                        <input type="checkbox" id="banner_top_flag" name="banner_top_flag" data-target="banner-top-content" class='check switch-checkout'>
                        ...
                        <div class="banner-top-content">
                            <div id='upload-banner'>
                                <input type="file" id="banner_upload" name="banner" data-max-file-size="10M" data-allowed-file-extensions="jpg jpeg png" onchange="showBannerPreview(event)">
                            </div>
                            ...
                            <div class="banner-intructions ">
                                ...
                                <div class="button-template">
                                    <button id="download_template_banner" class="line-button" type="button" data-href="{{ asset('/modules/checkouteditor/img/files/test-download.jps') }}">Baixar gabarito</button>
                                </div>
                        ...
                        <div class="countdown-container">
                            <div class="title-buttons-group">
                                ...
                                <div class="switch-holder mb-3">
                                    <label class="switch" style='top:3px'>
                                        <input type="checkbox" id="countdown_flag" name="countdown_flag" data-target="countdown-content" class='check switch-checkout'>
                                        <span class="slider round"></span>
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="textbar-container">
                            <div class="title-buttons-group">
                                ...
                                <div class="switch-holder mb-3">
                                    <label class="switch" style='top:3px'>
                                        <input type="checkbox" id="textbar_flag" name="textbar_flag" data-target="textbar-content" class='check switch-checkout'>
                                        <span class="slider round"></span>
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="sales-notifications-container">
                            ...
                            <div class="sales-notifications-content">
                                ...
                                <div id="notification-table">
                                    ...
                                    <table class="table table-hover" id="notification-table" data-plugin="selectable" data-row-selectable="true">
                                        <thead>
                                            <tr>
                                                <th class="w-50">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><b>XX</b> pessoas compraram {produto} nos últimos 30 minutos.</td>
                                                <td>
                        ...
                        <div class="social-proof-container">
                            ...
                            <div class="social-proof-content">
                                <div class="input-container">
                                    ...
                                    <textarea class="checkout-textarea" id="social-proof-message" name="social-proof-message" rows="1">Obrigado por comprar conosco!</textarea>
                                </div>
                ...
                <div class="checkout-content payment" id="payment_container">
                        ...
                        <div class="row-flex">
                            ...
                            <div class="input-container" style="flex: 3">
                                ...
                                <div id="payment_accept" class="check-group" style="justify-self: end;">
                                    ...
                                    <input class="custom-bubble-check accept-payment-method" id="accept_credit_card" type="checkbox" name="accept_payment_method" data-target="credit-card-container" data-target-preview="accepted_payment_card_creditcard" value="creditcard_accept" />
                                    <label for="accept_credit_card">Cartão de crédito</label>

                                    <input class="custom-bubble-check accept-payment-method" id="accept_pix" type="checkbox" name="accept_payment_method" data-target="" data-target-preview="accepted_payment_card_pix" value="pix_accept" />
                                    <label for="accept_pix">Pix</label>

                                    <input class="custom-bubble-check accept-payment-method" id="accept_billet" type="checkbox" name="accept_payment_method" data-target="" data-target-preview="accepted_payment_card_billet" value="billet_accept" />
                    ...
                    <div class="credit-card-container">
                        ...
                        <div style="display: flex; gap: 20px;">
                            <div class="input-container" style="flex: 1">
                                <label for="company_billing" class="checkout-label">Aplicar desconto de</label>
                                <div class="tagged-input-div">
                                    <input class="tagged-input" type="number" id="discount_applied_credit_card" name="discount_applied_credit_card" min="1" max="99" maxlength="3">
                    ...
                    <div class="billet-container">
                        ...
                        <div style="display: flex; gap: 20px;">
                            ...
                            <div class="input-container" style="flex: 1">
                                <label for="company_billing" class="checkout-label">Aplicar desconto de</label>
                                <div class="tagged-input-div">
                                    <input class="tagged-input" type="number" id="discount_applied_billet" name="discount_applied_billet" min="1" max="99" maxlength="3">
                                    <div class=" input-tag">%</div>
                                </div>
                            </div>    
                ...
                <div class="checkout-content post-purchase-pages" style="height: calc(100vh - 90px); max-height: calc(100vh - 70px);">
                    ...
                    <div class="thanks-page-container">
                        <div class="title-buttons-group">
                            ...
                            <div class="switch-holder mb-3">
                                <label class="switch" style='top:3px'>
                                    <input type="checkbox" id="thanks_page_flag" name="thanks_page_flag" data-target="thanks-page-content" class='check switch-checkout'>
                                    <span class="slider round"></span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="thanks-page-content">
                            ...
                            <input type="text" class="checkout-input-text" id="thanks_page_title" name="thanks_page_title" style="margin-bottom: 15px;"></input>
                    ...
                    <div id="preview_visual">
                        ...
                        <div class="preview-container">
                            <div class="preview-header">
                                <div id="secondary_color_preview" class="up-head-div secondary-color"></div>
                                <div id="primary_color_preview" class="down-head-div primary-color"></div>
                                <div id="banner_preview" class="preview-banner-div">
                                    <img id="preview_banner_img">
                                </div>                        
                            </div>
                            <div class="preview-body-visual">
                                <div class="preview-body-content-visual">
                                    ...
                                    <div class="checkout-body-right">
                                        ...
                                        <div class="list-placeholder-content">
                                            <div class="list-item-placeholder">
                                                <div class="circle-placeholder"></div> <div class="strip-placeholder"></div>
                                            </div>
                        ...
                        <div class="preview-colors">
                            ...
                            <div class="title-buttons-group">
                                <div>
                                    <label for="timeout-message" class="checkout-label">Utilizar um tema pronto</label>
                                </div>
                                <div class="switch-holder mb-3">
                                    <label class="switch" style='top:3px'>
                                        <input type="checkbox" id="theme_ready_flag" name="theme_ready_flag" data-target="theme-ready-content" data-toggle="custom-theme-content" class='check switch-checkout-accordion'>
                                        <span class="slider round"></span>
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="custom-theme-content">
                                <div>
                                    <label for="timeout-message" class="checkout-label">Personalize o seu próprio tema</label>
                            ...
                            <div class="preview-body-payment">
                                <div class="preview-body-content-payment">
                                    ...
                                    <div class="accepted-payment-list">
                                        <div id="accepted_payment_card_creditcard" class="fade-card">
                                                <div class="accepted-payment-card">
                                                    <img src="{{ asset('/modules/checkouteditor/img/svg/icon-card.svg') }}" style="width: 30px; filter: invert(100%) sepia(96%) saturate(15%) hue-rotate(209deg) brightness(150%) contrast(102%);">
                                                    <span>Cartão</span>
                                                </div>
                                            </div>

                                            <div id="accepted_payment_card_pix" class="fade-card">
                                                <div class="accepted-payment-card">
                                                    <img src="{{ asset('/modules/checkouteditor/img/svg/icon-pix.svg') }}" style="width: 52px;">
                                                    <span>Pix</span>
                                                </div>
                                            </div>
                                        
                                            <div id="accepted_payment_card_billet" class="fade-card">
                                                <div class="accepted-payment-card">
                                                    <img src="{{ asset('/modules/checkouteditor/img/svg/icon-boleto.svg') }}" style="width: 30px; filter: invert(100%) sepia(96%) saturate(15%) hue-rotate(209deg) brightness(150%) contrast(102%);">
                                                    <span>Boleto</span>
                                                </div>
                                            </div>
            ...
            <!-- <div class="save-changes" id="changing">
            ...
            <div class="save-changes" id="done">
                <div style="margin-right: 50px;">
