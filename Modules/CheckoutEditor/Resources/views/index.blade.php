            ...
            <div class="grid-checkout-editor">
                ...
                <div class="checkout-content visual">
                    <span class="title-icon">
                        <img class="icon-title" src="{{ mix('build/layouts/checkouteditor/img/svg/visual.svg') }}">
                        <h1 class="checkout-title">
                            Visual
                        </h1>
                    </span>
                    ...
                    <div class="favicon-logo-container">
                        <div class="logo-container">
                            ...
                            <div class="logo-content low-opacity">
                                ...
                                <div id='upload_logo'>
                                    <input type="file" id="checkout_logo" name="checkout_logo" data-max-file-size="10M" data-min-height="63" data-min-width="63" data-allowed-file-extensions="jpg jpeg png">
                        ...
                        <div class="favicon-container">
                            <div class="title-buttons-group">
                                <div class="row-flex">
                                    ...
                                    <div class="quantity-selector-tooltip">
                                        <img id="favicon-tooltip" data-target="favicon-tooltip-container" src="{{ mix('build/layouts/checkouteditor/img/svg/info-icon.svg') }}">
                                        <div id="favicon-tooltip-container" class="tooltip-container" style="display: none">
                                            <div class="tooltip-content">
                                                ...
                                                <div class="tab-example">
                                                    <div class="row-flex">
                                                        <img class="sirius-icon" src="build/layouts/checkouteditor/img/svg/icon-sirius.svg">
                                                        <p>Sirius</p>
                                                    </div>
                                                    <p>x</p>
                                                </div>
                            ...
                            <div class="favicon-content low-opacity">
                                ...
                                <div id='upload_favicon' class="low-opacity">
                                    <input type="file" id="checkout_favicon" name="checkout_favicon" data-errors-position="outside" data-show-errors="false" data-max-heigth="33" data-max-width="33" data-show-loader="false" data-max-file-size="10M" data-allowed-file-extensions="jpg jpeg png ico">
                            ...
                            <div style=" display: flex; min-width: 140px; justify-content: space-between; align-items: center;">
                                <div>
                                    <div id="banner_type" class="radio-group" style="justify-self: end; display: none;">
                                        ...
                                        <label for="banner_type_square"><img src="{{ mix('build/layouts/checkouteditor/img/svg/banner-square.svg') }}"></label>

                                        <input class="custom-icon-radio" id="banner_type_wide" type="radio" name="checkout_banner_type" value="1" />
                                        <label for="banner_type_wide"><img src="{{ mix('build/layouts/checkouteditor/img/svg/banner-wide.svg') }}"></label>
                                    </div>
                                </div>
                        ...
                        <div class="banner-top-content" style="display: none">
                            ...
                            <div class="row-flex">
                                ...
                                <div class="button-template">
                                    <button id="download_template_banner" class="line-button" type="button" data-href="{{ mix('build/layouts/checkouteditor/files/Gabarito_EditorCheckout.zip') }}">
                                        <img class="icon-title download" src="{{ mix('build/layouts/checkouteditor/img/svg/download-icon.svg') }}">
                            ...
                            <div class="countdown-content" style="display: none">
                                ...
                                <div class="input-container">
                                    <label for="timeout-message" class="checkout-label">Mensagem ao encerrar o
                                        tempo</label>
                                    <textarea class="checkout-textarea" id="countdown_finish_message" name="countdown_finish_message" rows="3" maxlength="55" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"></textarea>
                ...
                <div class="checkout-content payment" id="payment_container">
                    <div class="title-buttons-group">
                        <span class="title-icon">
                            <img class="icon-title" src="{{ mix('build/layouts/checkouteditor/img/svg/payments.svg') }}">
                            <h1 class="checkout-title">
                                Pagamentos
                            </h1>
                        </span>
                    ...
                    <div class="billing-content">
                        ...
                        <div class="row-flex">
                            ...
                            <div id="payments" class="input-container" style="flex: 7">
                                ...
                                <div id="company_billing_error" class="checkout-error" style="display: none;">
                        ...
                        <div class="row-flex">
                            <div class="input-container" style="flex: 2">
                                <label class="quantity-selector-label">Seletor de quantidade
                                    <div class="quantity-selector-tooltip">
                                        <img id="selector-tooltip" src="{{ mix('build/layouts/checkouteditor/img/svg/info-icon.svg') }}">
                                        <div id="selector-tooltip-container" class="tooltip-container" style="display: none">
                                            <div class="tooltip-content">
                                                ...
                                                <div class="input-example">
                                                    ...
                                                    <div class="counter-example">
                                                        <img src="{{ mix('build/layouts/checkouteditor/img/svg/red-minus.svg') }}">
                                                        <p>1</p>
                                                        <img src="{{ mix('build/layouts/checkouteditor/img/svg/green-plus.svg') }}">
                                                    </div>
                ...
                <div class="checkout-content post-purchase-pages" id="post_purchase" style="margin-bottom: 350px;">
                    ...
                    <span class="title-icon">
                        <img class="icon-title" src="{{ mix('build/layouts/checkouteditor/img/svg/paid-page.svg') }}">
                        <h1 class="checkout-title">
                            Página pós-compra
                        </h1>
                    </span>
                    ...
                    <div class="whatsapp-container">
                        ...
                        <div class="whatsapp-content" style="display: none">
                            ...
                            <div class="textarea-observation">
                                <img class="dot" src="{{ mix('build/layouts/checkouteditor/img/svg/info-icon.svg') }}"></span><span class="observation-span">Caso preenchido, esse número apareçerá para o cliente no
                    ...
                    <div id="preview_visual">
                        <div class="title-buttons-group">
                            ...
                            <div id="preview_type_visual" class="radio-group">
                                ...
                                <label for="preview_visual_computer"><img src="{{ mix('build/layouts/checkouteditor/img/svg/computer-icon.svg') }}"></label>
                                ...
                                <label for="preview_visual_mobile"><img src="{{ mix('build/layouts/checkouteditor/img/svg/mobile-icon.svg') }}"></label>
                            </div>
                        </div>
                    ...
                    <div id="preview_payment" style="display: none;">
                        <div class="title-buttons-group">
                            ...
                            <div class="radio-group">
                                ...
                                <label for="preview_payment_desktop"><img src="{{ mix('build/layouts/checkouteditor/img/svg/computer-icon.svg') }}"></label>
                                ...
                                <label for="preview_payment_mobile"><img src="{{ mix('build/layouts/checkouteditor/img/svg/mobile-icon.svg') }}"></label>
                            </div>
                        </div>
                                        ...
                                        <div class="preview-payment-content">
                                            ...
                                            <div class="accepted-payment-list">
                                                ...
                                                <div class="accepted-payment accepted-payment-pix" id="accepted_payment_pix">
                                                    <img src="{{ mix('build/layouts/checkouteditor/img/svg/icon-pix.svg') }}" style="width: 35px;">
                                                    <span>Pix</span>
                                                </div>

                                                <div class="accepted-payment accepted-payment-bank-billet" id="accepted_payment_bank_billet">
                                                    <img src="{{ mix('build/layouts/checkouteditor/img/svg/icon-boleto.svg') }}" style="width: 20px; filter: invert(100%) sepia(96%) saturate(15%) hue-rotate(209deg) brightness(150%) contrast(102%);">
                                                    <span>Boleto</span>
                                                </div>
                    ...
                    <div id="preview_post_purchase" style="display: none;">
                        <div class="title-buttons-group">
                            ...
                            <div id="preview_type_post_purchase" class="radio-group">
                                ...
                                <label for="preview_postpurchase_desktop"><img src="{{ mix('build/layouts/checkouteditor/img/svg/computer-icon.svg') }}"></label>
                                ...
                                <label for="preview_postpurchase_mobile"><img src="{{ mix('build/layouts/checkouteditor/img/svg/mobile-icon.svg') }}"></label>
                            </div>
                        </div>
                        ...
                        <div class="preview-container">
                            <div id="preview-desktop-post-purchase" class="preview-content desktop">
                                ...
                                <div class="preview-body desktop post-purchase">
                                    <img src="{{ mix('build/layouts/checkouteditor/img/svg/barcode-icon.svg') }}" style="margin: 10px 0">
                                    ...
                                    <div class="card-container" style="margin-bottom: 20px;">
                                        ...
                                        <div style="display: flex; width: 100%; justify-content: space-between">
                                            <div style="border-radius: 12px; height: 25px; width: 70px; background-color: #F5F5F5; margin: 0 20px 0 0;border-radius: 4px;">
                                            </div>

                                            <div class="primary-color" style="border-radius: 12px; height: 25px; width: 80px; background-color: #2E85EC; border-radius: 4px; margin-right: 5px;">
                                            </div>
                                            ...
                                            <div class="whatsapp-preview" style="display: flex; padding: 6px; border-radius: 12px; height: 25px; width: 120px; background-color: #36DB8C; border-radius: 4px;">
                                                <img src="{{ mix('build/layouts/checkouteditor/img/svg/whatsapp-icon.svg') }}">
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-container" style="display: flex; flex-direction: column; gap: 15px;">
                                        <div style="display: flex; width: 100%; justify-content: space-between; align-items: center; gap: 5px;">
                                            <div style="display: flex; width: 100%; align-items: center; gap: 5px;">
                                                <div class="grey-container" style="border-radius: 4px; height: 50px; width: 50px; min-width: 50px; background: linear-gradient(90deg, #F7F7F7 2.82%, rgba(239, 239, 239, 0) 95.36%);">
                                                </div>
                                                <div class="grey-container" style="border-radius: 4px; height: 35px; width: 100%; background: linear-gradient(90deg, #F7F7F7 2.82%, rgba(239, 239, 239, 0) 95.36%);">
                                                </div>
                                            </div>
                            ...
                            <div id="preview-mobile-post-purchase" class="preview-content mobile" style="display: none">
                                <div class="preview-mobile-collapse">
                                    <div class="preview-body mobile post-purchase">
                                        <img src="{{ mix('build/layouts/checkouteditor/img/svg/barcode-icon.svg') }}" style="height: 70px; margin: 5px 0">
                                        ...
                                        <div class="preview-card">
                                            ...
                                            <div style="display: flex; width: 100%; justify-content: space-between">
                                                <div style="border-radius: 12px; height: 35px; width: 70px; background-color: #F5F5F5; margin: 0 20px 0 0;border-radius: 8px;">
                                                </div>

                                                <div class="primary-color" style="border-radius: 12px; height: 35px; width: 100px; background-color: #2E85EC; border-radius: 4px;">
                                                </div>
                                            </div>
                ...
                <div class="editor-buttons position-fixed container page-content" style="width: inhe;">
                    ...
                    <div class="save-changes" id="save_success" style="display: none;">
                        ...
                        <div>
                            <img class="save-icon" src="{{ mix('build/layouts/checkouteditor/img/svg/save-check.svg') }}">
                        </div>
                    </div>
                    ...
                    <div class="save-changes" id="save_error" style="display: none;">
                        ...
                        <div>
                            <img class="save-icon" src="{{ mix('build/layouts/checkouteditor/img/svg/save-error.svg') }}">
                        </div>
                    </div>
                    ...
                    <div class="save-changes " id="save_changes" style="display: none">
                        ...
                        <div class="save-changes-button-group">
                            ...
                            <button type="submit" form="checkout_editor" class="font-size-16 btn btn-light text-primary mr-40 mr-sm-0 px-15 px-sm-40">Salvar
                                alterações</button>
                        </div>
                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div id="modal_verified_content" class="modal-body centered" style="display: none">
                    <img class="icon-verified-modal" src="{{ mix('build/layouts/checkouteditor/img/svg/verified-icon.svg') }}">
