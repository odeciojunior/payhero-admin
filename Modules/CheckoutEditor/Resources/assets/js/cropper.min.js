...
!(function (t, e) {
        ...
        return (
            ...
            (function (t, e) {
                if (t) {
                    ...
                    return "Map" === (i = "Object" === i && t.constructor ? t.constructor.name : i) || "Set" === i
                        ? Array.from(t)
    ...
    function Lt(t, e) {
        ...
        return (
            h && t
                ? ((e = a * i), ("contain" === o && n < e) || ("cover" === o && e < n) ? (a = n / i) : (n = a * i))
                : h
                ? (a = n / i)
                : t && (n = a * i),
            { width: n, height: a }
    ...
    var Rt = {
            ...
            renderImage: function (t) {
                ...
                rt(i, { width: a, height: n, left: (e.width - a) / 2, top: (e.height - n) / 2 }),
                    lt(
                        this.image,
                        rt({ width: i.width, height: i.height }, Ht(rt({ translateX: i.left, translateY: i.top }, i)))
                    ),
                    t && this.output();
            },
        ...
        St = {
            ...
            preview: function () {
                ...
                this.cropped &&
                    !this.disabled &&
                    (lt(this.viewBoxImage, rt({ width: c, height: d }, Ht(rt({ translateX: -l, translateY: -p }, h)))),
                    ht(this.previews, function (t) {
                        var e = vt(t, f),
                            i = e.width,
                            a = e.height,
                ...
                switch (h) {
                    ...
                    case O:
                        ...
                        (y = kt(this.cropper)),
                            ...
                            D.y < 0 && (c -= l),
                            this.cropped ||
                                (mt(this.cropBox, A), (this.cropped = !0), this.limited && this.limitCropBox(!0, !0));
                }
                w &&
        ...
        At = {
            ...
            destroy: function () {
                ...
                return (
                    t[c] &&
                        ((t[c] = void 0), this.isImg && this.replaced && (t.src = this.originalUrl), this.uncreate()),
                    this
                );
            },
            move: function (t) {
            ...
            moveTo: function (t) {
                ...
                return (
                    ...
                    this.ready &&
                        ...
                        (F(t) && ((i.left = t), (a = !0)), F(e) && ((i.top = e), (a = !0)), a && this.renderCanvas(!0)),
                    this
                );
            },
            zoom: function (t, e) {
            ...
            setData: function (t) {
                ...
                return (
                    this.ready &&
                        ...
                        it(t) &&
                        ((e = !1),
                        i.rotatable && F(t.rotate) && t.rotate !== a.rotate && ((a.rotate = t.rotate), (e = !0)),
                        i.scalable &&
                ...
                (e = [
                    {
                        ...
                        value: function () {
                            ...
                            if (!e[c]) {
                                if (((e[c] = this), "img" === i)) {
                                    if (((this.isImg = !0), (t = e.getAttribute("src") || ""), !(this.originalUrl = t)))
                                        return;
                                    t = e.src;
