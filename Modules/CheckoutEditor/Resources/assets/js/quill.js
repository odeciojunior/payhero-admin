                                ...
                                [range.start, range.end].forEach(function (position) {
                                    ...
                                    while (!(node instanceof Text) && node.childNodes.length > 0) {
                                        if (node.childNodes.length > offset) {
                                            ...
                                            node = node.lastChild;
                                            offset =
                                                node instanceof Text ? node.data.length : node.childNodes.length + 1;
                                        } else {
                                            break;
                                        }
                                    }
                        ...
                        [
                            {
                                key: "create",
                                value: function create(value) {
                                    var node = _get(Link.__proto__ || Object.getPrototypeOf(Link), "create", this).call(
                                        this,
                                        value
                                    );
                    ...
                    _createClass(Script, null, [
                        {
                            ...
                            value: function create(value) {
                                if (value === "super") {
                                    ...
                                    return _get(Script.__proto__ || Object.getPrototypeOf(Script), "create", this).call(
                                        this,
                                        value
                                    );
                                }
