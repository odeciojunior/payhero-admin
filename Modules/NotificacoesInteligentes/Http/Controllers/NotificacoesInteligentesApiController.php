...
class NotificacoesInteligentesApiController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $notificacoesInteligentesIntegration      = $notificacoesInteligentesIntegrationModel->find(current(Hashids::decode($id)));
    ...
    public function edit($id)
    {
        try {
            ...
            Log::warning('Erro ao tentar acessar tela editar Integração NotificacoesInteligentes (NotificacoesInteligentesController - edit)');
            report($e);
    ...
    public function destroy($id)
    {
        try {
            ...
            Log::warning('Erro ao tentar remover Integração NotificacoesInteligentes (NotificacoesInteligentesController - destroy)');
            report($e);
