...
@push('css')
    <link rel="stylesheet"
          href="{{ mix('build/layouts/whatsapp2/index.min.css') }}">
    <style>
        .o-arrow-right-1 {
            font-size: 30px;
        }
                ...
                <div class="modal-dialog modal-lg d-flex justify-content-center">
                    <div class="modal-content w-450"
                        ...
                        <div class="pt-10 pr-20 pl-20 modal_integracao_body">
                                ...
                                <div class='col-12'>
                                    <label for='email'>Token
                                        <i class="fa-question-circle-o text-info"
                                           data-content="Copie o token e adicione uma integração com a CloudFox na sua conta do SAK para gerar as urls de pedidos e checkouts. Depois cole as urls abaixo para finalizar sua integração"
                                           data-toggle="popover"
                            ...
                            @include('whatsapp2::create')
                            @include('whatsapp2::edit')
                        </div>
