...
@section('content')
    <div class='page'>
                        ...
                        <div class="pt-10 pr-20 pl-20 modal_integracao_body">
                            <div class='row'>
                                ...
                                <div id='invite-link-select' class='input-group col-12'>
                                    <input type='text' class='form-control' id='inputTokenWhats2' value='' readonly>
                                    <span class='input-group-btn'>
                                        <button id='btnCopyTokenWhats2' class='btn btn-default' type='button'>Copiar</button>
                                    </span>
                                </div>
                            </div>
        ...
        <div id="no-integration-found" class='row justify-content-center' style="display:none !important; width:100%;">
