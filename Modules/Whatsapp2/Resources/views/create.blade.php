    ...
    <div style="width:100%">
        ...
        <div class="row">
            <div class='form-group col-12'>
                ...
                <div class="d-flex input-group">
                    <input type="url" class="input-pad addon" name="url_order" id="url_order"
        ...
        <div class="row">
            <div class='form-group col-12'>
                ...
                <div class="d-flex input-group">
                    <input type="url" class="input-pad addon" name="url_checkout" id="url_checkout"
        ...
        <div class="row mt-20">
            <div class="col-6">
                <div class="switch-holder">
                    ...
                    <br>
                    <label class="switch">
                        <input type="checkbox" value='1' name="boleto_generated" id="boleto_generated" class='check'
                               checked>
        ...
        <div class="row mt-20">
            <div class="col-6">
                <div class="switch-holder">
                    ...
                    <br>
                    <label class="switch">
                        <input type="checkbox" value='1' name="credit_card_paid" id="credit_card_paid" class='check'
                               checked>
                        <span class="slider round"></span>
                    </label>
                </div>
            ...
            <div class="col-6">
                <div class="switch-holder">
                    ...
                    <br>
                    <label class="switch">
                        <input type="checkbox" value='1' name="credit_card_refused" id="credit_card_refused"
                               class='check' checked>
                        <span class="slider round"></span>
                    </label>
                </div>
        ...
        <div class="row mt-20">
            <div class="col-6">
                <div class="switch-holder">
                    ...
                    <br>
                    <label class="switch">
                        <input type="checkbox" value='1' name="abandoned_cart" id="abandoned_cart" class='check'
                               checked>
                        <span class="slider round"></span>
                    </label>
                </div>
