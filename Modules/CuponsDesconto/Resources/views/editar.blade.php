...
@section('content')
  ...
  <div class="page">
        ...
        <div class="page-header">
            <h1 class="page-title">Editar cupom de desconto</h1>
            <div class="page-header-actions">
                <a class="btn btn-primary float-right" href="{{ route('cuponsdesconto') }}">
                    ...
                    <div style="width:100%">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-xl-6">
                                ...
                                <input value="{!! $cupom->valor != '' ? $cupom->valor : '' !!}" name="valor" type="text" class="form-control" id="valor" placeholder="Valor">
                            </div>
                        </div>
