  ...
  <div class="page">
    ...
    <div class="page-header">
        ...
        <div class="page-header-actions">
            <a class="btn btn-success float-right" href="/cuponsdesconto/cadastro" style="margin-right: 10px">
    ...
    <div class="page-content container-fluid">
      <div class="panel pt-30 p-30" data-plugin="matchHeight">
        ...
        <div class="modal fade example-modal-lg modal-3d-flip-vertical" id="modal_excluir" aria-hidden="true" aria-labelledby="exampleModalTitle" role="dialog" tabindex="-1">
            <div class="modal-dialog modal-simple">
              <div class="modal-content">
                <form id="form_excluir_cupom" method="GET" action="/deletarcupomdesconto">
                  <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                      <span aria-hidden="true">×</span>
                    </button>
        ...
        $("#tabela_cuponsdesconto").DataTable( {
            ...
            "drawCallback": function() {
                ...
                $('.excluir_cupom').on('click', function(){
                    ...
                    var id_cupom = $(this).attr('cupom');

                    $('#form_excluir_cupom').attr('action','/cuponsdesconto/deletarcupomdesconto/'+id_cupom);

                    var name = $(this).closest("tr").find("td:first-child").text();

                    $('#modal_excluir_titulo').html('Excluir o cupom '+name+'?');
