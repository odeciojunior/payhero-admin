...
<form id='form_update_integration'
    ...
    <div style="width:100%">
        ...
        <div class="row">
            <div class='form-group col-12'>
                <label for="client_secret_edit">CLIENT SECRET</label>
                <div class="d-flex input-group">
                    <input type="password"
                           class="input-pad addon"
                           name="client_secret"
                           id="client_secret_edit"
        ...
        <div class="row">
            ...
            <div class="col-4">
                <div class="switch-holder">
                    <label for="boleto_expired_edit"
                           class='mb-10'>Boleto expirado:</label>
                    <br>
                    <label class="switch">
                        <input type="checkbox"
                               name="boleto_expired_edit"
                               id="boleto_expired_edit"
                               class='check'>
                        <span class="slider round"></span>
                    </label>
                </div>
        ...
        <div class="row mt-20">
            <div class="col-4">
                <div class="switch-holder">
                    <label for="pix_generated_edit"
                           class='mb-10'>Pix gerado:</label>
                    <br>
                    <label class="switch">
                        <input type="checkbox"
                               name="pix_generated"
                               id="pix_generated_edit"
                               class='check'>
                        <span class="slider round"></span>
                    </label>
                </div>
