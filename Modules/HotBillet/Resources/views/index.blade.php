...
@push('css')
    ...
    <link rel="stylesheet" href="{!! mix('build/layouts/hotbillet/index.min.css') !!}">
    <style>
        .gray:hover{
     ...
     <link rel="stylesheet" href="{!! mix('build/layouts/hotbillet/index2.min.css') !!}">
     <style>
        .o-arrow-right-1 {
            font-size: 30px;
        }
...
@section('content')
                ...
                <div class="modal-dialog modal-lg d-flex justify-content-center">
                    <div class="modal-content w-450" id="conteudo_modal_add">
                        ...
                        <div class="pt-10 pr-20 pl-20 modal_integracao_body">
                            @include('hotbillet::create')
                            @include('hotbillet::edit')
                        </div>
    ...
    @push('scripts')
        ...
        <script src="{{ mix('build/layouts/hotbillet/index.min.js') }}"></script>
    @endpush
@endsection
