...
class AutenticacaoServiceProvider extends ServiceProvider
{
    ...
    protected function registerConfig()
    {
        ...
        $this->mergeConfigFrom(
            __DIR__.'/../Config/config.php', 'autenticacao'
        );
    }
    ...
    public function registerViews()
    {
        ...
        }, \Config::get('view.paths')), [$sourcePath]), 'autenticacao');
    }
    ...
    public function registerTranslations()
    {
        ...
        if (is_dir($langPath)) {
            $this->loadTranslationsFrom($langPath, 'autenticacao');
        } else {
            $this->loadTranslationsFrom(__DIR__ .'/../Resources/lang', 'autenticacao');
        }
    }
