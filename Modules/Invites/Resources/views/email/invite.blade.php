...
<body
    ...
    <table style="width:600px; text-align:center"
        ...
        <table style="border-radius-top: 10px; line-height: 135%; padding: 20px 80px;background-color: white;width:600px;"
               align="center"
               cellpadding="0"
               cellspacing="0">
            <tr>
        ...
        <table style="text-align: center;background: white;padding: 25px 80px;width:600px;"
               align="center">
            <tr style='color: #444444;padding-bottom: 40px;margin-bottom: 40px;'>
                <td>
                    <p style='padding-bottom:20px;'>
                        Você recebeu um convite para se cadastrar na Cloudfox e agora chegou a sua hora de fazer parte
                        da
