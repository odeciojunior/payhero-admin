...
<div class="page">
    ...
    <div style="display: none" class="page-header container">
        <div class="row align-items-center justify-content-between" style="min-height:50px">
            ...
            <div class="col-4 text-right">
                <button id="store-invite" title='Adicionar convite' type="button" class="btn btn-floating btn-primary" style="position: relative; float: right" {{-- data-target='#modal' data-toggle='modal' --}}>
    ...
    <div class="page-content container" id='page-invites'>
        ...
        <div class="row no-gutters d-flex justify-content-center justify-content-md-end pb-35">
                        ...
                        <div id='body-modal'>
                            ...
                            <div class='row' style='margin-top: 35px'>
                                <div class='form-group col-12 text-right'>
                                    <input id='btn-send-invite' type='button' class='form-control btn btn-primary col-sm-12 col-m-3 col-lg-3' value='Enviar Convite'>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div id='modal-not-companies' class='modal-content p-10' style='display: none;'>
                    ...
                    <div class='modal-body simple-border-bottom' style='padding-bottom: 1%; padding-top: 1% ;'>
                        ...
                        <h5 align='center'>
                            ...
                            <a class='red pointer' href='{{ env('ACCOUNT_FRONT_URL') }}/redirect/{{ \Vinkla\Hashids\Facades\Hashids::connection('login')->encode(auth()->user()->id) }}/{{ (string) \Vinkla\Hashids\Facades\Hashids::encode(\Carbon\Carbon::now()->addMinute()->unix()) }}/companies'>Clique
                                aqui</a>
                        </h5>
                    </div>
...
<div class="modal fade example-modal-lg modal-3d-flip-vertical" id="modal-resend-invitation" aria-hidden="true" aria-labelledby="exampleModalTitle" role="dialog" tabindex="-1">
    <div class="modal-dialog  modal-dialog-centered  modal-simple">
        <div class="modal-content">
            ...
            <div class="modal-footer d-flex align-items-center justify-content-center">
                <button id='btn-cancel' type="button" class="col-4 btn btn-gray" data-dismiss="modal" style="width: 20%;">Cancelar
                </button>
                <button id="btn-resend-invitation" type="button" class="col-4 btn btn-success" style="width: 20%;" data-dismiss="modal">Enviar
                </button>
            </div>
        </div>
    </div>
