...
@section('content')
    ...
    <div class="page">
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 card">
                        <div class="card-body">
                            ...
                            <h4 id='invitations_sent'
                                class="font-size-30 bold number"></h4>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6 col-xs-12 card">
                        <div class="card-body">
                            ...
                            <h4 id='invitations_accepted'
                                class="font-size-30 bold number"></i>
                            </h4>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6 col-xs-12 card">
        ...
        <div id="content-error"
             ...
             style="display:none !important; margin-top: -40px;">
        ...
        <div class="page-content container"
            ...
            <div class="row no-gutters d-flex justify-content-center justify-content-md-end pb-35">
                <ul id="pagination-invites"
                    class="pagination-sm margin-chat-pagination mb-0 pagination-style"
