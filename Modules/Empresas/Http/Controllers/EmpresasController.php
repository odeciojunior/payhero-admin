...
class EmpresasController extends Controller {
    ...
    public function getDetalhesEmpresa(Request $request){
        ...
        $modalBody .= "<td>".$empresa->cnpj."</td>";
        $modalBody .= "</tr>";
        $modalBody .= "<tr>";
        $modalBody .= "<td><b>Nome fantasia:</b></td>";
        $modalBody .= "<td>".$empresa->nome."</td>";
        $modalBody .= "</tr>";
        $modalBody .= "<tr>";
        $modalBody .= "<td><b>Email:</b></td>";
        $modalBody .= "<td>".$empresa->email."</td>";
        $modalBody .= "</tr>";
        $modalBody .= "<tr>";
        $modalBody .= "<td><b>Telefone:</b></td>";
        $modalBody .= "<td>".$empresa->telefone."</td>";
        $modalBody .= "</tr>";
        $modalBody .= "<tr>";
        $modalBody .= "<td><b>CEP:</b></td>";
        $modalBody .= "<td>".$empresa->cep."</td>";
        $modalBody .= "</tr>";
        $modalBody .= "<tr>";
        $modalBody .= "<td><b>Estado:</b></td>";
        $modalBody .= "<td>".$empresa->estado."</td>";
        $modalBody .= "</tr>";
        $modalBody .= "<tr>";
        $modalBody .= "<td><b>Cidade:</b></td>";
        $modalBody .= "<td>".$empresa->cidade."</td>";
        $modalBody .= "</tr>";
        $modalBody .= "<tr>";
        $modalBody .= "<td><b>Bairro:</b></td>";
        $modalBody .= "<td>".$empresa->bairro."</td>";
        $modalBody .= "</tr>";
        $modalBody .= "<tr>";
        $modalBody .= "<td><b>Rua:</b></td>";
        $modalBody .= "<td>".$empresa->logradouro."</td>";
        $modalBody .= "</tr>";
        $modalBody .= "<tr>";
        $modalBody .= "<td><b>Número:</b></td>";
        $modalBody .= "<td>".$empresa->numero."</td>";
        $modalBody .= "</tr>";
        $modalBody .= "<tr>";
        $modalBody .= "<td><b>Complemento:</b></td>";
        $modalBody .= "<td>".$empresa->complemento."</td>";
        $modalBody .= "</tr>";
        $modalBody .= "</thead>";
        $modalBody .= "</table>";
        $modalBody .= "</div>";
