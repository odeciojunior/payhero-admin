            ...
            <div class="row">
                ...
                @if(auth()->user()->id == 24)
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 pointer d-flex align-items-stretch">
                        <div class="card" onclick="window.location.href='/apps/unicodrop'" style='width:300px;'>
                            ...
                            <img class="card-img-top mt-100" src="{!! asset('modules/global/img/unicodrop.jpeg') !!}" alt="" align="middle">
                            <div class="card-body mt-80">
                ...
                <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 pointer d-flex align-items-stretch">
                    <div class="card" onclick="window.location.href='/apps/smartfunnel'" style='width:300px;'>
                        ...
                        <img class="card-img-top" style='height:250px;' src="{!! asset('modules/global/img/smartfunnel.jpeg') !!}" alt="" align="middle">
                        <div class="card-body">
