                ...
                <div class="row">
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 pointer d-flex align-items-stretch div-notazz-integration">
                        <div class="card app-integration" data-url="/apps/notazz/" style='width: 270px;'>
                            ...
                            <img class="card-img-top card-img-controll" src="{!! mix('modules/global/img/notazz.png') !!}" alt="" align="middle">
                            <div class="card-body">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 pointer d-flex align-items-stretch">
                        <div class="card app-integration" data-url="/apps/hotzapp/" style='width: 270px;'>
                            ...
                            <img class="card-img-top card-img-controll" src="{!! mix('modules/global/img/hotzapp.png') !!}" alt="">
                            <div class="card-body">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 pointer d-flex align-items-stretch">
                        <div class="card app-integration" data-url="/apps/shopify" style='width: 270px;'>
                            ...
                            <img class="card-img-top card-img-controll" src="{!! mix('modules/global/img/shopify.png') !!}" alt="">
                            <div class="card-body">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 pointer d-flex align-items-stretch">
                        <div class="card app-integration" data-url="/apps/convertax" style='width: 270px;'>
                            ...
                            <img class="card-img-top card-img-controll" src="{!! mix('modules/global/img/convertax.png') !!}" alt="" align="middle">
                            <div class="card-body">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 pointer d-flex align-items-stretch">
                        <div class="card app-integration" data-url="/apps/activecampaign" style='width: 270px;'>
                            ...
                            <img class="card-img-top card-img-controll" src="{!! mix('modules/global/img/active_campaign.png') !!}" alt="" align="middle">
                            <div class="card-body">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 pointer d-flex align-items-stretch">
                        <div class="card app-integration" data-url="/apps/whatsapp2" style='width: 270px;'>
                            ...
                            <img class="card-img-top card-img-controll" src="{!! mix('modules/global/img/sak.png') !!}" alt="" align="middle">
                            <div class="card-body">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 pointer d-flex align-items-stretch">
                        <div class="card app-integration" data-url="/apps/reportana" style='width: 270px;'>
                            ...
                            <img class="card-img-top card-img-controll" src="{!! mix('modules/global/img/reportana.png') !!}" alt="" align="middle">
                            <div class="card-body">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 pointer d-flex align-items-stretch">
                        <div class="card app-integration" data-url="/apps/unicodrop" style='width: 270px;'>
                            ...
                            <img class="card-img-top card-img-controll" src="{!! mix('modules/global/img/unicodrop.png') !!}" alt="" align="middle">
                            <div class="card-body">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 pointer d-flex align-items-stretch">
                        <div class="card app-integration" data-url="/apps/smartfunnel" style='width: 270px;'>
                            ...
                            <img class="card-img-top card-img-controll" src="{!! mix('modules/global/img/smartfunnel.png') !!}" alt="" align="middle">
                            <div class="card-body">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 pointer d-flex align-items-stretch">
                        <div class="card app-integration" data-url="/apps/woocommerce" style='width: 270px;'>
                            ...
                            <img class="card-img-top card-img-controll mt-30" src="{!! mix('modules/global/img/woocom.jpg') !!}" alt="">
                            <div class="card-body">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 pointer d-flex align-items-stretch">
                        <div class="card app-integration" data-url="/apps/melhorenvio" style='width: 270px;'>
                            ...
                            <img class="card-img-top card-img-controll" src="{!! mix('modules/global/img/melhorenvio.png') !!}" alt="">
                            <div class="card-body">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 pointer d-flex align-items-stretch">
                        <div class="card app-integration" data-url="/apps/hotbillet" style='width: 270px;'>
                            ...
                            <img class="card-img-top card-img-controll  mt-100 mb-100" src="{!! mix('modules/global/img/hotbillet.png') !!}" alt="">
                            <div class="card-body">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 pointer d-flex align-items-stretch">
                        <div class="card app-integration" data-url="/apps/astronmembers" style='width: 270px;'>
                            ...
                            <img class="card-img-top card-img-controll  mt-100 " src="{!! mix('modules/global/img/astromembers.jpeg') !!}" alt="">
                            <div class="card-body">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 pointer d-flex align-items-stretch">
                        <div class="card app-integration" data-url="/integrations" style='width:270px;'>
                            ...
                            <img class="card-img-top card-img-controll p-20" src="{!! mix('modules/global/img/svg/api.svg') !!}" alt="">
                            <div class="card-body">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 pointer d-flex align-items-stretch">
                        <div class="card app-integration" data-url="/apps/digitalmanager" style='width: 270px;'>
                            ...
                            <img class="card-img-top card-img-controll" src="{!! mix('modules/global/img/digital_manager_guru.png') !!}" alt="" align="middle">
                            <div class="card-body">
