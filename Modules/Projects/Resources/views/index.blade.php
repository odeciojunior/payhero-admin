...
@section('content')
  ...
  <div class="page"> 
    ...
    <div class="page-header">
        <a href="{!! route('projetos.create') !!}" class="btn btn-floating btn-danger" style="position: relative; float: right"><i class="icon wb-plus" aria-hidden="true" style="margin-top:8px"></i></a>
              ...
              <div class="col-xl-3 col-md-6 info-panel">
                  <div class="card card-shadow">
                    ...
                    <div class="card-block">
                      <a href='/projetos/projeto/{!! $project['id'] !!}' class="text-center">
