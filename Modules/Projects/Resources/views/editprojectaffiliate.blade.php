<div class='card shadow p-30'>
    <form id='update-project'>
                        ...
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text"
                                      id="input_group_support_phone"
                                      id="addon-suport_phone">
                                    <span class="material-icons">phone</span>
                                </span>
                            </div>
                            <input name="suport_phone"
                                   value=""
                                   type="text"
                                   ...
                                   aria-describedby="addon-suport_phone">
                        </div>
                        ...
                        <p class='info pt-5'
                           style='font-size: 10px;'>
                            <i class='icon wb-info-circle'
                               aria-hidden='true'></i> Telefone para suporte. Em compras por boleto na página de
                            obrigado quando o cliente clicar em receber pelo whats a mensagem é encaminhada para esse
                            número
                        </p>
                    </div>
                </div>
        ...
        {{-- <div class="col-12"> --}}
        {{-- <div class='d-flex flex-column text-center' id='div-img-project' style='position: relative;'> --}}
        {{-- <img id='image-logo-email' alt='Selecione a foto do projeto' src='{{mix('build/global/img/projeto.svg')}}' style='max-height:250px;max-width:250px;margin:auto'> --}}
        {{-- </div> --}}
        {{-- </div> --}}
        {{-- </div> --}}
        {{-- </div> --}}
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer d-flex align-items-center justify-content-center">
                    <button type="button"
                            ...
                            data-dismiss="modal"
                            style="width: 20%;">Fechar</button>
                    <button type="button"
                            class="col-4 btn btn-primary btn-cancel-affiliation"
                            data-dismiss="modal"
                            style="width: 20%;">Excluir</button>
                </div>
            </div>
        </div>
    </div>
