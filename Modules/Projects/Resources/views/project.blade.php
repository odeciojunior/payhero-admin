...
@section('content')
    ...
    @push('scripts')
        ...
        <script type="text/javascript" src="{{asset('modules/global/ckeditor5/ckeditor.js?v=' . versionsFile()) }}"></script>
        <script type="text/javascript" src="{{asset('modules/global/ckeditor5/pt-br.js?v=' . versionsFile()) }}"></script>
        ...
        <script src="{{asset('modules/global/js/select2.min.js?v=' . versionsFile()) }}"></script>
        <script src="{{asset('modules/global/js/jquery.raty.min.js?v=' . versionsFile()) }}"></script>
        <script src="{{asset('modules/global/js-extra/jquery-loading.min.js?v=' . versionsFile()) }}"></script>
