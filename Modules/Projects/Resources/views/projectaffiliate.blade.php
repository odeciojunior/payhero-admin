            ...
            <div class="mt-15">
                                ...
                                <div class="row justify-content-between align-items-baseline">
                                    <div class="col-md-12">
                                        ...
                                        <div class="row d-flex row-title justify-content-between pt-0 align-items-start">
                                            ...
                                            <div id="show-status"
                                                 class="col-2 text-white text-center details-text my-5 ml-10 ml-sm-0 badge-pill badge-success">
                                            </div>
                                        </div>
                                        <small class="card-text gray font-size-14"
                                               id="created_at"></small>
                                    </div>
                                </div>
                                <div class='row'>
                ...
                <div class="nav-tabs-horizontal"
                    ...
                    <ul class="nav nav-tabs nav-tabs-line"
                        ...
                        <li class="nav-item tab_pixels-panel"
                            role="presentation">
                            <a id="tab_pixels"
                        ...
                        <li class="nav-item tab_links-panel"
                            role="presentation">
                            <a id="tab_links"
                               class="nav-link"
                               data-toggle="tab"
                               href="#tab_links-panel"
                               aria-controls="tab_links"
                               role="tab">
                                Links
                            </a>
                        </li>
