<div class="row">
    <div class="col-3">
        <img class="card-img-top img-fluid w-full"
             src="{!! '/' . Modules\Core\Helpers\CaminhoArquivosHelper::CAMINHO_FOTO_PROJETO . $projeto['foto'] !!}"
             alt="Imagem não encontrada"
             style="height: 180px;width: 90%; margin: 8px 0 8px 0">
    </div>
    <div class="col-9">
        <div style="position: relative; float: right">
            <a class="btn btn-success"
               href="/afiliados/afiliar/{!! $id_projeto !!}">
                Me afiliar
            </a>
        </div>
        <h3>{!! $projeto['nome'] !!}</h3>
            ...
            <ul class="nav nav-tabs"
                ...
                <li class="nav-item"
                    role="presentation"><a class="nav-link active"
                       data-toggle="tab"
                       href="#tab_info_geral"
                       aria-controls="tab_info_geral"
                       role="tab">Informações básicas</a></li>
                <li class="nav-item"
                    role="presentation"><a class="nav-link"
                       data-toggle="tab"
                       href="#tab_planos"
                       aria-controls="tab_planos"
                       role="tab">Planos</a></li>
            </ul>
                        ...
                        <div class="row">
                            <div class="col-3">
                                <img class="card-img-top img-fluid"
                                     src="{!! '/' . Modules\Core\Helpers\CaminhoArquivosHelper::CAMINHO_FOTO_PLANO . $plano['foto'] !!}"
                                     alt="Imagem não encontrada"
                                     style="height: 150px;">
                            </div>
                            <div class="col-9">
