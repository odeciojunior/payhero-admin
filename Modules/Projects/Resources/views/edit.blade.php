            ...
            <div class='col-lg-4'>
                <div class='d-flex flex-column text-center' id='div-img-project' style='position: relative;'>
                    ...
                    <div style="width:100%" class="text-center">
                        <img id='previewimage' alt='Selecione a foto do projeto' src='{{$project->photo ?? asset('modules/global/img/projeto.png')}}' onerror="this.onerror=null; this.src='{{asset('modules/global/img/projeto.png')}}'" style='min-width: 250px; max-width: 250px;margin: auto'>
                    </div>
                ...
                <div class='row'>
                    <div class="col-12">
                        <div class='d-flex flex-column text-center' id='div-img-project' style='position: relative;'>
                            ...
                            <img id='image-logo-email' alt='Selecione a foto do projeto' src='{{$project->logo ?? asset('modules/global/img/projeto.png')}}' onerror="this.onerror=null; this.src='{{asset('modules/global/img/projeto.png')}}'" style='max-height:250px;max-width:250px;margin:auto'>
