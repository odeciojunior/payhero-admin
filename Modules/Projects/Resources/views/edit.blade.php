    ...
    <div style="width:100%">
        ...
        <div class="row" style="margin: 0 2% 0 2%">
            ...
            <table class="table table-hover table-bordered">
                ...
                <tbody>
                    @if(count($extra_materials) == 0)
                        <tr>
                            <td colspan="3" style="text-align:center">Nenhum material extra adicionado</td>
                        </tr>
                    @else
                        @foreach($extra_materials as $extraMaterial)
                            <tr>
                                <td>{!! $extraMaterial['description'] !!}</td>
                                <td>{!! $extraMaterial['type'] !!}</td>
                                <td style="width:70px"><button type="button" class="btn btn-danger excluir_material_extra" material-extra="{!! $extraMaterial['id'] !!}">Excluir</button></td>
                            </tr>
                        @endforeach
                    @endif
                </tbody>
        ...
        <div class="row">
            ...
            <div id="div_responsavel_frete_projeto" class="form-group col-xl-6 col-lg-6" style="{!! $project['frete'] ? 'display:none' : '' !!}">
                ...
                <select name="shipment_responsible" type="text" class="form-control" id="responsavel_frete_projeto">
                    <option value="proprietario" {!! $project['shipment_responsible'] == 'owner' ? 'selected' : '' !!}>Proprietário</option>
