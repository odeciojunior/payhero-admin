...
@section('content')
  ...
  <div class="page">
    ...
    <div class="page-header">
        ...
        <div class="page-header-actions">
            <a class="btn btn-primary float-right" href="/transportadoras/cadastro">
    ...
    <div class="page-content container-fluid">
      <div class="panel" data-plugin="matchHeight">
        ...
        <table id="tabela_transportadoras" class="table-bordered table-hover w-full" style="margin-top: 80px">
  ...
  <script>
    ...
    $(document).ready( function(){
        ...
        $("#tabela_transportadoras").DataTable( {

            processing: true,
            serverSide: true,
            ajax: {
                url: '/transportadoras/data-source',
                type: 'POST'
            },
            columns: [
                { data: 'name', name: 'name'},
            ...
            "drawCallback": function() {
                ...
                $('.detalhes_transportadora').on('click', function() {
                    ...
                    $.post("/transportadoras/detalhe", data)
                ...
                $('.excluir_transportadora').on('click', function(){
                    ...
                    $('#form_excluir_transportadora').attr('action','/transportadoras/deletartransportadora/'+id_user);
