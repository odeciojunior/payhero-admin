...
@push('css')
    <link rel="stylesheet"
          href="{!! mix('build/layouts/activecampaign/index.min.css') !!}">
    <style>
        .o-arrow-right-1 {
            font-size: 30px;
        }
...
@section('content')
    <div class='page'>
        ...
        <div id="no-integration-found"
            ...
            <div class="content-error text-center">
                ...
                <p class="desc gray">Integre suas lojas com ActiveCampaign de forma totalmente automatizada!</p>
            </div>
        </div>
                ...
                <div class="modal-dialog modal-lg d-flex justify-content-center">
                    <div class="modal-content w-450"
                        ...
                        <div class="pt-10 pr-20 pl-20 modal_integracao_body">
                            @include('activecampaign::create')
                            @include('activecampaign::edit')
                        </div>
                        <div class="modal-footer"
                             style="margin-top: 15px">
                            <button id="bt_integration_add"
                                    type="button"
    ...
    @push('scripts')
        <script src="{{ mix('build/layouts/activecampaign/index.min.js') }}"></script>
    @endpush
@endsection
