<div class='row no-gutters mb-10'>
    <div class="top-holder text-right mb-5"
         style="width: 100%;">
        <div class='d-flex align-items-center justify-content-end'>
            <div class='col-md-6'>
                <div class='col-md-2'></div>
                <div id="add-event"
                     class="d-flex col-md-5 align-items-center float-right justify-content-end pointer">
                    <span class="link-button-dependent red"> Adicionar Evento </span>
                    <a class="ml-10 rounded-add pointer"><i class="o-add-1"
...
<ul id="pagination-events" class="pagination-sm margin-chat-pagination pagination-style" style="margin-top:10px;position:relative;float:right;margin-bottom:100px;">
        ...
        <div class="modal-content p-10"
            ...
            <div class="modal-header simple-border-bottom mb-10">
                <h4 class="modal-title"
                    id="modal-title-event"></h4>
                <a id="modal-button-close"
                   class="pointer close btn-close-add-event"
                   role="button"
                   data-dismiss="modal"
                   aria-label="Close">
            ...
            <div class="modal-footer">
                ...
                <button id="btn-modal"
                        type="button"
                        class="col-sm-6 col-md-3 col-lg-3 btn btn-success"
                        data-dismiss="modal">
...
{{-- Modal error --}}
<div class="modal fade example-modal-lg modal-3d-flip-vertical"
     id="modal-error-event"
     role="dialog"
     tabindex="-1">
    <div id="modal-add-size-event-error"
         class="modal-dialog modal-dialog-centered modal-simple">
        <div class="modal-content p-10"
             id="content-modal-event-error">
            <div class="modal-header simple-border-bottom mb-10">
                <h4 class="modal-title"
                    id="modal-title-event-error"></h4>
                <a id="modal-button-close"
                   class="pointer close btn-close-add-event"
                   role="button"
                   data-dismiss="modal"
            ...
            <div id="modal-add-event-body-error"
                 class="modal-body"
                 style='min-height: 100px'>
            </div>
            <div class="modal-footer"
                 id='modal-footer-event-error'>
                <a id="btn-mobile-modal-close"
                   class="col-sm-6 btn btn-primary display-sm-none display-m-none display-lg-none display-xlg-none"
                   style='color:white'
                   role="button"
                ...
                <button id="btn-modal-event-error"
                        type="button"
                        class="col-sm-6 col-md-3 col-lg-3 btn btn-success"
                        data-dismiss="modal">
                    <i class="material-icons btn-fix"> save </i> Salvar
