...
@push('css')
    <link rel="stylesheet"
          href="{{ mix('build/layouts/activecampaign/show.min.css') }}">
@endpush
                    ...
                    <ul class="nav nav-tabs nav-tabs-line"
                        ...
                        <li class="nav-item"
                            ...
                            <a id="tab_configuration"
                               ...
                               data-toggle="tab"
                               href="#tab_configuration_integration"
                               aria-controls="tab_configuration_integration"
                               role="tab">Configurações
                            </a>
                        </li>
                        <li class="nav-item"
                            role="presentation">
                            <a id="tab_events"
                               class="nav-link"
                               data-toggle="tab"
                               href="#tab_events-panel"
                               aria-controls="tab_events"
                               role="tab">
                                Eventos
                            </a>
                        </li>
                ...
                <div class="tab-content">
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active"
                             id="tab_configuration_integration"
                             role="tabpanel">
                        ...
                        <div class="modal-dialog  modal-dialog-centered  modal-simple">
                            <div class="modal-content">
                                ...
                                <div class="modal-body text-center p-20">
                                    ...
                                    <h3 class="black"
                                        id="modal-change-shopify-integration-title"> Você tem certeza? </h3>
                                    <p class="gray"
                                ...
                                <div class="modal-footer d-flex align-items-center justify-content-center">
                                    ...
                                    <button id="bt-modal-change-shopify-integration"
                                            ...
                                            style="width: 20%;">Confirmar</button>
                                </div>
                            </div>
                        </div>
                    </div>
