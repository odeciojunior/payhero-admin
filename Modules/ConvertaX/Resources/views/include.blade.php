            ...
            @foreach($projectsIntegrated as $project)
                <div class="col-sm-6 col-md-4 col-lg-3 col-xl-3">
                    <div class="card shadow card-edit" project='{{\Hashids::encode($project->id)}}' style='cursor:pointer;'>
                        <img class="card-img-top img-fluid w-full" src="{!! $project['photo'] !!}" onerror="this.onerror=null;this.src='{!! mix('modules/global/img/produto.png') !!}';" alt="{!! mix('modules/global/img/produto.png') !!}">
                        <div class="card-body">
                            <div class='row'>
                                <div class='col-md-10'>
