<div class='col-md-12'>
    @if (count($projectsIntegrated) == 0)
        @push('css')
            <link rel="stylesheet"
                  href="{!! mix('build/layouts/convertax/include.min.css') !!}">
        @endpush
            ...
            @foreach ($projectsIntegrated as $project)
                <div class="col-sm-6 col-md-4 col-lg-3 col-xl-3">
                    <div class="card shadow card-edit"
                         project='{{ \Hashids::encode($project->id) }}'
                         style='cursor:pointer;'>
                        <img class="card-img-top img-fluid w-full"
                             src="{!! $project['photo'] !!}"
                             onerror="this.onerror=null;this.src='{!! mix('build/global/img/produto.png') !!}';"
                             alt="{!! mix('build/global/img/produto.png') !!}">
                        <div class="card-body">
                            <div class='row'>
                                <div class='col-md-10'>
                                ...
                                <div class='col-md-2'>
                                    <a role='button'
                                       class='delete-integration pointer float-right mt-35'
                                       project='{{ \Hashids::encode($project->id) }}'
                                       data-toggle='modal'
