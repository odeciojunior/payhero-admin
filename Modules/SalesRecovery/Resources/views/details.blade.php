...
<div class="tab-content p-10" id="nav-tabContent">
    ...
    <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
        ...
        @else
            <span class="clear-fields table-title gray">Link: <a role='button' class='copy_link' style='cursor:pointer;' link='{{$link ?? ''}}' title='Copiar link'><span class="orion-icon-copy"></span></a></span>
        @endif
        <br>
