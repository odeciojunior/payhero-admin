...
<div class="tab-content p-10"
    ...
    <div class="tab-pane fade show active"
        ...
        <a href="{{ $whatsapp_link }}"
           ...
           title='Enviar mensagem pelo whatsapp'>
            <img src="{!! mix('build/global/img/whatsapplogo.png') !!}"
                 width="25px">
        </a>
        <br>
    ...
    <div class="tab-pane fade"
        ...
        @else
            <span class="clear-fields table-title gray">Link: <a role='button'
                   class='copy_link'
                   style='cursor:pointer;'
                   link='{{ $link ?? '' }}'
                   title='Copiar link'><span class="material-icons icon-copy-1"> content_copy </span></a></span>
        @endif
        <br>
