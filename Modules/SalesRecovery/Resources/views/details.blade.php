...
<div class="card shadow pr-20 pl-20 p-10">
    ...
    @foreach($products as $product)
        <div class='row align-items-baseline justify-content-between mb-15'>
            <div class="col-lg-2">
                <img onerror=this.src='/modules/global/img/produto.png' src='{{$product['photo'] ?? mix('modules/global/img/produto.png')}}' width='50px' style='border-radius: 6px;'>
            </div>
            <div class='col-lg-5'>
...
<div class="tab-content p-10" id="nav-tabContent">
    ...
    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
        ...
        <a href="{{$whatsapp_link}}" target='_blank' title='Enviar mensagem pelo whatsapp'>
            <img src="{!! mix('modules/global/img/whatsapplogo.png') !!}" width="25px" >
        </a>
        <br>
