                ...
                <div id=""
                    ...
                    <div class="row align-items-baseline">
                        ...
                        <div class="col-sm-6 col-md-3 col-xl-3 col-12 mb-15 mb-sm-0">
                            ...
                            <select name='select_type_recovery'
                                    id="recovery_type"
                                    class="sirius-select">
                                <option value="1"
                                        selected>Carrinho Abandonado</option>
                        ...
                        <div class="col-sm-6 col-md-3 col-xl-3 col-12 mb-15 mb-sm-0">
                            <div class="form-group form-icons">
                                ...
                                <input name='date-range-sales-recovery'
                                       id='date-range-sales-recovery'
                                       class='input-pad pr-30 default-border'
                    ...
                    <div class="row mb-10 mb-sm-0"
                        ...
                        <div class="col-6 col-xl-3 mt-20 offset-xl-6 pr-0">
                            <div class="btn btn-light-1 w-p100 bold d-flex justify-content-center align-items-center"
                                 ...
                                 aria-expanded="false"aria-controls="bt_collapse">
                                <img id="icon-filtro"
                            ...
                            <div class="modal-content p-20 "
                                ...
                                <div class="modal-body-cart-recovery">
                                    <div class="transition-details">
                                        <p id='date-as-hours'
                                           class="sm-text text-muted clear-fields">
                                        </p>
                                        <div class="status d-inline">
                                            <span class="clear-fields badge mr-5"
                                                  id='status-checkout'></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tab-content p-10"
                                        ...
                                        <div class="tab-pane fade show active"
                                            ...
                                            <span id='client-name-details'
                                                  class="table-title gray clear-fields"> </span>
                                            <br>
                                            ...
                                            <div id='div_delivery'
                                                 style='display:none;'>
                                                <h4> Entrega </h4>
                                                <span id="client-street"
                                                      class="table-title gray clear-fields"> </span>
                                                <br>
                                                <span id='client-zip-code'
                                                      class="table-title gray clear-fields"> </span>
                                                <br>
                                                <span id='client-city-state'
                                                      class="table-title gray clear-fields"></span>
                                            </div>
                                        </div>
                                        <!-- DETALHES  -->
                                        <div class="tab-pane fade"
                                            ...
                                            <span id='checkout-src'
                                                  class="table-title gray clear-fields"> </span>
                                            <br>
                                            <span id='checkout-utm-source'
                                                  class="table-title gray clear-fields"> </span>
                                            <br>
                                            <span id='checkout-utm-medium'
                                                  class="table-title gray clear-fields"> </span>
                                            <br>
                                            <span id='checkout-utm-campaign'
                                                  class="table-title gray clear-fields"></span>
                                            <br>
                                            <span id='checkout-utm-term'
                                                  class="table-title gray clear-fields"> </span>
                                            <br>
                                            <span id='checkout-utm-content'
                                                  class="table-title gray clear-fields"> </span>
                                        </div>
                                    </div>
                                </div>
