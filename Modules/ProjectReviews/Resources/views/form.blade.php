                    ...
                    <div class="col-12 col-sm-8">
                        <div class='form-group col-12 mb-20'>
                            ...
                            <div class="d-flex input-group">
                                <input type="text"
                                       ...
                                       style="height: 50px !important; border-radius: 8px;">
                            </div>
                        </div>
                        ...
                        <div class='form-group col-12 mb-20'>
                            ...
                            <div class="d-flex input-group">
                                <textarea type="text"
                                          ...
                                          style="height: 50px !important; border-radius: 8px;"></textarea>
                            </div>
                        </div>
                        ...
                        <div class='form-group col-12 col-sm-6 mb-20'>
                            ...
                            <select name="active_flag"
                                    ...
                                    class='sirius-select'>
                                <option value='1'
                                        selected='selected'>Ativo</option>
