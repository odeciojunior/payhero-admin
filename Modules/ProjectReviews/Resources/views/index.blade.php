            ...
            <div class='d-flex align-items-center'>
                <div class='col-sm-12'>
                    <div class="d-flex justify-content-end">
                        ...
                        <div class="btn-holder add-review d-flex align-items-center pointer"
                             data-toggle="modal"
    ...
    <div class="modal-dialog modal-lg d-flex justify-content-center">
        <div class="modal-content"
            ...
            <div class="modal-footer"
                ...
                <button type="button"
                        class="btn btn-success bt-review-save"
                        style='display:none;'>Salvar</button>
                <button type="button"
                        class="btn btn-success bt-review-update"
    ...
    <div class="modal-dialog d-flex justify-content-center">
        <div class="modal-content"
            ...
            <div class="modal-header mb-0">
                ...
                <h4 class="modal-title text-center"
                    style="font-weight: 700;">Configurações das reviews</h4>
            </div>
            <div class="pt-10 pr-20 pl-20 modal_review_body">
            ...
            <div class="modal-footer pt-0">
                <button type="button"
                        class="btn btn-success bt-review-config-update">Atualizar</button>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="modal-content p-10">
            <div class="modal-header simple-border-bottom mb-10">
                <h4 class="modal-title"
                    id="modal-title">Exibição do Review</h4>
    ...
    <div class="modal-dialog  modal-dialog-centered  modal-simple">
        <div class="modal-content">
            ...
            <div class="modal-footer d-flex align-items-center justify-content-center">
                ...
                <button type="button"
                        class="col-4 btn border-0 btn-outline btn-delete-review btn-delete-modal form-control d-flex justify-content-center align-items-center align-self-center flex-row"
                        data-dismiss="modal"
                        style="width: 20%;">
