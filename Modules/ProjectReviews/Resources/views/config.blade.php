<form id="form_config_review" method="post" action="#">
    @csrf
    @method('PUT')
    <div style="width:100%">
        <div class="row">
                ...
                <div class="row input-group">
                    <div class="col-4">
                        <div class="radio-custom radio-primary">
                            <input type="radio" id="starIcon" name="reviews_config_icon_type" value="star">
                            <label for="starIcon">
                    ...
                    <div class="col-4">
                        <div class="radio-custom radio-primary">
                            <input type="radio" id="heartIcon" name="reviews_config_icon_type" value="heart">
                            <label for="heartIcon">
                    ...
                    <div class='col-12 w-100 info pt-5' style='font-size: 10px;'>
            ...
            <div class="form-group col-12 pt-4">
                ...
                <input type="hidden" name="reviews_config_icon_color" value="#f8e34a"/>

                <div class="color-options">
                    <div data-color="#f8ce1c" style="background: #f8ce1c;" title="Amarelo">
