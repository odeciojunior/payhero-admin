...
@section('content')
    @push('css')
        <link rel="stylesheet"
              href="{{ mix('build/layouts/products/edit.min.css') }}">
    @endpush
    ...
    <div class="page">
        ...
        <div class="page-content container pb-20">
                ...
                <div class="form-buttons">
                    <div>
                        <a class="btn btn-lg btn-excluir delete-product"
                           ...
                           href="#"><span class="o-bin-1 mr-2"></span>Excluir produto</a>
                    </div>

                    <div>
                        <a class="btn btn-lg btn-converter converte-product"
                           data-toggle="modal"
                           data-target="#modal-converte"
                           href="#">
                            <svg width="17"
                                 class="svg-converter"
                                 height="19"
                    ...
                    <div>
                        <a class="btn btn-lg btn-cancelar"
                    ...
                    <div class="modal-content p-20">
                        <div id="modal_converter_body"
                            ...
                            <div class="d-flex flex-row-reverse simple-border-bottom pb-15">
                                ...
                                <button type="button"
                                        ...
                                        data-dismiss="modal"
                                        aria-label="Close"
                                        style="margin-top: -3px; font-size: 32px">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            ...
                            <div class="d-flex flex-column align-items-center mt-25">
                                <p class="aviso"
                                   style="width: 60%">Confirme a conversão do produto e insira o arquivo digital.</p>
                                <p class="aviso"
                                   style="width: 60%"> Essa ação não poderá ser desfeita! </p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center justify-content-center pt-10"
                            ...
                            <button id="bt_cancelar"
                                    ...
                                    class="col-4 btn border-0 btn-gray btn-cancel-modal form-control d-flex justify-content-center align-items-center align-self-center flex-row"
                                    data-dismiss="modal"
                                    style="width: 20%;; background-color: #F3F3F3; color: #636363; padding: 20px 0">
                                <b>Cancelar</b>
                            </button>
                            <button id="bt_converter"
                                    type="button"
                                    class="col-4 btn border-0 btn-outline btn-converte-modal form-control d-flex justify-content-center align-items-center align-self-center flex-row"
                                    data-dismiss="modal"
                                    style="width: 20%; background-color: #3772FF; color: #FCFCFD; padding: 20px 0">
            ...
            <div id="modal-plan-already-created"
                 class="modal fade"
                 role="dialog"
                ...
                <div class="modal-dialog p-2">
                    ...
                    <div class="modal-content p-4">
                        ...
                        <i class="material-icons gradient text-center"
                           style="font-size: 80px;color: #ff4c52;"> highlight_off </i>
                        ...
                        <div class="modal-body p-2 text-center">
                            <a class='btn btn-close-modal-plan mt-10 btn-success text-white'
                               data-dismiss="modal">
                                <b>Fechar</b></a>
                        </div>
                    </div>
