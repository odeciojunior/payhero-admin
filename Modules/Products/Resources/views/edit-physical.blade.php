    ...
    <div class="page-content container pb-20">
        <form id='my-form'>
            ...
            <div class="panel pt-10 pb-20" style="border-radius: 16px">
                ...
                <div class="px-40 row justify-content-between">
                    <div class="col-12 col-md-4 col-lg-2 col-xl-4 text-center">
                        <img id="caixinha-img" src="{{ mix('build/global/img/svg/caixinha.svg') }}" class="img-fluid" alt="novo produto fisico">
                    </div>
                    ...
                    <div class="row col-12 col-md-8 col-lg-10 col-xl-8">
                        ...
                        <div class="form-group col-12 mt-0">
                            <small class="text-muted">
                                Clique <a href="http://www2.correios.com.br/sistemas/precosprazos/Formato.cfm" target="_blank" style="color: #2E85EC; font-weight: bold;">aqui</a> para consultar as regras de
                            ...
                            <div class="d-flex flex-row align-items-center mt-10 px-2 py-1 rounded" style="width: fit-content; background: #F4F6FB;">
                                ...
                                <span class="font-size-10 ml-2" style="color: #636363">Em vendas de produtos físicos, será solicitado o rastreio
            ...
            <div class="form-buttons">
                <div id="empty-space" style="display: none">&nbsp;</div>
                <div>
