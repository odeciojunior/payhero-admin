    ...
    <div class="page"
        ...
        <div class="page-header container">
            <h1 class="page-title my-10"
                style="min-height: 28px; color: #707070;">Novo produto digital</h1>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-7 input-file-container">
                                    ...
                                    <input class="input-file"
                                           ...
                                           id="digital_product_url"
                                           type="file">
                                    <div class="form-group d-flex pt-10">
                                        <label tabindex="0"
                                               for="digital_product_url"
                                               class="input-file-trigger mb-0 px-15 py-5">Escolher arquivos</label>
                                        <span id="file_return"
                                              class="ml-20 pt-10"></span>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-md-5 div-expiration-time">
                                    ...
                                    <div class="form-group input-group">
                                        <input name="url_expiration_time"
                                               type="text"
                                               class="form-control"
                                               id="url_expiration_time"
                                               placeholder="Ex: 24"
                                               min="0"
                                               maxlength="3"
                                               data-mask="0#"
                                ...
                                <div class="form-group col-12">
                                    <small class="text-center text-muted mt-15"
                                           style="width: 100%">Este é o arquivo que será enviado ao cliente após a
                                        confirmação da venda.</small>
                                    <div class="d-flex flex-row align-items-center mt-10 px-2 py-1 rounded"
                                        ...
                                        <span class="font-size-10 ml-2"
                                              style="color: #636363">Essa opção é exclusiva para produtos digitais.</span>
                                    </div>
                                </div>
