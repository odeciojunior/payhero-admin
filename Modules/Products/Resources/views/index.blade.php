...
@push('css')
    <link rel="stylesheet"
          href="{{ mix('build/layouts/products/index.min.css') }}">
@endpush
...
<div class="page" style="margin-bottom: 0 !important">
    ...
    <div style="display: none" class="page-header container">
        ...
        <div id="project-not-empty"
            ...
            <div style="display: none !important; padding-top:0"
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div id="projects-list"
                                ...
                                <div class="box-projects"
                                     id="box-projects-1">
                                    <label id="select-projects-label-1"
                                           for="select-projects-1">Loja</label>
                                    <select id="select-projects-1"
                                            class="sirius-select">
                                ...
                                <div class="box-projects"
                                     id="box-projects-2">
                                    <label id="select-projects-label-2"
                                           for="select-projects-2">Loja</label>
                                    <select id="select-projects-2"
                                            class="sirius-select">
                                        {{-- <option class='opcao-vazia'></option> --}}
                                    </select>
                                </div>
            ...
            <div class="page-content container pb-40">
                ...
                <div class='products-is-empty'
                    ...
                    <div class="content-error text-center pt-0">
                        <img src="{!! mix('build/global/img/produtos.svg') !!}"
                             width="156px">
            ...
            <div class="modal-dialog modal-dialog-centered"
                ...
                <div class="modal-content"
                    ...
                    <div class="d-flex flex-row-reverse simple-border-bottom py-10 px-20">
                        ...
                        <button type="button"
                                class="new-product-modal-option-close-btn"
                                data-dismiss="modal"
                                aria-label="Close">
                    ...
                    <div class="d-flex flex-column align-self-center new-product-modal-body">
                        <div class="d-flex flex-row justify-content-between"
                            ...
                            <div class="d-flex flex-column align-items-center new-product-modal-option">
                                <button type="button"
                                        class="d-flex justify-content-center align-items-center new-product-btn"
                                        data-add-url="/products/create/physical">
                                    <img src="{{ mix('build/global/img/svg/new-box.svg') }}"
                            ...
                            <div class="d-flex flex-column align-items-center new-product-modal-option">
                                <button type="button"
                                        class="d-flex justify-content-center align-items-center new-product-btn"
                                        data-add-url="/products/create/digital">
                                    <img src="{{ mix('build/global/img/svg/new-phone.svg') }}"
                        ...
                        <div id="next-btn-container"
                             class="text-center"
                             style="display: none">
                            <p id="selected-option-desc"
                               class="font-weight-400 font-size-14 my-25"
                               style="color: #5B5B5B"></p>
                            <a id="selected-option-url"
                               href="#"
                               class="btn btn-primary"
                               style="padding: 12px 0px">Avançar</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-dialog  modal-dialog-centered  modal-simple">
                <div class="modal-content">
                    ...
                    <div class="modal-footer d-flex align-items-center justify-content-center">
                        ...
                        <button type="button"
                                class="bt_excluir_modal col-4 btn border-0 btn-outline btn-delete-modal form-control d-flex justify-content-center align-items-center align-self-center flex-row"
                                data-dismiss="modal"
                                style="width: 20%;">
                            <b class="mr-2"
                               style="color: #fff">Excluir </b>
