                                ...
                                <div class="row justify-content-between align-items-baseline">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="d-flex flex-column">
                                            ...
                                            <img id="previewimage" alt="Selecione a foto do produto" accept="image/*" src='{{ $product->photo ?? asset('modules/global/assets/img/projeto.png')}}' style="height: 300px; width: 300px;">
