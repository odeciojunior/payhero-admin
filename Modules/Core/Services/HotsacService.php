...
use Carbon\Carbon;
use Modules\Core\Entities\HotsacSent;
            ...
            if (!empty($domain)) {
                ...
                HotsacSent::create(
                    [
                        ...
                        'instance_id'           => $sale->id,
                        'instance'              => 'sale',
                        'event_sale'            => (new HotsacIntegration())->present()->getEvent($eventSale),
                        'hotsac_integration_id' => $this->integrationId,
                    ]
                );
