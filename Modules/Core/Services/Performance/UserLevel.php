...
class UserLevel
{
    public const LEVEL_DATA = [
        "1" => [
            ...
            "icon" => "https://nexuspay-digital-products.s3.amazonaws.com/admin/admin-002/nivel-1.png",
        ],
        "2" => [
            ...
            "icon" => "https://nexuspay-digital-products.s3.amazonaws.com/admin/admin-002/nivel-2.png",
        ],
        "3" => [
            "name" => "Conquistador",
            "description" => "Nível 3",
            ...
            "icon" => "https://nexuspay-digital-products.s3.amazonaws.com/admin/admin-002/nivel-3.png",
        ],
        "4" => [
            "name" => "Colonizador",
            "description" => "Nível 4",
            ...
            "icon" => "https://nexuspay-digital-products.s3.amazonaws.com/admin/admin-002/nivel-4.png",
        ],
        "5" => [
            ...
            "icon" => "https://nexuspay-digital-products.s3.amazonaws.com/admin/admin-002/nivel-5.png",
        ],
        "6" => [
            "name" => "Admin Major",
            "description" => "Nível 6",
            ...
            "icon" => "https://nexuspay-digital-products.s3.amazonaws.com/admin/admin-002/nivel-6.png",
        ],
    ];
