...
class UserLevel
{
    ...
    public const LEVEL_DATA = [
        '1' => [
            ...
            'icon' => 'https://cloudfox-documents.s3.amazonaws.com/cloudfox/defaults/nivel-1.png',
            'benefits' => ''
        ],
        '2' => [
            ...
            'icon' => 'https://cloudfox-documents.s3.amazonaws.com/cloudfox/defaults/nivel-2.png',
            'benefits' => ' Cashback de 0.5% e Receba a sua comissão mais rápido, sem a necessidade de avalição na solicitação de saque !',
        ],
        '3' => [
            'name' => 'Conquistador',
            'description' => 'Nível 3',
            ...
            'icon' => 'https://cloudfox-documents.s3.amazonaws.com/cloudfox/defaults/nivel-3.png',
            'benefits' => 'Gerente de contas e Receba de 1% até 11% de cashback !',
        ],
        '4' => [
            'name' => 'Colonizador',
            'description' => 'Nível 4',
            ...
            'icon' => 'https://cloudfox-documents.s3.amazonaws.com/cloudfox/defaults/nivel-4.png',
            'benefits' => 'Redução proporcional da taxa',
        ],
        '5' => [
            ...
            'icon' => 'https://cloudfox-documents.s3.amazonaws.com/cloudfox/defaults/nivel-5.png',
            'benefits' => ''
        ],
        '6' => [
            'name' => 'Sirius Major',
