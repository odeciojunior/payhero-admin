...
class SaleService
{
    ...
    public function updateSaleRefunded($sale, $response, $refundObservation): bool
    {
        try {
            DB::beginTransaction();
            ...
            $checkRecalc = $this->recalcSaleRefund($sale);
    ...
    private function recalcSaleRefund($sale): bool
    {
        try {
            $companyModel = new Company();
