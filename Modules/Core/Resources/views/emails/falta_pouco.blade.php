...
{{--=======--}}
{{-->>>>>>> 28db4488652b68e8ff6742679a77f0d6ed4df09b--}}
{{--<style>--}}
{{--    body {--}}
...
{{--                <td align="center">--}}
{{--<<<<<<< HEAD--}}
{{--                    <img src="{!! asset('modules/global/assets/logoCloudfox.png') !!}" width="80px;" class="logo">--}}
{{--=======--}}
...
{{--<<<<<<< HEAD--}}
{{--                    <img src="{!! asset('modules/global/assets/falta-pouco.png') !!}">--}}
{{--=======--}}
...
{{--            <tr>--}}
{{--                <td align="center">--}}
{{--                    <h1 class="blue"> Falta pouco! </h1>--}}
{{--                </td>--}}
{{--            </tr>--}}

{{--            <tr>--}}
{{--                <td align="center" style="padding-bottom: 20px;">--}}
{{--                    <span class="dark-grey"> Em poucos dias, você poderá testar nossa plataforma! </span>--}}
{{--                </td>--}}
{{--            </tr>--}}
