...
class CompanyResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        $data = [
            ...
            "fantasy_name" =>
                $this->resource->company_type == 1 ? "Pessoa física" : $this->resource->fantasy_name ?? "",
            "document" =>
                strlen($this->resource->document) == 14
                    ? FoxUtils::mask($this->resource->document, "##.###.###/####-##")
                    : (strlen($this->resource->document) == 11
                        ? FoxUtils::mask($this->resource->document, "###.###.###-##")
                        : $this->resource->document),
            "zip_code" => $this->resource->zip_code ?? "",
            "country" => $this->resource->country ?? "",
            "country_translated" => $this->resource->country
                ? __("definitions.enum.country." . $this->resource->country)
                : "",
            ...
            "contract_document_status" => $presenter->getContractDocumentStatus(
                $this->resource->contract_document_status
            ),
