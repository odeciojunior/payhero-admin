...
<head>
    ...
    <style>
        ...
        .table-striped-tracking td, .table-striped-tracking th {
...
<div class="col-12" style="background: #e9e9e9; padding:5px;">
...
<div>
    ...
    <p>
        ...
        Código
        rastreio: {{ isset($dataSale->tranckings[0]->tracking_code) ?  $dataSale->tranckings[0]->tracking_code : '' }}
        <br/>
    </p>
...
<div>
    ...
    @foreach($dataSale->tranckings as $tracking)
        ...
        <table class="table-striped-tracking" cellspacing="0">
            <thead>
