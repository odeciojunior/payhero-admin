@push('css')
    <link rel="stylesheet"
          href='{{ mix('build/layouts/chargebacks/contestations-files.min.css') }}'>
...
<div class="modal fade example-modal-lg"
     id="modal_contestation_files"
     aria-hidden="true"
     aria-labelledby="exampleModalTitle"
     role="dialog"
     tabindex="-1">
    <div class="modal-dialog modal-simple modal-sidebar modal-lg">
        <div id='modal-contestationFiles'
            ...
            <div class="modal-body row">
                ...
                <div class="col-lg-12 col-sm-8 col-md-8">
                    ...
                    <br>
                    <p class="text-warning"><i class="fa fa-info-circle"></i> Permitido no máximo 10 arquivos por
                        contestação</p>
                    ...
                    <form method="post"
                          id="sendfilesform"
                          name="sendfilesform"
                          action="{{ route('contestations.sendContestationFiles') }}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="row mt-10 mb-0">
                                <div class="col-8 text-left text-white">
                                    <div class="btn btn-primary-1 w-p100 bold d-flex justify-content-center align-items-center"
                                         style="padding:0">
                                        <label for="test"
