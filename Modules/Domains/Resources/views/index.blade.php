...
<div id="pagination-container-domain" class="d-none justify-content-center justify-content-md-end mb-50">
    <ul id="pagination-domain" class="pagination-sm text-right m-0 pagination-style">
                        ...
                        <div class="panel-body justify-content-center">
                            <div class="d-flex align-items-center">
                                <span> Digite o nome do seu <strong>domínio</strong> onde seu site esta hospedado e
                                    clique em <i class="material-icons btn-fix" style='color:green'> save </i><strong style='color:green'>Salvar</strong></span>
                            </div>
                        </div>
                    </div>
                </div>
