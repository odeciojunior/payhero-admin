        ...
        <div class="page-content container"
            ...
            <div id="content-error"
                ...
                <div class="content-modal-error text-center">
                    ...
                    <h1 class="m-0"
                        style="color: #636363; font-weight: normal; font-size: 24px; line-height: 30px;">Você ainda não
            ...
            <div class="mb-30"
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-12 col-md-12 col-lg-4 text-right">
                        <a href="https://docs.cloudfox.net/"
                           target="_blank"
                           ...
                           style="line-height: 46px;">
                            ...
                            <span class="o-arrow-right-1 ml-15"
                                  style="color: #2E85EC;"
                    ...
                    <div id="modal-create-integration"
                        ...
                        <div id="modal-reverse-body"
                            ...
                            <div class="row">
                                <div class="form-group col-12">
                                    ...
                                    <div id="enum-list">
                                        <select name="token_type_enum"
                                                id="select-enum-list"
                                                class="sirius-select">
                                            <option value="3">Integração Externa</option>
                                            <option value="4"
                                                    selected>Checkout API</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="modal-footer">
                            <button id="btn-save-integration"
                                    type="button"
                                    class="btn btn-lg btn-primary">Gerar Token</button>
                        </div>
                    </div>
                </div>
            </div>
