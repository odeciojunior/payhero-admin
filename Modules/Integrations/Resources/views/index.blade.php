...
<div class="page new-layout">
        ...
        <div class="d-flex justify-content-between align-items-center mb-45">
            <div>
                <h1 class="page-title my-10" style="min-height: 28px">
                    <img src="{{ mix('build/global/img/svg/api-sirius.png') }}" style="height: 40px; width: auto;" alt="API">
    ...
    <div class="page-content container" id='page-integrates'>
        ...
        <div id="container-pagination" class="row no-gutters justify-content-center justify-content-md-end mb-20">
                    ...
                    <div id="modal-reverse-body" class="modal-body">
                        <div class="row">
                            <div class="form-group col-12">
                                ...
                                <input name="description" type="text" class="form-control form-control-lg" id="description" placeholder="Digite uma descrição para sua integração">
                            </div>
                        </div>
