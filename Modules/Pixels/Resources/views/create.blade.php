                            ...
                            <div class="row justify-content-center">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <br> <input type="checkbox" value="0" name='checkout' id='checkout' class='check'>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <br> <input type="checkbox" value="0" name='purchase_card' id='purchase_card' class='check'>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <br> <input type="checkbox" value="0" name='purchase_boleto' id='purchase_boleto' class='check'>
                                    </div>
                                </div>
                            </div>
                            {{--<div class="row">--}}
