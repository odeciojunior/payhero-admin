...
<div id="pagination-container-pixel" class="d-none justify-content-center justify-content-md-end mb-50">
    <ul id="pagination-pixels" class="pagination-sm text-right m-0 pagination-style">
        {{-- js carrega... --}}
    </ul>
</div>
    ...
    <div class="modal-dialog  modal-dialog-centered  modal-simple">
        <div class="modal-content">
            ...
            <div class="modal-footer d-flex align-items-center justify-content-center">
                ...
                <button pixel="" type="button" id="btn-delete" class="col-4 btn border-0 btn-outline btn-delete-modal form-control d-flex justify-content-center align-items-center align-self-center flex-row" data-dismiss="modal" style="width: 20%;">
