                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <br> <input type="checkbox" @if($pixel->checkout == '1') value="1" checked="" @else value="0" @endif name='checkout' id='checkout' class='check'>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <br> <input type="checkbox" @if($pixel->purchase_card == '1') value="1" checked="" @else value="0" @endif name='purchase_card' id='purchase_card' class='check'>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <br> <input type="checkbox" @if($pixel->purchase_boleto == '1') value="1" checked="" @else value="0" @endif name='purchase_boleto' id='purchase_boleto' class='check'>
                                </div>
                            </div>
                        </div>
                        {{--<div class="row">--}}
