...
@section('content')
        ...
        <div class='page'>
            <div style="display: none" class="page-header container">
                <div class="row jusitfy-content-between">
                    <div class="col-lg-8">
                        <h1 class="page-title">Integrações HotSac</h1>
                    </div>
            ...
            <div id="no-integration-found" class='row justify-content-center' style="display:none; width:100%;">
                <div class="content-error text-center">
                    ...
                    <p class="desc gray">Integre seus projetos com HotSac de forma totalmente automatizada!</p>
                </div>
            </div>
        </div>
    </div>
    ...
    @push('scripts')
        <script src="/modules/hotsac/js/index.js?v=s0"></script>
    @endpush
@endsection
