<div class="col-12 templates-email template-abandoned-cart" style="background: #F7F7F7; padding: 40px;">
    <div class="col-12 pt-25 bg-white">
        ...
        <div class="col-12 text-center pb-20">
            <button class="btn btn-primary" style="background: #3A99E0">Finalizar Compra</button>
        </div>
    </div>
    ...
    <div class="mt-2 text-center" style="color: #757575; font-size: 10px;">
         Esse é um e-mail automático. Não responda esse e-mail. Caso queira contatar nosso suporte clique <a href="">aqui</a>
    </div>
</div>
