<div class="col-12 templates-email template-card-paid"
    ...
    <div class="col-12 pt-25 bg-white">
        <div align="center"
            ...
            <img align="center"
                 ...
                 border="0"
                 class=""
                 src="https://nexuspay-digital-products.s3.amazonaws.com/admin/admin-001/success.png"
                 style="text-decoration: none; -ms-interpolation-mode: bicubic; border: 0; height: 50px; width: 100%; max-width: 50px; display: block;"
                 title="Image"
                 width="125" />
            <div style="font-size:1px;line-height:15px"></div>
        </div>
        ...
        <div class="px-20 font-padrao m-0 pt-30 pb-20 font-15 color-333 p_text_message">
            Olá primeiro_nome, Seu pedido #sale_code foi confirmado. Aqui estão as informações e os detalhes da sua
            compra.
        </div>
    </div>
