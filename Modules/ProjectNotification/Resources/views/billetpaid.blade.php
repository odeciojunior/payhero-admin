<div class="col-12 templates-email template-billet-paid"
    ...
    <div class="col-12 pt-25 bg-white">
        <div align="center"
            ...
            <img align="center"
                 ...
                 border="0"
                 class=""
                 src="https://azcend-digital-products.s3.amazonaws.com/admin/admin-001/success-boleto.png"
        ...
        <div class="px-20 font-padrao m-0 pt-30 pb-20 font-15 color-333 p_text_message">
            Olá first_name , Seu pedido #sale_code foi aprovado. Obrigado pela sua compra, nos próximos dias enviaremos
            o código de rastreio para você acompanhar seu pedido.
        </div>
    </div>
    ...
    <div class="col-12 bg-white">
        ...
        <div class="row">
            <div class="col-9 font-padrao item-text-padrao">Subtotal</div>
            <div class="col-3 font-padrao item-text-padrao text-right">R$ 100,00</div>
        </div>
        <div class="row">
            <div class="col-9 font-padrao item-text-padrao">Frete</div>
            <div class="col-3 font-padrao item-text-padrao text-right">R$ 25,00</div>
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="col-8 font-padrao m-0 p-20 lineh-18 font-15 color-333">
                <strong>Total</strong>
            </div>
