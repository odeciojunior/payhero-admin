<div class="col-12 templates-email template-abandoned-cart-nextday" style="background: #F7F7F7; padding: 40px;">
    <div class="col-12 pt-25 bg-white">
        ...
        <div class="font-padrao m-0 text-center px-10 pb-5 pt-15 color-333" style="font-size: 28px;">
            <strong class="p_text_notification">O seu pedido está te esperando</strong>
        </div>
