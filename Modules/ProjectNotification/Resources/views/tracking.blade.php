<div class="col-12 templates-email template-tracking" style="background: #F7F7F7; padding: 40px;">
    <div class="col-12 pt-25 bg-white">
        <div align="center" class="mr-2 px-15" >
            ...
            <img align="center" alt="Image" border="0" class="" src="https://cloudfox-documents.s3.amazonaws.com/cloudfox/defaults/img-rastreio.png" style="text-decoration: none; -ms-interpolation-mode: bicubic; border: 0; height: 80px; width: 180px; display: block;" title="Image" width="125"/>
            <div style="font-size:1px;line-height:15px"></div>
        </div>
