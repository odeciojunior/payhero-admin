    ...
    <div class="card shadow" style="margin: 0 -1.429rem;">
        <div>
            <div class="page-invoice-table table-responsive standarzing-line">
                <table id="table-order-bump" class="table text-left table-striped unify mb-0" style="width: 100%;">
                    <thead>
                        <tr>
                ...
                <form id="form-store-order-bump" method="POST">
                    ...
                    <div class="form-group mb-10">
                        ...
                        <div class="d-flex input-group">
                            <input type="text" class="form-control" name="description" id="store-description-order-bump" placeholder="Digite a descrição">
                        </div>
                    </div>
                    ...
                    <div class="form-group mb-10" style="display: none;">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" name="discount" id="store-discount-order-bump" placeholder="Digite o valor do desconto">
                            <div class="input-group-append">
                    ...
                    <div class="form-group mb-10">
                        ...
                        <select name="apply_on_shipping[]" id="store-apply-on-shipping-order-bump" class="form-control" multiple="multiple" style="width:100%">
                        </select>
                    </div>
                    <div class="form-group mb-10 apply-on-plan-container">
                        <label for="link">Ao comprar o plano:</label>
                        <select name="apply_on_plans[]" id="store-apply-on-plans-order-bump" class="form-control" multiple="multiple" style="width:100%"></select>
                    </div>
                    <div class="form-group mb-10 offer-plan-container">
                        <label for="link">Oferecer o plano:</label>
                        <select name="offer_plans[]" id="store-offer-plans-order-bump" class="form-control" multiple="multiple" style="width:100%"></select>
                    </div>
                </form>
            </div>
            ...
            <div class="modal-body pb-0">
                <form id="form-update-order-bump" method="POST">
                    ...
                    <div class="form-group mb-10">
                        <label for="link">Descrição</label>
                        <div class="d-flex input-group">
                            <input type="text" class="form-control" name="description" id="update-description-order-bump" placeholder="Digite a descrição">
                        </div>
                    </div>
                    ...
                    <div class="form-group mb-10" style="display: none">
                        <label for="link">Desconto</label>
                        <div class="input-group">
                            <input type="text" class="form-control" name="discount" id="update-discount-order-bump" placeholder="Digite o valor do desconto" maxlength="2" data-mask="0#">
                            <div class="input-group-append">
                                <span class="input-group-text">%</span>
                            </div>
                        </div>
                    ...
                    <div class="form-group mb-10">
                        ...
                        <select name="apply_on_shipping[]" id="update-apply-on-shipping-order-bump" class="form-control" multiple="multiple" style="width:100%"></select>
                    </div>
                    <div class="form-group mb-10 apply-on-plan-container">
                        <label for="link">Ao comprar o plano</label>
                        <select name="apply_on_plans[]" id="update-apply-on-plans-order-bump" class="form-control" multiple="multiple" style="width:100%"></select>
                    </div>
                    <div class="form-group mb-10 offer-plan-container">
                        <label for="link">Oferecer o plano</label>
                        <select name="offer_plans[]" id="update-offer-plans-order-bump" class="form-control" multiple="multiple" style="width:100%"></select>
                    </div>
                </form>
            </div>
            <div class="modal-footer pt-0">
