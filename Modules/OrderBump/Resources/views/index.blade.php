<div class="card card-body"
    ...
    <div class="row no-gutters mb-20">
        <div class="top-holder w-full text-right mb-0"
             style="width: 100%;">
            <div class='d-flex align-items-center'>
                <div class='col-md-12'>
                    <div class="d-flex align-items-center justify-content-end">
                        <div class="btn-holder add-order-bump d-flex align-items-center pointer"
                             data-toggle="modal"
    ...
    <div class="card shadow"
        ...
        <div style="min-height: 300px">
            <div class="page-invoice-table table-responsive">
                <table id="table-order-bump"
                       class="table text-left table-striped unify"
    ...
    <div class="modal-dialog modal-dialog-centered modal-simple">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <table id="order-bump-show-table"
                       class="table table-striped mb-0 w-full">
                    <tr>
                        <td class="table-title">Descrição</td>
        ...
        <div class="modal-content">
                ...
                <form id="form-store-order-bump"
                    ...
                    <div class="form-group mb-10">
                        ...
                        <div class="d-flex input-group">
                            <input type="text"
                                   class="form-control"
                                   name="description"
                                   id="store-description-order-bump"
                    ...
                    <div class="form-group">
                        ...
                        <div id="ob_money_opt" class="input-group input-group-lg mb-3" >
                            ...
                            <input onkeyup="$(this).removeClass('warning-input')" maxlength="9" name="discount_value" id="ob_discount_value" type="text" class=" input-pad form-control value" placeholder="" aria-label="" aria-describedby="basic-addon1">
                        </div>

                        <div id="ob_percent_opt" class="input-group-lg input-group mb-3" style="display: none;">

                            <input onkeyup="$(this).removeClass('warning-input')" maxlength="2" data-mask="0#" name="percent_value" id="ob_percent_value" style="" type="text" class=" input-dad form-control" placeholder="" aria-label="" aria-describedby="basic-addon1" autocomplete="off">
                    ...
                    <div class="d-flex mb-10">
                        <div class="switch-holder w-full">
                            ...
                            <label class="switch">
                                <input type="checkbox"
                                       name="active_flag"
                                       id="store-active-flag-order-bump"
                                       class="check"
                                       value="1"
                                       checked>
                        ...
                        <div class="switch-holder w-full">
                            ...
                            <label class="switch">
                                <input type="checkbox"
                                       name="use_variants"
                                       class="use-variants-order-bump check"
                                       value="1"
                                       checked>
                                <span class="slider round"></span>
                            </label>
                    ...
                    <div class="form-group mb-10">
                        ...
                        <select name="apply_on_shipping[]"
                                id="store-apply-on-shipping-order-bump"
                                class="form-control"
                                multiple="multiple"
                                style="width:100%">
                        </select>
                    ...
                    <div class="form-group mb-10 apply-on-plan-container">
                        ...
                        <select name="apply_on_plans[]"
                                id="store-apply-on-plans-order-bump"
                                class="form-control"
                                multiple="multiple"
                    ...
                    <div class="form-group mb-10 offer-plan-container">
                        ...
                        <select name="offer_plans[]"
                                id="store-offer-plans-order-bump"
                                class="form-control"
                                multiple="multiple"
                                style="width:100%"></select>
                    </div>
            ...
            <div class="modal-footer pt-0">
                <button type="button"
                        ...
                        id="btn-store-order-bump">Salvar</button>
            </div>
        </div>
    </div>
</div>
...
<!-- Modal Update -->
<div id="modal-update-order-bump"
     class="modal fade modal-3d-flip-vertical"
     role="dialog"
     tabindex="-1">
    <div class="modal-dialog modal-dialog-centered modal-simple w-md-450">
        <div class="modal-content">
            ...
            <div class="modal-body pb-0">
                <form id="form-update-order-bump"
                      method="POST">
                    @csrf
                    @method('PUT')
                    <div class="form-group mb-10">
                    ...
                    <div class="form-group">
                        ...
                        <div id="obu_money_opt" class="input-group input-group-lg mb-3" >
                            ...
                            <input onkeyup="$(this).removeClass('warning-input')" maxlength="9" name="discount_value" id="obu_discount_value" type="text" class=" input-pad form-control value" placeholder="" aria-label="" aria-describedby="basic-addon1">
                        </div>

                        <div id="obu_percent_opt" class="input-group-lg input-group mb-3" style="display: none;">

                            <input onkeyup="$(this).removeClass('warning-input')" maxlength="2" data-mask="0#" name="percent_value" id="obu_percent_value" style="" type="text" class=" input-dad form-control" placeholder="" aria-label="" aria-describedby="basic-addon1" autocomplete="off">
                            <div class="input-group-append">
                                <span style="border-color: #e0e7ee; background-color: #fafafa" class="input-group-text" id="basic-addon1">%</span>
                            </div>
                        </div>
                    ...
                    <div class="d-flex mb-10">
                        <div class="switch-holder w-full">
                            ...
                            <label class="switch">
                                <input type="checkbox"
                                       name="active_flag"
                                       id="update-active-flag-order-bump"
                                       class="check">
                                <span class="slider round"></span>
                            </label>
                        </div>
                    ...
                    <div class="form-group mb-10">
                        ...
                        <select name="apply_on_shipping[]"
                                id="update-apply-on-shipping-order-bump"
                                class="form-control"
                                multiple="multiple"
                                style="width:100%"></select>
                    </div>
                    <div class="form-group mb-10 apply-on-plan-container">
                        <label for="link">Ao comprar o plano</label>
                        <select name="apply_on_plans[]"
                                id="update-apply-on-plans-order-bump"
                                class="form-control"
                                multiple="multiple"
                                style="width:100%"></select>
                    </div>
                    <div class="form-group mb-10 offer-plan-container">
                        <label for="link">Oferecer o plano</label>
                        <select name="offer_plans[]"
                                id="update-offer-plans-order-bump"
                                class="form-control"
                                multiple="multiple"
                                style="width:100%"></select>
                    </div>
            ...
            <div class="modal-footer pt-0">
                <button type="button"
                        class="btn btn-success"
                        id="btn-update-order-bump">Atualizar</button>
            </div>
        </div>
    </div>
</div>
<!-- End Modal Update -->
<!-- Delete -->
<div id="modal-delete-order-bump"
    ...
    <div class="modal-dialog  modal-dialog-centered  modal-simple">
        <div class="modal-content">
            ...
            <div class="modal-footer d-flex align-items-center justify-content-center">
                ...
                <button order-bump-id=""
                        type="button"
                        data-dismiss="modal"
                        id="btn-delete-orderbump"
