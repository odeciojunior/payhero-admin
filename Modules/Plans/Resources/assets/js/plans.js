$(function () {
                    ...
                    success: function success(response) {
                        ...
                        if (response.data.length > 0) {
                            response.data.forEach(function (product) {
                                var index_product = selected_products
                                    .map(function (e) {
                                        return e.id;
                                    })
                                    .indexOf(product.id);
                            ...
                            append +=
                                '<div class="text-center" style="height: 150px; margin-bottom: 25px; margin-top: 15px;"><img style="margin: 0 auto;" class="product-photo" src="/build/global/img/search-product_not-found.png" ></div>';
                            append +=
                                '<p class="m-0 text-center" style="font-size: 24px; line-height: 30px; color: #636363;">Nenhum resultado encontrado.</p>';
                            append +=
                                '<p class="text-center" style="font-size: 16px; line-height: 20px; color: #9A9A9A; margin-bottom: 20px;">Por aqui, nenhum produto com esse nome.</p>';
                            append += "</div>";
                        }
                        append + "</div>";
                                        ...
                                        $(modal)
                                            ...
                                            .done(function () {
                                                $(modal)
                                                    ...
                                                    .done(function () {
                                                        if (response.data.length > 6) {
                                                            $(modal).find(find_stage).find(".box-products").css({
                                                                height: "316px",
                                                            });
                                                        }
                    ...
                    success: function success(response) {
                        ...
                        if (response.data.length > 0) {
                            ...
                            append +=
                                '<p class="m-0 text-center" style="font-size: 24px; line-height: 30px; color: #636363;">Nenhum resultado encontrado.</p>';
                            append +=
                                '<p class="text-center" style="font-size: 16px; line-height: 20px; color: #9A9A9A;">Por aqui, nenhum produto com esse nome.</p>';
                            append += "</div>";
                        }
                        append + "</div>";
                        ...
                        selected_products.forEach(function (product) {
                            ...
                            $.ajax({
                                ...
                                success: function success(response) {
                                    ...
                                    append +=
                                        '<div class="product d-flex align-items-center" data-code="' +
                                        response.data.id +
                                        '">';
                                    append +=
                ...
                $.ajax({
                    ...
                    success: function success(response) {
                        ...
                        if (products.length <= 10) {
                            ...
                            products.forEach(function (product) {
                                ...
                                if (count <= 8) {
                                    append +=
                                        ...
                                        product.product_name +
                                        '" class="box-product" style="cursor: inherit;">';
                                    append +=
                                        '<div class="background-photo" style="width: 43px; height: 43px;"><img class="product-photo" src="' +
                                        product.photo +
                                        '" style="display: none;"></div>';
                                    append += "</div>";
                                }
                            ...
                            append +=
                                '<a type="button" id="all-products" style="cursor: pointer; color: #2E85EC; font-weight: bold; font-size: 16px;">+' +
                                missingProducts +
                                "</a>";
                            append += "</div>";
                            append += "</div>";
                ...
                products_plan.forEach(function (product) {
                    ...
                    if (product.custom_configs.length > 0) {
                        ...
                        append +=
                            ...
                            product.product_id +
                            '" name="check-values" class="check active_custom_product" value="' +
                            product.is_custom +
                            '" ' +
                            (product.is_custom ? "checked" : "") +
                            ">";
                ...
                $(modal)
                    ...
                    .done(function () {
                        if (products_plan.length > 2) {
                            $(modal).find("#stage1-customization").find(".body-products").css({
                                height: "214px",
                                position: "relative",
                                overflow: "hidden",
                            });
    ...
    function getProductCustom(modal, product_ID) {
        ...
        $(modal)
            ...
            .done(function () {
                ...
                index_product_custom = products_plan
                    .map(function (p) {
                        return p.product_id;
                    })
                    .indexOf(product_ID);
                ...
                $(modal)
                    .find("#stage2-customization")
                    .find(".qtd-product")
                    .html("Qtd: " + products_plan[index_product_custom].amount);
                $(modal)
                    .find("#stage2-customization")
                    .find(".active_custom")
    ...
    function storePlan(modalID, type) {
        if (type == "create") {
            $("#btn-modal-plan-next").attr("disabled", true);
            $.ajax({
                method: "POST",
                ...
                error: function error(response) {
                    errorAjaxResponse(response);
                    $("#btn-modal-plan-next").attr("disabled", false);
                },
                success: function success(response) {
                    index();
    ...
    $("body").on("click", ".box-product", function () {
        ...
        if ($(this).hasClass("review")) {
            ...
            if (
                (tabID == "tabs-modal-edit-plans" && stageID == "stage2") ||
                (tabID == "tabs-modal-create-plans" && stageID == "stage1")
            ) {
                        ...
                        $.ajax({
                            ...
                            success: function success(response) {
                                if (!response.product_in_plan_sale) {
                                    ...
                                    alertCustom(
                                        "error",
                                        "Não é possível remover o produto, possui vendas associadas a este plano."
                                    );
                                }
                            },
                        });
    ...
    $("body").on("click", "#check-values", function () {
        ...
        if (checkbox_value == 0) {
            ...
            var first_currency = $(".box-products")
                .find(".product")
                .first()
                .find('select[name="currency_type_enum"]')
                .val();
    ...
    $("#table-plans").on("click", ".details-plan", function () {
        ...
        $(modal)
            .find("#btn-cancel-update-informations-plan")
            .trigger("click")
            .promise()
            .done(function () {
    ...
    $("body").on("click", "#add-list-custom-product", function () {
        ...
        if (custom_title != "" && custom_type != "") {
            if (numCustom >= 5) {
                var msg =
                    numCustom == 5
                        ? "Você pode adicionar no máximo 5 personalizações ao seu produto"
                        : "Número máximo de personalizações do seu produto excedida";
            ...
            append +=
                '<input readonly type="text" name="label[' +
                product_ID +
                '][]" class="form-control input-pad edit-input" placeholder="Nome para personalização" value="' +
                custom_title +
                '">';
            append += "</div>";
    ...
    $("body").on("click", ".btn-delete", function (event) {
        ...
        if ($(".list-custom-products").find(".row").length == 0) {
            $(".list-custom-products").html(
                '<div class="row custom-empty" style="margin-bottom: 20px;"><div class="col-sm-12">Nenhum personalização adicionada</div></div>'
            );
        }
    });
    ...
    $("body").on("click", "#all-products", function () {
        ...
        $(modal)
            .find(".box-breadcrumbs")
            .find("span")
            .html(" " + products_plan.length + " produtos");
        ...
        $(modal)
            ...
            .done(function () {
                ...
                products_plan.forEach(function (product) {
                    append +=
                        '<div class="box-product align-items-center" style="cursor: inherit;margin-bottom: 16px;padding: 16px 29px 0px;border-radius: 0;border-left: none;border-right: none;border-bottom: none; border-color: #EBEBEB;">';
                    append +=
                        "<div " +
                        (product.product_name_short_flag
                            ? 'data-toggle="tooltip" data-placement="top" title="' + product.product_name + '"'
                    ...
                    $(".fullInformation-plans").bind("mouseover", function () {
                        ...
                        if (this.offsetWidth < this.scrollWidth && !$this.attr("title")) {
                            $this
                                ...
                                .tooltip({
                                    container: ".container-tooltips-plans",
                                });
                            $this.tooltip("show");
                        }
                    });
                    ...
                    success: function success(response) {
                        ...
                        if (response.data.length > 0) {
                            ...
                            append +=
                                '<p class="m-0 text-center" style="font-size: 24px; line-height: 30px; color: #636363;">Nenhum resultado encontrado.</p>';
                            append +=
                                '<p class="text-center" style="font-size: 16px; line-height: 20px; color: #9A9A9A; margin-bottom: 40px;">Por aqui, nenhum plano com esse nome.</p>';
                            append += "</div>";
                        }
                        append + "</div>";
    ...
    $("body").on("click", ".box-plan", function () {
        ...
        if ($(this).hasClass("review")) {
            ...
            if (!$(this).hasClass("selected")) {
                ...
                var index_selected_plans = selected_plans
                    .map(function (e) {
                        return e.id;
                    })
                    .indexOf(plan_id);
                                    ...
                                    success: function success(response) {
                                        ...
                                        if (response.data.length > 0) {
                                            ...
                                            append +=
                                                '<p class="m-0 text-center" style="font-size: 24px; line-height: 30px; color: #636363;">Nenhum resultado encontrado.</p>';
                                            append +=
                                                '<p class="text-center" style="font-size: 16px; line-height: 20px; color: #9A9A9A;">Por aqui, nenhum plano com esse nome.</p>';
                                            append += "</div>";
                                        }
                                        append + "</div>";
        ...
        $.ajax({
            ...
            success: function success(response) {
                ...
                $(".div-cost_currency")
                    ...
                    .attr(
                        "data-original-title",
                        "Definir uma moeda padrão para a configuração dos seus planos. Configuração utilizada para emissão de notas fiscais."
                    );
                ...
                $(".div-cost_shopify")
                    ...
                    .attr(
                        "data-original-title",
                        "Se configurado como sim, os custos serão atualizados sempre que houver alteração no shopify."
                    );
