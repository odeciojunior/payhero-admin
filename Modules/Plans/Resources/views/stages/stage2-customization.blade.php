<div>
    <form id="form-update-custom-config"
        ...
        <div class="box-breadcrumbs"
            ...
            <div class="d-flex"
                ...
                <div class="d-flex align-items-center">
                    <div class="icon mr-15"><img src="/build/global/img/icon-products-plans.svg"
                             alt="Icon Products"></div>
                    <div class="title"></div>
                </div>
            </div>
        </div>
        ...
        <div class="row"
            ...
            <div class="col-sm-12">
                <div class="d-flex align-items-end">
                    ...
                    <div>
                        <button style="width: 45px; height: 45px; line-height: 19px;"
                                type="button"
                                class="btn btn-plus"
                                id="add-list-custom-product">
                            <svg width="19"
                                 height="19"
                                 viewBox="0 0 19 19"
                                 fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path d="M18 9.5H1M9.5 1V18V1Z"
                                      stroke="#41DC8F"
                                      stroke-width="2"
        ...
        <div class="row"
             style="margin-bottom: 24px; line-height: 14px;">
            <div class="col-sm-12">
                <small>ATENÇÃO: Seja claro e objetivo. O campo de “nome” aparecerá como a descrição do arquivo ou texto
                    que seu cliente preencherá na página de obrigado.</small>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <h5 class="bold mb-0"
                    style="color: #636363;">Personalizações adicionadas</h5>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="list-custom-products"
                     id="list-custom-products">
                    {{-- JS carrega --}}
                </div>
            </div>
        </div>
