    ...
    <div class="box-breadcrumbs">
        <div class="d-flex"
            ...
            <div class="d-flex align-items-center">
                <div class="icon mr-15"><img src="/build/global/img/icon-info-plans-c.svg"
                         alt="Icon Informations"></div>
                <div class="title">Informações do plano</div>
            </div>
            <button class="btn btn-edit"
                    id="btn-edit-informations-plan">
                <svg width="15"
                     height="15"
                     viewBox="0 0 15 15"
                     fill="none"
...
<div class="review-edit">
    <div>
        <div class="d-flex"
             style="justify-content: space-between !important;">
            <div class="d-flex align-items-center">
                <div class="icon mr-15"><img src="/build/global/img/icon-review-plans-c.svg"
                         alt="Icon Informations"></div>
    ...
    <div class="review-data"
        ...
        <div class="d-flex justify-content-between"
            ...
            <div class="profit-plan">
                ...
                <p class="font-weight-bold m-0"
                   style="line-height: 100%; color: #41DC8F;"></p>
            </div>
        </div>
        <div class="text-center description-tax">
            <p class="m-0"
               style="line-height: 14px; font-size: 11px;">Simulação considerando compras à vista com taxa de
                <span></span> % + 1,00 (D+<span class="release_money_days"></span>).
            </p>
            <p class="font-weight-bold m-0"
               style="line-height: 14px; font-size: 11px;">Valor estimado sujeito à mudanças de acordo com as condições
                de pagamento.</p>
        </div>
    </div>
</div>
