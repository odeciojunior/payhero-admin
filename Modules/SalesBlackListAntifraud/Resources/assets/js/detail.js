$(() => {
    ...
    function renderSale(sale) {
        ...
        $("#payment-type").text(
            `Pagamento via ${sale.payment_method === 2 ? "Boleto" : "Cartao " + sale.flag} em ${sale.start_date} `
        );
        ...
        status
            .html("")
            .append(
                `<img style='width: 50px;' src='/build/global/img/cartoes/${sale.flag}.png' alt='Cartao utilizado'>`
            );
        if (sale.delivery_id != "") {
    ...
    function renderProducts(products) {
        ...
        $.each(products, function (index, value) {
            ...
            div += `<div class="row align-items-baseline justify-content-between mb-15">
                        <div class="col-lg-2">
                            <img onerror=this.src='/build/global/img/produto.svg' src='${value.photo}' width='50px' style='border-radius: 6px;'>
                        </div>
                        <div class="col-lg-5">
