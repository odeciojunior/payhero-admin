...
<div class='modal fade example-modal-lg'
     id='modal-detalhes-black-antifraud'
     aria-hidden='true'
     aria-labelledby='exampleModalTitle'
     role='dialog'
     tabindex='-1'>
    <div class='modal-dialog modal-simple modal-sidebar modal-lg'>
        <div id='modal-sale-details-blackantifraud'
            ...
            <div class='modal-body-detalhes-black-antifraud'>
                <div id='sale-details-black-antifraud'>
                    <h3 id='sale-code'
                        class=''></h3>
                    <p id='payment-type'
                       class='sm-text text-muted'></p>
                    <div id='status'
                         class='d-inline'></div>
                </div>
                <div class='clearfox'></div>
                <div id='sale-details-card-blackAntifraud'
                    ...
                    <div class="tab-pane fade show active"
                        ...
                        <div class="d-flex align-items-center">
                            <label for="customer-telephone"
                                   class="table-title gray mb-0">Telefone:</label>&nbsp;
                            <input id="customer-telephone"
                        ...
                        <div class="d-flex align-items-center">
                            <label for="customer-email"
                                   class="table-title gray mb-0">E-mail:</label>&nbsp;
