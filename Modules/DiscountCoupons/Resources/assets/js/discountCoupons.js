...
function formatMoney(input) {
    $(input).on("blur", function () {
        ...
        $(this).val(
            new Intl.NumberFormat("de-DE", { minimumFractionDigits: 2, maximumFractionDigits: 2 }).format($(this).val())
        );
        // input = this
                    ...
                    var item =
                        ...
                        `" >
                                    ...
                                    <span style="background-image: url('https://cloudfox-files.s3.amazonaws.com/produto.svg')" class="image">
                                        ...
                                        <span style="background-image: url(` +
                        (data[plan].photo ? data[plan].photo : "https://cloudfox-files.s3.amazonaws.com/produto.svg") +
                        `)" class="image2"></span>
                                    </span>
