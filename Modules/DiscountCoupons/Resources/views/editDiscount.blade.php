<form id="form-update-discount"
    ...
    <div style="display: none"
        ...
        <div class="modal-content s-border-radius"
             style="width:646px; min-height:624px; position: relative;">
            ...
            <div id="edit_step0"
                 style="min-height: 471px; max-height: 520px; overflow: hidden;">

                <div style='min-height: 100px; position: relative;'
                     class="pt-25 pb-30 pr-30 pl-30 simple-border-bottom">
                    ...
                    <div id="edit-name-box"
                        ...
                        <div class=""
                            ...
                            <input class="input-pad"
                                   ...
                                   maxlength="20"
                                   type="text"
                                   style="margin-bottom: 24px; height:48px" /> <br>
                            <div class="d-flex flex-row-reverse">

                                <button id="save_name_edit"
                                        class="btn btn-primary save-name-btn"
                                        type="button"
                                        style="margin-left: 4px">Finalizar</button>
                                <button id="cancel_name_edit"
                                        class="clean-cancel  btn btn-default btn-lg mr-10"
                ...
                <div id="plans_holder"
                     style='min-height: 100px; position: relative; padding: 30px 30px 0'
                     class="simple-border-bottom scroller">
                    ...
                    <div class="modal-disc">
                        ...
                        <span class="sub-title"> Planos com desconto <span
                                  style="color:#969696; font-size: 14px; font-weight: normal"> • <span
                                      id="planos-count">x planos</span></span> </span>
            ...
            <div id="edit_step1"
                ...
                <div style='min-height: 100px; position: relative;'
                    ...
                    <p>
                        ...
                        <span class="sub-title"> Planos no desconto <span
                                  style="color:#969696; font-size: 14px; font-weight: normal"> • <span
                                      id="planos-count-edit">x planos</span></span> </span>

                    <div class="custom-control custom-checkbox"
                         style="position: absolute; right: 32px; top: 26px;">
                        <span id="all-plans4"
                              class="pointer"
                    ...
                    <div class="edit-plans-thumbs edit-disc-plans-thumbs-scroll"
                         style="height: 76px">
                    ...
                    <div class="d-flex modal-new-layout box-description"
                         style="width: 594px">
                        <input class="form-control form-control-lg search_input_create_coupon search_coupon"
                               type="text"
                               id="search_input2"
                        ...
                        <div class="input-group input-group-lg"
                             style="width: 644px;">
                            <input onkeyup="set_description_value(this, $('.search_input_create_coupon'))"
                                   class="form-control"
                                   type="text"
                    ...
                    <div id="search_result2"
                         class="mt-20  search_result2"
                         style="height: 322px; width:621px; overflow: hidden">
            ...
            <div id="edit_step2"
                ...
                <div style='min-height: 100px'
                     class="inputs-warning2 pl-30 pr-30 simple-border-bottom">
                    ...
                    <div class="mt-10 h-60">
                        ...
                        <div class="float-left"
                            ...
                            <select id="buy-edit"
                                    class="sirius-select w-auto d-inline-block adjust-select">
                        ...
                        <div class="float-left">
                            ...
                            <input class="input-pad "
                                   id="qtde-edit"
                                   type="text"
                                   onkeyup="$(this).removeClass('warning-input')"
                                   style="margin: 0 1px; width: 60px; height:49px"
                                   maxlength="2"
                                   data-mask="0#" />
                            ...
                            <input class="input-pad "
                                   type="text"
                                   onkeyup="$(this).removeClass('warning-input')"
                                   style="width: 86px; display: none; height:48px; margin-right: 8px"
                                   id="percent-edit"
                                   maxlength="2"
                                   data-mask="0#"
                                   autocomplete="off">
                        ...
                        <div class="float-left">
                            <div id="add_rule-edit"
                                 class="add_rule pointer"
                    ...
                    <div class="clear-both"
                        ...
                        <div class="clear-both warning-text2"
                             style="font-weight: normal;
                                font-size: 13px;
                                line-height: 16px;
                                display:none;
                                color: #DE0000;">
                            <svg style="margin-top: -4px; margin-right: 4px "
                                 width="12"
                                 height="12"
                                 viewBox="0 0 12 12"
                                 fill="none"
                ...
                <div id="empty-rules2"
                    ...
                    <div class="col-4">
                        ...
                        <svg style="margin:45px 0 0 80px"
                             width="150"
                             height="153"
                             viewBox="0 0 150 153"
                             fill="none"
                            ...
                            <path d="M75 150C116.421 150 150 116.421 150 75C150 33.5786 116.421 0 75 0C33.5786 0 0 33.5786 0 75C0 116.421 33.5786 150 75 150Z"
                                  fill="url(#paint0_linear_397:1078)"></path>
                            <g filter="url(#filter0_d_397:1078)">
                                <mask id="mask0_397:1078"
                                      ...
                                      height="150">
                                    <path d="M75 150C116.421 150 150 116.421 150 75C150 33.5786 116.421 0 75 0C33.5786 0 0 33.5786 0 75C0 116.421 33.5786 150 75 150Z"
                                          fill="url(#paint1_linear_397:1078)"></path>
                                </mask>
                                <g mask="url(#mask0_397:1078)">
                                    <path d="M118 43H32C29.2386 43 27 45.2386 27 48V153C27 155.761 29.2386 158 32 158H118C120.761 158 123 155.761 123 153V48C123 45.2386 120.761 43 118 43Z"
                                          fill="white"></path>
                                </g>
                            </g>
                            <path d="M66 53H40C38.3431 53 37 54.3431 37 56C37 57.6569 38.3431 59 40 59H66C67.6569 59 69 57.6569 69 56C69 54.3431 67.6569 53 66 53Z"
                                  fill="#E1EBFA"></path>
                            <path d="M66 95H40C38.3431 95 37 96.3431 37 98C37 99.6569 38.3431 101 40 101H66C67.6569 101 69 99.6569 69 98C69 96.3431 67.6569 95 66 95Z"
                                  fill="#E1EBFA"></path>
                            <path d="M108 68H42C39.7909 68 38 69.7909 38 72V82C38 84.2091 39.7909 86 42 86H108C110.209 86 112 84.2091 112 82V72C112 69.7909 110.209 68 108 68Z"
                                  stroke="#1485FD"
                                  stroke-width="2"></path>
                            <path d="M108 109H42C39.2386 109 37 111.239 37 114V122C37 124.761 39.2386 127 42 127H108C110.761 127 113 124.761 113 122V114C113 111.239 110.761 109 108 109Z"
                                  fill="#DFEAFB"></path>
                            <path d="M53 32C55.2091 32 57 30.2091 57 28C57 25.7909 55.2091 24 53 24C50.7909 24 49 25.7909 49 28C49 30.2091 50.7909 32 53 32Z"
                                  fill="white"></path>
                            <path d="M75 32C77.2091 32 79 30.2091 79 28C79 25.7909 77.2091 24 75 24C72.7909 24 71 25.7909 71 28C71 30.2091 72.7909 32 75 32Z"
                                  fill="#1485FD"></path>
                            <path d="M97 32C99.2091 32 101 30.2091 101 28C101 25.7909 99.2091 24 97 24C94.7909 24 93 25.7909 93 28C93 30.2091 94.7909 32 97 32Z"
                                  fill="white"></path>
                            <path d="M86 88C88.7614 88 91 85.7614 91 83C91 80.2386 88.7614 78 86 78C83.2386 78 81 80.2386 81 83C81 85.7614 83.2386 88 86 88Z"
                                  fill="#DFEAFB"></path>
                            ...
                            <defs>
                                <filter id="filter0_d_397:1078"
                                    ...
                                    <feBlend mode="normal"
                                             ...
                                             result="effect1_dropShadow_397:1078"></feBlend>
                                    <feBlend mode="normal"
                                             in="SourceGraphic"
                                             in2="effect1_dropShadow_397:1078"
                                             result="shape"></feBlend>
                                </filter>
                                <linearGradient id="paint0_linear_397:1078"
                                                x1="75"
                                                y1="0"
                                                x2="75"
                                                y2="150"
                                    ...
                                    <stop offset="1"
                                          stop-color="#DAE7FF"></stop>
                                </linearGradient>
                                <linearGradient id="paint1_linear_397:1078"
                                                x1="75"
                                                y1="0"
                                                x2="75"
                                                y2="150"
                ...
                <div class="modal-footer"
                     style="border-bottom-left-radius: 16px; border-bottom-right-radius: 16px; position: absolute; bottom:0px; width:646px; border-top: 1px solid #EBEBEB; background-color: #fff; z-index:1000">
                    <div class="justify-center text-center mt-10"
                         style="width: 100%">
                        <button id="edit-rules-back"
                                class="btn back-btn"
                                type="button">Voltar</button>
                        <button class="btn btn-primary btn2 btn-save-edit-rules"
            ...
            <div class="modal-footer footer-padding"
                 style="border-bottom-left-radius: 16px; border-bottom-right-radius: 16px; bottom:0px; width:646px; border-top: 1px solid #EBEBEB; background-color: #fff">
                <div class="d-flex mt-10"
                    ...
                    <div id="plans-actions"
                         style="display: none;  width:100%"
                         class="justify-center text-center ">
                        <button class="btn cancel-btn"
                                type="button">Voltar</button>
                        <button class="btn btn-primary next-btn btn-edit-plans-save"
                                disabled
