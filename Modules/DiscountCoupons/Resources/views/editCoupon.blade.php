    ...
    <div style="display: none"
        ...
        <div class="modal-content s-border-radius"
            ...
            <div class="mdtpad simple-border-bottom">
                ...
                <a id="modal-button-close-3"
                   class="modal-button-close-2 pointer close"
                   role="button"
                   data-dismiss="modal"
                   aria-label="Close">
                    ...
                    <svg width="16"
                        ...
                        <path d="M15 1L1 15M1 1L15 15L1 1Z"
                              stroke="#636363"
                              stroke-width="2"
            ...
            <div id="c-edit_step0">
                <div id="coupon_edit_step0"
                     style="max-height: 553px; min-height:480px; overflow:hidden">

                    <div style=' position: relative; padding: 25px 30px 20px'
                        ...
                        <div id="edit-name-box-c"
                             style=" height: 68px; ">

                            <div class="row pt-20"
                                 id="c-display_name"
                                 style="color: #636363; padding-bottom:2px">
                                <div class="col-6">
                            ...
                            <div class="row pt-20"
                                ...
                                <div class="col-12 text-right">
                                    ...
                                    <button id="c-cancel_name_edit"
                                            class="mr-10 btn btn-default btn-lg clean-cancel"
                                            type="button">Cancelar</button>
                                    <button id="c-save_name_edit"
                                            class="btn btn-primary save-name-btn"
                                            type="button"
                    ...
                    <div style='min-height: 100px; position: relative; padding: 20px 30px 0px'
                        ...
                        <div style="padding-top: 10px; width: 160px; padding-bottom:18px">
                            <span style="color:#2E85EC; font-size: 14px; font-weight: 400; "
                                  id="mostrar_mais2"
                                  class="pointer">
                ...
                <div class="modal-footer "
                    ...
                    <div class="d-flex justify-content-between"
                         style="padding:15px 30px 20px; width: 100%;">
                        <div style="width: 236px"
                             class="mr-auto switch-holder d-flex align-items-center">
                            <label class="switch">
                                <input id="c-edit_status"
                                       type="checkbox"
                                       value="1"
                                       name="status"
                                       class="check status"
                            ...
                            <label id="c-edit_status_label"
                                   for="c-edit_status"
                                   class="pointer"
                                   style="font: normal normal bold 16px Inter; margin-bottom: 0;">Desconto
                                ativo</label>
                            <input type="hidden"
                                   name="set_status"
                                   id="c-set_status">
            ...
            <div id="c-edit_step1"
                 style="display: none">
                <div style='min-height: 100px; position: relative; padding:25px 25px 0px 25px'
                     class=" ">
                    ...
                    <div class="mb-20">
                        ...
                        <span class="sub-title"> Planos no cupom <span
                                  style="color:#969696; font-size: 14px; font-weight: normal"> • <span
                                      id="planos-count-edit">x planos</span></span> </span>

                        <div class="custom-control custom-checkbox"
                             style="position: absolute; right: 32px; top: 34px;">
                            <span id="all-plans2"
                                  class="pointer"
                    ...
                    <div class="edit-plans-thumbs edit-plans-thumbs-scroll"
                         style="height: 76px; ">
                    ...
                    <div class="d-flex modal-new-layout box-description"
                         style="width: 594px">
                        <input class="form-control form-control-lg search_input_create_coupon search_coupon search_input_create_coupon_edit_id"
                               type="text"
                               id="search_input2"
                               placeholder="Pesquisa por nome"
                               style="border-top-right-radius: 0;border-bottom-right-radius: 0; height: 48px !important; border-right: 0;">
                        <div class="input-group input-group-lg"
                             style="width: 644px;">
                            <input onkeyup="set_description_value(this, $('.search_input_create_coupon_edit_id'))"
                                   class="form-control"
                                   type="text"
                                   id="search_input_description"
                                   placeholder="Pesquisa por descrição"
                                   style="border-top-left-radius: 0;border-bottom-left-radius: 0;">
                            <div class="input-group-append">
                                <span class="input-group-text">
                                    <img src="/build/global/img/icon-search.svg"
                                         alt="Icon Search">
                                </span>
                            </div>
                        </div>
                ...
                <div class="modal-footer"
                    ...
                    <div style="width: 646px"
                         class="justify-center text-center mt-10">
                        <button class="btn btn2 c-plans-back"
                                type="button">Voltar</button>
                        <button class="btn btn-primary btn2 c-edit-plans-save"
                                disabled
            ...
            <div id="c-edit_step2"
                ...
                <div style='position: relative; min-height: 100px; padding:30px '
                     class="">
                    <div class="mb-20">
                        <svg width="36"
                             height="36"
                        ...
                        <div class="col-6">
                            ...
                            <div id="2money_opt"
                                ...
                                <div class="input-group-prepend">
                                    <span style="border-color: #e0e7ee; background-color: #fafafa"
                                          class="input-group-text"
                                          id="basic-addon1">R$</span>
                                </div>
                                <input onkeyup="$(this).removeClass('warning-input')"
                                       maxlength="9"
                                       name="discount_value"
                                       id="2discount_value"
                                       style=""
                    ...
                    <div class=" pt-20 flex row">
                        <div class="col-4"
                            ...
                            <input name="expires"
                                   ...
                                   type="text"
                                   id="date_range2"
                                   style="padding-right: 40px; height: 48px"
                                   autocomplete="off">
                            <svg id="cal-icon2"
                                 class="pointer"
                ...
                <div class="modal-footer"
                    ...
                    <div style="width: 646px"
                         class="justify-center text-center mt-10">
                        <button class="btn back-btn rule-coupon-back"
                                type="button">Voltar</button>
                        <button class="btn btn-primary btn2 update-rule-coupon"
