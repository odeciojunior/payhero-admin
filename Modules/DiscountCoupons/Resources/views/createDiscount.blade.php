<form id="form-register-discount">
    ...
    <div style="display: none"
        ...
        <div class="modal-content  s-border-radius"
             style="width:646px; height:696px">
                ...
                <div style='min-height: 100px; position: relative; padding: 25px 24px 0px 25px'
                    ...
                    <div style="margin-bottom: 21px">
                        ...
                        <div class="custom-control custom-checkbox"
                             style="position: absolute; right: 32px; top: 30px;">
                            <span id="all-plans3"
                                  class="pointer"
                    ...
                    <div class="d-flex modal-new-layout box-description"
                         style="width: 594px">
                        <input class="form-control form-control-lg search_input_create_discount"
                               type="text"
                               id="search_input"
                        ...
                        <div class="input-group input-group-lg"
                             style="width: 644px;">
                            <input onkeyup="set_description_value(this, $('.search_input_create_discount'))"
                                   class="form-control"
                                   type="text"
            ...
            <div id="step2"
                 style="display: none; position: relative; height: 622px">
                <div style=''
                     class=" ">
                    <input name="name"
                           id="discount_name"
                ...
                <div style='min-height: 100px; color:#636363'
                     class="inputs-warning pl-30 pr-25 simple-border-bottom">
                    ...
                    <div class="clear-both"
                        ...
                        <div class="clear-both warning-text"
                ...
                border-top:1px solid #EBEBEB">
                    ...
                    <button class="btn back-btn mr-10"
                            type="button">Voltar</button>
                    <button class="btn btn-primary finish-btn"
