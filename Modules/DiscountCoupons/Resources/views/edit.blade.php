<form id="form-update-coupon" method="PUT">
    ...
    <div class="row">
        <div class="form-group col-xl-12">
            ...
            <input value="" name="name" type="text" class="form-control coupon-name" placeholder="Descrição"
                   maxlength='20'>
        </div>
    </div>
    <div class="row">
        ...
        <div class="form-group col-xl-6">
            ...
            <input value="" name="value" type="text" class="form-control coupon-value" placeholder="Valor"
                   data-mask="0#">
        </div>
    </div>
    <div class="row">
        <div class="form-group col-xl-6">
            ...
            <input value="" name="code" type="text" class="form-control coupon-code" placeholder="Código"
                   maxlength='30'>
        </div>
        <div class="form-group col-xl-6">
