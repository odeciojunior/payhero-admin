<form id="form-register-coupon">
    @csrf
    <div style="display: none; padding:25px"
         id="select-coupon">
        <div class="modal-content s-border-radius"
             style="width:646px; height:698px">
            <div class="mdtpad simple-border-bottom">
                ...
                <a id="modal-button-close-4"
                   class="modal-button-close-3 pointer close"
                   role="button"
                   data-dismiss="modal"
                   aria-label="Close">
                    <svg width="16"
            ...
            <div class="step1">
                <div style='min-height: 100px; position: relative;'
                     class="pt-25 pl-25 pr-25 simple-border-bottom">
                    ...
                    <div class="mb-25">
                        ...
                        <span class="sub-title"
                              style="color: #636363"> Selecione os planos que terão cupom </span>

                        <div class="custom-control custom-checkbox"
                             style="position: absolute; right: 32px; top: 28px;">
                            <span id="all-plans"
                                  class="pointer"
                    ...
                    <div class="d-flex modal-new-layout box-description"
                         style="width: 594px">
                        <input class="form-control form-control-lg search_input_create_coupon  search_coupon search_input_create_coupon_id"
                               type="text"
                               id="search_input"
                        ...
                        <div class="input-group input-group-lg"
                             style="width: 644px;">
                            <input onkeyup="set_description_value(this, $('.search_input_create_coupon_id') )"
                                   class="form-control"
                                   type="text"
                    ...
                    <div id="search_result"
                         class="mt-20 "
                         style=" height: 393px; width:621px">
                ...
                <div class="modal-footer">
                    <div style="width: 100%"
                        ...
                        <button class="btn btn-primary coupon-next btn2"
                                disabled
            ...
            <div class="step2"
                ...
                <div style='position: relative; min-height: 100px'
                     class="p-25 simple-border-bottom">
                ...
                <div style='position: relative; height: 364px'
                     class="p-25 simple-border-bottom">
                    <p>
                    ...
                    <div class="pl-10 pt-20 flex row">
                        ...
                        <div class="col-6 pt-40">
                            ...
                            <label class="custom-check">
                                <input onchange="$('#date_range').removeClass('warning-input')"
                                       name="nao_vence"
                                       type="checkbox"
                ...
                <div class="modal-footer">
                    <div style="width: 100%"
                         class="justify-center text-center mt-10">
                        <button class="btn back-btn add-coupon-back"
                                type="button">Voltar</button>
                        <button class="btn btn-primary btn2 add-coupon"
