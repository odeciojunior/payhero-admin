        ...
        <div class="row">
            <div class='form-group col-12'>
                ...
                <div class="d-flex input-group">
                    <input type="text" class="input-pad addon" name="api_token" id="api_token_edit" placeholder="Digite o API Token" value=''>
                </div>
            </div>
        </div>
        <div class="row">
            <div class='form-group col-12'>
                ...
                <div class="d-flex input-group">
                    <input type="text" class="input-pad addon" name="url" id="url_edit" placeholder="Digite a URL">
                </div>
            </div>
        </div>
        <div class="row mt-20">
