    ...
    <div style="width:100%">
        ...
        <div class="row">
            <div class='form-group col-12'>
                <label for="url_store">API Token</label>
                <div class="d-flex input-group">
                    <input type="text" class="input-pad addon" name="api_token" id="api_token" placeholder="Digite o API Token">
                </div>
            </div>
        </div>
        <div class="row">
            <div class='form-group col-12'>
                ...
                <div class="d-flex input-group">
                    <input type="text" class="input-pad addon" name="url" id="url" placeholder="Digite a URL">
                </div>
            </div>
        </div>
        <div class="row mt-20">
