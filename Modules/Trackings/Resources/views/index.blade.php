...
@push('css')
<link rel="stylesheet" href="{!! asset('modules/global/css/empty.css?v=149') !!}">
...
<div class="page pb-0 " style="margin-bottom: 0px !important;">
    ...
    <div id="project-not-empty" style="display:none !important;">
        <div class="page-content container">
            ...
            <div class="row justify-content-center justify-content-md-end" style="max-height: 45px;">
                <ul id="pagination-trackings" class="pl-5 pr-md-15 pb-60" style="margin-top:10px;position:relative;float:right;">
                    {{-- js carrega... --}}
                </ul>
            </div>
