...
@section('content')
    @push('css')
        <link rel="stylesheet"
              href="{{ mix('build/layouts/trackings/index.min.css') }}">
    @endpush
    ...
    <div class="page pb-0 "
        ...
        <div style="display: none"
            ...
            <div class="row align-items-center justify-content-between"
                ...
                <div class="col">
                    <div id="export-excel"
                         class="row justify-content-lg-end">
                        <div class="col mt-lg-0 mt-20"
                             style="flex-grow: 0">
                            <div class="d-flex align-items-center">
                                <span class="o-download-cloud-1 mr-2"></span>
                                <div class="btn-group"
                                     role="group">
                                    <button id="btn-export-xls"
                                            type="button"
                                            class="btn btn-round btn-default btn-outline btn-pill-left border-right-0">.xls
                                    </button>
                        ...
                        @can('trackings_manage')
                            <div class="col mt-lg-0 mt-20 p-0 mr-25"
                                 style="flex-grow: 0">
                                <div class="d-flex align-items-center">
                                    <button id="btn-import-xls"
                                            type="button"
                                            class="btn btn-round btn-default btn-outline font-weight-bold"
                                            style="min-width: 118px; font-size: 14px;">Importar
                                    </button>
                                    <input type="file"
                                           id="input-import-xls"
                                           style="display:none"
                            ...
                            <div class="col mt-lg-0 mt-20 p-0"
                                 style="flex-grow: 0">
                                <div class="d-flex align-items-center mr-15">
                                    <a class="rounded-info btn mr-3 d-flex justify-content-center align-items-center btn-default btn-outline"
                                       data-toggle="modal"
                                       data-target="#modal-detalhes-importar"
                    ...
                    <div class="panel-group panel-group-continuous m-0"
                        ...
                        <div class="panel">
                            ...
                            <div class="panel-collapse collapse"
                                 ...
                                 role="tabpanel"
                                 style="">
                                <div class="panel-body justify-content-center position-relative"
                                ...
                                <div class="panel-body">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <span class="o-download-cloud-1 mr-2"></span>
                                            <button type="button"
                                                    class="btn btn-round btn-default btn-outline"
        ...
        <div id="project-not-empty"
            ...
            <div class="page-content container">
                    ...
                    <div class="collapse"
                        ...
                        <div class="row pt-15">
                            <div class="col-sm-6 col-md-6 col-xl-3 col-12 mb-15 mb-sm-0">
                                ...
                                <select name='status_commission'
                                        id="status_commission"
                                        class="form-control select-pad applySelect2">
                                    <option value="">Todos</option>
                            ...
                            <div class="col-sm-6 col-md-6 col-xl-3 col-12 mb-15 mb-sm-0 form-icons">
                                ...
                                <i style="right: 30px; margin-top: -9px;"
                    ...
                    <div class="row mb-10 mb-sm-0"
                        ...
                        <div class="col-6 col-xl-3 mt-20 offset-xl-6 pr-0">
                            <div class="btn btn-light-1 w-p100 bold d-flex justify-content-center align-items-center"
                                ...
                                <div id="text-filtro"
                                     style="white-space: normal">Filtros avançados</div>
                            </div>
                        </div>
                ...
                <div id="alert-tracking-issues"
                     class="d-flex alert alert-light alert-dismissible fade show text-primary border border-primary alert-tracking"
                     role="alert"
                    ...
                    <button type="button"
                            class="close text-primary ml-auto"
                            data-dismiss="alert"
                            aria-label="Close"
                            style="opacity: 1">
                ...
                <div id="alert-blockedbalance"
                     class="alert alert-danger alert-dismissible fade show card py-10 pl-20 pr-10"
                     style="display:none;">
                    <div class="d-flex">
                ...
                <!-- Resumo -->
                <div class="container">
                    <div id="viewer-data-general"
                         class="row">

                        <div class="col-12 col-lg-6 adjust">
                            <div id="panel-cards"
                                 class="row pr-lg-30 pb-0">

                                <div id="posted"
                                     class="col-md-4 col-sm-6 col-xs-12 border-right border-bottom px-0 bg-white card-posted">
                                    <div class="card mb-0 rounded-0 card-posted">
                                        <div class="card-body">
                                            <h6 class="font-size-16 gray-600 m-0"
                                                data-toggle="tooltip"
                                                data-container=".page"
                                                data-placement="top"
                                                title="Postados">Postados </h6>
                                            <h4 id="percentual-posted"
                                                class="mt-12 mb-0 text-nowrap resume-number">
                                    ...
                                    <div class="card mb-0 rounded-0">
                                        <div class="card-body">
                                            <h6 class="font-size-16 gray-600 m-0"
                                                ...
                                                data-container=".page"
                                                data-placement="top"
                                                title="Em trânsito">Em trânsito</h6>
                                            <h4 id="percentual-dispatched"
                                                class="mt-12 mb-0 text-nowrap resume-number">
                                                <span class="resume-number">0</span>
                                            </h4>
                                        </div>
                                ...
                                <div class="col-md-4 col-sm-6 col-xs-12 border-bottom pl-0 pr-0 bg-white card-to-delivery">
                                    <div class="card mb-0 rounded-0 card-to-delivery">
                                        <div class="card-body">
                                            <h6 class="font-size-16 gray-600 m-0 text-truncate"
                                                data-toggle="tooltip"
                                                data-container=".page"
                                                data-placement="top"
                                                title="Saiu para entrega">Saiu para entrega</h6>
                                            <h4 id="percentual-out"
                                                class="mt-12 mb-0 text-nowrap resume-number">
                                                <span class="resume-number">0</span>
                                            </h4>
                                        </div>
                                    ...
                                    <div class="card mb-0 rounded-0 card-delivery-problem">
                                        <div class="card-body">
                                            <h6 class="font-size-16 gray-600 m-0 text-truncate"
                                                ...
                                                data-container=".page"
                                                data-placement="top"
                                                title="Problema na entrega">Problema na entrega</h6>
                                            <h4 id="percentual-exception"
                                                class="mt-12 mb-0 text-nowrap resume-number">
                                                <span class="resume-number">0</span>
                                            </h4>
                                        </div>
                                    ...
                                    <div class="card mb-0 rounded-0">
                                        <div class="card-body">
                                            <h6 class="font-size-16 gray-600 m-0 text-truncate"
                                                ...
                                                data-container=".page"
                                                data-placement="top"
                                                title="Não informado">Não informado</h6>
                                            <h4 id="percentual-unknown"
                                                class="mt-12 mb-0 text-nowrap resume-number">
                                                <span class="resume-number">0</span>
                                            </h4>
                                        </div>
                                    ...
                                    <div class="card mb-0 rounded-0 card-delivered">
                                        <div class="card-body">
                                            <h6 class="font-size-16 gray-600 m-0"
                                                ...
                                                data-container=".page"
                                                data-placement="top"
                                                title="Entregues">Entregues</h6>
                                            <h4 id="percentual-delivered"
                                                class="mt-12 mb-0 text-nowrap resume-number">
                                                <span class="resume-number">0</span>
                                            </h4>
                                        </div>
                        ...
                        <!--GRAFICO E LEGENDA -->
                        <div
                             class="col-12 col-lg-6 card-graphic-labels bg-white d-flex align-items-center justify-content-center mt-20 mt-lg-0">
                            ...
                            <div id="panel-graph"
                                ...
                                <div class="col-md-7 px-0 ">
                                    <div class="card m-0 card-graphic-labels"
                                        ...
                                        <div id="data-labels"
                                             class="d-flex card-body pl-10 justify-content-start align-items-center">
                                            <div class="labels row">
                                                <h2 class="font-size-14 gray-600 col-6 mt-10 "> <i
                                                       class="fas fa-circle mr-5 posted"></i> Postados</h2>
                                                <h2 class="font-size-14 gray-600 col-6 mt-10"> <i
                                                       class="fas fa-circle mr-5 delivered"></i> Entregues</h2>
                                                <h2 class="font-size-14 gray-600 col-6 mt-10"> <i
                                                       class="fas fa-circle mr-5 inTransit"></i> Em trânsito</h2>
                                                <h2 class="font-size-14 gray-600 col-6 mt-10 "> <i
                                                       class="fas fa-circle mr-5 withoutInfo"></i> Não informado</h2>
                                                <h2 class="font-size-14 gray-600 col-6 mt-10 "> <i
                                                       class="fas fa-circle mr-5 onDelivery"></i> Saiu para entrega</h2>
                                                <h2 class="font-size-14 gray-600 col-6 mt-10 "> <i
                                                       class="fas fa-circle mr-5 withProblem"></i> Problema na entrega</h2>
                                            </div>
                                        </div>
                    ...
                    <div class="page-invoice-table table-responsive no-final-space">
                        <table id="tabela_trackings"
                            ...
                            <tbody id="dados_tabela"
                                   img-empty="{!! mix('build/global/img/rastreio.svg') !!}">
                                {{-- js carrega... --}}
                            </tbody>
                        </table>
                    </div>
                        ...
                        <div id='modal-tracking-details'
                            ...
                            <div class="modal-body">
                                ...
                                <div class="p-10">
                                    ...
                                    <div class="row align-items-center mb-20">
                                        <div class="col-lg-10 col-9">
                                            <div class="row align-items-center pl-10">
                                                <img id="tracking-product-image"
                                                     src=""
                                                     width="50px"
                                                     style="border-radius: 6px;">
                                                <h4 id="tracking-product-name"
                                                    class="table-title ml-10 ellipsis"
                                                    style="flex: 1"></h4>
                                            </div>
                                        </div>
                                        <div class="col-lg-2 col-3 text-center">
                                            <span id="tracking-product-amount"
                                                  class="sm-text text-muted"></span>
                                        </div>
                                    </div>
                                    <div>
                                        <h4> Destino </h4>
                                        <span id="tracking-delivery-address"
                                              class="table-title gray"></span>
                                        <br>
                                        <span id="tracking-delivery-neighborhood"
                                              class="table-title gray"></span>
                                        <br>
                                        <span id="tracking-delivery-zipcode"
                                              class="table-title gray"></span>
                                        <br>
                                        <span id="tracking-delivery-city"
                                              class="table-title gray"></span>
                                    </div>
                                    ...
                                    <p class="mt-5"
                                       id="link-tracking"><i class="material-icons">link</i>
                                        <a target="_blank"
                                           class="pointer text-body">Acessar link de rastreio</a>
                                    </p>
                                    <table class="table">
                                        <thead>
                                            <tr>
