...
class TrackingShowResource extends JsonResource
{
    public function toArray($request)
    {
        ...
        if (!empty($this->product)) {
            ...
            $linkBase = $domain ? $domain->name : "nexuspay.vip";
        } else {
        ...
        return [
            ...
            "tracking_status" => $this->tracking_status_enum
                ? __(
                    "definitions.enum.tracking.tracking_status_enum." .
                        $this->present()->getTrackingStatusEnum($this->tracking_status_enum)
                )
                : "Não informado",
