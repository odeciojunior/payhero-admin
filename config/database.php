    ...
    */
    ...
    'connections' => [
        ...
        'stage' => [
            ...
            'database' => env('DB_DATABASE_STAGE', 'forge'),
            'username' => env('DB_USERNAME_STAGE', 'forge'),
            'password' => env('DB_PASSWORD_STAGE', ''),

            'driver' => 'mysql',
            'unix_socket' => env('DB_SOCKET_STAGE', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'strict' => true,
    ...
    */
    ...
    'redis' => [
        ...
        'redis-statement' => [
            ...
            'database' => env('REDIS_STATEMENT_DB', 3),
        ],
    ]
